...
`;function mo(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen])}}function ho(e,t,n){return t===``||n===``?[...e]:e.filter(e=>Yr(M(e,t))===n)}function go(e){let t=e.getAttribute(`source`)??``;if(t===``)return null;let n=j(B().FF_DATA_SOURCES,t);return n?{quelle:n,zeilen:ho(Et(B().SEDATA,n.name,n.tableId,n.offenerSatz),e.getAttribute(`tagfield`)??``,ei()),lies:Ui(e)}:null}function _o(e){return _a(e.getAttribute(`spalten`)??``)}function vo(e,t){let n=j(B().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?xt(n,t):``}function yo(e){let t=j(B().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return t!==void 0&&t.indexField!==``}function bo(e,t){t&&e.vergissGeschriebene();let n=go(e);if(!n){e.datenzeilen=[];return}let r=_o(e),{rows:i,gefiltert:a}=Yt(e,n.zeilen),o=Ht(F(e),i,e=>e)[0]??-1,s=n.lies;e.datenGeliefert=!0,e.rohzeilen=i,e.auswahlIndex=o,e.durchAuswahlGefiltert=a,e.datenzeilen=i.map(e=>r.map(t=>t.feld===``?``:s(e,t.feld)))}var xo=Ri({hydriere:bo}),So=xo.connect,Co=xo.disconnect;function wo(e,t){let n=[];return e.forEach((e,r)=>{ai(e,t)&&n.push(r)}),n}function To(e,t){return!e&&t.trim()!==``}function Eo(e,t,n){return e&&t&&n===0}function Do(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function Oo(e){return da([...e,ua(e.length)])}function ko(e,t,n){let r=Pa(e);if(!r)return null;let i=new Set(n.map(e=>e.kennung)),a=Fa(r,t.map(e=>e.kennung).filter(e=>e!==``&&!i.has(e)));return a===r?null:Ia(a)}function Ao(e,t){return e.length<=1||t<0||t>=e.length?e:e.filter((e,n)=>n!==t)}function jo(e,t,n,r){let i=n();if(e<0||e>=i.length)return;let a=Math.max(0,Math.min(t,i.length-1));if(a===e)return;let[o]=i.splice(e,1);i.splice(a,0,o),r(i)}var Mo=5;function No(e,t,n){if(e.button!==0||!n.editable()||e.target instanceof HTMLElement&&e.target.isContentEditable)return;let r=e.currentTarget?.parentElement;if(!r)return;let i=[...r.children].filter(e=>e instanceof HTMLElement&&e.tagName===`DIV`);if(i.length<2)return;e.stopPropagation();let a=e.clientX,o=!1,s=t,c=e=>{for(let t=0;t<i.length;t++){let n=i[t].getBoundingClientRect();if(e<n.left+n.width/2)return t}return i.length},l=e=>{i.forEach((n,r)=>{n.classList.toggle(`zug-quelle`,o&&r===t),n.classList.toggle(`zug-slot`,o&&r===e),n.classList.toggle(`zug-slot-ende`,o&&e===i.length&&r===i.length-1)})},u=e=>{e.stopPropagation(),e.preventDefault()},d=()=>{window.removeEventListener(`pointermove`,f),window.removeEventListener(`pointerup`,p),window.removeEventListener(`pointercancel`,m),window.removeEventListener(`blur`,m);let e=o;o=!1,l(-1),e&&(document.body.style.cursor=``)};function f(e){if(!o){if(Math.abs(e.clientX-a)<Mo)return;o=!0,n.vorZug(),document.body.style.cursor=`grabbing`,window.addEventListener(`click`,u,{capture:!0,once:!0})}e.preventDefault(),s=c(e.clientX),l(s)}function p(){let e=o,r=s;d(),e&&jo(t,r>t?r-1:r,n.liste,n.aendere)}function m(){o&&window.removeEventListener(`click`,u,!0),d()}window.addEventListener(`pointermove`,f),window.addEventListener(`pointerup`,p),window.addEventListener(`pointercancel`,m),window.addEventListener(`blur`,m)}function Po(e,t){let n=e.currentTarget;n&&(e.stopPropagation(),e.preventDefault(),at(n,(e,n)=>e===``||e===n.trim()?!1:(t(e),!0)))}function Fo(e,t,n,r){Po(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var Io=220,Lo=new WeakMap;function Ro(e){let t=Lo.get(e);t!==void 0&&(clearTimeout(t),Lo.delete(e))}function zo(e){return{dblklickKopf:(t,n)=>{e.editable()&&(Ro(e.baustein),Fo(t,n,e.liste,e.aendere))},klickKopf:(t,n)=>{e.editable()&&Bo(e.baustein,t,{prop:e.prop,index:n,liste:e.liste}),e.sortiere(n)}}}function Bo(e,t,n){t.stopPropagation();let r=t.currentTarget.getBoundingClientRect();Ro(e),Lo.set(e,setTimeout(()=>{Lo.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n.prop,index:n.index,top:r.bottom+4,left:r.left,...n.liste?{liste:n.liste()}:{}},bubbles:!0,composed:!0}))},Io))}var Vo=`\0`;function Ho(e,t){return e+Vo+String(t)}var Uo=class{constructor(){this.werte=new Map}setze(e,t,n){if(e===``)return!1;let r=Ho(e,t);return this.werte.get(r)===n?!1:(this.werte.set(r,n),!0)}nimmZurueck(e,t){return this.werte.delete(Ho(e,t))}wert(e,t){return e===``?void 0:this.werte.get(Ho(e,t))}get anzahl(){return this.werte.size}proSatz(){let e=[];for(let[t,n]of this.werte){let[r,i]=t.split(Vo),a=Number(i),o=e.find(e=>e.satz===r),s={satz:r,spalte:a,wert:n};o?o.aenderungen.push(s):e.push({satz:r,aenderungen:[s]})}return e}nimmSatzZurueck(e){let t=!1;for(let n of[...this.werte.keys()])n.slice(0,n.indexOf(Vo))===e&&this.werte.delete(n)&&(t=!0);return t}},Wo=class{constructor(e){this.aenderungen=new Uo,this.geloescht=new Set,this.wirt=e}get geaenderteZeilen(){if(this.aenderungen.anzahl===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let{satz:r}of this.aenderungen.proSatz()){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}get geloeschteZeilen(){if(this.geloescht.size===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let r of this.geloescht){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}austragen(e,t){let n=!1;for(let r of t)n=e===`geaendert`?this.aenderungen.nimmSatzZurueck(r)||n:this.geloescht.delete(r)||n;n&&this.wirt.melde()}vorgemerkteAenderungen(){return this.geaenderteZeilen.length}vorgemerkteLoeschungen(){return this.geloeschteZeilen.length}statusVon(e){let t=this.satzVon(e);if(t===``)return{status:`gebucht`,titel:``};if(this.geloescht.has(t))return this.wirt.lauf.zeigt(`geloescht`,t,`loeschung`);let n=this.wirt.spalten().some((e,n)=>this.aenderungen.wert(t,n)!==void 0);return this.wirt.lauf.zeigt(`geaendert`,t,n?`geaendert`:`gebucht`)}satzPlaetze(){let e=new Map;return this.wirt.rohzeilen().forEach((t,n)=>{let r=vo(this.wirt.baustein,t);r!==``&&!e.has(r)&&e.set(r,n)}),e}satzVon(e){let t=this.wirt.rohzeilen()[e];return t===void 0?``:vo(this.wirt.baustein,t)}schalteLoeschung(e){let t=this.satzVon(e);t!==``&&(this.geloescht.has(t)?this.geloescht.delete(t):(this.geloescht.add(t),this.wirt.spalten().forEach((e,n)=>{this.aenderungen.nimmZurueck(t,n)})),this.wirt.melde())}istGeloescht(e){let t=this.satzVon(e);return t!==``&&this.geloescht.has(t)}zellWert(e,t){let n=this.aenderungen.wert(this.satzVon(e),t);return n===void 0?this.wirt.datenzeilen()[e]?.[t]??``:n}istGeaendert(e,t){return this.aenderungen.wert(this.satzVon(e),t)!==void 0}tippeZelle(e,t,n){this.aenderungen.setze(this.satzVon(e),t,n)&&this.wirt.melde()}verlasseZelle(e,t,n){let r=this.satzVon(e);(n===(this.wirt.datenzeilen()[e]?.[t]??``)?this.aenderungen.nimmZurueck(r,t):this.aenderungen.setze(r,t,n))&&this.wirt.melde()}zelleNachbar(e,t,n,r){let i=Array.from(this.wirt.baustein.shadowRoot?.querySelectorAll(`.koerper > .zeile:not(.erfassung) .zell-eingabe[data-spalte="${e}"]`)??[]),a=i.indexOf(t);if(a<0)return;let o=a+n;if(o>i.length-1){if(r&&this.wirt.erfassungAn()){this.wirt.fokussiereErfassungsZelle(0);return}o=i.length-1}o<0&&(o=0);let s=i[o];!s||s===t||(s.focus(),s.select(),s.scrollIntoView({block:`nearest`}))}tasteZelle(e,t,n){let r=n.target;if(n.key===`Escape`){n.preventDefault(),n.stopPropagation(),this.aenderungen.nimmZurueck(this.satzVon(e),t)&&this.wirt.melde();return}let i={Enter:1,ArrowDown:1,ArrowUp:-1,PageDown:10,PageUp:-10}[n.key];i!==void 0&&(n.preventDefault(),n.stopPropagation(),this.zelleNachbar(t,r,i,n.key===`Enter`))}},Go={gebucht:``,erfasst:`Neue Zeile — noch nicht geschrieben`,geaendert:`Geändert — noch nicht geschrieben`,loeschung:`Zum Löschen vorgemerkt — noch nicht geschrieben`,schreibt:`Wird geschrieben …`,geschrieben:`Hinausgeschickt — bleibt stehen, bis neue Daten kommen`,fehler:`Nicht geschrieben`},Ko=class{constructor(e){this.schreibend=new Map,this.fehler=new Map,this.melde=e}schreibt(e,t){this.fehler.get(e)?.delete(t);let n=this.schreibend.get(e)??new Set;n.add(t),this.schreibend.set(e,n),this.melde()}gescheitert(e,t,n){this.schreibend.get(e)?.delete(t);let r=this.fehler.get(e)??new Map;r.set(t,n),this.fehler.set(e,r),this.melde()}fertig(e,t){this.schreibend.get(e)?.clear();let n=this.fehler.get(e);if(n)for(let e of t)n.delete(e);this.melde()}zeigt(e,t,n){let r=this.fehler.get(e)?.get(t);return r===void 0?this.schreibend.get(e)?.has(t)===!0?{status:`schreibt`,titel:Go.schreibt}:{status:n,titel:Go[n]}:{status:`fehler`,titel:Go.fehler+`: `+r}}},qo=4;function Jo(e){return e??qo}function Yo(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function Xo(e,t,n){let r=Yo(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function Zo(e,t){return e===null?null:Math.max(0,e-t)}function Qo({sichtbar:e,hatQuelle:t,platzhalterZeilen:n}){return t?{seiten:1,seite:0,zeilen:[...e]}:{seiten:1,seite:0,zeilen:Array.from({length:n},()=>null)}}function $o({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function es(e){if(!e.hasAttribute(`fuellt`))return-1;let t=e.renderRoot.querySelector(`.koerper`);return t instanceof HTMLElement?t.clientHeight:-1}function ts(e){let t=e.renderRoot.querySelector(`.kopf`);return t instanceof HTMLElement?t.offsetHeight:0}function ns(e,t){let n=es(e);if(n===-1)return{mass:null,hoehe:n,kopf:0};let r=ts(e);return{mass:Xo(n,r,t),hoehe:n,kopf:r}}function rs(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}var is=`ff-zeile-aktiviert`,as=`data-ff-roh`;function os(e,t){e.dispatchEvent(new CustomEvent(is,{detail:t,bubbles:!0,composed:!0}))}function ss(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(as);return r===null||r===``?null:Number(r)}function cs(e,t){if(!(e instanceof HTMLElement))return!1;let n=e.closest(`.zeile`),r=n?.parentElement;if(!n||!r)return!1;let i=[...r.querySelectorAll(`.zeile[${as}]`)],a=i.indexOf(n),o=a===-1?void 0:i[a+t];return o?(o.focus(),!0):!1}function ls(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.zeile[${as}]`);return t?(t.focus(),!0):!1}function us(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.suchzeile input`);return t?(t.focus(),!0):!1}function ds(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var fs=class{constructor(e){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._rumpfGemessen=-1,this._kopfGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this.wirt=e}get suchtext(){return this._suchtext}get suchtAktiv(){return this._suchtext.trim()!==``}get sortSpalte(){return this._sortSpalte}get sortAuf(){return this._sortAuf}get seite(){return this._seite}get mass(){return this._mass}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.wirt.melde()}klickSortiere(e){this.wirt.editable()||(this.merkeZeilenFokus(),this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.wirt.melde())}blaettere(e){this.merkeZeilenFokus(),this._seite=e,this.wirt.melde()}fokussiereSuche(){let e=this.wirt.baustein.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}merkeZeilenFokus(){let e=ss(this.wirt.baustein.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.wirt.zeilenHoehe();this._taktGemessen=e;let{mass:t,hoehe:n,kopf:r}=ns(this.wirt.baustein,e);this._rumpfGemessen=n,this._kopfGemessen=r,!(t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe)&&(this._mass=t,this.wirt.melde())}beobachte(){this._beobachter||(this._beobachter=rs(this.wirt.baustein,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}nachRendern(){(this._taktGemessen!==this.wirt.zeilenHoehe()||this._rumpfGemessen!==es(this.wirt.baustein)||this._kopfGemessen!==ts(this.wirt.baustein))&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,ds(this.wirt.baustein.shadowRoot,this._fokusZeile))}loese(){this._beobachter?.disconnect(),this._beobachter=null}nachPush(){this._seite=0,this._mass=null,this._taktGemessen=0,this._rumpfGemessen=-1,this._kopfGemessen=0}zuruecksetzen(){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this.nachPush(),this._fokusZeile=null,this._fokusHolen=!1}};function ps(e,t,n,r){if(n===null||e.hasAttribute(`data-ff-editor`))return;let i=t[n];i!==void 0&&(os(e,{rohzeile:i,rohIndex:n,ansichtIndex:r}),hs(e,i),Tr(e,`onRowClick`,{PINDEX:vo(e,i)}).catch(_r))}function ms(e,t,n){if(n===null||e.hasAttribute(`data-ff-editor`))return;let r=t[n];r!==void 0&&Tr(e,`onRowDblClick`,{PINDEX:vo(e,r)}).catch(_r)}function hs(e,t){let n=F(e);n!==``&&Ut(n,t)}var gs={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,kennungKey:`kennung`,standardTitel:ca,eintragNeu:e=>{let t=ga(e.spalten);return t.length>=16?{}:{spalten:Oo(t)}},eintragWeg:(e,t)=>{let n=ga(e.spalten),r=Ao(n,t);if(r===n)return{};let i=ko(e.rechnung,n,r);return{spalten:[...r],...i===null?{}:{rechnung:i}}},eintragsSchalter:[{key:`summe`,label:`Summe in der Fußzeile`,kurz:`Summe`},{key:`aenderbar`,label:`In der Zeile änderbar`,kurz:`änderbar`,standard:!0,nurEigeneQuelle:!0}],herkunftProp:`spaltenHerkunft`,eintragsFeldWahl:[{key:`fuellFeld`,label:`Nachschlagen`,hinweis:`Beim Erfassen füllt der gewählte Satz der Hilfsquelle diese Zelle.`,nurFremdeQuellen:!0}]};function _s(e){let t=e,n=gs.eintragsSchalter?.find(e=>e.key===`aenderbar`);return n!==void 0&&e.feld!==``&&gi(gs,t).includes(n)&&hi(n,t)}function vs(e,t,n){let r=0,i=0;for(let t of e){let e=io(t);e!==null&&(r+=e,i++)}return i===0?``:r.toLocaleString(`de-DE`,{minimumFractionDigits:t,maximumFractionDigits:n})}var ys={min:0,max:3};function bs(e,t){let n=[];return e.spalten.forEach((r,i)=>{if(r.summe!==!0)return;let a=vs(t.map(t=>e.wertVon(t,i)),ys.min,ys.max);a!==``&&n.push({titel:r.titel,text:a})}),n}function xs(e){return e.datenzeilen.map((t,n)=>e.spalten.map((t,r)=>e.wertVon(n,r)))}function Ss(e){let t=xs(e),n=wo(t,e.suchtext);return e.sortSpalte<0?n:lo(n.map(e=>t[e]),e.sortSpalte,e.sortAuf).map(e=>n[e])}function Cs(e){let t={gridTemplateColumns:va(e.spalten,e.breiteVon)},n=e.gemessen?.zeilenHoehe??28,r=e.hatQuelle,i=!e.erfassungAn&&Eo(r,e.datenGeliefert,e.datenzeilen.length),a=Ss(e),o=e.erfassungAn?1+e.erfassteAnzahl:0,s=e.gemessen===null?null:Math.max(1,e.gemessen.passen-o),c={sichtbar:a,hatQuelle:r,proSeite:s??Math.max(1,10-o),wunschSeite:e.wunschSeite,platzhalterZeilen:Jo(s)},{seiten:l,seite:u,zeilen:d}=e.blaettert?$o(c):Qo(c);return{cols:t,takt:28,zeilenHoehe:n,hatQuelle:r,leer:i,gesamt:a.length,seiten:l,seite:u,zeilen:d,linealTakte:Zo(s,d.length),summen:bs(e,a)}}var ws=[U(`suche`,`Suchzeile`,`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,{requiresDataSource:!0}),U(`erfassung`,`Erfassungszeile`,`Eine leere Zeile zum Tippen neuer Positionen.`),U(`loeschbar`,`Zeilen löschbar`,`Kreuz an jeder Zeile: merkt sie zum Löschen vor.`,{requiresDataSource:!0}),U(`blaettern`,`Blättern`,`Ja: Seiten mit Blätter-Knöpfen. Nein: alles untereinander, der Rumpf rollt.`),U(`kopfzeile`,`Kopfzeile`,`Aus: keine Titelzeile, kein Sortieren per Titelklick.`),{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Sätze des gewählten Tages.`,kind:`field`},Ra()];function Ts(e,t){let n=e.erfasst+e.geaendert+e.geloescht,r=e.seiten>1||e.summen.length>0||n>0||e.suchtAktiv||e.auswahlAktiv;return e.leer||!r?S:b`<div class="fusszeile">
  ...
  </div>`}var Es=/[.*+?^${}()|[\]\\]/g;function Ds(e,t){let n=ii(t);if(n.length===0||e===``)return e;let r;try{r=RegExp(`(${n.map(e=>e.replace(Es,`\\$&`)).join(`|`)})`,`ig`)}catch{return e}let i=e.split(r);return i.length<=1?e:b`${i.map((e,t)=>t%2==1?b`<mark>${e}</mark>`:e)}`}function Os(e,t,n){let r=40-e,i=t-40,a=r>i?0:Math.min(i,Math.max(r,Math.round(n)));return{links:Math.round(e+a),rechts:Math.round(t-a)}}function ks(e,t,n){if(e.button!==0)return;let r=[...e.currentTarget?.parentElement?.children??[]].filter(e=>e instanceof HTMLElement&&e.tagName===`DIV`),i=r[t],a=r[t+1];if(!i||!a)return;e.stopPropagation(),e.preventDefault();let o=e.clientX,s=i.getBoundingClientRect().width,c=a.getBoundingClientRect().width,l=Os(s,c,0),u=()=>{window.removeEventListener(`pointermove`,p),window.removeEventListener(`pointerup`,m),window.removeEventListener(`pointercancel`,h),window.removeEventListener(`keydown`,ee),window.removeEventListener(`blur`,h)},d=r.map(e=>Math.max(1,Math.round(e.getBoundingClientRect().width))),f=()=>d.map((e,n)=>n===t?{index:n,breite:l.links}:n===t+1?{index:n,breite:l.rechts}:{index:n,breite:e});function p(e){l=Os(s,c,e.clientX-o),n.zeige(f())}function m(){u(),n.uebernimm(f())}function h(){u(),n.verwirf()}function ee(e){e.key===`Escape`&&(e.preventDefault(),h())}window.addEventListener(`pointermove`,p),window.addEventListener(`pointerup`,m),window.addEventListener(`pointercancel`,h),window.addEventListener(`keydown`,ee),window.addEventListener(`blur`,h)}function As(e,t){return Array.from({length:Math.max(0,e-1)},(e,n)=>b`<span
    class="breite-griff"
    role="presentation"
    style="grid-row: 1; grid-column: ${n+1}"
    title="Linie ziehen: links breiter, rechts schmaler"
    @pointerdown=${e=>ks(e,n,t)}
    @click=${e=>e.stopPropagation()}
    @dblclick=${e=>e.stopPropagation()}
  ></span>`)}function js(e){return e.linealTakte===0?S:b`<div class="lineal" role="presentation" style=${W(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>b`<div></div>`)}
        </div>`}function Ms(e,t){return b`
      ...
      ${e.zeigeKopf?b`<div class="kopf" role="row" style=${W(e.cols)}>
        ${e.spalten.map((n,r)=>b`<div
          ...
          >${e.imEditor&&(e.herkunft[r]??``)!==``?b`<span class="kopf-titel">${n.titel}</span><span
                ...
                >${e.herkunft[r]}</span>`:n.titel}${!e.editable&&e.sortSpalte===r?b`<span class="sort-pfeil">${e.sortAuf?` ▲`:` ▼`}</span>`:``}</div>`)}
        ${As(e.spalten.length,t.breiten)}
      </div>`:S}
        ${``}
        ...
        ${e.zeilen.map((n,r)=>{let i=n!==null&&!e.imEditor,a=n!==null&&e.zeilenStand.istGeloescht(n),o=n===null?{status:`gebucht`,titel:``}:e.zeilenStand.statusVon(n);return b`<div
          ...
          >
            ${``}
            ${e.spalten.map((r,i)=>{let a=n===null?`—`:e.datenzeilen[n]?.[i]??``,o=e.imEditor&&!e.zeigeKopf&&e.editable;if(e.aendernMoeglich&&n!==null&&_s(r)){let t=e.zeilenStand;return b`<div class="tippbar" role="cell">
                <input
...
`,K=class e extends O{constructor(...e){super(...e),this.spalten=pa(),this.spaltenHerkunft=[],this.source=``,this.suche=`ja`,this.erfassung=`nein`,this.blaettern=`ja`,this.loeschbar=`nein`,this.kopfzeile=`ja`,this.leerText=La,this.rechnung=``,this.datenzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._besitz=`softengine`,this._breiten=new Map,this._breiteVorZug=null,this._ansicht=new fs({baustein:this,editable:()=>this.editable,zeilenHoehe:()=>this.zeilenHoehe,melde:()=>this.requestUpdate()}),this._erfassung=new fo,this._lauf=new Ko(()=>this.requestUpdate()),this._zeilen=new Wo({baustein:this,spalten:()=>this.spaltenListe(),rohzeilen:()=>this.rohzeilen,datenzeilen:()=>this.datenzeilen,melde:()=>this.requestUpdate(),lauf:this._lauf,erfassungAn:()=>this.erfassungAn,fokussiereErfassungsZelle:e=>this.fokussiereErfassungsZelle(e)}),this.nimmSeFokus=e=>{e.defaultPrevented||!this.erfassungAn||this.hasAttribute(`data-ff-editor`)||(e.preventDefault(),this.fokussiereErfassungsZelle(0))}}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.kannErfassen={wenn:{attributeName:`erfassung`,equals:`ja`}}}static{this.aenderungsSchluessel=`aenderbar`}static{this.kannLoeschen={wenn:{attributeName:`loeschbar`,equals:`ja`}}}static{this.blockEvents=[{key:`onRowClick`,name:`Zeile gewählt`},{key:`onRowDblClick`,name:`Zeile doppelt geklickt`}]}static{this.listenBindung=gs}static{this.defaultProps={width:`fill`,source:``,spalten:pa(),suche:`ja`,erfassung:`nein`,blaettern:`ja`,loeschbar:`nein`,kopfzeile:`ja`,tagField:``,rechnung:``,leerText:La}}static{this.customProperties=ws}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?Co(this):So(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=mo(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.nachPush(),this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.zuruecksetzen(),this._erfassung.zuruecksetzen()}get erfassteZeilen(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.werte)}get erfassteSchluessel(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.kennung)}get geaenderteZeilen(){return this._zeilen.geaenderteZeilen}get geloeschteZeilen(){return this._zeilen.geloeschteZeilen}zeileSchreibt(e,t){this._lauf.schreibt(e,t)}zeileGescheitert(e,t,n){this._lauf.gescheitert(e,t,n)}laufFertig(e,t){if(this._lauf.fertig(e,t),e===`erfasst`){this._erfassung.markiereGeschrieben(this.erfassungsUmfeld(),t)&&this.requestUpdate();return}this._zeilen.austragen(e,t)}vergissGeschriebene(){this._erfassung.vergissGeschriebene()&&this.requestUpdate()}erfasstStand(e){return this._lauf.zeigt(`erfasst`,this._erfassung.schluessel[e]??``,this._erfassung.istGeschrieben(e)?`geschrieben`:`erfasst`)}erfasseZeile(){return this._erfassung.erfasse(this.erfassungsUmfeld())?(this.requestUpdate(),this.fokussiereErfassungsZelle(0),this.zeigeLetzteErfasste(),!0):!1}zeigeLetzteErfasste(){this.updateComplete.then(()=>{let e=this.shadowRoot?.querySelector(`.koerper`);e&&(e.scrollTop=e.scrollHeight)})}fokussiereSuche(){return this._ansicht.fokussiereSuche()}setzeSuchtext(e){this._ansicht.setzeSuchtext(e),this.requestUpdate()}get hatQuelle(){return this._besitz===`provided`||To(this.hasAttribute(`data-ff-editor`),this.source)}spaltenListe(){return ga(this.spalten)}get zeilenHoehe(){return 28}breitenWirt(){let e=e=>{this._breiteVorZug===null&&(this._breiteVorZug=new Map(e.map(e=>[e.index,this._breiten.get(e.index)])))};return{zeige:t=>{e(t);for(let e of t)this._breiten.set(e.index,e.breite);this.requestUpdate()},uebernimm:e=>{this._breiteVorZug=null;let t=this.spaltenListe();if(!this.hasAttribute(`data-ff-editor`)){for(let t of e)this._breiten.set(t.index,t.breite);this.requestUpdate();return}for(let n of e)n.index>=t.length||(this._breiten.delete(n.index),t[n.index]={...t[n.index],breite:n.breite});this.aendere(t)},verwirf:()=>{let e=this._breiteVorZug;if(this._breiteVorZug=null,e){for(let[t,n]of e)n===void 0?this._breiten.delete(t):this._breiten.set(t,n);this.requestUpdate()}}}}get erfassungAn(){return this.erfassung===`ja`}erfassungsWirt(){return{baustein:this,lauf:this._erfassung.lauf,umfeld:()=>this.erfassungsUmfeld(),melde:()=>this.requestUpdate(),fokussiere:e=>this.fokussiereErfassungsZelle(e),erfasseZeile:()=>this.erfasseZeile()}}fokussiereErfassungsZelle(e){this.updateComplete.then(()=>{let t=this.shadowRoot?.querySelectorAll(`.zeile.erfassung .erf-eingabe`)?.[e];t&&(t.focus(),t.scrollIntoView({block:`nearest`}))})}erfassungsUmfeld(){return this._erfassung.umfeld(this,this.spaltenListe(),this.source,Pa(this.rechnung))}aendere(e){let t=ko(this.rechnung,this.spaltenListe(),e);if(t===null){this.meldeProp(`spalten`,e);return}this.meldeProp(`rechnung`,t,`beginn`),this.meldeProp(`spalten`,e,`ende`)}meldeProp(e,t,n){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:e,value:t,...n===void 0?{}:{geste:n}},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&So(this),document.addEventListener(Ln,this.nimmSeFokus),this._ansicht.beobachte()}firstUpdated(){this._ansicht.beobachte()}willUpdate(e){super.willUpdate(e),e.has(`spalten`)&&this._breiten.clear(),!(!this.erfassungAn||this.hasAttribute(`data-ff-editor`))&&this._erfassung.lauf.aktualisiereVorschlaege(this.erfassungsUmfeld())}updated(){this._ansicht.nachRendern(),Pr(this)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(Ln,this.nimmSeFokus),Ro(this),this._ansicht.loese(),Qs(this),Co(this)}static{this.styles=[O.styles,Ba,Ns,di,po]}render(){let t=this.spaltenListe(),n=Cs({spalten:t,breiteVon:e=>this._breiten.get(e),hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._ansicht.suchtext,sortSpalte:this._ansicht.sortSpalte,sortAuf:this._ansicht.sortAuf,wunschSeite:this._ansicht.seite,gemessen:this._ansicht.mass,erfassungAn:this.erfassungAn,erfassteAnzahl:this._erfassung.zeilen.length,wertVon:(e,t)=>this._zeilen.zellWert(e,t),blaettert:this.blaettern===`ja`});return b`<div class="tabelle" style=${W({"--takt":`${n.takt}px`,"--zeilen-hoehe":`${n.zeilenHoehe}px`})}>
    ...
    >${sa()}</button>
    ${e.liste}
  </div>`}var Is={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:ca,quelleProp:`nachschlagQuelle`};function Ls(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?ga(e):[]}function Rs(e,t){let n=e[0];return n===void 0?t:n.feld}function zs(e,t){let n=e.trim();return n===``||n===t.trim()}function Bs(e,t,n){let r=t.trim(),i=[],a=zs(t,n),o=new Set;for(let t of e){let e=M(t,n).trim(),s=r===``?e:M(t,r).trim();if(!(s===``&&e===``)){if(a){if(o.has(e))continue;o.add(e)}i.push({anzeige:s,wert:e,satz:t})}}return i}function Vs(e,t,n,r){return Bs(Yt(e,t).rows,n,r)}function Hs(e){let t=j(B().FF_DATA_SOURCES,e);return t?Et(B().SEDATA,t.name,t.tableId,t.offenerSatz):null}function Us(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=Hs(e.quelleId);if(t===null)return{ok:!1,grund:`quelleFehlt`};let n=Rs(Ls([...e.spalten]),e.speicherFeld);return{ok:!0,eintraege:Vs(e.el,t,n,e.speicherFeld)}}function Ws(e,t){return t&&e.length===1?e[0]:null}function Gs(e,t){let{rows:n,gefiltert:r}=Yt(e,[t]);return!r||n.length>0}function Ks(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var qs=null,Js=null,Ys=null;function Xs(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function Zs(e=!0){let t=e?Ys:null;Ys=null,qs?.remove(),qs=null,Js=null,t?.focus()}function Qs(e){Js===e&&Zs(!1)}function $s(e){return[{kennung:``,titel:e.speicherTitel===``?`Wert`:e.speicherTitel,feld:e.speicherFeld}]}function ec(e){let t=e=>e.stopPropagation(),n=e.editor;return b`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >${e.inhalt}</ff-dialog-rahmen>`}function tc(e,t){let n=Ls([...e.spalten]),r=zs(Rs(n,e.speicherFeld),e.speicherFeld);return b`<ff-tabelle
    fuellt
    suche="ja"
    style="--se-r-lg:0px"
    .besitz=${`provided`}
    .spalten=${n.length>0?n:$s(e)}
  ...
  ></ff-tabelle>`}function nc(e){let t=e.eintraege;if(t===void 0){let n=Us(e);if(!n.ok){z(n.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}t=n.eintraege}Zs(!1);let n=document.createElement(`div`);n.style.display=`contents`,ze(ec({titel:e.titel,breite:e.breite,hoehe:e.hoehe,inhalt:tc(e,t),onSchliessen:()=>Zs()}),n);let r=n.querySelector(Zt),i=n.querySelector(K.tagName);i?.addEventListener(is,n=>{let r=n.detail,i=t[r.rohIndex];i&&(Zs(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),Ys=e.rueckFokus??Xs(e.el),document.body.appendChild(n),qs=n,Js=e.el;let a=e.suchtext??``;i&&a!==``&&i.setzeSuchtext(a),r&&i&&Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}function rc(e){return ec({titel:e.titel,breite:e.breite,hoehe:e.hoehe,onSchliessen:e.onSchliessen,editor:{onGroesse:e.onGroesse},inhalt:b`<ff-tabelle
      data-ff-editor
      fuellt
      suche="ja"
      style="--se-r-lg:0px"
    ...
    </div>`}connectedCallback(){super.connectedCallback(),ea(this)}disconnectedCallback(){super.disconnectedCallback(),ta(this),Qs(this)}};D([T()],q.prototype,`fieldType`,void 0),D([T()],q.prototype,`placeholder`,void 0),D([T()],q.prototype,`options`,void 0),D([T()],q.prototype,`source`,void 0),D([T()],q.prototype,`value`,void 0),D([T()],q.prototype,`valueField`,void 0),D([T()],q.prototype,`nachschlagQuelle`,void 0),D([T()],q.prototype,`speicherFeld`,void 0),D([T()],q.prototype,`speicherTitel`,void 0),D([T({converter:{fromAttribute:e=>Ls(e??``),toAttribute:e=>JSON.stringify(e)}})],q.prototype,`nachschlagSpalten`,void 0),D([T({type:Number})],q.prototype,`fensterBreite`,void 0),D([T({type:Number})],q.prototype,`fensterHoehe`,void 0),D([T()],q.prototype,`einzigerTreffer`,void 0),D([E()],q.prototype,`spaltenDialog`,void 0),D([E()],q.prototype,`anzeige`,void 0),D([E()],q.prototype,`getippt`,void 0),D([E()],q.prototype,`marke`,void 0),D([E()],q.prototype,`listeZu`,void 0),D([E()],q.prototype,`angehakt`,void 0),D([E()],q.prototype,`imSteuerelement`,void 0),O.defineAndRegister(q);var ic=`ziel`,ac=o`
...
`,sc=`frei · hierher ziehen`,cc=`ff-zimmer-inhalt`,J=class extends O{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[H.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[O.styles,Ba,oc,ac,o`
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(cc,{bubbles:!0,composed:!0}))}render(){return b`<div class="zimmer ${ic}">
      <div
        class="kopf"
        data-ff-editable
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(cc,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(H.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return b`<div class="col ${ic} v-${Lr(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};D([T()],Y.prototype,`variant`,void 0),D([T()],Y.prototype,`heading`,void 0),D([T({attribute:!1})],Y.prototype,`leerHinweis`,void 0),D([E()],Y.prototype,`_count`,void 0),O.defineAndRegister(Y);function lc(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function uc(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var dc=new WeakMap,fc=Y.tagName,pc=J.tagName,mc=H.tagName;function hc(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===fc)}function gc(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===mc)}function _c(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===pc)}function vc(e){return[e,..._c(e)]}function yc(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=_c(e);for(let e of t)r(e,gc(e).length===0?sc:``);r(e,t.length===0&&gc(e).length===0?n:``)}}function bc(e){return qe().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function xc(e,t){let n=_c(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??J.defaultProps.heading),a=lc(M(t,r),i);return a>=0?n[a]:n[0]}function Sc(e){Z?.board===e&&Oc();let t=e.getAttribute(`statusfield`)??``,n=go(e);if(!n)return;let r=hc(e);if(r.length===0)return;let i=dc.get(e);if(!i){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(mc);t&&(i=t.cloneNode(!0),dc.set(e,i))}if(!i)return;let a=n.zeilen,o=r.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),s=bc(i.tagName),c=uc(r.map(e=>e.getAttribute(`auffang`))),l=n.lies;for(let e of r)for(let t of vc(e))gc(t).forEach(e=>e.remove());for(let e of a){let a=i.cloneNode(!0),u=t===``?-1:lc(M(e,t),o),d=u>=0?r[u]:c>=0?r[c]:r[0];(xc(d,e)??d).appendChild(a);for(let t of s){let n=a.getAttribute(vi(t.prop))??``;n!==``&&(a[t.prop]=l(e,n))}let f=xt(n.quelle,e);X.set(a,{row:e,pindex:f}),a.draggable=!0}yc(e,r);let u=r.flatMap(e=>vc(e).flatMap(gc)),d=Ht(F(e),u,e=>X.get(e)?.row);for(let e of d)u[e].setAttribute(`data-ff-auswahl`,``)}var X=new WeakMap,Z=null,Cc=new WeakSet,wc=`data-ff-zieht`,Tc=`data-ff-ziel`,Ec=null;function Dc(e){Ec!==e&&(Ec?.removeAttribute(Tc),Ec=e,Ec?.setAttribute(Tc,``))}function Oc(){Z?.card.removeAttribute(wc),Z=null,Dc(null)}function kc(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function Ac(e,t){return kc(e,t,fc)}function jc(e,t,n){if(!Z||Z.board!==e)return;let r=X.get(Z.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;Tr(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(_r)}function Mc(e){Cc.has(e)||(Cc.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;if(!n)return;let r=X.get(n);r&&Ut(F(e),r.row),Tr(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(_r)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{Z?.card===n&&n.setAttribute(wc,``)},0))}),e.addEventListener(`dragend`,Oc),e.addEventListener(`dragover`,t=>{let n=Ac(e,t);if(Z?.board!==e||!n){Dc(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),Dc(kc(e,t,pc)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&Dc(null)}),e.addEventListener(`drop`,t=>{let n=Ac(e,t);n&&(t.preventDefault(),jc(e,n,kc(e,t,pc)),Oc())}))}var Nc=Ri({hydriere:Sc,verdrahte:Mc}),Pc=Nc.connect,Fc=Nc.disconnect,Ic=Y.blockType,Lc=class extends O{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Ic]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:Ic}}static{this.templateChild={type:H.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:La}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Feld, das die Spalte bestimmt. Leer: alle in die Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Einträge des gewählten Tages.`,kind:`field`},Ra()]}static{this.defaultChildren=[{type:Ic,props:{heading:`Offen`,variant:`warning`},children:[{type:H.blockType}]},{type:Ic,props:{heading:`In Arbeit`,variant:`info`}},{type:Ic,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[O.styles,o`
    ...
    `]}render(){return b`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),Pc(this)}disconnectedCallback(){super.disconnectedCallback(),Fc(this)}};O.defineAndRegister(Lc);var Rc={breite:56,breiteOffen:224},zc=`ff-seiten-wechsel`,Bc=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],Q=class extends O{static{this.blockType=`navi-eintrag`}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:Bc.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[O.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(zc,{detail:e,bubbles:!0,composed:!0}))}render(){return b`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};D([T()],Q.prototype,`seite`,void 0),D([T()],Q.prototype,`seitename`,void 0),D([T({reflect:!0})],Q.prototype,`ton`,void 0),O.defineAndRegister(Q);var Vc=`aktiv`;function Hc(e){return Array.from(e.querySelectorAll(Q.tagName))}function Uc(e,t){let n=Hc(e),r=t??n.find(e=>e.hasAttribute(Vc))??n[0];for(let e of n)e===r?e.setAttribute(Vc,``):e.removeAttribute(Vc)}function Wc(e){let t=e.hasAttribute(`offen`);for(let n of Hc(e))n.toggleAttribute(`breit`,t)}function Gc(e){return e.getAttribute(`name`)??String(st.defaultProps.name)}function Kc(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function qc(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(st.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=Kc(e,i);if(!a)return;let o=r.find(e=>Gc(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var Jc=new WeakMap,Yc=new WeakSet;function Xc(e){let t=t=>{let n=t.detail;n&&(Uc(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),Wc(e),!e.hasAttribute(`data-ff-editor`)&&qc(e,n.ansicht))};e.addEventListener(zc,t),Jc.set(e,t)}function Zc(e){let t=Jc.get(e);t&&(e.removeEventListener(zc,t),Jc.delete(e))}function Qc(e){if(Uc(e),Wc(e),e.hasAttribute(`data-ff-editor`)||Yc.has(e))return;let t=Hc(e)[0];if(!t)return;Yc.add(e);let n=()=>qc(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var $c=Q.blockType,el=class extends O{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[$c]}static{this.addChildButton={label:`Eintrag`,childType:$c}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[ot]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[O.styles,o`
      :host {
        height: 100%;
        width: ${Rc.breite}px;
        transition: width var(--se-move);
      }
      :host([offen]) { width: ${Rc.breiteOffen}px; }
      .leiste {
        box-sizing: border-box;
        height: 100%;
        width: 100%;
    ...
    `]}connectedCallback(){super.connectedCallback(),Xc(this)}disconnectedCallback(){super.disconnectedCallback(),Zc(this)}klappen(){this.toggleAttribute(`offen`),Wc(this)}render(){return b`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
    ...
    `]}render(){return b`<div
      class="text"
      style=${W({fontSize:`${hl(this.groesse)}px`,fontWeight:dl[gl(this.gewicht)],textAlign:fl[_l(this.ausrichtung)],color:pl[vl(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
    ...
    `]}render(){return b`<div class="flaeche ${xl(this.richtung)}"><div class="linie"></div></div>`}};D([T()],Sl.prototype,`richtung`,void 0),O.defineAndRegister(Sl),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;z(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();