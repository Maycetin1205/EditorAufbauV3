...
`;function Io(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen])}}function Lo(e,t,n){return t===``||n===``?[...e]:e.filter(e=>ei(j(e,t))===n)}function Ro(e){let t=e.getAttribute(`source`)??``;if(t===``)return null;let n=A(R().FF_DATA_SOURCES,t);return n?{quelle:n,zeilen:Lo(Nt(R().SEDATA,n.name,n.tableId,n.offenerSatz),e.getAttribute(`tagfield`)??``,ai()),lies:ma(e)}:null}function zo(e){return Ha(e.getAttribute(`spalten`)??``)}function Bo(e,t){let n=A(R().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?Ot(n,t):``}function Vo(e){let t=A(R().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return t!==void 0&&t.indexField!==``}function Ho(e,t){t&&e.vergissGeschriebene();let n=Ro(e);if(!n){e.datenzeilen=[];return}let r=zo(e),{rows:i,gefiltert:a}=nn(e,n.zeilen),o=Yt(P(e),i,e=>e)[0]??-1,s=n.lies;e.datenGeliefert=!0,e.rohzeilen=i,e.auswahlIndex=o,e.durchAuswahlGefiltert=a,e.datenzeilen=i.map(e=>r.map(t=>t.feld===``?``:s(e,t.feld)))}var Uo=la({hydriere:Ho}),Wo=Uo.connect,Go=Uo.disconnect;function Ko(e,t){let n=[];return e.forEach((e,r)=>{wi(e,t)&&n.push(r)}),n}function qo(e,t){return!e&&t.trim()!==``}function Jo(e,t,n){return e&&t&&n===0}function Yo(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function Xo(e){return La([...e,Ia(e.length)])}function Zo(e,t,n){let r=no(e);if(!r)return null;let i=new Set(n.map(e=>e.kennung)),a=ro(r,t.map(e=>e.kennung).filter(e=>e!==``&&!i.has(e)));return a===r?null:io(a)}function Qo(e,t){return e.length<=1||t<0||t>=e.length?e:e.filter((e,n)=>n!==t)}function $o(e,t,n){if(t<0||t>=e.length)return e;let r=Math.max(0,Math.min(n,e.length-1));if(r===t)return e;let i=[...e],[a]=i.splice(t,1);return i.splice(r,0,a),i}var es=`\0`;function ts(e,t){return e+es+String(t)}var ns=class{constructor(){this.werte=new Map}setze(e,t,n){if(e===``)return!1;let r=ts(e,t);return this.werte.get(r)!==n&&(this.werte.set(r,n),!0)}nimmZurueck(e,t){return this.werte.delete(ts(e,t))}wert(e,t){return e===``?void 0:this.werte.get(ts(e,t))}get anzahl(){return this.werte.size}proSatz(){let e=[];for(let[t,n]of this.werte){let[r,i]=t.split(es),a=Number(i),o=e.find(e=>e.satz===r),s={satz:r,spalte:a,wert:n};o?o.aenderungen.push(s):e.push({satz:r,aenderungen:[s]})}return e}nimmSatzZurueck(e){let t=!1;for(let n of[...this.werte.keys()])n.slice(0,n.indexOf(es))===e&&this.werte.delete(n)&&(t=!0);return t}},rs=class{constructor(e){this.aenderungen=new ns,this.geloescht=new Set,this.wirt=e}get geaenderteZeilen(){if(this.aenderungen.anzahl===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let{satz:r}of this.aenderungen.proSatz()){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}get geloeschteZeilen(){if(this.geloescht.size===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let r of this.geloescht){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}austragen(e,t){let n=!1;for(let r of t)n=e===`geaendert`?this.aenderungen.nimmSatzZurueck(r)||n:this.geloescht.delete(r)||n;n&&this.wirt.melde()}vorgemerkteAenderungen(){return this.geaenderteZeilen.length}vorgemerkteLoeschungen(){return this.geloeschteZeilen.length}statusVon(e){let t=this.satzVon(e);if(t===``)return{status:`gebucht`,titel:``};if(this.geloescht.has(t))return this.wirt.lauf.zeigt(`geloescht`,t,`loeschung`);let n=this.wirt.spalten().some((e,n)=>this.aenderungen.wert(t,n)!==void 0);return this.wirt.lauf.zeigt(`geaendert`,t,n?`geaendert`:`gebucht`)}satzPlaetze(){let e=new Map;return this.wirt.rohzeilen().forEach((t,n)=>{let r=Bo(this.wirt.baustein,t);r!==``&&!e.has(r)&&e.set(r,n)}),e}satzVon(e){let t=this.wirt.rohzeilen()[e];return t===void 0?``:Bo(this.wirt.baustein,t)}schalteLoeschung(e){let t=this.satzVon(e);t!==``&&(this.geloescht.has(t)?this.geloescht.delete(t):(this.geloescht.add(t),this.wirt.spalten().forEach((e,n)=>{this.aenderungen.nimmZurueck(t,n)})),this.wirt.melde())}istGeloescht(e){let t=this.satzVon(e);return t!==``&&this.geloescht.has(t)}zellWert(e,t){let n=this.aenderungen.wert(this.satzVon(e),t);return n===void 0?this.wirt.datenzeilen()[e]?.[t]??``:n}istGeaendert(e,t){return this.aenderungen.wert(this.satzVon(e),t)!==void 0}tippeZelle(e,t,n){this.aenderungen.setze(this.satzVon(e),t,n)&&this.wirt.melde()}verlasseZelle(e,t,n){let r=this.satzVon(e);(n===(this.wirt.datenzeilen()[e]?.[t]??``)?this.aenderungen.nimmZurueck(r,t):this.aenderungen.setze(r,t,n))&&this.wirt.melde()}zelleNachbar(e,t,n,r){let i=Array.from(this.wirt.baustein.shadowRoot?.querySelectorAll(`.koerper > .zeile:not(.erfassung) .zell-eingabe[data-spalte="${e}"]`)??[]),a=i.indexOf(t);if(a<0)return;let o=a+n;if(o>i.length-1){if(r&&this.wirt.erfassungAn()){this.wirt.fokussiereErfassungsZelle(0);return}o=i.length-1}o<0&&(o=0);let s=i[o];s&&s!==t&&(s.focus(),s.select(),s.scrollIntoView({block:`nearest`}))}tasteZelle(e,t,n){let r=n.target;if(n.key===`Escape`){n.preventDefault(),n.stopPropagation(),this.aenderungen.nimmZurueck(this.satzVon(e),t)&&this.wirt.melde();return}let i={Enter:1,ArrowDown:1,ArrowUp:-1,PageDown:10,PageUp:-10}[n.key];i!==void 0&&(n.preventDefault(),n.stopPropagation(),this.zelleNachbar(t,r,i,n.key===`Enter`))}},is={gebucht:``,erfasst:`Neue Zeile — noch nicht geschrieben`,geaendert:`Geändert — noch nicht geschrieben`,loeschung:`Zum Löschen vorgemerkt — noch nicht geschrieben`,schreibt:`Wird geschrieben …`,geschrieben:`Hinausgeschickt — bleibt stehen, bis neue Daten kommen`,fehler:`Nicht geschrieben`},as=class{constructor(e){this.schreibend=new Map,this.fehler=new Map,this.melde=e}schreibt(e,t){this.fehler.get(e)?.delete(t);let n=this.schreibend.get(e)??new Set;n.add(t),this.schreibend.set(e,n),this.melde()}gescheitert(e,t,n){this.schreibend.get(e)?.delete(t);let r=this.fehler.get(e)??new Map;r.set(t,n),this.fehler.set(e,r),this.melde()}fertig(e,t){this.schreibend.get(e)?.clear();let n=this.fehler.get(e);if(n)for(let e of t)n.delete(e);this.melde()}zeigt(e,t,n){let r=this.fehler.get(e)?.get(t);return r===void 0?this.schreibend.get(e)?.has(t)===!0?{status:`schreibt`,titel:is.schreibt}:{status:n,titel:is[n]}:{status:`fehler`,titel:is.fehler+`: `+r}}},os=4;function ss(e){return e??os}function cs(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function ls(e,t,n){let r=cs(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function us(e,t){return e===null?null:Math.max(0,e-t)}function ds({sichtbar:e,hatQuelle:t,platzhalterZeilen:n}){return t?{seiten:1,seite:0,zeilen:[...e]}:{seiten:1,seite:0,zeilen:Array.from({length:n},()=>null)}}function fs({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function ps(e){if(!e.hasAttribute(`fuellt`))return-1;let t=e.renderRoot.querySelector(`.koerper`);return t instanceof HTMLElement?t.clientHeight:-1}function ms(e){let t=e.renderRoot.querySelector(`.kopf`);return t instanceof HTMLElement?t.offsetHeight:0}function hs(e,t){let n=ps(e);if(n===-1)return{mass:null,hoehe:n,kopf:0};let r=ms(e);return{mass:ls(n,r,t),hoehe:n,kopf:r}}function gs(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}var _s=`ff-zeile-aktiviert`,vs=`data-ff-roh`;function ys(e,t){e.dispatchEvent(new CustomEvent(_s,{detail:t,bubbles:!0,composed:!0}))}function bs(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(vs);return r===null||r===``?null:Number(r)}function xs(e,t){if(!(e instanceof HTMLElement))return!1;let n=e.closest(`.zeile`),r=n?.parentElement;if(!n||!r)return!1;let i=[...r.querySelectorAll(`.zeile[${vs}]`)],a=i.indexOf(n),o=a===-1?void 0:i[a+t];return o?(o.focus(),o.scrollIntoView?.({block:`nearest`}),!0):!1}function Ss(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.zeile[${vs}]`);return t?(t.focus(),!0):!1}function Cs(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.suchzeile input`);return t?(t.focus(),!0):!1}function ws(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var Ts=class{constructor(e){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._rumpfGemessen=-1,this._kopfGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this.wirt=e}get suchtext(){return this._suchtext}get suchtAktiv(){return this._suchtext.trim()!==``}get sortSpalte(){return this._sortSpalte}get sortAuf(){return this._sortAuf}get seite(){return this._seite}get mass(){return this._mass}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.wirt.melde()}klickSortiere(e){this.wirt.editable()||(this.merkeZeilenFokus(),this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.wirt.melde())}blaettere(e){this.merkeZeilenFokus(),this._seite=e,this.wirt.melde()}fokussiereSuche(){let e=this.wirt.baustein.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}merkeZeilenFokus(){let e=bs(this.wirt.baustein.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.wirt.zeilenHoehe();this._taktGemessen=e;let{mass:t,hoehe:n,kopf:r}=hs(this.wirt.baustein,e);this._rumpfGemessen=n,this._kopfGemessen=r,(t?.passen!==this._mass?.passen||t?.zeilenHoehe!==this._mass?.zeilenHoehe)&&(this._mass=t,this.wirt.melde())}beobachte(){this._beobachter||(this._beobachter=gs(this.wirt.baustein,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}nachRendern(){(this._taktGemessen!==this.wirt.zeilenHoehe()||this._rumpfGemessen!==ps(this.wirt.baustein)||this._kopfGemessen!==ms(this.wirt.baustein))&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,ws(this.wirt.baustein.shadowRoot,this._fokusZeile))}loese(){this._beobachter?.disconnect(),this._beobachter=null}nachPush(){this._seite=0,this._mass=null,this._taktGemessen=0,this._rumpfGemessen=-1,this._kopfGemessen=0}zuruecksetzen(){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this.nachPush(),this._fokusZeile=null,this._fokusHolen=!1}};function Es(e,t,n,r){if(n===null||e.hasAttribute(`data-ff-editor`))return;let i=t[n];if(i===void 0)return;let a=e,o=a.auswahlIndex===n;a.auswahlIndex=o?-1:n;let s=P(e);o?(s!==``&&Qt(s),ys(e,{rohzeile:i,rohIndex:-1,ansichtIndex:r})):(s!==``&&Zt(s,i,!0),ys(e,{rohzeile:i,rohIndex:n,ansichtIndex:r}),V(e,`onRowClick`,{PINDEX:Bo(e,i)}).catch(B))}function Ds(e,t,n){if(n===null||e.hasAttribute(`data-ff-editor`))return;let r=t[n];r!==void 0&&V(e,`onRowDblClick`,{PINDEX:Bo(e,r)}).catch(B)}function Os(e,t,n){let r=40-e,i=t-40,a=r>i?0:Math.min(i,Math.max(r,Math.round(n)));return{links:Math.round(e+a),rechts:Math.round(t-a)}}function ks(e,t,n){if(e.button!==0)return;let r=[...e.currentTarget?.parentElement?.children??[]].filter(e=>e instanceof HTMLElement&&e.tagName===`DIV`),i=r[t],a=r[t+1];if(!i||!a)return;e.stopPropagation(),e.preventDefault();let o=e.clientX,s=i.getBoundingClientRect().width,c=a.getBoundingClientRect().width,l=Os(s,c,0),u=()=>{window.removeEventListener(`pointermove`,p),window.removeEventListener(`pointerup`,ee),window.removeEventListener(`pointercancel`,m),window.removeEventListener(`keydown`,te),window.removeEventListener(`blur`,m)},d=r.map(e=>Math.max(1,Math.round(e.getBoundingClientRect().width))),f=()=>d.map((e,n)=>n===t?{index:n,breite:l.links}:n===t+1?{index:n,breite:l.rechts}:{index:n,breite:e});function p(e){l=Os(s,c,e.clientX-o),n.zeige(f())}function ee(){u(),n.uebernimm(f())}function m(){u(),n.verwirf()}function te(e){e.key===`Escape`&&(e.preventDefault(),m())}window.addEventListener(`pointermove`,p),window.addEventListener(`pointerup`,ee),window.addEventListener(`pointercancel`,m),window.addEventListener(`keydown`,te),window.addEventListener(`blur`,m)}function As(e,t){return Array.from({length:Math.max(0,e-1)},(e,n)=>y`<span
  ...
  ></span>`)}var js=class{constructor(e){this._breiten=new Map,this._vorZug=null,this.wirt=e}breiteVon(e){return this._breiten.get(e)}vergessen(){this._breiten.clear()}voll(e){return e.map(e=>({index:this.wirt.vollerPlatz(e.index),breite:e.breite}))}wirtFuerZug(){return{zeige:e=>{let t=this.voll(e);this._vorZug===null&&(this._vorZug=new Map(t.map(e=>[e.index,this._breiten.get(e.index)])));for(let e of t)this._breiten.set(e.index,e.breite);this.wirt.melde()},uebernimm:e=>{let t=this.voll(e);if(this._vorZug=null,!this.wirt.imEditor()){for(let e of t)this._breiten.set(e.index,e.breite);this.wirt.melde();return}let n=this.wirt.spaltenListe();for(let e of t)e.index>=n.length||(this._breiten.delete(e.index),n[e.index]={...n[e.index],breite:e.breite});this.wirt.schreibeSpalten(n)},verwirf:()=>{let e=this._vorZug;if(this._vorZug=null,e){for(let[t,n]of e)n===void 0?this._breiten.delete(t):this._breiten.set(t,n);this.wirt.melde()}}}}},Ms={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,kennungKey:`kennung`,standardTitel:Pa,eintragNeu:e=>{let t=W(e.spalten);return t.length>=16?{}:{spalten:Xo(t)}},eintragWeg:(e,t)=>{let n=W(e.spalten),r=Qo(n,t);if(r===n)return{};let i=Zo(e.rechnung,n,r);return{spalten:[...r],...i===null?{}:{rechnung:i}}},eintragVerschieben:(e,t,n)=>{let r=W(e.spalten),i=$o(r,t,n);return i===r?{}:{spalten:[...i]}},eintragStellen:`[data-ff-eintrag]`,eintragsSchalter:[{key:`summe`,label:`Summe in der Fußzeile`,kurz:`Summe`},{key:`aenderbar`,label:`In der Zeile änderbar`,kurz:`änderbar`,standard:!0,nurEigeneQuelle:!0},{key:`versteckt`,label:`In der Maske ausblenden`,kurz:`ausgeblendet`}],herkunftProp:`spaltenHerkunft`,eintragsFeldWahl:[{key:`fuellFeld`,label:`Nachschlagen`,hinweis:`Beim Erfassen füllt der gewählte Satz der Hilfsquelle diese Zelle.`,nurFremdeQuellen:!0}]};function Ns(e){let t=e,n=Ms.eintragsSchalter?.find(e=>e.key===`aenderbar`);return n!==void 0&&e.feld!==``&&Li(Ms,t).includes(n)&&Ii(n,t)}var Ps=`ff_spaltenwahl_`,Fs=new Map;function Is(e){let t=typeof document>`u`?``:document.title,n=e.getAttribute(O);if(n!==null&&n!==``)return`${Ps}${t}|${n}`;let r=Array.from(e.ownerDocument?.querySelectorAll(e.tagName)??[]);return`${Ps}${t}|#${Math.max(0,r.indexOf(e))}`}function Ls(e){let t=Fs.get(e);if(t)return new Set(t);try{let t=localStorage.getItem(e);if(t===null)return new Set;let n=JSON.parse(t);return Array.isArray(n)?new Set(n.filter(e=>typeof e==`string`)):new Set}catch{return new Set}}function Rs(e,t){let n=[...t];Fs.set(e,n);try{n.length===0?localStorage.removeItem(e):localStorage.setItem(e,JSON.stringify(n))}catch{}}function zs(e,t){if(e===null)return x;let n=e.waehlbar.filter(t=>!e.weg.has(t.kennung)).length;return y`<div class="sw-schirm" @pointerdown=${t.schliesse}></div>
    <div
      class="spaltenwahl"
      role="dialog"
    ...
    >
      ...
      ${e.weg.size===0?x:y`<button
        ...
        @click=${t.alleZeigen}
      >Alle zeigen</button>`}
    </div>`}var Bs=new Set,Vs=class{constructor(e){this._weg=null,this._offen=null,this.nimmTaste=e=>{e.key===`Escape`&&this.schliesse()},this.wirt=e}get offen(){return this._offen}weg(){return this.wirt.an()?(this._weg===null&&(this._weg=Ls(Is(this.wirt.baustein))),this._weg):Bs}oeffne(e,t){e.preventDefault(),e.stopPropagation(),this._offen={links:Math.max(4,Math.min(e.clientX-t.left,Math.max(4,t.width-170))),oben:Math.max(4,Math.min(e.clientY-t.top,Math.max(4,t.height-60)))},window.addEventListener(`keydown`,this.nimmTaste),this.wirt.melde()}schliesse(){this._offen!==null&&(this._offen=null,window.removeEventListener(`keydown`,this.nimmTaste),this.wirt.melde())}schalte(e){let t=new Set(this.weg());t.has(e)?t.delete(e):t.add(e),this.merke(t)}alleZeigen(){this.merke(new Set)}merke(e){this._weg=e,Rs(Is(this.wirt.baustein),e),this.wirt.breitenVergessen(),this.wirt.melde()}loese(){window.removeEventListener(`keydown`,this.nimmTaste),this._offen=null}};function Hs(e,t,n){let r=0,i=0;for(let t of e){let e=Do(t);e!==null&&(r+=e,i++)}return i===0?``:r.toLocaleString(`de-DE`,{minimumFractionDigits:t,maximumFractionDigits:n})}var Us={min:0,max:3};function Ws(e,t){let n=[];return e.spalten.forEach((r,i)=>{if(r.summe!==!0)return;let a=Hs(t.map(t=>e.wertVon(t,i)),Us.min,Us.max);a!==``&&n.push({titel:r.titel,text:a})}),n}function Gs(e){return e.datenzeilen.map((t,n)=>e.spalten.map((t,r)=>e.wertVon(n,r)))}function Ks(e){let t=Gs(e),n=Ko(t,e.suchtext);return e.sortSpalte<0?n:Mo(n.map(e=>t[e]),e.sortSpalte,e.sortAuf).map(e=>n[e])}function qs(e){let t=e.gezeichnet??e.spalten,n=e.plaetze??t.map((e,t)=>t),r={gridTemplateColumns:Ua(t,t=>e.breiteVon?.(n[t]??t))},i=e.gemessen?.zeilenHoehe??28,a=e.hatQuelle,o=!e.erfassungAn&&Jo(a,e.datenGeliefert,e.datenzeilen.length),s=Ks(e),c=e.erfassungAn?1+e.erfassteAnzahl:0,l=e.gemessen===null?null:Math.max(1,e.gemessen.passen-c),u={sichtbar:s,hatQuelle:a,proSeite:l??Math.max(1,10-c),wunschSeite:e.wunschSeite,platzhalterZeilen:ss(l)},{seiten:d,seite:f,zeilen:p}=e.blaettert?fs(u):ds(u);return{cols:r,takt:28,zeilenHoehe:i,hatQuelle:a,leer:o,gesamt:s.length,seiten:d,seite:f,zeilen:p,linealTakte:us(l,p.length),summen:Ws(e,s)}}var Js=[U(`suche`,`Suchzeile`,`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,{requiresDataSource:!0}),U(`erfassung`,`Erfassungszeile`,`Eine leere Zeile zum Tippen neuer Positionen.`),U(`loeschbar`,`Zeilen löschbar`,`Kreuz an jeder Zeile: merkt sie zum Löschen vor.`,{requiresDataSource:!0}),U(`blaettern`,`Blättern`,`Ja: Seiten mit Blätter-Knöpfen. Nein: alles untereinander, der Rumpf rollt.`),U(`kopfzeile`,`Kopfzeile`,`Aus: keine Titelzeile, kein Sortieren per Titelklick.`),U(`spaltenwahl`,`Spaltenwahl`,`In der Maske: Rechtsklick auf eine Spaltenüberschrift nimmt Spalten weg und holt sie zurück. Braucht die Kopfzeile.`),{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Sätze des gewählten Tages.`,kind:`field`},oo()];function Ys(e,t){let n=e.seiten>1||e.summen.length>0||e.suchtAktiv||e.auswahlAktiv;return e.leer||!n?x:y`<div class="fusszeile">
    ...
    ${e.blaettert?y`<div class="seiten-nav">
  ...
  </div>`}var Xs=/[.*+?^${}()|[\]\\]/g;function Zs(e,t){let n=Ci(t);if(n.length===0||e===``)return e;let r;try{r=RegExp(`(${n.map(e=>e.replace(Xs,`\\$&`)).join(`|`)})`,`ig`)}catch{return e}let i=e.split(r);return i.length<=1?e:y`${i.map((e,t)=>t%2==1?y`<mark>${e}</mark>`:e)}`}function Qs(e){return e.linealTakte===0?x:y`<div class="lineal" role="presentation" style=${G(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>y`<div></div>`)}
        </div>`}function $s(e,t){return y`
      ...
      ${e.zeigeKopf?y`<div class="kopf" role="row" style=${G(e.cols)}>
        ...
        ${e.zeilen.map((n,r)=>{let i=n!==null&&!e.imEditor,a=n!==null&&e.zeilenStand.istGeloescht(n),o=n===null?{status:`gebucht`,titel:``}:e.zeilenStand.statusVon(n);return y`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,i)=>{let a=e.plaetze[i],o=n===null?`—`:e.datenzeilen[n]?.[a]??``,s=e.imEditor&&!e.zeigeKopf&&e.editable;if(e.aendernMoeglich&&n!==null&&Ns(t)){let r=e.zeilenStand;return y`<div class="tippbar" role="cell">
                <input
      ...
      ${zs(e.spaltenwahl,t.spaltenwahl)}
    `}var ec=o`
...
`,q=class extends D{constructor(...e){super(...e),this.spalten=za(),this.source=``,this.suche=`ja`,this.erfassung=`nein`,this.blaettern=`ja`,this.loeschbar=`nein`,this.kopfzeile=`ja`,this.spaltenwahl=`nein`,this.leerText=ao,this.rechnung=``,this.datenzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._besitz=`softengine`,this._breiten=new js({imEditor:()=>this.imEditor,vollerPlatz:e=>Na(this.spaltenListe(),this.imEditor).plaetze[e]??e,spaltenListe:()=>this.spaltenListe(),schreibeSpalten:e=>this.aendere(e),melde:()=>this.requestUpdate()}),this._ansicht=new Ts({baustein:this,editable:()=>this.editable,zeilenHoehe:()=>this.zeilenHoehe,melde:()=>this.requestUpdate()}),this._erfassung=new Po,this._lauf=new as(()=>this.requestUpdate()),this._wahl=new Vs({baustein:this,an:()=>this.spaltenwahlAn,melde:()=>this.requestUpdate(),breitenVergessen:()=>this._breiten.vergessen()}),this._zeilen=new rs({baustein:this,spalten:()=>this.spaltenListe(),rohzeilen:()=>this.rohzeilen,datenzeilen:()=>this.datenzeilen,melde:()=>this.requestUpdate(),lauf:this._lauf,erfassungAn:()=>this.erfassungAn,fokussiereErfassungsZelle:e=>this.fokussiereErfassungsZelle(e)}),this.nimmSeFokus=e=>{!e.defaultPrevented&&this.erfassungAn&&(this.imEditor||(e.preventDefault(),this.fokussiereErfassungsZelle(0)))}}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.kannErfassen={wenn:{attributeName:`erfassung`,equals:`ja`}}}static{this.aenderungsSchluessel=`aenderbar`}static{this.kannLoeschen={wenn:{attributeName:`loeschbar`,equals:`ja`}}}static{this.blockEvents=[{key:`onRowClick`,name:`Zeile gewählt`},{key:`onRowDblClick`,name:`Zeile doppelt geklickt`}]}static{this.listenBindung=Ms}static{this.defaultProps={width:`fill`,source:``,spalten:za(),suche:`ja`,erfassung:`nein`,blaettern:`ja`,loeschbar:`nein`,kopfzeile:`ja`,spaltenwahl:`nein`,tagField:``,rechnung:``,leerText:ao}}static{this.customProperties=Js}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?Go(this):Wo(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=Io(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.nachPush(),this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.zuruecksetzen(),this._erfassung.zuruecksetzen()}get erfassteZeilen(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.werte)}get erfassteSchluessel(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.kennung)}get geaenderteZeilen(){return this._zeilen.geaenderteZeilen}get geloeschteZeilen(){return this._zeilen.geloeschteZeilen}zeileSchreibt(e,t){this._lauf.schreibt(e,t)}zeileGescheitert(e,t,n){this._lauf.gescheitert(e,t,n)}laufFertig(e,t){if(this._lauf.fertig(e,t),e===`erfasst`){this._erfassung.markiereGeschrieben(this.erfassungsUmfeld(),t)&&this.requestUpdate();return}this._zeilen.austragen(e,t)}vergissGeschriebene(){this._erfassung.vergissGeschriebene()&&this.requestUpdate()}erfasstStand(e){return this._lauf.zeigt(`erfasst`,this._erfassung.schluessel[e]??``,this._erfassung.istGeschrieben(e)?`geschrieben`:`erfasst`)}erfasseZeile(){return this._erfassung.erfasse(this.erfassungsUmfeld())?(this.requestUpdate(),this.fokussiereErfassungsZelle(0),this.zeigeLetzteErfasste(),!0):!1}zeigeLetzteErfasste(){this.updateComplete.then(()=>{let e=this.shadowRoot?.querySelector(`.koerper`);e&&(e.scrollTop=e.scrollHeight)})}fokussiereSuche(){return this._ansicht.fokussiereSuche()}setzeSuchtext(e){this._ansicht.setzeSuchtext(e),this.requestUpdate()}get hatQuelle(){return this._besitz===`provided`||qo(this.imEditor,this.source)}spaltenListe(){return W(this.spalten)}get zeilenHoehe(){return 28}get erfassungAn(){return this.erfassung===`ja`}erfassungsWirt(){return{baustein:this,lauf:this._erfassung.lauf,umfeld:()=>this.erfassungsUmfeld(),melde:()=>this.requestUpdate(),fokussiere:e=>this.fokussiereErfassungsZelle(e),erfasseZeile:()=>this.erfasseZeile()}}fokussiereErfassungsZelle(e){this.updateComplete.then(()=>{let t=this.shadowRoot?.querySelector(`.zeile.erfassung .erf-eingabe[data-spalte="${e}"]`);t&&(t.focus(),t.scrollIntoView({block:`nearest`}))})}erfassungsUmfeld(){return this._erfassung.umfeld(this,this.spaltenListe(),this.source,no(this.rechnung))}aendere(e){let t=Zo(this.rechnung,this.spaltenListe(),e);if(t===null){this.meldeProp(`spalten`,e);return}this.meldeProp(`rechnung`,t,`beginn`),this.meldeProp(`spalten`,e,`ende`)}meldeProp(e,t,n){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:e,value:t,...n===void 0?{}:{geste:n}},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&Wo(this),document.addEventListener(Gn,this.nimmSeFokus),this._ansicht.beobachte()}firstUpdated(){this._ansicht.beobachte()}willUpdate(e){super.willUpdate(e),e.has(`spalten`)&&this._breiten.vergessen(),this.erfassungAn&&!this.imEditor&&this._erfassung.lauf.aktualisiereVorschlaege(this.erfassungsUmfeld())}updated(){this._ansicht.nachRendern(),zr(this)}disconnectedCallback(){super.disconnectedCallback(),this._wahl.loese(),document.removeEventListener(Gn,this.nimmSeFokus),this._ansicht.loese(),yc(this),Go(this)}static{this.styles=[D.styles,co,ec,Mi,Fo]}get spaltenwahlAn(){return this.spaltenwahl===`ja`&&this.kopfzeile===`ja`&&!this.imEditor}oeffneSpaltenwahl(e){let t=this.shadowRoot?.querySelector(`.tabelle`)?.getBoundingClientRect();t&&this._wahl.oeffne(e,t)}render(){let e=this.spaltenListe(),t=Na(e,this.imEditor,this._wahl.weg()),n=qs({spalten:e,gezeichnet:t.spalten,plaetze:t.plaetze,breiteVon:e=>this._breiten.breiteVon(e),hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._ansicht.suchtext,sortSpalte:this._ansicht.sortSpalte,sortAuf:this._ansicht.sortAuf,wunschSeite:this._ansicht.seite,gemessen:this._ansicht.mass,erfassungAn:this.erfassungAn,erfassteAnzahl:this._erfassung.zeilen.length,wertVon:(e,t)=>this._zeilen.zellWert(e,t),blaettert:this.blaettern===`ja`});return y`<div class="tabelle" style=${G({"--takt":`${n.takt}px`,"--zeilen-hoehe":`${n.zeilenHoehe}px`})}>
    ...
    >${Ma()}</button>
    ${e.liste}
  </div>`}var rc={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Pa,quelleProp:`nachschlagQuelle`};function ic(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?W(e):[]}function ac(e,t){let n=e[0];return n===void 0?t:n.feld}function oc(e,t){let n=e.trim();return n===``||n===t.trim()}function sc(e,t,n){let r=t.trim(),i=[],a=oc(t,n),o=new Set;for(let t of e){let e=j(t,n).trim(),s=r===``?e:j(t,r).trim();if(s!==``||e!==``){if(a){if(o.has(e))continue;o.add(e)}i.push({anzeige:s,wert:e,satz:t})}}return i}function cc(e,t,n,r){return sc(nn(e,t).rows,n,r)}function lc(e){let t=A(R().FF_DATA_SOURCES,e);return t?Nt(R().SEDATA,t.name,t.tableId,t.offenerSatz):null}function uc(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=lc(e.quelleId);if(t===null)return{ok:!1,grund:`quelleFehlt`};let n=ac(ic([...e.spalten]),e.speicherFeld);return{ok:!0,eintraege:cc(e.el,t,n,e.speicherFeld)}}function dc(e,t){return t&&e.length===1?e[0]:null}function fc(e,t){let{rows:n,gefiltert:r}=nn(e,[t]);return!r||n.length>0}function pc(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var mc=null,hc=null,gc=null;function _c(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function vc(e=!0){let t=e?gc:null;gc=null,mc?.remove(),mc=null,hc=null,t?.focus()}function yc(e){hc===e&&vc(!1)}function bc(e){return[{kennung:``,titel:e.speicherTitel===``?`Wert`:e.speicherTitel,feld:e.speicherFeld}]}function xc(e){let t=e=>e.stopPropagation(),n=e.editor;return y`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >${e.inhalt}</ff-dialog-rahmen>`}function Sc(e,t){let n=ic([...e.spalten]),r=oc(ac(n,e.speicherFeld),e.speicherFeld);return y`<ff-tabelle
    fuellt
    suche="ja"
    style="--se-r-lg:0px"
    .besitz=${`provided`}
    .spalten=${n.length>0?n:bc(e)}
  ...
  ></ff-tabelle>`}function Cc(e){let t=e.eintraege;if(t===void 0){let n=uc(e);if(!n.ok){L(n.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}t=n.eintraege}vc(!1);let n=document.createElement(`div`);n.style.display=`contents`,Ve(xc({titel:e.titel,breite:e.breite,hoehe:e.hoehe,inhalt:Sc(e,t),onSchliessen:()=>vc()}),n);let r=n.querySelector(an),i=n.querySelector(q.tagName);i?.addEventListener(_s,n=>{let r=n.detail,i=t[r.rohIndex];i&&(vc(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),gc=e.rueckFokus??_c(e.el),document.body.appendChild(n),mc=n,hc=e.el;let a=e.suchtext??``;i&&a!==``&&i.setzeSuchtext(a),r&&i&&Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}function wc(e){return xc({titel:e.titel,breite:e.breite,hoehe:e.hoehe,onSchliessen:e.onSchliessen,editor:{onGroesse:e.onGroesse},inhalt:y`<ff-tabelle
      data-ff-editor
      fuellt
      suche="ja"
      style="--se-r-lg:0px"
...
`,Oc=`frei · hierher ziehen`,kc=`ff-zimmer-inhalt`,Y=class extends D{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[H.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[D.styles,co,Dc,Ec,o`
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(kc,{bubbles:!0,composed:!0}))}render(){return y`<div class="zimmer ${Tc}">
      <div
        class="kopf"
        data-ff-editable
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(kc,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(H.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return y`<div class="col ${Tc} v-${Hr(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};E([w()],X.prototype,`variant`,void 0),E([w()],X.prototype,`heading`,void 0),E([w({attribute:!1})],X.prototype,`leerHinweis`,void 0),E([T()],X.prototype,`_count`,void 0),D.defineAndRegister(X);function Ac(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function jc(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var Mc=new WeakMap,Nc=X.tagName,Pc=Y.tagName,Fc=H.tagName;function Ic(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Nc)}function Lc(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Fc)}function Rc(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Pc)}function zc(e){return[e,...Rc(e)]}function Bc(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=Rc(e);for(let e of t)r(e,Lc(e).length===0?Oc:``);r(e,t.length===0&&Lc(e).length===0?n:``)}}function Vc(e){return Ye().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Hc(e,t){let n=Rc(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),a=Ac(j(t,r),i);return a>=0?n[a]:n[0]}function Uc(e){Q?.board===e&&Yc();let t=e.getAttribute(`statusfield`)??``,n=Ro(e);if(!n)return;let r=Ic(e);if(r.length===0)return;let i=Mc.get(e);if(!i){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(Fc);t&&(i=t.cloneNode(!0),Mc.set(e,i))}if(!i)return;let a=n.zeilen,o=r.map(e=>e.getAttribute(`heading`)??X.defaultProps.heading),s=Vc(i.tagName),c=jc(r.map(e=>e.getAttribute(`auffang`))),l=n.lies;for(let e of r)for(let t of zc(e))Lc(t).forEach(e=>e.remove());for(let e of a){let a=i.cloneNode(!0),u=t===``?-1:Ac(j(e,t),o),d=u>=0?r[u]:c>=0?r[c]:r[0];(Hc(d,e)??d).appendChild(a);for(let t of s){let n=a.getAttribute(zi(t.prop))??``;n!==``&&(a[t.prop]=l(e,n))}let f=Ot(n.quelle,e);Z.set(a,{row:e,pindex:f}),a.draggable=!0}Bc(e,r);let u=r.flatMap(e=>zc(e).flatMap(Lc)),d=Yt(P(e),u,e=>Z.get(e)?.row);for(let e of d)u[e].setAttribute(`data-ff-auswahl`,``)}var Z=new WeakMap,Q=null,Wc=new WeakSet,Gc=`data-ff-zieht`,Kc=`data-ff-ziel`,qc=null;function Jc(e){qc!==e&&(qc?.removeAttribute(Kc),qc=e,qc?.setAttribute(Kc,``))}function Yc(){Q?.card.removeAttribute(Gc),Q=null,Jc(null)}function Xc(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function Zc(e,t){return Xc(e,t,Nc)}function Qc(e,t,n){if(!Q||Q.board!==e)return;let r=Z.get(Q.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;V(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(B)}function $c(e){Wc.has(e)||(Wc.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Z.has(e))??null;if(!n)return;let r=Z.get(n);r&&Xt(P(e),r.row),V(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(B)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Z.has(e))??null;n&&(Q={card:n,board:e},t.dataTransfer?.setData(`text/plain`,Z.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{Q?.card===n&&n.setAttribute(Gc,``)},0))}),e.addEventListener(`dragend`,Yc),e.addEventListener(`dragover`,t=>{let n=Zc(e,t);if(Q?.board!==e||!n){Jc(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),Jc(Xc(e,t,Pc)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&Jc(null)}),e.addEventListener(`drop`,t=>{let n=Zc(e,t);n&&(t.preventDefault(),Qc(e,n,Xc(e,t,Pc)),Yc())}))}var el=la({hydriere:Uc,verdrahte:$c}),tl=el.connect,nl=el.disconnect,rl=X.blockType,il=class extends D{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[rl]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:rl}}static{this.templateChild={type:H.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:ao}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Feld, das die Spalte bestimmt. Leer: alle in die Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Einträge des gewählten Tages.`,kind:`field`},oo()]}static{this.defaultChildren=[{type:rl,props:{heading:`Offen`,variant:`warning`},children:[{type:H.blockType}]},{type:rl,props:{heading:`In Arbeit`,variant:`info`}},{type:rl,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[D.styles,o`
    ...
    `]}render(){return y`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),tl(this)}disconnectedCallback(){super.disconnectedCallback(),nl(this)}};D.defineAndRegister(il);var al={breite:56,breiteOffen:224},ol=`ff-seiten-wechsel`,sl=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],cl=class extends D{static{this.blockType=`navi-eintrag`}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:sl.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[D.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(ol,{detail:e,bubbles:!0,composed:!0}))}render(){return y`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};E([w()],cl.prototype,`seite`,void 0),E([w()],cl.prototype,`seitename`,void 0),E([w({reflect:!0})],cl.prototype,`ton`,void 0),D.defineAndRegister(cl);var ll=`aktiv`;function ul(e){return Array.from(e.querySelectorAll(cl.tagName))}function dl(e,t){let n=ul(e),r=t??n.find(e=>e.hasAttribute(ll))??n[0];for(let e of n)e===r?e.setAttribute(ll,``):e.removeAttribute(ll)}function fl(e){let t=e.hasAttribute(`offen`);for(let n of ul(e))n.toggleAttribute(`breit`,t)}function pl(e){return e.getAttribute(`name`)??String(dt.defaultProps.name)}function ml(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function hl(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(dt.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=ml(e,i);if(!a)return;let o=r.find(e=>pl(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var gl=new WeakMap,_l=new WeakSet;function vl(e){let t=t=>{let n=t.detail;n&&(dl(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),fl(e),!e.hasAttribute(`data-ff-editor`)&&hl(e,n.ansicht))};e.addEventListener(ol,t),gl.set(e,t)}function yl(e){let t=gl.get(e);t&&(e.removeEventListener(ol,t),gl.delete(e))}function bl(e){if(dl(e),fl(e),e.hasAttribute(`data-ff-editor`)||_l.has(e))return;let t=ul(e)[0];if(!t)return;_l.add(e);let n=()=>hl(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var xl=cl.blockType,Sl=class extends D{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[xl]}static{this.addChildButton={label:`Eintrag`,childType:xl}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[ut]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[D.styles,o`
      :host {
        height: 100%;
        width: ${al.breite}px;
        transition: width var(--se-move);
      }
      :host([offen]) { width: ${al.breiteOffen}px; }
      .leiste {
        box-sizing: border-box;
        height: 100%;
        width: 100%;
    ...
    `]}connectedCallback(){super.connectedCallback(),vl(this)}disconnectedCallback(){super.disconnectedCallback(),yl(this)}klappen(){this.toggleAttribute(`offen`),fl(this)}render(){return y`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
        ...
        <div class="eintraege">
          <slot @slotchange=${()=>bl(this)}></slot>
        </div>
      </div>`}};D.defineAndRegister(Sl);var Cl=zi(`text`);function wl(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(Cl)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function Tl(e){let t=ha(e,Cl);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function El(e){wl(e)&&(e.text=``)}var Dl=la({hydriere:Tl,verdrahte:El}),Ol=Dl.connect,kl=Dl.disconnect,Al=6,jl=96,Ml=14,Nl={duenn:`300`,normal:`400`,fett:`700`},Pl={links:`left`,mitte:`center`,rechts:`right`},Fl={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},Il=`standard`;function Ll(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(jl,Math.max(Al,t)):Ml}function Rl(e){return typeof e==`string`&&e in Nl?e:`normal`}function zl(e){return typeof e==`string`&&e in Pl?e:`links`}function Bl(e){return typeof e==`string`&&e in Fl?e:Il}var $=class extends D{constructor(...e){super(...e),this.groesse=Ml,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=Il,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:Ml,gewicht:`normal`,ausrichtung:`links`,farbe:Il,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Al,max:jl,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[D.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return y`<div
      class="text"
      style=${G({fontSize:`${Ll(this.groesse)}px`,fontWeight:Nl[Rl(this.gewicht)],textAlign:Pl[zl(this.ausrichtung)],color:Fl[Bl(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),Ol(this)}disconnectedCallback(){super.disconnectedCallback(),kl(this)}};E([w({type:Number})],$.prototype,`groesse`,void 0),E([w()],$.prototype,`gewicht`,void 0),E([w()],$.prototype,`ausrichtung`,void 0),E([w()],$.prototype,`farbe`,void 0),E([w()],$.prototype,`text`,void 0),E([w()],$.prototype,`source`,void 0),E([w()],$.prototype,`textField`,void 0),D.defineAndRegister($);var Vl=[`waagerecht`,`senkrecht`],Hl=`waagerecht`;function Ul(e){return Vl.includes(e)?e:Hl}var Wl=class extends D{constructor(...e){super(...e),this.richtung=Hl}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:Hl}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[D.styles,o`
    ...
    `]}render(){return y`<div class="flaeche ${Ul(this.richtung)}"><div class="linie"></div></div>`}};E([w()],Wl.prototype,`richtung`,void 0),D.defineAndRegister(Wl),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;L(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();