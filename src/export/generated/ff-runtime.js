...
`;function Ca(e,t){let n=t.trim();return n===``?-1:e.findIndex(e=>e.feld===n)}function wa(e,t){let n=(e?.fuellFeld??``).trim(),r=n===``?(e?.feld??``).trim():n;if(r===``)return{art:`frei`,quelleId:``,code:``};let{quelleId:i,code:a}=ai(r);return i===``?{art:`eigen`,quelleId:t,code:a}:{art:`verknuepft`,quelleId:i,code:a}}function K(e,t){return wa(e.spalten[t],e.quelleId)}function Ta(e){let t=[];for(let n of e.spalten){let r=wa(n,e.quelleId);r.art!==`verknuepft`||r.quelleId===``||t.includes(r.quelleId)||t.push(r.quelleId)}return t}function Ea(e,t){let n=K(e,t);if(!(n.quelleId===``||n.code===``))for(let r=0;r<e.spalten.length;r++){if(r===t)continue;let i=e.spalten[r],a=wa(i,e.quelleId);if(a.quelleId===n.quelleId&&!(a.code===``||a.code===n.code))return{titel:i.titel,code:a.code}}}function Da(e,t){let n=K(e,t);if(n.art!==`verknuepft`||n.quelleId===``||n.code===``)return[];let r=[];for(let t of e.spalten){let i=wa(t,e.quelleId);i.quelleId!==n.quelleId||i.code===``||r.some(e=>e.feld===i.code)||r.push({titel:t.titel,feld:i.code})}return r}function Oa(e,t,n){let r=e.map(e=>({toField:e.toField,soll:t(e.fromField)})).filter(e=>e.soll!==void 0);return r.length===0?[...n]:n.filter(e=>r.every(t=>t.soll!==``&&t.soll===A(e,t.toField)))}function ka(e,t,n){return v`<input
    class="erf-eingabe"
    type="text"
    ...
    @blur=${()=>t.verlassen(n)}
  />`}function Aa(e,t){let n=e.einheitWahl;return!n||n.index!==t?b:v`<select
    class="erf-einheit"
    title=${`Wert umrechnen — Ziel-Einheit: ${n.ziel}`}
    @click=${e=>e.stopPropagation()}
    @change=${e=>{let t=e.target,r=t.value;t.value=``,r!==``&&n.umrechnen(r)}}
  >
    <option value="">${n.ziel}</option>
    ${n.optionen.map(e=>v`<option value=${e.kennung}>${e.klarname}</option>`)}
  </select>`}function ja(e,t,n,r){if(r)return v`<div class="erf-halter">
      ${ka(e,t,n)}
      ${Aa(e,n)}
    </div>`;let i=e.tippSpalte===n&&e.vorschlaege.length>0;return v`<div class=${e.listeNachOben?`erf-halter nach-oben`:`erf-halter`}>
    ${ka(e,t,n)}
    ${Aa(e,n)}
    ${i?ti({eintraege:e.vorschlaege,marke:e.marke,onWaehlen:e=>t.waehleVorschlag(e),onMarke:e=>t.setzeMarke(e)}):b}
  </div>`}function Ma(e,t){return v`<div class="zeile erfassung" role="row" style=${G(e.cols)}>
    ${e.spalten.map((n,r)=>e.imEditor?v`<div role="cell">${`—`}</div>`:v`<div role="cell">${ja(e,t,r,wa(n,e.quelleId).art===`frei`)}</div>`)}
  </div>`}function Na(e,t,n){let r=e.lauf.vorschlaege[n];r!==void 0&&(e.lauf.uebernimm(e.umfeld(),t,r.satz),e.melde())}function Pa(e,t){let n=e.umfeld(),r=n.spalten[t],i=K(n,t);if(r===void 0||i.quelleId===``||i.code===``)return;let a=Da(n,t);Rs({el:e.baustein,quelleId:i.quelleId,speicherFeld:i.code,speicherTitel:r.titel,spalten:a,titel:r.titel,breite:gs(a.length),hoehe:380,eintraege:e.lauf.eintraege(n,t),rueckFokus:null,suchtext:e.lauf.wertVon(n,t),onUebernehmen:(n,r,i)=>{e.lauf.uebernimm(e.umfeld(),t,i),e.melde(),Fa(e,t,`Enter`)}})}function Fa(e,t,n){let r=e.umfeld();if(n===`Tab`){let n=t+1;return n<r.spalten.length?(e.fokussiere(n),!0):e.erfasseZeile()}let i=e.lauf.naechsteLeere(r,t);return i===-1?n===`Enter`&&e.erfasseZeile():e.fokussiere(i),!0}function Ia(e,t,n){if(n.key===`Tab`&&n.shiftKey)return;let r=n.key===`ArrowDown`&&n.altKey?`F4`:n.key,i=e.lauf.entscheideTaste(e.umfeld(),t,r);if(i===`nichts`){n.key===`Enter`&&n.preventDefault();return}let a=!0;i===`uebernehmen`?(Na(e,t,e.lauf.marke),a=Fa(e,t,n.key)):i===`fenster`?Pa(e,t):i===`liste-auf`?e.lauf.oeffneListe(t):i===`weiter`?a=Fa(e,t,n.key):i===`leeren`&&e.lauf.leere(e.umfeld(),t),a&&n.preventDefault(),e.melde()}function La(e,t){let n=t.rechnung;if(!n||n.einheiten.length===0)return;let r=Ca(t.spalten,n.menge.feld);if(r===-1)return;let i=e.lauf.zielEinheit(t);if(i!==``)return{index:r,ziel:i,optionen:n.einheiten,umrechnen:t=>{e.lauf.rechneUm(e.umfeld(),t),e.melde(),e.fokussiere(r)}}}function Ra(e,t,n){let r=e.umfeld();return Ma({spalten:r.spalten,quelleId:r.quelleId,cols:t,imEditor:e.baustein.hasAttribute(`data-ff-editor`),wert:t=>e.lauf.wertVon(r,t),tippSpalte:e.lauf.tippSpalte,vorschlaege:e.lauf.vorschlaege,marke:e.lauf.marke,listeNachOben:n,einheitWahl:La(e,r)},{tippen:(t,n)=>{e.lauf.tippe(t,n),e.melde()},taste:(t,n)=>Ia(e,t,n),verlassen:t=>{e.lauf.verlasse(t),e.melde()},waehleVorschlag:t=>Na(e,e.lauf.tippSpalte,t),setzeMarke:t=>{e.lauf.setzeMarke(t),e.melde()}})}var za=1,Ba=/^-?[1-9]\d{0,2}(\.\d{3})+(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,Va=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,Ha=/^(\d{4})-(\d{2})-(\d{2})$/;function Ua(e){let t=e.trim();if(t===``||!Ba.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?[1-9]\d{0,2}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function Wa(e){let t=e.trim();if(t===``)return null;let n=Ha.exec(t);if(n){let[,e,t,r]=n;return Ga(Number(e),Number(t),Number(r))}let r=Va.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return Ga(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function Ga(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function Ka(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,Ua(i)!==null&&n++,Wa(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var qa=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function Ja(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=Ka(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return za;if(o===``)return-1;let s=i===`zahl`?(Ua(n)??0)-(Ua(o)??0):i===`datum`?(Wa(n)??0)-(Wa(o)??0):qa.compare(n,o);return s===0?e-t:s*a})}var Ya=class{constructor(){this.getippt=new Map,this.gewaehlt=new Map,this.vonHand=new Set,this._tippSpalte=-1,this._marke=0,this._listeZu=!1,this._listeAuf=-1,this._markeVonHand=!1,this._gerechnet=null,this._vorschlaege=[]}get tippSpalte(){return this._tippSpalte}get marke(){return this._marke}get vorschlaege(){return this._vorschlaege}wertVon(e,t){let n=this.getippt.get(t);if(n!==void 0&&n!==``)return n;if(this._gerechnet?.index===t)return this._gerechnet.wert;if(n!==void 0)return n;let r=K(e,t);if(r.quelleId===``||r.code===``)return``;let i=this.gewaehlt.get(r.quelleId);return i===void 0?``:A(i,r.code)}gegebeneZahl(e,t){let n=this.getippt.get(t);if(n!==void 0){if(n.trim()===``)return null;let e=ua(n);return e===null?`fehler`:e}let r=K(e,t);if(r.quelleId===``||r.code===``)return null;let i=this.gewaehlt.get(r.quelleId);if(i===void 0)return null;let a=A(i,r.code).trim();if(a===``)return null;let o=Ua(a);return o===null?`fehler`:o}rechne(e){this._gerechnet=null;let t=e.rechnung;if(!t)return;let n={},r={},i=new Set;for(let a of aa){let o=Ca(e.spalten,t[a].feld);r[a]=o,n[a]=o===-1?null:this.gegebeneZahl(e,o),o!==-1&&i.add(a)}let a=ma(t,n,i);a&&(this._gerechnet={index:r[a.platz],wert:pa(a.wert,t[a.platz].runden.stellen)})}zielEinheit(e){let t=e.rechnung;if(!t||t.einheitFeld.trim()===``)return``;let n=Ca(e.spalten,t.einheitFeld);return n===-1?``:this.wertVon(e,n).trim()}rechneUm(e,t){let n=e.rechnung;if(!n)return;let r=Ca(e.spalten,n.menge.feld);if(r===-1)return;let i=this.wertVon(e,r).trim();if(i===``)return;let a=ua(i)??Ua(i);if(a===null)return;let o=fa(a,t,this.zielEinheit(e),n.einheiten);o!==null&&(this.getippt.set(r,pa(o,n.menge.runden.stellen)),this.rechne(e))}tippe(e,t){this.getippt.set(e,t),this._tippSpalte=e,this._marke=0,this._markeVonHand=!1,this._listeZu=!1}verlasse(e){this._tippSpalte===e&&(this._tippSpalte=-1,this._listeZu=!1,this._listeAuf=-1,this._marke=0,this._markeVonHand=!1)}entscheideTaste(e,t,n){let r=this._tippSpalte===t&&this._vorschlaege.length>0;if(n===`Tab`){if(!r)return`weiter`;n=`Enter`}if(n===`F4`)return K(e,t).art===`frei`||this.eintraege(e,t).length===0?`nichts`:`fenster`;let i=this.wertVon(e,t);if(n===`Escape`&&!r)return i===``?`nichts`:`leeren`;if(K(e,t).art===`frei`)return n===`Enter`?`weiter`:`nichts`;if(n===`ArrowDown`&&!r)return K(e,t).art===`verknuepft`?`liste-auf`:`nichts`;let a=ei(n,{listeOffen:r,feldLeer:i===``,treffer:this._vorschlaege.length,markeVonHand:this._markeVonHand});if(a===`marke-hoch`||a===`marke-runter`){let e=a===`marke-hoch`?-1:1;this._marke=Qr(this._marke,this._vorschlaege.length,e),this._markeVonHand=!0}else if(a===`liste-zu`)this._listeZu=!0,this._listeAuf=-1;else if(a===`fenster`&&this.eintraege(e,t).length===0)return`weiter`;else if(a===`nichts`&&n===`Enter`&&i!==``&&(this.getippt.get(t)===void 0||K(e,t).art!==`verknuepft`))return`weiter`;return a}oeffneListe(e){this._tippSpalte=e,this._listeZu=!1,this._listeAuf=e,this._marke=0,this._markeVonHand=!0}naechsteLeere(e,t){for(let n=t+1;n<e.spalten.length;n++)if(this.wertVon(e,n)===``)return n;return-1}leere(e,t){this.getippt.delete(t);let n=K(e,t);n.quelleId!==``&&this.gewaehlt.has(n.quelleId)&&this.setze(e,n.quelleId,void 0),this._listeZu=!1,this._marke=0,this._markeVonHand=!1}setzeMarke(e){this._marke=e}uebernimm(e,t,n){let r=K(e,t);if(r.quelleId!==``){if(this.setze(e,r.quelleId,n),this.vonHand.add(r.quelleId),r.art===`eigen`)for(let t of[...this.gewaehlt.keys()])t!==r.quelleId&&this.setze(e,t,void 0);this.gleicheAb(e),this._tippSpalte=-1,this._marke=0,this._markeVonHand=!1,this._listeZu=!1}}setze(e,t,n){n===void 0?(this.gewaehlt.delete(t),this.vonHand.delete(t)):this.gewaehlt.set(t,n);for(let n=0;n<e.spalten.length;n++)wa(e.spalten[n],e.quelleId).quelleId===t&&this.getippt.delete(n)}schluesselWert(e,t,n,r){if(t!==``&&t!==e.quelleId){let e=this.gewaehlt.get(t);return e===void 0?void 0:A(e,n)}let i=this.gewaehlt.get(e.quelleId);if(i!==void 0)return A(i,n);for(let t of Ta(e)){if(t===r||!this.vonHand.has(t))continue;let i=e.partnerVon(t);if(i!==``&&i!==e.quelleId)continue;let a=this.gewaehlt.get(t);if(a!==void 0)for(let r of e.paareZu(t)){if(r.fromField!==n)continue;let e=A(a,r.toField);if(e!==``)return e}}}moegliche(e,t,n){let r=e.partnerVon(t);return Oa(e.paareZu(t),n=>this.schluesselWert(e,r,n,t),n)}gleicheAb(e){let t=Ta(e);for(let n=0;n<=t.length;n++){let n=!1;for(let r of t){let t=e.paareZu(r);if(t.length===0)continue;let i=e.partnerVon(r),a=this.gewaehlt.get(r);if(a!==void 0){t.every(t=>{let n=this.schluesselWert(e,i,t.fromField,r);return n===void 0||n!==``&&n===A(a,t.toField)})||(this.setze(e,r,void 0),n=!0);continue}if(!t.some(t=>this.schluesselWert(e,i,t.fromField,r)!==void 0))continue;let o=ws(r);if(o===null)continue;let s=this.moegliche(e,r,o);s.length===1&&(this.setze(e,r,s[0]),this.vonHand.delete(r),n=!0)}if(!n)break}}uebernimmWerte(e){this.zuruecksetzen(),e.forEach((e,t)=>{e!==``&&this.getippt.set(t,e)})}zuruecksetzen(){this.getippt.clear(),this.gewaehlt.clear(),this.vonHand.clear(),this._gerechnet=null,this._tippSpalte=-1,this._marke=0,this._markeVonHand=!1,this._listeZu=!1,this._listeAuf=-1,this._vorschlaege=[]}aktualisiereVorschlaege(e){this.rechne(e),this._vorschlaege=this.berechne(e),this._marke=$r(this._marke,this._vorschlaege.length)}berechne(e){let t=this._tippSpalte;if(this._listeZu||K(e,t).art===`frei`)return[];let n=this.getippt.get(t)??``;return n===``?this._listeAuf===t?this.eintraege(e,t).slice(0,8):[]:Zr(this.eintraege(e,t),n)}eintraege(e,t){let n=K(e,t);if(n.art!==`verknuepft`||n.quelleId===``||n.code===``)return[];let r=ws(n.quelleId);return r===null?[]:Ss(this.moegliche(e,n.quelleId,r),Ea(e,t)?.code??``,n.code)}},Xa=class{constructor(){this.lauf=new Ya,this._zeilen=[],this.naechsteKennung=1,this._zurueck=null}get zeilen(){return this._zeilen.map(e=>e.werte)}vormerkungen(e){let t=this._zeilen.filter(e=>e.geschrieben!==!0).map(e=>({kennung:e.kennung,werte:e.werte})),n=this._zurueck;if(!n)return t;let r=e.spalten.map((t,n)=>this.lauf.wertVon(e,n));if(r.every(e=>e===``))return t;let i=this._zeilen.slice(0,n.platz).filter(e=>e.geschrieben!==!0).length;return[...t.slice(0,i),{kennung:n.kennung,werte:r},...t.slice(i)]}istGeschrieben(e){return this._zeilen[e]?.geschrieben===!0}get schluessel(){return this._zeilen.map(e=>e.kennung)}umfeld(e,t,n,r=null){let i=Ei(e);return{spalten:t,quelleId:n,paareZu:e=>i.find(t=>t.quelleId===e)?.keyPairs??[],partnerVon:e=>i.find(t=>t.quelleId===e)?.partnerId??``,rechnung:r}}erfasse(e){this.lauf.rechne(e);let t=e.spalten.map((t,n)=>this.lauf.wertVon(e,n)),n=this._zurueck;return t.every(e=>e===``)?n?(this._zurueck=null,this.lauf.zuruecksetzen(),!0):!1:(n?(this._zeilen=[...this._zeilen.slice(0,n.platz),{kennung:n.kennung,werte:t},...this._zeilen.slice(n.platz)],this._zurueck=null):(this._zeilen=[...this._zeilen,{kennung:`e${this.naechsteKennung}`,werte:t}],this.naechsteKennung+=1),this.lauf.zuruecksetzen(),!0)}zurueckholen(e,t){let n=this._zeilen[t];if(!n||n.geschrieben===!0)return!1;this.erfasse(e);let r=this._zeilen.indexOf(n);return r===-1?!1:(this._zeilen=this._zeilen.filter((e,t)=>t!==r),this._zurueck={kennung:n.kennung,platz:r},this.lauf.uebernimmWerte(n.werte),!0)}entferne(e){return e<0||e>=this._zeilen.length?!1:(this._zeilen=this._zeilen.filter((t,n)=>n!==e),!0)}markiereGeschrieben(e,t){if(t.length===0)return!1;let n=!1;this._zeilen=this._zeilen.map(e=>e.geschrieben===!0||!t.includes(e.kennung)?e:(n=!0,{...e,geschrieben:!0}));let r=this._zurueck;return r!==null&&t.includes(r.kennung)&&(this._zeilen=[...this._zeilen.slice(0,r.platz),{kennung:r.kennung,werte:e.spalten.map((t,n)=>this.lauf.wertVon(e,n)),geschrieben:!0},...this._zeilen.slice(r.platz)],this._zurueck=null,this.lauf.zuruecksetzen(),n=!0),n}vergissGeschriebene(){let e=this._zeilen.filter(e=>e.geschrieben!==!0);return e.length===this._zeilen.length?!1:(this._zeilen=e,!0)}zuruecksetzen(){this._zeilen=[],this._zurueck=null,this.lauf.zuruecksetzen()}},Za=o`
      .zeile.erfassung {
        flex: none;
        background: var(--se-panel-2);
      ...
      /* Der Einheiten-Umrechner an der Abgabemenge (Rechnung): kein Kasten.
         Unsichtbar, bis die Zelle bedient wird — dann flach und grau, nur
         Einheit und Systempfeil. */
      .erf-einheit {
        display: none;
        flex: none;
        max-width: 56px;
      ...
      .erf-halter:focus-within .erf-einheit,
      .erf-halter:hover .erf-einheit {
        display: block;
      }
...
`;function Qa(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen])}}function $a(e,t,n){return t===``||n===``?[...e]:e.filter(e=>Br(A(e,t))===n)}function eo(e){let t=e.getAttribute(`source`)??``;if(t===``)return null;let n=k(R().FF_DATA_SOURCES,t);return n?{quelle:n,zeilen:$a(Dt(R().SEDATA,n.name,n.tableId,n.offenerSatz),e.getAttribute(`tagfield`)??``,Gr()),lies:Di(e)}:null}function to(e){return Qi(e.getAttribute(`spalten`)??``)}function no(e,t){let n=k(R().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?St(n,t):``}function ro(e){let t=k(R().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return t!==void 0&&t.indexField!==``}function io(e,t){t&&e.vergissGeschriebene();let n=eo(e);if(!n){e.datenzeilen=[];return}let r=to(e),{rows:i,gefiltert:a}=Yt(e,n.zeilen),o=Ht(N(e),i,e=>e)[0]??-1,s=n.lies;e.datenGeliefert=!0,e.rohzeilen=i,e.auswahlIndex=o,e.durchAuswahlGefiltert=a,e.datenzeilen=i.map(e=>r.map(t=>t.feld===``?``:s(e,t.feld)))}var ao=Si({hydriere:io}),oo=ao.connect,so=ao.disconnect;function co(e,t){let n=[];return e.forEach((e,r)=>{Xr(e,t)&&n.push(r)}),n}function lo(e,t){return!e&&t.trim()!==``}function uo(e,t,n){return e&&t&&n===0}function fo(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function po(e){return[...e,W(e.length)]}function mo(e,t,n){let r=t();r.length<=1||e<0||e>=r.length||(r.splice(e,1),n(r))}function ho(e,t,n){return v`<div class="steuerung">
    <button
      title="Letzte Spalte entfernen"
      @click=${r=>{n(r),mo(e().length-1,e,t)}}
    >−</button>
    <button
      title="Spalte hinzufügen"
      @click=${r=>{n(r);let i=e();i.length<16&&t(po(i))}}
    >+</button>
  </div>`}function go(e,t){let n=e.currentTarget;n&&(e.stopPropagation(),e.preventDefault(),at(n,(e,n)=>e===``||e===n.trim()?!1:(t(e),!0)))}function _o(e,t,n,r){go(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var vo=220,yo=new WeakMap;function bo(e){let t=yo.get(e);t!==void 0&&(clearTimeout(t),yo.delete(e))}function xo(e,t,n){return v`<button
    class="kopf-weg"
    type="button"
  ...
  >&#x2715;</button>`}function So(e){return{dblklickKopf:(t,n)=>{e.editable()&&(bo(e.baustein),_o(t,n,e.liste,e.aendere))},klickKopf:(t,n)=>{e.editable()&&Co(e.baustein,t,{prop:e.prop,index:n,liste:e.liste}),e.sortiere(n)}}}function Co(e,t,n){t.stopPropagation();let r=t.currentTarget.getBoundingClientRect();bo(e),yo.set(e,setTimeout(()=>{yo.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n.prop,index:n.index,top:r.bottom+4,left:r.left,...n.liste?{liste:n.liste()}:{}},bubbles:!0,composed:!0}))},vo))}var wo=`\0`;function To(e,t){return e+wo+String(t)}var Eo=class{constructor(){this.werte=new Map}setze(e,t,n){if(e===``)return!1;let r=To(e,t);return this.werte.get(r)===n?!1:(this.werte.set(r,n),!0)}nimmZurueck(e,t){return this.werte.delete(To(e,t))}wert(e,t){return e===``?void 0:this.werte.get(To(e,t))}get anzahl(){return this.werte.size}proSatz(){let e=[];for(let[t,n]of this.werte){let[r,i]=t.split(wo),a=Number(i),o=e.find(e=>e.satz===r),s={satz:r,spalte:a,wert:n};o?o.aenderungen.push(s):e.push({satz:r,aenderungen:[s]})}return e}nimmSatzZurueck(e){let t=!1;for(let n of[...this.werte.keys()])n.slice(0,n.indexOf(wo))===e&&this.werte.delete(n)&&(t=!0);return t}},Do=class{constructor(e){this.aenderungen=new Eo,this.geloescht=new Set,this.wirt=e}get geaenderteZeilen(){if(this.aenderungen.anzahl===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let{satz:r}of this.aenderungen.proSatz()){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}get geloeschteZeilen(){if(this.geloescht.size===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let r of this.geloescht){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}austragen(e,t){let n=!1;for(let r of t)n=e===`geaendert`?this.aenderungen.nimmSatzZurueck(r)||n:this.geloescht.delete(r)||n;n&&this.wirt.melde()}vorgemerkteAenderungen(){return this.geaenderteZeilen.length}vorgemerkteLoeschungen(){return this.geloeschteZeilen.length}statusVon(e){let t=this.satzVon(e);if(t===``)return{status:`gebucht`,titel:``};if(this.geloescht.has(t))return this.wirt.lauf.zeigt(`geloescht`,t,`loeschung`);let n=this.wirt.spalten().some((e,n)=>this.aenderungen.wert(t,n)!==void 0);return this.wirt.lauf.zeigt(`geaendert`,t,n?`geaendert`:`gebucht`)}satzPlaetze(){let e=new Map;return this.wirt.rohzeilen().forEach((t,n)=>{let r=no(this.wirt.baustein,t);r!==``&&!e.has(r)&&e.set(r,n)}),e}satzVon(e){let t=this.wirt.rohzeilen()[e];return t===void 0?``:no(this.wirt.baustein,t)}schalteLoeschung(e){let t=this.satzVon(e);t!==``&&(this.geloescht.has(t)?this.geloescht.delete(t):(this.geloescht.add(t),this.wirt.spalten().forEach((e,n)=>{this.aenderungen.nimmZurueck(t,n)})),this.wirt.melde())}istGeloescht(e){let t=this.satzVon(e);return t!==``&&this.geloescht.has(t)}zellWert(e,t){let n=this.aenderungen.wert(this.satzVon(e),t);return n===void 0?this.wirt.datenzeilen()[e]?.[t]??``:n}istGeaendert(e,t){return this.aenderungen.wert(this.satzVon(e),t)!==void 0}tippeZelle(e,t,n){this.aenderungen.setze(this.satzVon(e),t,n)&&this.wirt.melde()}verlasseZelle(e,t,n){let r=this.satzVon(e);(n===(this.wirt.datenzeilen()[e]?.[t]??``)?this.aenderungen.nimmZurueck(r,t):this.aenderungen.setze(r,t,n))&&this.wirt.melde()}zelleNachbar(e,t,n,r){let i=Array.from(this.wirt.baustein.shadowRoot?.querySelectorAll(`.koerper > .zeile:not(.erfassung) .zell-eingabe[data-spalte="${e}"]`)??[]),a=i.indexOf(t);if(a<0)return;let o=a+n;if(o>i.length-1){if(r&&this.wirt.erfassungAn()){this.wirt.fokussiereErfassungsZelle(0);return}o=i.length-1}o<0&&(o=0);let s=i[o];!s||s===t||(s.focus(),s.select(),s.scrollIntoView({block:`nearest`}))}tasteZelle(e,t,n){let r=n.target;if(n.key===`Escape`){n.preventDefault(),n.stopPropagation(),this.aenderungen.nimmZurueck(this.satzVon(e),t)&&this.wirt.melde();return}let i={Enter:1,ArrowDown:1,ArrowUp:-1,PageDown:10,PageUp:-10}[n.key];i!==void 0&&(n.preventDefault(),n.stopPropagation(),this.zelleNachbar(t,r,i,n.key===`Enter`))}},Oo={gebucht:``,erfasst:`Neue Zeile — noch nicht geschrieben`,geaendert:`Geändert — noch nicht geschrieben`,loeschung:`Zum Löschen vorgemerkt — noch nicht geschrieben`,schreibt:`Wird geschrieben …`,geschrieben:`Hinausgeschickt — bleibt stehen, bis neue Daten kommen`,fehler:`Nicht geschrieben`},ko=class{constructor(e){this.schreibend=new Map,this.fehler=new Map,this.melde=e}schreibt(e,t){this.fehler.get(e)?.delete(t);let n=this.schreibend.get(e)??new Set;n.add(t),this.schreibend.set(e,n),this.melde()}gescheitert(e,t,n){this.schreibend.get(e)?.delete(t);let r=this.fehler.get(e)??new Map;r.set(t,n),this.fehler.set(e,r),this.melde()}fertig(e,t){this.schreibend.get(e)?.clear();let n=this.fehler.get(e);if(n)for(let e of t)n.delete(e);this.melde()}zeigt(e,t,n){let r=this.fehler.get(e)?.get(t);return r===void 0?this.schreibend.get(e)?.has(t)===!0?{status:`schreibt`,titel:Oo.schreibt}:{status:n,titel:Oo[n]}:{status:`fehler`,titel:Oo.fehler+`: `+r}}},Ao=4;function jo(e){return e??Ao}function Mo(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function No(e,t,n){let r=Mo(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function Po(e,t){return e===null?null:Math.max(0,e-t)}function Fo({sichtbar:e,hatQuelle:t,platzhalterZeilen:n}){return t?{seiten:1,seite:0,zeilen:[...e]}:{seiten:1,seite:0,zeilen:Array.from({length:n},()=>null)}}function Io({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function Lo(e){if(!e.hasAttribute(`fuellt`))return-1;let t=e.renderRoot.querySelector(`.koerper`);return t instanceof HTMLElement?t.clientHeight:-1}function Ro(e){let t=e.renderRoot.querySelector(`.kopf`);return t instanceof HTMLElement?t.offsetHeight:0}function zo(e,t){let n=Lo(e);if(n===-1)return{mass:null,hoehe:n,kopf:0};let r=Ro(e);return{mass:No(n,r,t),hoehe:n,kopf:r}}function Bo(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}var Vo=`ff-zeile-aktiviert`,Ho=`data-ff-roh`;function Uo(e,t){e.dispatchEvent(new CustomEvent(Vo,{detail:t,bubbles:!0,composed:!0}))}function Wo(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(Ho);return r===null||r===``?null:Number(r)}function Go(e,t){if(!(e instanceof HTMLElement))return!1;let n=e.closest(`.zeile`),r=n?.parentElement;if(!n||!r)return!1;let i=[...r.querySelectorAll(`.zeile[${Ho}]`)],a=i.indexOf(n),o=a===-1?void 0:i[a+t];return o?(o.focus(),!0):!1}function Ko(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.zeile[${Ho}]`);return t?(t.focus(),!0):!1}function qo(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.suchzeile input`);return t?(t.focus(),!0):!1}function Jo(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var Yo=class{constructor(e){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._rumpfGemessen=-1,this._kopfGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this.wirt=e}get suchtext(){return this._suchtext}get suchtAktiv(){return this._suchtext.trim()!==``}get sortSpalte(){return this._sortSpalte}get sortAuf(){return this._sortAuf}get seite(){return this._seite}get mass(){return this._mass}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.wirt.melde()}klickSortiere(e){this.wirt.editable()||(this.merkeZeilenFokus(),this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.wirt.melde())}blaettere(e){this.merkeZeilenFokus(),this._seite=e,this.wirt.melde()}fokussiereSuche(){let e=this.wirt.baustein.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}merkeZeilenFokus(){let e=Wo(this.wirt.baustein.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.wirt.zeilenHoehe();this._taktGemessen=e;let{mass:t,hoehe:n,kopf:r}=zo(this.wirt.baustein,e);this._rumpfGemessen=n,this._kopfGemessen=r,!(t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe)&&(this._mass=t,this.wirt.melde())}beobachte(){this._beobachter||(this._beobachter=Bo(this.wirt.baustein,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}nachRendern(){(this._taktGemessen!==this.wirt.zeilenHoehe()||this._rumpfGemessen!==Lo(this.wirt.baustein)||this._kopfGemessen!==Ro(this.wirt.baustein))&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,Jo(this.wirt.baustein.shadowRoot,this._fokusZeile))}loese(){this._beobachter?.disconnect(),this._beobachter=null}nachPush(){this._seite=0,this._mass=null,this._taktGemessen=0,this._rumpfGemessen=-1,this._kopfGemessen=0}zuruecksetzen(){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this.nachPush(),this._fokusZeile=null,this._fokusHolen=!1}};function Xo(e,t,n,r){if(n===null||e.hasAttribute(`data-ff-editor`))return;let i=t[n];i!==void 0&&(Uo(e,{rohzeile:i,rohIndex:n,ansichtIndex:r}),Qo(e,i),V(e,`onRowClick`,{PINDEX:no(e,i)}).catch(B))}function Zo(e,t,n){if(n===null||e.hasAttribute(`data-ff-editor`))return;let r=t[n];r!==void 0&&V(e,`onRowDblClick`,{PINDEX:no(e,r)}).catch(B)}function Qo(e,t){let n=N(e);n!==``&&Ut(n,t)}var $o={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Ki,eintragsSchalter:[{key:`summe`,label:`Summe in der Fußzeile`,kurz:`Summe`},{key:`aenderbar`,label:`In der Zeile änderbar`,kurz:`änderbar`,standard:!0,nurEigeneQuelle:!0}],herkunftProp:`spaltenHerkunft`,eintragsFeldWahl:[{key:`fuellFeld`,label:`Nachschlagen`,hinweis:`Beim Erfassen füllt der gewählte Satz der Hilfsquelle diese Zelle.`,nurFremdeQuellen:!0}]};function es(e){let t=e,n=$o.eintragsSchalter?.find(e=>e.key===`aenderbar`);return n!==void 0&&e.feld!==``&&si($o,t).includes(n)&&oi(n,t)}function ts(e,t,n){let r=0,i=0;for(let t of e){let e=Ua(t);e!==null&&(r+=e,i++)}return i===0?``:r.toLocaleString(`de-DE`,{minimumFractionDigits:t,maximumFractionDigits:n})}var ns={min:0,max:3};function rs(e,t){let n=[];return e.spalten.forEach((r,i)=>{if(r.summe!==!0)return;let a=ts(t.map(t=>e.wertVon(t,i)),ns.min,ns.max);a!==``&&n.push({titel:r.titel,text:a})}),n}function is(e){let t=co(e.datenzeilen,e.suchtext);return e.sortSpalte<0?t:Ja(t.map(t=>e.datenzeilen[t]),e.sortSpalte,e.sortAuf).map(e=>t[e])}function as(e){let t={gridTemplateColumns:$i(e.spalten,e.breiteVon)},n=e.gemessen?.zeilenHoehe??28,r=e.hatQuelle,i=!e.erfassungAn&&uo(r,e.datenGeliefert,e.datenzeilen.length),a=is(e),o=e.erfassungAn?1+e.erfassteAnzahl:0,s=e.gemessen===null?null:Math.max(1,e.gemessen.passen-o),c={sichtbar:a,hatQuelle:r,proSeite:s??Math.max(1,10-o),wunschSeite:e.wunschSeite,platzhalterZeilen:jo(s)},{seiten:l,seite:u,zeilen:d}=e.blaettert?Io(c):Fo(c);return{cols:t,takt:28,zeilenHoehe:n,hatQuelle:r,leer:i,gesamt:a.length,seiten:l,seite:u,zeilen:d,linealTakte:Po(s,d.length),summen:rs(e,a)}}var os=[U(`suche`,`Suchzeile`,`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,{requiresDataSource:!0}),U(`erfassung`,`Erfassungszeile`,`Eine leere Zeile zum Tippen neuer Positionen.`),U(`loeschbar`,`Zeilen löschbar`,`Kreuz an jeder Zeile: merkt sie zum Löschen vor.`,{requiresDataSource:!0}),U(`blaettern`,`Blättern`,`Ja: Seiten mit Blätter-Knöpfen. Nein: alles untereinander, der Rumpf rollt.`),U(`kopfzeile`,`Kopfzeile`,`Aus: keine Titelzeile, kein Sortieren per Titelklick.`),{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Sätze des gewählten Tages.`,kind:`field`},ba()];function ss(e,t){let n=e.erfasst+e.geaendert+e.geloescht,r=e.seiten>1||e.summen.length>0||n>0||e.suchtAktiv||e.auswahlAktiv;return e.leer||!r?b:v`<div class="fusszeile">
    <div class="seiten-info">${fo({hatQuelle:e.hatQuelle,sichtbar:e.sichtbar,gesamt:e.gesamt,suchtAktiv:e.suchtAktiv,auswahlAktiv:e.auswahlAktiv})}</div>
  ...
  </div>`}var cs=/[.*+?^${}()|[\]\\]/g;function ls(e,t){let n=Yr(t);if(n.length===0||e===``)return e;let r;try{r=RegExp(`(${n.map(e=>e.replace(cs,`\\$&`)).join(`|`)})`,`ig`)}catch{return e}let i=e.split(r);return i.length<=1?e:v`${i.map((e,t)=>t%2==1?v`<mark>${e}</mark>`:e)}`}function us(e,t,n){let r=40-e,i=t-40,a=r>i?0:Math.min(i,Math.max(r,Math.round(n)));return{links:Math.round(e+a),rechts:Math.round(t-a)}}function ds(e,t,n){if(e.button!==0)return;let r=[...e.currentTarget?.parentElement?.children??[]].filter(e=>e instanceof HTMLElement&&e.tagName===`DIV`),i=r[t],a=r[t+1];if(!i||!a)return;e.stopPropagation(),e.preventDefault();let o=e.clientX,s=i.getBoundingClientRect().width,c=a.getBoundingClientRect().width,l=us(s,c,0),u=()=>{window.removeEventListener(`pointermove`,p),window.removeEventListener(`pointerup`,ee),window.removeEventListener(`pointercancel`,m),window.removeEventListener(`keydown`,te),window.removeEventListener(`blur`,m)},d=r.map(e=>Math.max(1,Math.round(e.getBoundingClientRect().width))),f=()=>d.map((e,n)=>n===t?{index:n,breite:l.links}:n===t+1?{index:n,breite:l.rechts}:{index:n,breite:e});function p(e){l=us(s,c,e.clientX-o),n.zeige(f())}function ee(){u(),n.uebernimm(f())}function m(){u(),n.verwirf()}function te(e){e.key===`Escape`&&(e.preventDefault(),m())}window.addEventListener(`pointermove`,p),window.addEventListener(`pointerup`,ee),window.addEventListener(`pointercancel`,m),window.addEventListener(`keydown`,te),window.addEventListener(`blur`,m)}function fs(e,t){return Array.from({length:Math.max(0,e-1)},(e,n)=>v`<span
    class="breite-griff"
    role="presentation"
    style="grid-row: 1; grid-column: ${n+1}"
    title="Linie ziehen: links breiter, rechts schmaler"
    @pointerdown=${e=>ds(e,n,t)}
    @click=${e=>e.stopPropagation()}
    @dblclick=${e=>e.stopPropagation()}
  ></span>`)}function ps(e){return e.linealTakte===0?b:v`<div class="lineal" role="presentation" style=${G(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>v`<div></div>`)}
        </div>`}function ms(e,t){return v`
      ...
      ${e.zeigeKopf?v`<div class="kopf" role="row" style=${G(e.cols)}>
        ${e.spalten.map((n,r)=>v`<div
          ...
          >${e.imEditor&&(e.herkunft[r]??``)!==``?v`<span class="kopf-titel">${n.titel}</span><span
                ...
                >${e.herkunft[r]}</span>`:n.titel}${!e.editable&&e.sortSpalte===r?v`<span class="sort-pfeil">${e.sortAuf?` ▲`:` ▼`}</span>`:``}${e.imEditor&&e.editable&&e.spalten.length>1?xo(n.titel,r,t.loescheSpalte):b}</div>`)}
        ${fs(e.spalten.length,t.breiten)}
      </div>`:b}
        ${``}
        ${e.leer?xa(e.leerText,!0):v`
        ...
        ${e.zeilen.map((n,r)=>{let i=n!==null&&!e.imEditor,a=n!==null&&e.zeilenStand.istGeloescht(n),o=n===null?{status:`gebucht`,titel:``}:e.zeilenStand.statusVon(n);return v`<div
          ...
          >
            ${``}
            ${e.spalten.map((r,i)=>{let a=n===null?`—`:e.datenzeilen[n]?.[i]??``,o=e.imEditor&&!e.zeigeKopf&&e.editable;if(e.aendernMoeglich&&n!==null&&es(r)){let t=e.zeilenStand;return v`<div class="tippbar" role="cell">
                <input
...
`,q=class e extends D{constructor(...e){super(...e),this.spalten=Ji(),this.spaltenHerkunft=[],this.source=``,this.suche=`ja`,this.erfassung=`nein`,this.blaettern=`ja`,this.loeschbar=`nein`,this.kopfzeile=`ja`,this.leerText=ya,this.rechnung=``,this.datenzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._besitz=`softengine`,this._breiten=new Map,this._breiteVorZug=null,this._ansicht=new Yo({baustein:this,editable:()=>this.editable,zeilenHoehe:()=>this.zeilenHoehe,melde:()=>this.requestUpdate()}),this._erfassung=new Xa,this._lauf=new ko(()=>this.requestUpdate()),this._zeilen=new Do({baustein:this,spalten:()=>this.spaltenListe(),rohzeilen:()=>this.rohzeilen,datenzeilen:()=>this.datenzeilen,melde:()=>this.requestUpdate(),lauf:this._lauf,erfassungAn:()=>this.erfassungAn,fokussiereErfassungsZelle:e=>this.fokussiereErfassungsZelle(e)}),this.nimmSeFokus=e=>{e.defaultPrevented||!this.erfassungAn||this.hasAttribute(`data-ff-editor`)||(e.preventDefault(),this.fokussiereErfassungsZelle(0))}}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.kannErfassen={wenn:{attributeName:`erfassung`,equals:`ja`}}}static{this.aenderungsSchluessel=`aenderbar`}static{this.kannLoeschen={wenn:{attributeName:`loeschbar`,equals:`ja`}}}static{this.blockEvents=[{key:`onRowClick`,name:`Zeile gewählt`},{key:`onRowDblClick`,name:`Zeile doppelt geklickt`}]}static{this.listenBindung=$o}static{this.defaultProps={width:`fill`,source:``,spalten:Ji(),suche:`ja`,erfassung:`nein`,blaettern:`ja`,loeschbar:`nein`,kopfzeile:`ja`,tagField:``,rechnung:``,leerText:ya}}static{this.customProperties=os}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?so(this):oo(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=Qa(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.nachPush(),this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.zuruecksetzen(),this._erfassung.zuruecksetzen()}get erfassteZeilen(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.werte)}get erfassteSchluessel(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.kennung)}get geaenderteZeilen(){return this._zeilen.geaenderteZeilen}get geloeschteZeilen(){return this._zeilen.geloeschteZeilen}zeileSchreibt(e,t){this._lauf.schreibt(e,t)}zeileGescheitert(e,t,n){this._lauf.gescheitert(e,t,n)}laufFertig(e,t){if(this._lauf.fertig(e,t),e===`erfasst`){this._erfassung.markiereGeschrieben(this.erfassungsUmfeld(),t)&&this.requestUpdate();return}this._zeilen.austragen(e,t)}vergissGeschriebene(){this._erfassung.vergissGeschriebene()&&this.requestUpdate()}erfasstStand(e){return this._lauf.zeigt(`erfasst`,this._erfassung.schluessel[e]??``,this._erfassung.istGeschrieben(e)?`geschrieben`:`erfasst`)}erfasseZeile(){return this._erfassung.erfasse(this.erfassungsUmfeld())?(this.requestUpdate(),this.fokussiereErfassungsZelle(0),this.zeigeLetzteErfasste(),!0):!1}zeigeLetzteErfasste(){this.updateComplete.then(()=>{let e=this.shadowRoot?.querySelector(`.koerper`);e&&(e.scrollTop=e.scrollHeight)})}fokussiereSuche(){return this._ansicht.fokussiereSuche()}setzeSuchtext(e){this._ansicht.setzeSuchtext(e),this.requestUpdate()}get hatQuelle(){return this._besitz===`provided`||lo(this.hasAttribute(`data-ff-editor`),this.source)}spaltenListe(){return Zi(this.spalten)}get zeilenHoehe(){return 28}breitenWirt(){let e=e=>{this._breiteVorZug===null&&(this._breiteVorZug=new Map(e.map(e=>[e.index,this._breiten.get(e.index)])))};return{zeige:t=>{e(t);for(let e of t)this._breiten.set(e.index,e.breite);this.requestUpdate()},uebernimm:e=>{this._breiteVorZug=null;let t=this.spaltenListe();if(!this.hasAttribute(`data-ff-editor`)){for(let t of e)this._breiten.set(t.index,t.breite);this.requestUpdate();return}for(let n of e)n.index>=t.length||(this._breiten.delete(n.index),t[n.index]={...t[n.index],breite:n.breite});this.aendere(t)},verwirf:()=>{let e=this._breiteVorZug;if(this._breiteVorZug=null,e){for(let[t,n]of e)n===void 0?this._breiten.delete(t):this._breiten.set(t,n);this.requestUpdate()}}}}get erfassungAn(){return this.erfassung===`ja`}erfassungsWirt(){return{baustein:this,lauf:this._erfassung.lauf,umfeld:()=>this.erfassungsUmfeld(),melde:()=>this.requestUpdate(),fokussiere:e=>this.fokussiereErfassungsZelle(e),erfasseZeile:()=>this.erfasseZeile()}}fokussiereErfassungsZelle(e){this.updateComplete.then(()=>{let t=this.shadowRoot?.querySelectorAll(`.zeile.erfassung .erf-eingabe`)?.[e];t&&(t.focus(),t.scrollIntoView({block:`nearest`}))})}erfassungsUmfeld(){return this._erfassung.umfeld(this,this.spaltenListe(),this.source,va(this.rechnung))}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&oo(this),document.addEventListener(Fn,this.nimmSeFokus),this._ansicht.beobachte()}firstUpdated(){this._ansicht.beobachte()}willUpdate(e){super.willUpdate(e),e.has(`spalten`)&&this._breiten.clear(),!(!this.erfassungAn||this.hasAttribute(`data-ff-editor`))&&this._erfassung.lauf.aktualisiereVorschlaege(this.erfassungsUmfeld())}updated(){this._ansicht.nachRendern(),Tr(this)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(Fn,this.nimmSeFokus),bo(this),this._ansicht.loese(),Ps(this),so(this)}static{this.styles=[D.styles,Sa,hs,ni,Za]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=as({spalten:t,breiteVon:e=>this._breiten.get(e),hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._ansicht.suchtext,sortSpalte:this._ansicht.sortSpalte,sortAuf:this._ansicht.sortAuf,wunschSeite:this._ansicht.seite,gemessen:this._ansicht.mass,erfassungAn:this.erfassungAn,erfassteAnzahl:this._erfassung.zeilen.length,wertVon:(e,t)=>this._zeilen.zellWert(e,t),blaettert:this.blaettern===`ja`});return v`<div class="tabelle" style=${G({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
    ...
    </div>`}};E([w({converter:{fromAttribute:e=>e?Qi(e):Ji(),toAttribute:e=>JSON.stringify(e)}})],q.prototype,`spalten`,void 0),E([w({attribute:!1})],q.prototype,`spaltenHerkunft`,void 0),E([w()],q.prototype,`source`,void 0),E([w()],q.prototype,`suche`,void 0),E([w()],q.prototype,`erfassung`,void 0),E([w()],q.prototype,`blaettern`,void 0),E([w()],q.prototype,`loeschbar`,void 0),E([w()],q.prototype,`kopfzeile`,void 0),E([w()],q.prototype,`leerText`,void 0),E([w()],q.prototype,`rechnung`,void 0),E([w({attribute:!1})],q.prototype,`datenzeilen`,void 0),E([w({attribute:!1})],q.prototype,`rohzeilen`,void 0),E([w({attribute:!1})],q.prototype,`auswahlIndex`,void 0),E([w({attribute:!1})],q.prototype,`durchAuswahlGefiltert`,void 0),E([w({attribute:!1})],q.prototype,`datenGeliefert`,void 0),D.defineAndRegister(q);function gs(e){return Math.min(900,Math.max(520,160+180*e))}function _s(e){return v`<div class="nachschlag">
    <input
      class="ctrl"
      type="text"
      .value=${e.wert}
    ...
    >${Gi()}</button>
    ${e.liste}
  </div>`}var vs={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Ki,quelleProp:`nachschlagQuelle`};function ys(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?Zi(e):[]}function bs(e,t){let n=e[0];return n===void 0?t:n.feld}function xs(e,t){let n=e.trim();return n===``||n===t.trim()}function Ss(e,t,n){let r=t.trim(),i=[],a=xs(t,n),o=new Set;for(let t of e){let e=A(t,n).trim(),s=r===``?e:A(t,r).trim();if(!(s===``&&e===``)){if(a){if(o.has(e))continue;o.add(e)}i.push({anzeige:s,wert:e,satz:t})}}return i}function Cs(e,t,n,r){return Ss(Yt(e,t).rows,n,r)}function ws(e){let t=k(R().FF_DATA_SOURCES,e);return t?Dt(R().SEDATA,t.name,t.tableId,t.offenerSatz):null}function Ts(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=ws(e.quelleId);if(t===null)return{ok:!1,grund:`quelleFehlt`};let n=bs(ys([...e.spalten]),e.speicherFeld);return{ok:!0,eintraege:Cs(e.el,t,n,e.speicherFeld)}}function Es(e,t){return t&&e.length===1?e[0]:null}function Ds(e,t){let{rows:n,gefiltert:r}=Yt(e,[t]);return!r||n.length>0}function Os(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var ks=null,As=null,js=null;function Ms(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function Ns(e=!0){let t=e?js:null;js=null,ks?.remove(),ks=null,As=null,t?.focus()}function Ps(e){As===e&&Ns(!1)}function Fs(e){return[{titel:e.speicherTitel===``?`Wert`:e.speicherTitel,feld:e.speicherFeld}]}function Is(e){let t=e=>e.stopPropagation(),n=e.editor;return v`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >${e.inhalt}</ff-dialog-rahmen>`}function Ls(e,t){let n=ys([...e.spalten]),r=xs(bs(n,e.speicherFeld),e.speicherFeld);return v`<ff-tabelle
    fuellt
    suche="ja"
    style="--se-r-lg:0px"
    .besitz=${`provided`}
    .spalten=${n.length>0?n:Fs(e)}
  ...
  ></ff-tabelle>`}function Rs(e){let t=e.eintraege;if(t===void 0){let n=Ts(e);if(!n.ok){L(n.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}t=n.eintraege}Ns(!1);let n=document.createElement(`div`);n.style.display=`contents`,Ve(Is({titel:e.titel,breite:e.breite,hoehe:e.hoehe,inhalt:Ls(e,t),onSchliessen:()=>Ns()}),n);let r=n.querySelector(Zt),i=n.querySelector(q.tagName);i?.addEventListener(Vo,n=>{let r=n.detail,i=t[r.rohIndex];i&&(Ns(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),js=e.rueckFokus??Ms(e.el),document.body.appendChild(n),ks=n,As=e.el;let a=e.suchtext??``;i&&a!==``&&i.setzeSuchtext(a),r&&i&&Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}function zs(e){return Is({titel:e.titel,breite:e.breite,hoehe:e.hoehe,onSchliessen:e.onSchliessen,editor:{onGroesse:e.onGroesse},inhalt:v`<ff-tabelle
      data-ff-editor
      fuellt
      suche="ja"
      style="--se-r-lg:0px"
...
`,Us=`frei · hierher ziehen`,Ws=`ff-zimmer-inhalt`,Y=class extends D{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[H.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[D.styles,Sa,Hs,Vs,o`
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(Ws,{bubbles:!0,composed:!0}))}render(){return v`<div class="zimmer ${Bs}">
      <div
        class="kopf"
        data-ff-editable
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(Ws,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(H.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return v`<div class="col ${Bs} v-${Or(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};E([w()],X.prototype,`variant`,void 0),E([w()],X.prototype,`heading`,void 0),E([w({attribute:!1})],X.prototype,`leerHinweis`,void 0),E([T()],X.prototype,`_count`,void 0),D.defineAndRegister(X);function Gs(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function Ks(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var qs=new WeakMap,Js=X.tagName,Ys=Y.tagName,Xs=H.tagName;function Zs(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Js)}function Qs(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Xs)}function $s(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Ys)}function ec(e){return[e,...$s(e)]}function tc(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=$s(e);for(let e of t)r(e,Qs(e).length===0?Us:``);r(e,t.length===0&&Qs(e).length===0?n:``)}}function nc(e){return Je().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function rc(e,t){let n=$s(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),a=Gs(A(t,r),i);return a>=0?n[a]:n[0]}function ic(e){Q?.board===e&&uc();let t=e.getAttribute(`statusfield`)??``,n=eo(e);if(!n)return;let r=Zs(e);if(r.length===0)return;let i=qs.get(e);if(!i){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(Xs);t&&(i=t.cloneNode(!0),qs.set(e,i))}if(!i)return;let a=n.zeilen,o=r.map(e=>e.getAttribute(`heading`)??X.defaultProps.heading),s=nc(i.tagName),c=Ks(r.map(e=>e.getAttribute(`auffang`))),l=n.lies;for(let e of r)for(let t of ec(e))Qs(t).forEach(e=>e.remove());for(let e of a){let a=i.cloneNode(!0),u=t===``?-1:Gs(A(e,t),o),d=u>=0?r[u]:c>=0?r[c]:r[0];(rc(d,e)??d).appendChild(a);for(let t of s){let n=a.getAttribute(ci(t.prop))??``;n!==``&&(a[t.prop]=l(e,n))}let f=St(n.quelle,e);Z.set(a,{row:e,pindex:f}),a.draggable=!0}tc(e,r);let u=r.flatMap(e=>ec(e).flatMap(Qs)),d=Ht(N(e),u,e=>Z.get(e)?.row);for(let e of d)u[e].setAttribute(`data-ff-auswahl`,``)}var Z=new WeakMap,Q=null,ac=new WeakSet,oc=`data-ff-zieht`,sc=`data-ff-ziel`,cc=null;function lc(e){cc!==e&&(cc?.removeAttribute(sc),cc=e,cc?.setAttribute(sc,``))}function uc(){Q?.card.removeAttribute(oc),Q=null,lc(null)}function dc(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function fc(e,t){return dc(e,t,Js)}function pc(e,t,n){if(!Q||Q.board!==e)return;let r=Z.get(Q.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;V(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(B)}function mc(e){ac.has(e)||(ac.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Z.has(e))??null;if(!n)return;let r=Z.get(n);r&&Ut(N(e),r.row),V(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(B)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Z.has(e))??null;n&&(Q={card:n,board:e},t.dataTransfer?.setData(`text/plain`,Z.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{Q?.card===n&&n.setAttribute(oc,``)},0))}),e.addEventListener(`dragend`,uc),e.addEventListener(`dragover`,t=>{let n=fc(e,t);if(Q?.board!==e||!n){lc(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),lc(dc(e,t,Ys)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&lc(null)}),e.addEventListener(`drop`,t=>{let n=fc(e,t);n&&(t.preventDefault(),pc(e,n,dc(e,t,Ys)),uc())}))}var hc=Si({hydriere:ic,verdrahte:mc}),gc=hc.connect,_c=hc.disconnect,vc=X.blockType,yc=class extends D{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[vc]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:vc}}static{this.templateChild={type:H.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:ya}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Feld, das die Spalte bestimmt. Leer: alle in die Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Einträge des gewählten Tages.`,kind:`field`},ba()]}static{this.defaultChildren=[{type:vc,props:{heading:`Offen`,variant:`warning`},children:[{type:H.blockType}]},{type:vc,props:{heading:`In Arbeit`,variant:`info`}},{type:vc,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[D.styles,o`
    ...
    `]}render(){return v`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),gc(this)}disconnectedCallback(){super.disconnectedCallback(),_c(this)}};D.defineAndRegister(yc);var bc={breite:56,breiteOffen:224},xc=`ff-seiten-wechsel`,Sc=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],Cc=class extends D{static{this.blockType=`navi-eintrag`}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:Sc.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[D.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(xc,{detail:e,bubbles:!0,composed:!0}))}render(){return v`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};E([w()],Cc.prototype,`seite`,void 0),E([w()],Cc.prototype,`seitename`,void 0),E([w({reflect:!0})],Cc.prototype,`ton`,void 0),D.defineAndRegister(Cc);var wc=`aktiv`;function Tc(e){return Array.from(e.querySelectorAll(Cc.tagName))}function Ec(e,t){let n=Tc(e),r=t??n.find(e=>e.hasAttribute(wc))??n[0];for(let e of n)e===r?e.setAttribute(wc,``):e.removeAttribute(wc)}function Dc(e){let t=e.hasAttribute(`offen`);for(let n of Tc(e))n.toggleAttribute(`breit`,t)}function Oc(e){return e.getAttribute(`name`)??String(st.defaultProps.name)}function kc(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function Ac(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(st.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=kc(e,i);if(!a)return;let o=r.find(e=>Oc(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var jc=new WeakMap,Mc=new WeakSet;function Nc(e){let t=t=>{let n=t.detail;n&&(Ec(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),Dc(e),!e.hasAttribute(`data-ff-editor`)&&Ac(e,n.ansicht))};e.addEventListener(xc,t),jc.set(e,t)}function Pc(e){let t=jc.get(e);t&&(e.removeEventListener(xc,t),jc.delete(e))}function Fc(e){if(Ec(e),Dc(e),e.hasAttribute(`data-ff-editor`)||Mc.has(e))return;let t=Tc(e)[0];if(!t)return;Mc.add(e);let n=()=>Ac(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var Ic=Cc.blockType,Lc=class extends D{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Ic]}static{this.addChildButton={label:`Eintrag`,childType:Ic}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[ot]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[D.styles,o`
      :host {
        height: 100%;
        width: ${bc.breite}px;
    ...
    `]}connectedCallback(){super.connectedCallback(),Nc(this)}disconnectedCallback(){super.disconnectedCallback(),Pc(this)}klappen(){this.toggleAttribute(`offen`),Dc(this)}render(){return v`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
        ...
        <div class="eintraege">
          <slot @slotchange=${()=>Fc(this)}></slot>
        </div>
      </div>`}};D.defineAndRegister(Lc);var Rc=ci(`text`);function zc(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(Rc)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function Bc(e){let t=Oi(e,Rc);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function Vc(e){zc(e)&&(e.text=``)}var Hc=Si({hydriere:Bc,verdrahte:Vc}),Uc=Hc.connect,Wc=Hc.disconnect,Gc=6,Kc=96,qc=14,Jc={duenn:`300`,normal:`400`,fett:`700`},Yc={links:`left`,mitte:`center`,rechts:`right`},Xc={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},Zc=`standard`;function Qc(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(Kc,Math.max(Gc,t)):qc}function $c(e){return typeof e==`string`&&e in Jc?e:`normal`}function el(e){return typeof e==`string`&&e in Yc?e:`links`}function tl(e){return typeof e==`string`&&e in Xc?e:Zc}var $=class extends D{constructor(...e){super(...e),this.groesse=qc,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=Zc,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:qc,gewicht:`normal`,ausrichtung:`links`,farbe:Zc,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Gc,max:Kc,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[D.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return v`<div
      class="text"
      style=${G({fontSize:`${Qc(this.groesse)}px`,fontWeight:Jc[$c(this.gewicht)],textAlign:Yc[el(this.ausrichtung)],color:Xc[tl(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),Uc(this)}disconnectedCallback(){super.disconnectedCallback(),Wc(this)}};E([w({type:Number})],$.prototype,`groesse`,void 0),E([w()],$.prototype,`gewicht`,void 0),E([w()],$.prototype,`ausrichtung`,void 0),E([w()],$.prototype,`farbe`,void 0),E([w()],$.prototype,`text`,void 0),E([w()],$.prototype,`source`,void 0),E([w()],$.prototype,`textField`,void 0),D.defineAndRegister($);var nl=[`waagerecht`,`senkrecht`],rl=`waagerecht`;function il(e){return nl.includes(e)?e:rl}var al=class extends D{constructor(...e){super(...e),this.richtung=rl}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:rl}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[D.styles,o`
    ...
    `]}render(){return v`<div class="flaeche ${il(this.richtung)}"><div class="linie"></div></div>`}};E([w()],al.prototype,`richtung`,void 0),D.defineAndRegister(al),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;L(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();