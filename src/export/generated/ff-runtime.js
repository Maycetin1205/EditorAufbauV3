...
`;function za(e,t){let n=(e?.fuellFeld??``).trim(),r=n===``?(e?.feld??``).trim():n;if(r===``)return{art:`frei`,quelleId:``,code:``};let{quelleId:i,code:a}=mi(r);return i===``?{art:`eigen`,quelleId:t,code:a}:{art:`verknuepft`,quelleId:i,code:a}}function K(e,t){return za(e.spalten[t],e.quelleId)}function Ba(e){let t=[];for(let n of e.spalten){let r=za(n,e.quelleId);r.art!==`verknuepft`||r.quelleId===``||t.includes(r.quelleId)||t.push(r.quelleId)}return t}function Va(e,t){let n=K(e,t);if(!(n.quelleId===``||n.code===``))for(let r=0;r<e.spalten.length;r++){if(r===t)continue;let i=e.spalten[r],a=za(i,e.quelleId);if(a.quelleId===n.quelleId&&!(a.code===``||a.code===n.code))return{titel:i.titel,code:a.code}}}function Ha(e,t){let n=K(e,t);if(n.art!==`verknuepft`||n.quelleId===``||n.code===``)return[];let r=[];for(let t of e.spalten){let i=za(t,e.quelleId);i.quelleId!==n.quelleId||i.code===``||r.some(e=>e.feld===i.code)||r.push({kennung:``,titel:t.titel,feld:i.code})}return r}function Ua(e,t,n){let r=e.map(e=>({toField:e.toField,soll:t(e.fromField)})).filter(e=>e.soll!==void 0);return r.length===0?[...n]:n.filter(e=>r.every(t=>t.soll!==``&&t.soll===M(e,t.toField)))}function Wa(e,t,n){return y`<input
    class="erf-eingabe"
    type="text"
    ...
    @blur=${()=>t.verlassen(n)}
  />`}function Ga(e,t,n,r){if(r)return y`<div class="erf-halter">
      ${Wa(e,t,n)}
...
`;function fo(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen])}}function po(e,t,n){return t===``||n===``?[...e]:e.filter(e=>Yr(M(e,t))===n)}function mo(e){let t=e.getAttribute(`source`)??``;if(t===``)return null;let n=j(z().FF_DATA_SOURCES,t);return n?{quelle:n,zeilen:po(Et(z().SEDATA,n.name,n.tableId,n.offenerSatz),e.getAttribute(`tagfield`)??``,ei()),lies:Hi(e)}:null}function ho(e){return _a(e.getAttribute(`spalten`)??``)}function go(e,t){let n=j(z().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?xt(n,t):``}function _o(e){let t=j(z().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return t!==void 0&&t.indexField!==``}function vo(e,t){t&&e.vergissGeschriebene();let n=mo(e);if(!n){e.datenzeilen=[];return}let r=ho(e),{rows:i,gefiltert:a}=Xt(e,n.zeilen),o=Ut(F(e),i,e=>e)[0]??-1,s=n.lies;e.datenGeliefert=!0,e.rohzeilen=i,e.auswahlIndex=o,e.durchAuswahlGefiltert=a,e.datenzeilen=i.map(e=>r.map(t=>t.feld===``?``:s(e,t.feld)))}var yo=Li({hydriere:vo}),bo=yo.connect,xo=yo.disconnect;function So(e,t){let n=[];return e.forEach((e,r)=>{ai(e,t)&&n.push(r)}),n}function Co(e,t){return!e&&t.trim()!==``}function wo(e,t,n){return e&&t&&n===0}function To(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function Eo(e){return da([...e,la(e.length)])}function Do(e,t,n){let r=t();r.length<=1||e<0||e>=r.length||(r.splice(e,1),n(r))}function Oo(e,t,n){return y`<div class="steuerung">
    <button
      title="Letzte Spalte entfernen"
      @click=${r=>{n(r),Do(e().length-1,e,t)}}
    >−</button>
    <button
      title="Spalte hinzufügen"
      @click=${r=>{n(r);let i=e();i.length<16&&t(Eo(i))}}
    >+</button>
  </div>`}function ko(e,t,n,r){let i=n();if(e<0||e>=i.length)return;let a=Math.max(0,Math.min(t,i.length-1));if(a===e)return;let[o]=i.splice(e,1);i.splice(a,0,o),r(i)}var Ao=5;function jo(e,t,n){if(e.button!==0||!n.editable()||e.target instanceof HTMLElement&&e.target.isContentEditable)return;let r=e.currentTarget?.parentElement;if(!r)return;let i=[...r.children].filter(e=>e instanceof HTMLElement&&e.tagName===`DIV`);if(i.length<2)return;e.stopPropagation();let a=e.clientX,o=!1,s=t,c=e=>{for(let t=0;t<i.length;t++){let n=i[t].getBoundingClientRect();if(e<n.left+n.width/2)return t}return i.length},l=e=>{i.forEach((n,r)=>{n.classList.toggle(`zug-quelle`,o&&r===t),n.classList.toggle(`zug-slot`,o&&r===e),n.classList.toggle(`zug-slot-ende`,o&&e===i.length&&r===i.length-1)})},u=e=>{e.stopPropagation(),e.preventDefault()},d=()=>{window.removeEventListener(`pointermove`,f),window.removeEventListener(`pointerup`,p),window.removeEventListener(`pointercancel`,m),window.removeEventListener(`blur`,m);let e=o;o=!1,l(-1),e&&(document.body.style.cursor=``)};function f(e){if(!o){if(Math.abs(e.clientX-a)<Ao)return;o=!0,n.vorZug(),document.body.style.cursor=`grabbing`,window.addEventListener(`click`,u,{capture:!0,once:!0})}e.preventDefault(),s=c(e.clientX),l(s)}function p(){let e=o,r=s;d(),e&&ko(t,r>t?r-1:r,n.liste,n.aendere)}function m(){o&&window.removeEventListener(`click`,u,!0),d()}window.addEventListener(`pointermove`,f),window.addEventListener(`pointerup`,p),window.addEventListener(`pointercancel`,m),window.addEventListener(`blur`,m)}function Mo(e,t){let n=e.currentTarget;n&&(e.stopPropagation(),e.preventDefault(),at(n,(e,n)=>e===``||e===n.trim()?!1:(t(e),!0)))}function No(e,t,n,r){Mo(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var Po=220,Fo=new WeakMap;function Io(e){let t=Fo.get(e);t!==void 0&&(clearTimeout(t),Fo.delete(e))}function Lo(e,t,n){return y`<button
    class="kopf-weg"
    type="button"
  ...
  >&#x2715;</button>`}function Ro(e){return{dblklickKopf:(t,n)=>{e.editable()&&(Io(e.baustein),No(t,n,e.liste,e.aendere))},klickKopf:(t,n)=>{e.editable()&&zo(e.baustein,t,{prop:e.prop,index:n,liste:e.liste}),e.sortiere(n)}}}function zo(e,t,n){t.stopPropagation();let r=t.currentTarget.getBoundingClientRect();Io(e),Fo.set(e,setTimeout(()=>{Fo.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n.prop,index:n.index,top:r.bottom+4,left:r.left,...n.liste?{liste:n.liste()}:{}},bubbles:!0,composed:!0}))},Po))}var Bo=`\0`;function Vo(e,t){return e+Bo+String(t)}var Ho=class{constructor(){this.werte=new Map}setze(e,t,n){if(e===``)return!1;let r=Vo(e,t);return this.werte.get(r)===n?!1:(this.werte.set(r,n),!0)}nimmZurueck(e,t){return this.werte.delete(Vo(e,t))}wert(e,t){return e===``?void 0:this.werte.get(Vo(e,t))}get anzahl(){return this.werte.size}proSatz(){let e=[];for(let[t,n]of this.werte){let[r,i]=t.split(Bo),a=Number(i),o=e.find(e=>e.satz===r),s={satz:r,spalte:a,wert:n};o?o.aenderungen.push(s):e.push({satz:r,aenderungen:[s]})}return e}nimmSatzZurueck(e){let t=!1;for(let n of[...this.werte.keys()])n.slice(0,n.indexOf(Bo))===e&&this.werte.delete(n)&&(t=!0);return t}},Uo=class{constructor(e){this.aenderungen=new Ho,this.geloescht=new Set,this.wirt=e}get geaenderteZeilen(){if(this.aenderungen.anzahl===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let{satz:r}of this.aenderungen.proSatz()){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}get geloeschteZeilen(){if(this.geloescht.size===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let r of this.geloescht){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}austragen(e,t){let n=!1;for(let r of t)n=e===`geaendert`?this.aenderungen.nimmSatzZurueck(r)||n:this.geloescht.delete(r)||n;n&&this.wirt.melde()}vorgemerkteAenderungen(){return this.geaenderteZeilen.length}vorgemerkteLoeschungen(){return this.geloeschteZeilen.length}statusVon(e){let t=this.satzVon(e);if(t===``)return{status:`gebucht`,titel:``};if(this.geloescht.has(t))return this.wirt.lauf.zeigt(`geloescht`,t,`loeschung`);let n=this.wirt.spalten().some((e,n)=>this.aenderungen.wert(t,n)!==void 0);return this.wirt.lauf.zeigt(`geaendert`,t,n?`geaendert`:`gebucht`)}satzPlaetze(){let e=new Map;return this.wirt.rohzeilen().forEach((t,n)=>{let r=go(this.wirt.baustein,t);r!==``&&!e.has(r)&&e.set(r,n)}),e}satzVon(e){let t=this.wirt.rohzeilen()[e];return t===void 0?``:go(this.wirt.baustein,t)}schalteLoeschung(e){let t=this.satzVon(e);t!==``&&(this.geloescht.has(t)?this.geloescht.delete(t):(this.geloescht.add(t),this.wirt.spalten().forEach((e,n)=>{this.aenderungen.nimmZurueck(t,n)})),this.wirt.melde())}istGeloescht(e){let t=this.satzVon(e);return t!==``&&this.geloescht.has(t)}zellWert(e,t){let n=this.aenderungen.wert(this.satzVon(e),t);return n===void 0?this.wirt.datenzeilen()[e]?.[t]??``:n}istGeaendert(e,t){return this.aenderungen.wert(this.satzVon(e),t)!==void 0}tippeZelle(e,t,n){this.aenderungen.setze(this.satzVon(e),t,n)&&this.wirt.melde()}verlasseZelle(e,t,n){let r=this.satzVon(e);(n===(this.wirt.datenzeilen()[e]?.[t]??``)?this.aenderungen.nimmZurueck(r,t):this.aenderungen.setze(r,t,n))&&this.wirt.melde()}zelleNachbar(e,t,n,r){let i=Array.from(this.wirt.baustein.shadowRoot?.querySelectorAll(`.koerper > .zeile:not(.erfassung) .zell-eingabe[data-spalte="${e}"]`)??[]),a=i.indexOf(t);if(a<0)return;let o=a+n;if(o>i.length-1){if(r&&this.wirt.erfassungAn()){this.wirt.fokussiereErfassungsZelle(0);return}o=i.length-1}o<0&&(o=0);let s=i[o];!s||s===t||(s.focus(),s.select(),s.scrollIntoView({block:`nearest`}))}tasteZelle(e,t,n){let r=n.target;if(n.key===`Escape`){n.preventDefault(),n.stopPropagation(),this.aenderungen.nimmZurueck(this.satzVon(e),t)&&this.wirt.melde();return}let i={Enter:1,ArrowDown:1,ArrowUp:-1,PageDown:10,PageUp:-10}[n.key];i!==void 0&&(n.preventDefault(),n.stopPropagation(),this.zelleNachbar(t,r,i,n.key===`Enter`))}},Wo={gebucht:``,erfasst:`Neue Zeile — noch nicht geschrieben`,geaendert:`Geändert — noch nicht geschrieben`,loeschung:`Zum Löschen vorgemerkt — noch nicht geschrieben`,schreibt:`Wird geschrieben …`,geschrieben:`Hinausgeschickt — bleibt stehen, bis neue Daten kommen`,fehler:`Nicht geschrieben`},Go=class{constructor(e){this.schreibend=new Map,this.fehler=new Map,this.melde=e}schreibt(e,t){this.fehler.get(e)?.delete(t);let n=this.schreibend.get(e)??new Set;n.add(t),this.schreibend.set(e,n),this.melde()}gescheitert(e,t,n){this.schreibend.get(e)?.delete(t);let r=this.fehler.get(e)??new Map;r.set(t,n),this.fehler.set(e,r),this.melde()}fertig(e,t){this.schreibend.get(e)?.clear();let n=this.fehler.get(e);if(n)for(let e of t)n.delete(e);this.melde()}zeigt(e,t,n){let r=this.fehler.get(e)?.get(t);return r===void 0?this.schreibend.get(e)?.has(t)===!0?{status:`schreibt`,titel:Wo.schreibt}:{status:n,titel:Wo[n]}:{status:`fehler`,titel:Wo.fehler+`: `+r}}},Ko=4;function qo(e){return e??Ko}function Jo(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function Yo(e,t,n){let r=Jo(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function Xo(e,t){return e===null?null:Math.max(0,e-t)}function Zo({sichtbar:e,hatQuelle:t,platzhalterZeilen:n}){return t?{seiten:1,seite:0,zeilen:[...e]}:{seiten:1,seite:0,zeilen:Array.from({length:n},()=>null)}}function Qo({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function $o(e){if(!e.hasAttribute(`fuellt`))return-1;let t=e.renderRoot.querySelector(`.koerper`);return t instanceof HTMLElement?t.clientHeight:-1}function es(e){let t=e.renderRoot.querySelector(`.kopf`);return t instanceof HTMLElement?t.offsetHeight:0}function ts(e,t){let n=$o(e);if(n===-1)return{mass:null,hoehe:n,kopf:0};let r=es(e);return{mass:Yo(n,r,t),hoehe:n,kopf:r}}function ns(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}var rs=`ff-zeile-aktiviert`,is=`data-ff-roh`;function as(e,t){e.dispatchEvent(new CustomEvent(rs,{detail:t,bubbles:!0,composed:!0}))}function os(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(is);return r===null||r===``?null:Number(r)}function ss(e,t){if(!(e instanceof HTMLElement))return!1;let n=e.closest(`.zeile`),r=n?.parentElement;if(!n||!r)return!1;let i=[...r.querySelectorAll(`.zeile[${is}]`)],a=i.indexOf(n),o=a===-1?void 0:i[a+t];return o?(o.focus(),!0):!1}function cs(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.zeile[${is}]`);return t?(t.focus(),!0):!1}function ls(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.suchzeile input`);return t?(t.focus(),!0):!1}function us(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var ds=class{constructor(e){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._rumpfGemessen=-1,this._kopfGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this.wirt=e}get suchtext(){return this._suchtext}get suchtAktiv(){return this._suchtext.trim()!==``}get sortSpalte(){return this._sortSpalte}get sortAuf(){return this._sortAuf}get seite(){return this._seite}get mass(){return this._mass}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.wirt.melde()}klickSortiere(e){this.wirt.editable()||(this.merkeZeilenFokus(),this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.wirt.melde())}blaettere(e){this.merkeZeilenFokus(),this._seite=e,this.wirt.melde()}fokussiereSuche(){let e=this.wirt.baustein.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}merkeZeilenFokus(){let e=os(this.wirt.baustein.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.wirt.zeilenHoehe();this._taktGemessen=e;let{mass:t,hoehe:n,kopf:r}=ts(this.wirt.baustein,e);this._rumpfGemessen=n,this._kopfGemessen=r,!(t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe)&&(this._mass=t,this.wirt.melde())}beobachte(){this._beobachter||(this._beobachter=ns(this.wirt.baustein,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}nachRendern(){(this._taktGemessen!==this.wirt.zeilenHoehe()||this._rumpfGemessen!==$o(this.wirt.baustein)||this._kopfGemessen!==es(this.wirt.baustein))&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,us(this.wirt.baustein.shadowRoot,this._fokusZeile))}loese(){this._beobachter?.disconnect(),this._beobachter=null}nachPush(){this._seite=0,this._mass=null,this._taktGemessen=0,this._rumpfGemessen=-1,this._kopfGemessen=0}zuruecksetzen(){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this.nachPush(),this._fokusZeile=null,this._fokusHolen=!1}};function fs(e,t,n,r){if(n===null||e.hasAttribute(`data-ff-editor`))return;let i=t[n];i!==void 0&&(as(e,{rohzeile:i,rohIndex:n,ansichtIndex:r}),ms(e,i),H(e,`onRowClick`,{PINDEX:go(e,i)}).catch(V))}function ps(e,t,n){if(n===null||e.hasAttribute(`data-ff-editor`))return;let r=t[n];r!==void 0&&H(e,`onRowDblClick`,{PINDEX:go(e,r)}).catch(V)}function ms(e,t){let n=F(e);n!==``&&Wt(n,t)}var hs={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,kennungKey:`kennung`,standardTitel:sa,eintragsSchalter:[{key:`summe`,label:`Summe in der Fußzeile`,kurz:`Summe`},{key:`aenderbar`,label:`In der Zeile änderbar`,kurz:`änderbar`,standard:!0,nurEigeneQuelle:!0}],herkunftProp:`spaltenHerkunft`,eintragsFeldWahl:[{key:`fuellFeld`,label:`Nachschlagen`,hinweis:`Beim Erfassen füllt der gewählte Satz der Hilfsquelle diese Zelle.`,nurFremdeQuellen:!0}]};function gs(e){let t=e,n=hs.eintragsSchalter?.find(e=>e.key===`aenderbar`);return n!==void 0&&e.feld!==``&&gi(hs,t).includes(n)&&hi(n,t)}function _s(e,t,n){let r=0,i=0;for(let t of e){let e=no(t);e!==null&&(r+=e,i++)}return i===0?``:r.toLocaleString(`de-DE`,{minimumFractionDigits:t,maximumFractionDigits:n})}var vs={min:0,max:3};function ys(e,t){let n=[];return e.spalten.forEach((r,i)=>{if(r.summe!==!0)return;let a=_s(t.map(t=>e.wertVon(t,i)),vs.min,vs.max);a!==``&&n.push({titel:r.titel,text:a})}),n}function bs(e){return e.datenzeilen.map((t,n)=>e.spalten.map((t,r)=>e.wertVon(n,r)))}function xs(e){let t=bs(e),n=So(t,e.suchtext);return e.sortSpalte<0?n:so(n.map(e=>t[e]),e.sortSpalte,e.sortAuf).map(e=>n[e])}function Ss(e){let t={gridTemplateColumns:va(e.spalten,e.breiteVon)},n=e.gemessen?.zeilenHoehe??28,r=e.hatQuelle,i=!e.erfassungAn&&wo(r,e.datenGeliefert,e.datenzeilen.length),a=xs(e),o=e.erfassungAn?1+e.erfassteAnzahl:0,s=e.gemessen===null?null:Math.max(1,e.gemessen.passen-o),c={sichtbar:a,hatQuelle:r,proSeite:s??Math.max(1,10-o),wunschSeite:e.wunschSeite,platzhalterZeilen:qo(s)},{seiten:l,seite:u,zeilen:d}=e.blaettert?Qo(c):Zo(c);return{cols:t,takt:28,zeilenHoehe:n,hatQuelle:r,leer:i,gesamt:a.length,seiten:l,seite:u,zeilen:d,linealTakte:Xo(s,d.length),summen:ys(e,a)}}var Cs=[W(`suche`,`Suchzeile`,`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,{requiresDataSource:!0}),W(`erfassung`,`Erfassungszeile`,`Eine leere Zeile zum Tippen neuer Positionen.`),W(`loeschbar`,`Zeilen löschbar`,`Kreuz an jeder Zeile: merkt sie zum Löschen vor.`,{requiresDataSource:!0}),W(`blaettern`,`Blättern`,`Ja: Seiten mit Blätter-Knöpfen. Nein: alles untereinander, der Rumpf rollt.`),W(`kopfzeile`,`Kopfzeile`,`Aus: keine Titelzeile, kein Sortieren per Titelklick.`),{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Sätze des gewählten Tages.`,kind:`field`},Ia()];function ws(e,t){let n=e.erfasst+e.geaendert+e.geloescht,r=e.seiten>1||e.summen.length>0||n>0||e.suchtAktiv||e.auswahlAktiv;return e.leer||!r?x:y`<div class="fusszeile">
    <div class="seiten-info">${To({hatQuelle:e.hatQuelle,sichtbar:e.sichtbar,gesamt:e.gesamt,suchtAktiv:e.suchtAktiv,auswahlAktiv:e.auswahlAktiv})}</div>
  ...
  </div>`}var Ts=/[.*+?^${}()|[\]\\]/g;function Es(e,t){let n=ii(t);if(n.length===0||e===``)return e;let r;try{r=RegExp(`(${n.map(e=>e.replace(Ts,`\\$&`)).join(`|`)})`,`ig`)}catch{return e}let i=e.split(r);return i.length<=1?e:y`${i.map((e,t)=>t%2==1?y`<mark>${e}</mark>`:e)}`}function Ds(e,t,n){let r=40-e,i=t-40,a=r>i?0:Math.min(i,Math.max(r,Math.round(n)));return{links:Math.round(e+a),rechts:Math.round(t-a)}}function Os(e,t,n){if(e.button!==0)return;let r=[...e.currentTarget?.parentElement?.children??[]].filter(e=>e instanceof HTMLElement&&e.tagName===`DIV`),i=r[t],a=r[t+1];if(!i||!a)return;e.stopPropagation(),e.preventDefault();let o=e.clientX,s=i.getBoundingClientRect().width,c=a.getBoundingClientRect().width,l=Ds(s,c,0),u=()=>{window.removeEventListener(`pointermove`,p),window.removeEventListener(`pointerup`,m),window.removeEventListener(`pointercancel`,h),window.removeEventListener(`keydown`,ee),window.removeEventListener(`blur`,h)},d=r.map(e=>Math.max(1,Math.round(e.getBoundingClientRect().width))),f=()=>d.map((e,n)=>n===t?{index:n,breite:l.links}:n===t+1?{index:n,breite:l.rechts}:{index:n,breite:e});function p(e){l=Ds(s,c,e.clientX-o),n.zeige(f())}function m(){u(),n.uebernimm(f())}function h(){u(),n.verwirf()}function ee(e){e.key===`Escape`&&(e.preventDefault(),h())}window.addEventListener(`pointermove`,p),window.addEventListener(`pointerup`,m),window.addEventListener(`pointercancel`,h),window.addEventListener(`keydown`,ee),window.addEventListener(`blur`,h)}function ks(e,t){return Array.from({length:Math.max(0,e-1)},(e,n)=>y`<span
    class="breite-griff"
    role="presentation"
    style="grid-row: 1; grid-column: ${n+1}"
    title="Linie ziehen: links breiter, rechts schmaler"
    @pointerdown=${e=>Os(e,n,t)}
    @click=${e=>e.stopPropagation()}
    @dblclick=${e=>e.stopPropagation()}
  ></span>`)}function As(e){return e.linealTakte===0?x:y`<div class="lineal" role="presentation" style=${G(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>y`<div></div>`)}
        </div>`}function js(e,t){return y`
      ${e.zeigeSuche?y`<div class="suchzeile">
        <input
          ...
          @keydown=${e=>{e.key===`ArrowDown`&&cs(e.target)&&e.preventDefault()}}
        />
      </div>`:``}
      ...
      ${e.zeigeKopf?y`<div class="kopf" role="row" style=${G(e.cols)}>
        ${e.spalten.map((n,r)=>y`<div
          ...
          >${e.imEditor&&(e.herkunft[r]??``)!==``?y`<span class="kopf-titel">${n.titel}</span><span
                ...
                >${e.herkunft[r]}</span>`:n.titel}${!e.editable&&e.sortSpalte===r?y`<span class="sort-pfeil">${e.sortAuf?` ▲`:` ▼`}</span>`:``}${e.imEditor&&e.editable&&e.spalten.length>1?Lo(n.titel,r,t.loescheSpalte):x}</div>`)}
        ${ks(e.spalten.length,t.breiten)}
      </div>`:x}
        ${``}
        ${e.leer?La(e.leerText,!0):y`
        ...
        ${e.zeilen.map((n,r)=>{let i=n!==null&&!e.imEditor,a=n!==null&&e.zeilenStand.istGeloescht(n),o=n===null?{status:`gebucht`,titel:``}:e.zeilenStand.statusVon(n);return y`<div
            ...
            @keydown=${e=>{if(!e.target.closest(`.zell-eingabe`)){if(e.key===`ArrowDown`||e.key===`ArrowUp`){let t=e.key===`ArrowUp`;(ss(e.target,t?-1:1)||t&&ls(e.target))&&e.preventDefault();return}e.key===`Enter`&&(e.preventDefault(),t.aktiviereZeile(n,r))}}}
          >
            ${``}
            ${e.spalten.map((r,i)=>{let a=n===null?`—`:e.datenzeilen[n]?.[i]??``,o=e.imEditor&&!e.zeigeKopf&&e.editable;if(e.aendernMoeglich&&n!==null&&gs(r)){let t=e.zeilenStand;return y`<div class="tippbar" role="cell">
                <input
...
`,q=class e extends O{constructor(...e){super(...e),this.spalten=pa(),this.spaltenHerkunft=[],this.source=``,this.suche=`ja`,this.erfassung=`nein`,this.blaettern=`ja`,this.loeschbar=`nein`,this.kopfzeile=`ja`,this.leerText=Fa,this.rechnung=``,this.datenzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._besitz=`softengine`,this._breiten=new Map,this._breiteVorZug=null,this._ansicht=new ds({baustein:this,editable:()=>this.editable,zeilenHoehe:()=>this.zeilenHoehe,melde:()=>this.requestUpdate()}),this._erfassung=new lo,this._lauf=new Go(()=>this.requestUpdate()),this._zeilen=new Uo({baustein:this,spalten:()=>this.spaltenListe(),rohzeilen:()=>this.rohzeilen,datenzeilen:()=>this.datenzeilen,melde:()=>this.requestUpdate(),lauf:this._lauf,erfassungAn:()=>this.erfassungAn,fokussiereErfassungsZelle:e=>this.fokussiereErfassungsZelle(e)}),this.nimmSeFokus=e=>{e.defaultPrevented||!this.erfassungAn||this.hasAttribute(`data-ff-editor`)||(e.preventDefault(),this.fokussiereErfassungsZelle(0))}}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.kannErfassen={wenn:{attributeName:`erfassung`,equals:`ja`}}}static{this.aenderungsSchluessel=`aenderbar`}static{this.kannLoeschen={wenn:{attributeName:`loeschbar`,equals:`ja`}}}static{this.blockEvents=[{key:`onRowClick`,name:`Zeile gewählt`},{key:`onRowDblClick`,name:`Zeile doppelt geklickt`}]}static{this.listenBindung=hs}static{this.defaultProps={width:`fill`,source:``,spalten:pa(),suche:`ja`,erfassung:`nein`,blaettern:`ja`,loeschbar:`nein`,kopfzeile:`ja`,tagField:``,rechnung:``,leerText:Fa}}static{this.customProperties=Cs}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?xo(this):bo(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=fo(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.nachPush(),this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.zuruecksetzen(),this._erfassung.zuruecksetzen()}get erfassteZeilen(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.werte)}get erfassteSchluessel(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.kennung)}get geaenderteZeilen(){return this._zeilen.geaenderteZeilen}get geloeschteZeilen(){return this._zeilen.geloeschteZeilen}zeileSchreibt(e,t){this._lauf.schreibt(e,t)}zeileGescheitert(e,t,n){this._lauf.gescheitert(e,t,n)}laufFertig(e,t){if(this._lauf.fertig(e,t),e===`erfasst`){this._erfassung.markiereGeschrieben(this.erfassungsUmfeld(),t)&&this.requestUpdate();return}this._zeilen.austragen(e,t)}vergissGeschriebene(){this._erfassung.vergissGeschriebene()&&this.requestUpdate()}erfasstStand(e){return this._lauf.zeigt(`erfasst`,this._erfassung.schluessel[e]??``,this._erfassung.istGeschrieben(e)?`geschrieben`:`erfasst`)}erfasseZeile(){return this._erfassung.erfasse(this.erfassungsUmfeld())?(this.requestUpdate(),this.fokussiereErfassungsZelle(0),this.zeigeLetzteErfasste(),!0):!1}zeigeLetzteErfasste(){this.updateComplete.then(()=>{let e=this.shadowRoot?.querySelector(`.koerper`);e&&(e.scrollTop=e.scrollHeight)})}fokussiereSuche(){return this._ansicht.fokussiereSuche()}setzeSuchtext(e){this._ansicht.setzeSuchtext(e),this.requestUpdate()}get hatQuelle(){return this._besitz===`provided`||Co(this.hasAttribute(`data-ff-editor`),this.source)}spaltenListe(){return ga(this.spalten)}get zeilenHoehe(){return 28}breitenWirt(){let e=e=>{this._breiteVorZug===null&&(this._breiteVorZug=new Map(e.map(e=>[e.index,this._breiten.get(e.index)])))};return{zeige:t=>{e(t);for(let e of t)this._breiten.set(e.index,e.breite);this.requestUpdate()},uebernimm:e=>{this._breiteVorZug=null;let t=this.spaltenListe();if(!this.hasAttribute(`data-ff-editor`)){for(let t of e)this._breiten.set(t.index,t.breite);this.requestUpdate();return}for(let n of e)n.index>=t.length||(this._breiten.delete(n.index),t[n.index]={...t[n.index],breite:n.breite});this.aendere(t)},verwirf:()=>{let e=this._breiteVorZug;if(this._breiteVorZug=null,e){for(let[t,n]of e)n===void 0?this._breiten.delete(t):this._breiten.set(t,n);this.requestUpdate()}}}}get erfassungAn(){return this.erfassung===`ja`}erfassungsWirt(){return{baustein:this,lauf:this._erfassung.lauf,umfeld:()=>this.erfassungsUmfeld(),melde:()=>this.requestUpdate(),fokussiere:e=>this.fokussiereErfassungsZelle(e),erfasseZeile:()=>this.erfasseZeile()}}fokussiereErfassungsZelle(e){this.updateComplete.then(()=>{let t=this.shadowRoot?.querySelectorAll(`.zeile.erfassung .erf-eingabe`)?.[e];t&&(t.focus(),t.scrollIntoView({block:`nearest`}))})}erfassungsUmfeld(){return this._erfassung.umfeld(this,this.spaltenListe(),this.source,Pa(this.rechnung))}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&bo(this),document.addEventListener(zn,this.nimmSeFokus),this._ansicht.beobachte()}firstUpdated(){this._ansicht.beobachte()}willUpdate(e){super.willUpdate(e),e.has(`spalten`)&&this._breiten.clear(),!(!this.erfassungAn||this.hasAttribute(`data-ff-editor`))&&this._erfassung.lauf.aktualisiereVorschlaege(this.erfassungsUmfeld())}updated(){this._ansicht.nachRendern(),Pr(this)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(zn,this.nimmSeFokus),Io(this),this._ansicht.loese(),Zs(this),xo(this)}static{this.styles=[O.styles,Ra,Ms,di,uo]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=Ss({spalten:t,breiteVon:e=>this._breiten.get(e),hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._ansicht.suchtext,sortSpalte:this._ansicht.sortSpalte,sortAuf:this._ansicht.sortAuf,wunschSeite:this._ansicht.seite,gemessen:this._ansicht.mass,erfassungAn:this.erfassungAn,erfassteAnzahl:this._erfassung.zeilen.length,wertVon:(e,t)=>this._zeilen.zellWert(e,t),blaettert:this.blaettern===`ja`});return y`<div class="tabelle" style=${G({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
    ...
    >${oa()}</button>
    ${e.liste}
  </div>`}var Fs={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:sa,quelleProp:`nachschlagQuelle`};function Is(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?ga(e):[]}function Ls(e,t){let n=e[0];return n===void 0?t:n.feld}function Rs(e,t){let n=e.trim();return n===``||n===t.trim()}function zs(e,t,n){let r=t.trim(),i=[],a=Rs(t,n),o=new Set;for(let t of e){let e=M(t,n).trim(),s=r===``?e:M(t,r).trim();if(!(s===``&&e===``)){if(a){if(o.has(e))continue;o.add(e)}i.push({anzeige:s,wert:e,satz:t})}}return i}function Bs(e,t,n,r){return zs(Xt(e,t).rows,n,r)}function Vs(e){let t=j(z().FF_DATA_SOURCES,e);return t?Et(z().SEDATA,t.name,t.tableId,t.offenerSatz):null}function Hs(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=Vs(e.quelleId);if(t===null)return{ok:!1,grund:`quelleFehlt`};let n=Ls(Is([...e.spalten]),e.speicherFeld);return{ok:!0,eintraege:Bs(e.el,t,n,e.speicherFeld)}}function Us(e,t){return t&&e.length===1?e[0]:null}function Ws(e,t){let{rows:n,gefiltert:r}=Xt(e,[t]);return!r||n.length>0}function Gs(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var Ks=null,qs=null,Js=null;function Ys(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function Xs(e=!0){let t=e?Js:null;Js=null,Ks?.remove(),Ks=null,qs=null,t?.focus()}function Zs(e){qs===e&&Xs(!1)}function Qs(e){return[{kennung:``,titel:e.speicherTitel===``?`Wert`:e.speicherTitel,feld:e.speicherFeld}]}function $s(e){let t=e=>e.stopPropagation(),n=e.editor;return y`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >${e.inhalt}</ff-dialog-rahmen>`}function ec(e,t){let n=Is([...e.spalten]),r=Rs(Ls(n,e.speicherFeld),e.speicherFeld);return y`<ff-tabelle
    fuellt
    suche="ja"
    style="--se-r-lg:0px"
    .besitz=${`provided`}
    .spalten=${n.length>0?n:Qs(e)}
  ...
  ></ff-tabelle>`}function tc(e){let t=e.eintraege;if(t===void 0){let n=Hs(e);if(!n.ok){R(n.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}t=n.eintraege}Xs(!1);let n=document.createElement(`div`);n.style.display=`contents`,Be($s({titel:e.titel,breite:e.breite,hoehe:e.hoehe,inhalt:ec(e,t),onSchliessen:()=>Xs()}),n);let r=n.querySelector(Qt),i=n.querySelector(q.tagName);i?.addEventListener(rs,n=>{let r=n.detail,i=t[r.rohIndex];i&&(Xs(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),Js=e.rueckFokus??Ys(e.el),document.body.appendChild(n),Ks=n,qs=e.el;let a=e.suchtext??``;i&&a!==``&&i.setzeSuchtext(a),r&&i&&Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}function nc(e){return $s({titel:e.titel,breite:e.breite,hoehe:e.hoehe,onSchliessen:e.onSchliessen,editor:{onGroesse:e.onGroesse},inhalt:y`<ff-tabelle
      data-ff-editor
      fuellt
      suche="ja"
      style="--se-r-lg:0px"
...
`,oc=`frei · hierher ziehen`,sc=`ff-zimmer-inhalt`,Y=class extends O{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[U.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[O.styles,Ra,ac,ic,o`
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(sc,{bubbles:!0,composed:!0}))}render(){return y`<div class="zimmer ${rc}">
      <div
        class="kopf"
        data-ff-editable
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(sc,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(U.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return y`<div class="col ${rc} v-${Lr(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};D([T()],X.prototype,`variant`,void 0),D([T()],X.prototype,`heading`,void 0),D([T({attribute:!1})],X.prototype,`leerHinweis`,void 0),D([E()],X.prototype,`_count`,void 0),O.defineAndRegister(X);function cc(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function lc(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var uc=new WeakMap,dc=X.tagName,fc=Y.tagName,pc=U.tagName;function mc(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===dc)}function hc(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===pc)}function gc(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===fc)}function _c(e){return[e,...gc(e)]}function vc(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=gc(e);for(let e of t)r(e,hc(e).length===0?oc:``);r(e,t.length===0&&hc(e).length===0?n:``)}}function yc(e){return qe().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function bc(e,t){let n=gc(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),a=cc(M(t,r),i);return a>=0?n[a]:n[0]}function xc(e){Q?.board===e&&Dc();let t=e.getAttribute(`statusfield`)??``,n=mo(e);if(!n)return;let r=mc(e);if(r.length===0)return;let i=uc.get(e);if(!i){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(pc);t&&(i=t.cloneNode(!0),uc.set(e,i))}if(!i)return;let a=n.zeilen,o=r.map(e=>e.getAttribute(`heading`)??X.defaultProps.heading),s=yc(i.tagName),c=lc(r.map(e=>e.getAttribute(`auffang`))),l=n.lies;for(let e of r)for(let t of _c(e))hc(t).forEach(e=>e.remove());for(let e of a){let a=i.cloneNode(!0),u=t===``?-1:cc(M(e,t),o),d=u>=0?r[u]:c>=0?r[c]:r[0];(bc(d,e)??d).appendChild(a);for(let t of s){let n=a.getAttribute(_i(t.prop))??``;n!==``&&(a[t.prop]=l(e,n))}let f=xt(n.quelle,e);Z.set(a,{row:e,pindex:f}),a.draggable=!0}vc(e,r);let u=r.flatMap(e=>_c(e).flatMap(hc)),d=Ut(F(e),u,e=>Z.get(e)?.row);for(let e of d)u[e].setAttribute(`data-ff-auswahl`,``)}var Z=new WeakMap,Q=null,Sc=new WeakSet,Cc=`data-ff-zieht`,wc=`data-ff-ziel`,Tc=null;function Ec(e){Tc!==e&&(Tc?.removeAttribute(wc),Tc=e,Tc?.setAttribute(wc,``))}function Dc(){Q?.card.removeAttribute(Cc),Q=null,Ec(null)}function Oc(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function kc(e,t){return Oc(e,t,dc)}function Ac(e,t,n){if(!Q||Q.board!==e)return;let r=Z.get(Q.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;H(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(V)}function jc(e){Sc.has(e)||(Sc.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Z.has(e))??null;if(!n)return;let r=Z.get(n);r&&Wt(F(e),r.row),H(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(V)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Z.has(e))??null;n&&(Q={card:n,board:e},t.dataTransfer?.setData(`text/plain`,Z.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{Q?.card===n&&n.setAttribute(Cc,``)},0))}),e.addEventListener(`dragend`,Dc),e.addEventListener(`dragover`,t=>{let n=kc(e,t);if(Q?.board!==e||!n){Ec(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),Ec(Oc(e,t,fc)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&Ec(null)}),e.addEventListener(`drop`,t=>{let n=kc(e,t);n&&(t.preventDefault(),Ac(e,n,Oc(e,t,fc)),Dc())}))}var Mc=Li({hydriere:xc,verdrahte:jc}),Nc=Mc.connect,Pc=Mc.disconnect,Fc=X.blockType,Ic=class extends O{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Fc]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:Fc}}static{this.templateChild={type:U.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:Fa}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Feld, das die Spalte bestimmt. Leer: alle in die Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Einträge des gewählten Tages.`,kind:`field`},Ia()]}static{this.defaultChildren=[{type:Fc,props:{heading:`Offen`,variant:`warning`},children:[{type:U.blockType}]},{type:Fc,props:{heading:`In Arbeit`,variant:`info`}},{type:Fc,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[O.styles,o`
    ...
    `]}render(){return y`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),Nc(this)}disconnectedCallback(){super.disconnectedCallback(),Pc(this)}};O.defineAndRegister(Ic);var Lc={breite:56,breiteOffen:224},Rc=`ff-seiten-wechsel`,zc=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],Bc=class extends O{static{this.blockType=`navi-eintrag`}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:zc.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[O.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(Rc,{detail:e,bubbles:!0,composed:!0}))}render(){return y`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};D([T()],Bc.prototype,`seite`,void 0),D([T()],Bc.prototype,`seitename`,void 0),D([T({reflect:!0})],Bc.prototype,`ton`,void 0),O.defineAndRegister(Bc);var Vc=`aktiv`;function Hc(e){return Array.from(e.querySelectorAll(Bc.tagName))}function Uc(e,t){let n=Hc(e),r=t??n.find(e=>e.hasAttribute(Vc))??n[0];for(let e of n)e===r?e.setAttribute(Vc,``):e.removeAttribute(Vc)}function Wc(e){let t=e.hasAttribute(`offen`);for(let n of Hc(e))n.toggleAttribute(`breit`,t)}function Gc(e){return e.getAttribute(`name`)??String(st.defaultProps.name)}function Kc(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function qc(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(st.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=Kc(e,i);if(!a)return;let o=r.find(e=>Gc(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var Jc=new WeakMap,Yc=new WeakSet;function Xc(e){let t=t=>{let n=t.detail;n&&(Uc(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),Wc(e),!e.hasAttribute(`data-ff-editor`)&&qc(e,n.ansicht))};e.addEventListener(Rc,t),Jc.set(e,t)}function Zc(e){let t=Jc.get(e);t&&(e.removeEventListener(Rc,t),Jc.delete(e))}function Qc(e){if(Uc(e),Wc(e),e.hasAttribute(`data-ff-editor`)||Yc.has(e))return;let t=Hc(e)[0];if(!t)return;Yc.add(e);let n=()=>qc(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var $c=Bc.blockType,el=class extends O{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[$c]}static{this.addChildButton={label:`Eintrag`,childType:$c}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[ot]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[O.styles,o`
      :host {
        height: 100%;
        width: ${Lc.breite}px;
    ...
    `]}connectedCallback(){super.connectedCallback(),Xc(this)}disconnectedCallback(){super.disconnectedCallback(),Zc(this)}klappen(){this.toggleAttribute(`offen`),Wc(this)}render(){return y`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
        ...
        <div class="eintraege">
          <slot @slotchange=${()=>Qc(this)}></slot>
        </div>
      </div>`}};O.defineAndRegister(el);var tl=_i(`text`);function nl(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(tl)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function rl(e){let t=Ui(e,tl);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function il(e){nl(e)&&(e.text=``)}var al=Li({hydriere:rl,verdrahte:il}),ol=al.connect,sl=al.disconnect,cl=6,ll=96,ul=14,dl={duenn:`300`,normal:`400`,fett:`700`},fl={links:`left`,mitte:`center`,rechts:`right`},pl={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},ml=`standard`;function hl(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(ll,Math.max(cl,t)):ul}function gl(e){return typeof e==`string`&&e in dl?e:`normal`}function _l(e){return typeof e==`string`&&e in fl?e:`links`}function vl(e){return typeof e==`string`&&e in pl?e:ml}var $=class extends O{constructor(...e){super(...e),this.groesse=ul,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=ml,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:ul,gewicht:`normal`,ausrichtung:`links`,farbe:ml,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:cl,max:ll,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[O.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return y`<div
      class="text"
      style=${G({fontSize:`${hl(this.groesse)}px`,fontWeight:dl[gl(this.gewicht)],textAlign:fl[_l(this.ausrichtung)],color:pl[vl(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),ol(this)}disconnectedCallback(){super.disconnectedCallback(),sl(this)}};D([T({type:Number})],$.prototype,`groesse`,void 0),D([T()],$.prototype,`gewicht`,void 0),D([T()],$.prototype,`ausrichtung`,void 0),D([T()],$.prototype,`farbe`,void 0),D([T()],$.prototype,`text`,void 0),D([T()],$.prototype,`source`,void 0),D([T()],$.prototype,`textField`,void 0),O.defineAndRegister($);var yl=[`waagerecht`,`senkrecht`],bl=`waagerecht`;function xl(e){return yl.includes(e)?e:bl}var Sl=class extends O{constructor(...e){super(...e),this.richtung=bl}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:bl}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[O.styles,o`
    ...
    `]}render(){return y`<div class="flaeche ${xl(this.richtung)}"><div class="linie"></div></div>`}};D([T()],Sl.prototype,`richtung`,void 0),O.defineAndRegister(Sl),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;R(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();