...
`;function Ta(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen])}}function Ea(e,t,n){return t===``||n===``?[...e]:e.filter(e=>Vr(A(e,t))===n)}function Da(e){let t=e.getAttribute(`source`)??``;if(t===``)return null;let n=k(L().FF_DATA_SOURCES,t);return n?{quelle:n,zeilen:Ea(Dt(L().SEDATA,n.name,n.tableId,n.offenerSatz),e.getAttribute(`tagfield`)??``,Kr()),lies:Oi(e)}:null}function Oa(e){return $i(e.getAttribute(`spalten`)??``)}function ka(e,t){let n=k(L().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?St(n,t):``}function Aa(e){let t=k(L().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return t!==void 0&&t.indexField!==``}function ja(e,t){t&&e.vergissGeschriebene();let n=Da(e);if(!n){e.datenzeilen=[];return}let r=Oa(e),{rows:i,gefiltert:a}=Yt(e,n.zeilen),o=Ht(N(e),i,e=>e)[0]??-1,s=n.lies;e.datenGeliefert=!0,e.rohzeilen=i,e.auswahlIndex=o,e.durchAuswahlGefiltert=a,e.datenzeilen=i.map(e=>r.map(t=>t.feld===``?``:s(e,t.feld)))}var Ma=Ci({hydriere:ja}),Na=Ma.connect,Pa=Ma.disconnect;function Fa(e,t){let n=[];return e.forEach((e,r)=>{Zr(e,t)&&n.push(r)}),n}function Ia(e,t){return!e&&t.trim()!==``}function La(e,t,n){return e&&t&&n===0}function Ra(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function za(e,t,n){let r=t();r.length<=1||e<0||e>=r.length||(r.splice(e,1),n(r))}function Ba(e,t,n){return v`<div class="steuerung">
    <button
      title="Letzte Spalte entfernen"
      @click=${r=>{n(r),za(e().length-1,e,t)}}
    >−</button>
    <button
      title="Spalte hinzufügen"
      @click=${r=>{n(r);let i=e();i.length<16&&(i.push(U(i.length)),t(i))}}
    >+</button>
  </div>`}function Va(e,t){let n=e.currentTarget;n&&(e.stopPropagation(),e.preventDefault(),at(n,(e,n)=>e===``||e===n.trim()?!1:(t(e),!0)))}function Ha(e,t,n,r){Va(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var Ua=220,Wa=new WeakMap;function Ga(e){let t=Wa.get(e);t!==void 0&&(clearTimeout(t),Wa.delete(e))}function Ka(e,t,n){return v`<button
    class="kopf-weg"
    type="button"
  ...
  >&#x2715;</button>`}function qa(e){return{dblklickKopf:(t,n)=>{e.editable()&&(Ga(e.baustein),Ha(t,n,e.liste,e.aendere))},klickKopf:(t,n)=>{e.editable()&&Ja(e.baustein,t,{prop:e.prop,index:n,liste:e.liste}),e.sortiere(n)}}}function Ja(e,t,n){t.stopPropagation();let r=t.currentTarget.getBoundingClientRect();Ga(e),Wa.set(e,setTimeout(()=>{Wa.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n.prop,index:n.index,top:r.bottom+4,left:r.left,...n.liste?{liste:n.liste()}:{}},bubbles:!0,composed:!0}))},Ua))}var Ya=`\0`;function Xa(e,t){return e+Ya+String(t)}var Za=class{constructor(){this.werte=new Map}setze(e,t,n){if(e===``)return!1;let r=Xa(e,t);return this.werte.get(r)===n?!1:(this.werte.set(r,n),!0)}nimmZurueck(e,t){return this.werte.delete(Xa(e,t))}wert(e,t){return e===``?void 0:this.werte.get(Xa(e,t))}get anzahl(){return this.werte.size}proSatz(){let e=[];for(let[t,n]of this.werte){let[r,i]=t.split(Ya),a=Number(i),o=e.find(e=>e.satz===r),s={satz:r,spalte:a,wert:n};o?o.aenderungen.push(s):e.push({satz:r,aenderungen:[s]})}return e}nimmSatzZurueck(e){let t=!1;for(let n of[...this.werte.keys()])n.slice(0,n.indexOf(Ya))===e&&this.werte.delete(n)&&(t=!0);return t}},Qa=class{constructor(e){this.aenderungen=new Za,this.geloescht=new Set,this.wirt=e}get geaenderteZeilen(){if(this.aenderungen.anzahl===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let{satz:r}of this.aenderungen.proSatz()){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}get geloeschteZeilen(){if(this.geloescht.size===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let r of this.geloescht){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}austragen(e,t){let n=!1;for(let r of t)n=e===`geaendert`?this.aenderungen.nimmSatzZurueck(r)||n:this.geloescht.delete(r)||n;n&&this.wirt.melde()}vorgemerkteAenderungen(){return this.geaenderteZeilen.length}vorgemerkteLoeschungen(){return this.geloeschteZeilen.length}statusVon(e){let t=this.satzVon(e);if(t===``)return{status:`gebucht`,titel:``};if(this.geloescht.has(t))return this.wirt.lauf.zeigt(`geloescht`,t,`loeschung`);let n=this.wirt.spalten().some((e,n)=>this.aenderungen.wert(t,n)!==void 0);return this.wirt.lauf.zeigt(`geaendert`,t,n?`geaendert`:`gebucht`)}satzPlaetze(){let e=new Map;return this.wirt.rohzeilen().forEach((t,n)=>{let r=ka(this.wirt.baustein,t);r!==``&&!e.has(r)&&e.set(r,n)}),e}satzVon(e){let t=this.wirt.rohzeilen()[e];return t===void 0?``:ka(this.wirt.baustein,t)}schalteLoeschung(e){let t=this.satzVon(e);t!==``&&(this.geloescht.has(t)?this.geloescht.delete(t):(this.geloescht.add(t),this.wirt.spalten().forEach((e,n)=>{this.aenderungen.nimmZurueck(t,n)})),this.wirt.melde())}istGeloescht(e){let t=this.satzVon(e);return t!==``&&this.geloescht.has(t)}zellWert(e,t){let n=this.aenderungen.wert(this.satzVon(e),t);return n===void 0?this.wirt.datenzeilen()[e]?.[t]??``:n}istGeaendert(e,t){return this.aenderungen.wert(this.satzVon(e),t)!==void 0}tippeZelle(e,t,n){this.aenderungen.setze(this.satzVon(e),t,n)&&this.wirt.melde()}verlasseZelle(e,t,n){let r=this.satzVon(e);(n===(this.wirt.datenzeilen()[e]?.[t]??``)?this.aenderungen.nimmZurueck(r,t):this.aenderungen.setze(r,t,n))&&this.wirt.melde()}zelleNachbar(e,t,n,r){let i=Array.from(this.wirt.baustein.shadowRoot?.querySelectorAll(`.koerper > .zeile:not(.erfassung) .zell-eingabe[data-spalte="${e}"]`)??[]),a=i.indexOf(t);if(a<0)return;let o=a+n;if(o>i.length-1){if(r&&this.wirt.erfassungAn()){this.wirt.fokussiereErfassungsZelle(0);return}o=i.length-1}o<0&&(o=0);let s=i[o];!s||s===t||(s.focus(),s.select(),s.scrollIntoView({block:`nearest`}))}tasteZelle(e,t,n){let r=n.target;if(n.key===`Escape`){n.preventDefault(),n.stopPropagation(),this.aenderungen.nimmZurueck(this.satzVon(e),t)&&this.wirt.melde();return}let i={Enter:1,ArrowDown:1,ArrowUp:-1,PageDown:10,PageUp:-10}[n.key];i!==void 0&&(n.preventDefault(),n.stopPropagation(),this.zelleNachbar(t,r,i,n.key===`Enter`))}},$a={gebucht:``,erfasst:`Neue Zeile — noch nicht geschrieben`,geaendert:`Geändert — noch nicht geschrieben`,loeschung:`Zum Löschen vorgemerkt — noch nicht geschrieben`,schreibt:`Wird geschrieben …`,geschrieben:`Hinausgeschickt — bleibt stehen, bis neue Daten kommen`,fehler:`Nicht geschrieben`},eo=class{constructor(e){this.schreibend=new Map,this.fehler=new Map,this.melde=e}schreibt(e,t){this.fehler.get(e)?.delete(t);let n=this.schreibend.get(e)??new Set;n.add(t),this.schreibend.set(e,n),this.melde()}gescheitert(e,t,n){this.schreibend.get(e)?.delete(t);let r=this.fehler.get(e)??new Map;r.set(t,n),this.fehler.set(e,r),this.melde()}fertig(e,t){this.schreibend.get(e)?.clear();let n=this.fehler.get(e);if(n)for(let e of t)n.delete(e);this.melde()}zeigt(e,t,n){let r=this.fehler.get(e)?.get(t);return r===void 0?this.schreibend.get(e)?.has(t)===!0?{status:`schreibt`,titel:$a.schreibt}:{status:n,titel:$a[n]}:{status:`fehler`,titel:$a.fehler+`: `+r}}},to=4;function no(e){return e??to}function ro(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function io(e,t,n){let r=ro(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function ao(e,t){return e===null?null:Math.max(0,e-t)}function oo({sichtbar:e,hatQuelle:t,platzhalterZeilen:n}){return t?{seiten:1,seite:0,zeilen:[...e]}:{seiten:1,seite:0,zeilen:Array.from({length:n},()=>null)}}function so({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function co(e){if(!e.hasAttribute(`fuellt`))return-1;let t=e.renderRoot.querySelector(`.koerper`);return t instanceof HTMLElement?t.clientHeight:-1}function lo(e,t){let n=co(e);if(n===-1)return{mass:null,hoehe:n};let r=e.renderRoot.querySelector(`.kopf`);return{mass:io(n,r instanceof HTMLElement?r.offsetHeight:0,t),hoehe:n}}function uo(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}var fo=`ff-zeile-aktiviert`,po=`data-ff-roh`;function mo(e,t){e.dispatchEvent(new CustomEvent(fo,{detail:t,bubbles:!0,composed:!0}))}function ho(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(po);return r===null||r===``?null:Number(r)}function go(e,t){if(!(e instanceof HTMLElement))return!1;let n=e.closest(`.zeile`),r=n?.parentElement;if(!n||!r)return!1;let i=[...r.querySelectorAll(`.zeile[${po}]`)],a=i.indexOf(n),o=a===-1?void 0:i[a+t];return o?(o.focus(),!0):!1}function _o(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.zeile[${po}]`);return t?(t.focus(),!0):!1}function vo(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.suchzeile input`);return t?(t.focus(),!0):!1}function yo(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var bo=class{constructor(e){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._rumpfGemessen=-1,this._fokusZeile=null,this._fokusHolen=!1,this.wirt=e}get suchtext(){return this._suchtext}get suchtAktiv(){return this._suchtext.trim()!==``}get sortSpalte(){return this._sortSpalte}get sortAuf(){return this._sortAuf}get seite(){return this._seite}get mass(){return this._mass}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.wirt.melde()}klickSortiere(e){this.wirt.editable()||(this.merkeZeilenFokus(),this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.wirt.melde())}blaettere(e){this.merkeZeilenFokus(),this._seite=e,this.wirt.melde()}fokussiereSuche(){let e=this.wirt.baustein.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}merkeZeilenFokus(){let e=ho(this.wirt.baustein.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.wirt.zeilenHoehe();this._taktGemessen=e;let{mass:t,hoehe:n}=lo(this.wirt.baustein,e);this._rumpfGemessen=n,!(t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe)&&(this._mass=t,this.wirt.melde())}beobachte(){this._beobachter||(this._beobachter=uo(this.wirt.baustein,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}nachRendern(){(this._taktGemessen!==this.wirt.zeilenHoehe()||this._rumpfGemessen!==co(this.wirt.baustein))&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,yo(this.wirt.baustein.shadowRoot,this._fokusZeile))}loese(){this._beobachter?.disconnect(),this._beobachter=null}nachPush(){this._seite=0,this._mass=null,this._taktGemessen=0,this._rumpfGemessen=-1}zuruecksetzen(){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this.nachPush(),this._fokusZeile=null,this._fokusHolen=!1}};function xo(e,t,n,r){if(n===null||e.hasAttribute(`data-ff-editor`))return;let i=t[n];i!==void 0&&(mo(e,{rohzeile:i,rohIndex:n,ansichtIndex:r}),Co(e,i),B(e,`onRowClick`,{PINDEX:ka(e,i)}).catch(z))}function So(e,t,n){if(n===null||e.hasAttribute(`data-ff-editor`))return;let r=t[n];r!==void 0&&B(e,`onRowDblClick`,{PINDEX:ka(e,r)}).catch(z)}function Co(e,t){let n=N(e);n!==``&&Ut(n,t)}var wo={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:qi,eintragsSchalter:[{key:`summe`,label:`Summe in der Fußzeile`,kurz:`Summe`},{key:`aenderbar`,label:`In der Zeile änderbar`,kurz:`änderbar`,standard:!0,nurEigeneQuelle:!0}],herkunftProp:`spaltenHerkunft`,eintragsFeldWahl:[{key:`fuellFeld`,label:`Nachschlagen`,hinweis:`Beim Erfassen füllt der gewählte Satz der Hilfsquelle diese Zelle.`,nurFremdeQuellen:!0}]};function To(e){let t=e,n=wo.eintragsSchalter?.find(e=>e.key===`aenderbar`);return n!==void 0&&e.feld!==``&&ci(wo,t).includes(n)&&si(n,t)}var Eo=1,Do=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,Oo=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,ko=/^(\d{4})-(\d{2})-(\d{2})$/;function Ao(e){let t=e.trim();if(t===``||!Do.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function jo(e){let t=e.trim();if(t===``)return null;let n=ko.exec(t);if(n){let[,e,t,r]=n;return Mo(Number(e),Number(t),Number(r))}let r=Oo.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return Mo(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function Mo(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function No(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,Ao(i)!==null&&n++,jo(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var Po=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function Fo(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=No(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return Eo;if(o===``)return-1;let s=i===`zahl`?(Ao(n)??0)-(Ao(o)??0):i===`datum`?(jo(n)??0)-(jo(o)??0):Po.compare(n,o);return s===0?e-t:s*a})}function Io(e,t,n){let r=0,i=0;for(let t of e){let e=Ao(t);e!==null&&(r+=e,i++)}return i===0?``:r.toLocaleString(`de-DE`,{minimumFractionDigits:t,maximumFractionDigits:n})}var Lo={min:0,max:3};function Ro(e,t){let n=[];return e.spalten.forEach((r,i)=>{if(r.summe!==!0)return;let a=Io(t.map(t=>e.wertVon(t,i)),Lo.min,Lo.max);a!==``&&n.push({titel:r.titel,text:a})}),n}function zo(e){let t=Fa(e.datenzeilen,e.suchtext);return e.sortSpalte<0?t:Fo(t.map(t=>e.datenzeilen[t]),e.sortSpalte,e.sortAuf).map(e=>t[e])}function Bo(e){let t={gridTemplateColumns:ea(e.spalten,e.breiteVon)},n=e.gemessen?.zeilenHoehe??28,r=e.hatQuelle,i=!e.erfassungAn&&La(r,e.datenGeliefert,e.datenzeilen.length),a=zo(e),o=e.erfassungAn?1+e.erfassteAnzahl:0,s=e.gemessen===null?null:Math.max(1,e.gemessen.passen-o),c={sichtbar:a,hatQuelle:r,proSeite:s??Math.max(1,10-o),wunschSeite:e.wunschSeite,platzhalterZeilen:no(s)},{seiten:l,seite:u,zeilen:d}=e.blaettert?so(c):oo(c);return{cols:t,takt:28,zeilenHoehe:n,hatQuelle:r,leer:i,gesamt:a.length,seiten:l,seite:u,zeilen:d,linealTakte:ao(s,d.length),summen:Ro(e,a)}}var Vo=[H(`suche`,`Suchzeile`,`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,{requiresDataSource:!0}),H(`erfassung`,`Erfassungszeile`,`Eine leere Zeile zum Tippen neuer Positionen.`),H(`loeschbar`,`Zeilen löschbar`,`Kreuz an jeder Zeile: merkt sie zum Löschen vor.`,{requiresDataSource:!0}),H(`blaettern`,`Blättern`,`Ja: Seiten mit Blätter-Knöpfen. Nein: alles untereinander, der Rumpf rollt.`),H(`kopfzeile`,`Kopfzeile`,`Aus: keine Titelzeile, kein Sortieren per Titelklick.`),{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Sätze des gewählten Tages.`,kind:`field`},sa()];function Ho(e,t){let n=e.erfasst+e.geaendert+e.geloescht,r=e.seiten>1||e.summen.length>0||n>0||e.suchtAktiv||e.auswahlAktiv;return e.leer||!r?b:v`<div class="fusszeile">
  ...
  </div>`}var Uo=/[.*+?^${}()|[\]\\]/g;function Wo(e,t){let n=Xr(t);if(n.length===0||e===``)return e;let r;try{r=RegExp(`(${n.map(e=>e.replace(Uo,`\\$&`)).join(`|`)})`,`ig`)}catch{return e}let i=e.split(r);return i.length<=1?e:v`${i.map((e,t)=>t%2==1?v`<mark>${e}</mark>`:e)}`}function Go(e,t,n){let r=40-e,i=t-40,a=r>i?0:Math.min(i,Math.max(r,Math.round(n)));return{links:Math.round(e+a),rechts:Math.round(t-a)}}function Ko(e,t,n){if(e.button!==0)return;let r=e.currentTarget?.parentElement,i=r?.nextElementSibling;if(!r||!(i instanceof HTMLElement))return;e.stopPropagation(),e.preventDefault();let a=e.clientX,o=r.getBoundingClientRect().width,s=i.getBoundingClientRect().width,c=Go(o,s,0),l=()=>{window.removeEventListener(`pointermove`,d),window.removeEventListener(`pointerup`,f),window.removeEventListener(`pointercancel`,p),window.removeEventListener(`keydown`,ee),window.removeEventListener(`blur`,p)},u=()=>[{index:t,breite:c.links},{index:t+1,breite:c.rechts}];function d(e){c=Go(o,s,e.clientX-a),n.zeige(u())}function f(){l(),n.uebernimm(u())}function p(){l(),n.verwirf()}function ee(e){e.key===`Escape`&&(e.preventDefault(),p())}window.addEventListener(`pointermove`,d),window.addEventListener(`pointerup`,f),window.addEventListener(`pointercancel`,p),window.addEventListener(`keydown`,ee),window.addEventListener(`blur`,p)}function qo(e,t){return v`<span
    class="breite-griff"
    role="presentation"
    title="Linie ziehen: links breiter, rechts schmaler"
    @pointerdown=${n=>Ko(n,e,t)}
    @click=${e=>e.stopPropagation()}
    @dblclick=${e=>e.stopPropagation()}
  ></span>`}function Jo(e){return e.linealTakte===0?b:v`<div class="lineal" role="presentation" style=${W(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>v`<div></div>`)}
        </div>`}function Yo(e,t){return v`
      ${e.zeigeSuche?v`<div class="suchzeile">
        <input
          ...
          @keydown=${e=>{e.key===`ArrowDown`&&_o(e.target)&&e.preventDefault()}}
        />
      </div>`:``}
      ...
      ${e.zeigeKopf?v`<div class="kopf" role="row" style=${W(e.cols)}>
        ${e.spalten.map((n,r)=>v`<div
          ...
          >${e.imEditor&&(e.herkunft[r]??``)!==``?v`<span class="kopf-titel">${n.titel}</span><span
                ...
                >${e.herkunft[r]}</span>`:n.titel}${!e.editable&&e.sortSpalte===r?v`<span class="sort-pfeil">${e.sortAuf?` ▲`:` ▼`}</span>`:``}${e.imEditor&&e.editable&&e.spalten.length>1?Ka(n.titel,r,t.loescheSpalte):b}${r<e.spalten.length-1?qo(r,t.breiten):b}</div>`)}
      </div>`:b}
        ${``}
        ...
        ${e.zeilen.map((n,r)=>{let i=n!==null&&!e.imEditor,a=n!==null&&e.zeilenStand.istGeloescht(n),o=n===null?{status:`gebucht`,titel:``}:e.zeilenStand.statusVon(n);return v`<div
            ...
            @keydown=${e=>{if(!e.target.closest(`.zell-eingabe`)){if(e.key===`ArrowDown`||e.key===`ArrowUp`){let t=e.key===`ArrowUp`;(go(e.target,t?-1:1)||t&&vo(e.target))&&e.preventDefault();return}e.key===`Enter`&&(e.preventDefault(),t.aktiviereZeile(n,r))}}}
          >
            ${``}
            ${e.spalten.map((r,i)=>{let a=n===null?`—`:e.datenzeilen[n]?.[i]??``,o=e.imEditor&&!e.zeigeKopf&&e.editable;if(e.aendernMoeglich&&n!==null&&To(r)){let t=e.zeilenStand;return v`<div class="tippbar" role="cell">
                <input
...
`,q=class e extends D{constructor(...e){super(...e),this.spalten=Yi(),this.spaltenHerkunft=[],this.source=``,this.suche=`ja`,this.erfassung=`nein`,this.blaettern=`ja`,this.loeschbar=`nein`,this.kopfzeile=`ja`,this.leerText=oa,this.datenzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._besitz=`softengine`,this._breiten=new Map,this._breiteVorZug=null,this._ansicht=new bo({baustein:this,editable:()=>this.editable,zeilenHoehe:()=>this.zeilenHoehe,melde:()=>this.requestUpdate()}),this._erfassung=new Ca,this._lauf=new eo(()=>this.requestUpdate()),this._zeilen=new Qa({baustein:this,spalten:()=>this.spaltenListe(),rohzeilen:()=>this.rohzeilen,datenzeilen:()=>this.datenzeilen,melde:()=>this.requestUpdate(),lauf:this._lauf,erfassungAn:()=>this.erfassungAn,fokussiereErfassungsZelle:e=>this.fokussiereErfassungsZelle(e)}),this.nimmSeFokus=e=>{e.defaultPrevented||!this.erfassungAn||this.hasAttribute(`data-ff-editor`)||(e.preventDefault(),this.fokussiereErfassungsZelle(0))}}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.kannErfassen={wenn:{attributeName:`erfassung`,equals:`ja`}}}static{this.aenderungsSchluessel=`aenderbar`}static{this.kannLoeschen={wenn:{attributeName:`loeschbar`,equals:`ja`}}}static{this.blockEvents=[{key:`onRowClick`,name:`Zeile gewählt`},{key:`onRowDblClick`,name:`Zeile doppelt geklickt`}]}static{this.listenBindung=wo}static{this.defaultProps={width:`fill`,source:``,spalten:Yi(),suche:`ja`,erfassung:`nein`,blaettern:`ja`,loeschbar:`nein`,kopfzeile:`ja`,tagField:``,leerText:oa}}static{this.customProperties=Vo}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?Pa(this):Na(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=Ta(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.nachPush(),this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.zuruecksetzen(),this._erfassung.zuruecksetzen()}get erfassteZeilen(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.werte)}get erfassteSchluessel(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.kennung)}get geaenderteZeilen(){return this._zeilen.geaenderteZeilen}get geloeschteZeilen(){return this._zeilen.geloeschteZeilen}zeileSchreibt(e,t){this._lauf.schreibt(e,t)}zeileGescheitert(e,t,n){this._lauf.gescheitert(e,t,n)}laufFertig(e,t){if(this._lauf.fertig(e,t),e===`erfasst`){this._erfassung.markiereGeschrieben(this.erfassungsUmfeld(),t)&&this.requestUpdate();return}this._zeilen.austragen(e,t)}vergissGeschriebene(){this._erfassung.vergissGeschriebene()&&this.requestUpdate()}erfasstStand(e){return this._lauf.zeigt(`erfasst`,this._erfassung.schluessel[e]??``,this._erfassung.istGeschrieben(e)?`geschrieben`:`erfasst`)}erfasseZeile(){return this._erfassung.erfasse(this.erfassungsUmfeld())?(this.requestUpdate(),this.fokussiereErfassungsZelle(0),this.zeigeLetzteErfasste(),!0):!1}zeigeLetzteErfasste(){this.updateComplete.then(()=>{let e=this.shadowRoot?.querySelector(`.koerper`);e&&(e.scrollTop=e.scrollHeight)})}fokussiereSuche(){return this._ansicht.fokussiereSuche()}setzeSuchtext(e){this._ansicht.setzeSuchtext(e),this.requestUpdate()}get hatQuelle(){return this._besitz===`provided`||Ia(this.hasAttribute(`data-ff-editor`),this.source)}spaltenListe(){return Qi(this.spalten)}get zeilenHoehe(){return 28}breitenWirt(){let e=e=>{this._breiteVorZug===null&&(this._breiteVorZug=new Map(e.map(e=>[e.index,this._breiten.get(e.index)])))};return{zeige:t=>{e(t);for(let e of t)this._breiten.set(e.index,e.breite);this.requestUpdate()},uebernimm:e=>{this._breiteVorZug=null;let t=this.spaltenListe();if(!this.hasAttribute(`data-ff-editor`)){for(let t of e)this._breiten.set(t.index,t.breite);this.requestUpdate();return}for(let n of e)n.index>=t.length||(this._breiten.delete(n.index),t[n.index]={...t[n.index],breite:n.breite});this.aendere(t)},verwirf:()=>{let e=this._breiteVorZug;if(this._breiteVorZug=null,e){for(let[t,n]of e)n===void 0?this._breiten.delete(t):this._breiten.set(t,n);this.requestUpdate()}}}}get erfassungAn(){return this.erfassung===`ja`}erfassungsWirt(){return{baustein:this,lauf:this._erfassung.lauf,umfeld:()=>this.erfassungsUmfeld(),melde:()=>this.requestUpdate(),fokussiere:e=>this.fokussiereErfassungsZelle(e),erfasseZeile:()=>this.erfasseZeile()}}fokussiereErfassungsZelle(e){this.updateComplete.then(()=>{let t=this.shadowRoot?.querySelectorAll(`.zeile.erfassung .erf-eingabe`)?.[e];t&&(t.focus(),t.scrollIntoView({block:`nearest`}))})}erfassungsUmfeld(){return this._erfassung.umfeld(this,this.spaltenListe(),this.source)}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&Na(this),document.addEventListener(In,this.nimmSeFokus),this._ansicht.beobachte()}firstUpdated(){this._ansicht.beobachte()}willUpdate(e){super.willUpdate(e),e.has(`spalten`)&&this._breiten.clear(),!(!this.erfassungAn||this.hasAttribute(`data-ff-editor`))&&this._erfassung.lauf.aktualisiereVorschlaege(this.erfassungsUmfeld())}updated(){this._ansicht.nachRendern(),Er(this)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(In,this.nimmSeFokus),Ga(this),this._ansicht.loese(),hs(this),Pa(this)}static{this.styles=[D.styles,la,Xo,ri,wa]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=Bo({spalten:t,breiteVon:e=>this._breiten.get(e),hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._ansicht.suchtext,sortSpalte:this._ansicht.sortSpalte,sortAuf:this._ansicht.sortAuf,wunschSeite:this._ansicht.seite,gemessen:this._ansicht.mass,erfassungAn:this.erfassungAn,erfassteAnzahl:this._erfassung.zeilen.length,wertVon:(e,t)=>this._zeilen.zellWert(e,t),blaettert:this.blaettern===`ja`});return v`<div class="tabelle" style=${W({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
    ...
    >${Ki()}</button>
    ${e.liste}
  </div>`}var $o={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:qi,quelleProp:`nachschlagQuelle`};function es(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?Qi(e):[]}function ts(e,t){let n=e[0];return n===void 0?t:n.feld}function ns(e,t){let n=e.trim();return n===``||n===t.trim()}function rs(e,t,n){let r=t.trim(),i=[],a=ns(t,n),o=new Set;for(let t of e){let e=A(t,n).trim(),s=r===``?e:A(t,r).trim();if(!(s===``&&e===``)){if(a){if(o.has(e))continue;o.add(e)}i.push({anzeige:s,wert:e,satz:t})}}return i}function is(e,t,n,r){return rs(Yt(e,t).rows,n,r)}function as(e){let t=k(L().FF_DATA_SOURCES,e);return t?Dt(L().SEDATA,t.name,t.tableId,t.offenerSatz):null}function os(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=as(e.quelleId);if(t===null)return{ok:!1,grund:`quelleFehlt`};let n=ts(es([...e.spalten]),e.speicherFeld);return{ok:!0,eintraege:is(e.el,t,n,e.speicherFeld)}}function ss(e,t){return t&&e.length===1?e[0]:null}function cs(e,t){let{rows:n,gefiltert:r}=Yt(e,[t]);return!r||n.length>0}function ls(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var us=null,ds=null,fs=null;function ps(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function ms(e=!0){let t=e?fs:null;fs=null,us?.remove(),us=null,ds=null,t?.focus()}function hs(e){ds===e&&ms(!1)}function gs(e){return[{titel:e.speicherTitel===``?`Wert`:e.speicherTitel,feld:e.speicherFeld}]}function _s(e){let t=e=>e.stopPropagation(),n=e.editor;return v`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >${e.inhalt}</ff-dialog-rahmen>`}function vs(e,t){let n=es([...e.spalten]),r=ns(ts(n,e.speicherFeld),e.speicherFeld);return v`<ff-tabelle
    fuellt
    suche="ja"
    style="--se-r-lg:0px"
    .besitz=${`provided`}
    .spalten=${n.length>0?n:gs(e)}
  ...
  ></ff-tabelle>`}function ys(e){let t=e.eintraege;if(t===void 0){let n=os(e);if(!n.ok){I(n.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}t=n.eintraege}ms(!1);let n=document.createElement(`div`);n.style.display=`contents`,Ve(_s({titel:e.titel,breite:e.breite,hoehe:e.hoehe,inhalt:vs(e,t),onSchliessen:()=>ms()}),n);let r=n.querySelector(Zt),i=n.querySelector(q.tagName);i?.addEventListener(fo,n=>{let r=n.detail,i=t[r.rohIndex];i&&(ms(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),fs=e.rueckFokus??ps(e.el),document.body.appendChild(n),us=n,ds=e.el;let a=e.suchtext??``;i&&a!==``&&i.setzeSuchtext(a),r&&i&&Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}function bs(e){return _s({titel:e.titel,breite:e.breite,hoehe:e.hoehe,onSchliessen:e.onSchliessen,editor:{onGroesse:e.onGroesse},inhalt:v`<ff-tabelle
      data-ff-editor
      fuellt
      suche="ja"
      style="--se-r-lg:0px"
...
`,ws=`frei · hierher ziehen`,Ts=`ff-zimmer-inhalt`,Y=class extends D{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[V.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[D.styles,la,Cs,Ss,o`
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(Ts,{bubbles:!0,composed:!0}))}render(){return v`<div class="zimmer ${xs}">
      <div
        class="kopf"
        data-ff-editable
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(Ts,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(V.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return v`<div class="col ${xs} v-${kr(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};E([w()],X.prototype,`variant`,void 0),E([w()],X.prototype,`heading`,void 0),E([w({attribute:!1})],X.prototype,`leerHinweis`,void 0),E([T()],X.prototype,`_count`,void 0),D.defineAndRegister(X);function Es(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function Ds(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var Os=new WeakMap,ks=X.tagName,As=Y.tagName,js=V.tagName;function Ms(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===ks)}function Ns(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===js)}function Ps(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===As)}function Fs(e){return[e,...Ps(e)]}function Is(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=Ps(e);for(let e of t)r(e,Ns(e).length===0?ws:``);r(e,t.length===0&&Ns(e).length===0?n:``)}}function Ls(e){return Je().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Rs(e,t){let n=Ps(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),a=Es(A(t,r),i);return a>=0?n[a]:n[0]}function zs(e){Q?.board===e&&Gs();let t=e.getAttribute(`statusfield`)??``,n=Da(e);if(!n)return;let r=Ms(e);if(r.length===0)return;let i=Os.get(e);if(!i){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(js);t&&(i=t.cloneNode(!0),Os.set(e,i))}if(!i)return;let a=n.zeilen,o=r.map(e=>e.getAttribute(`heading`)??X.defaultProps.heading),s=Ls(i.tagName),c=Ds(r.map(e=>e.getAttribute(`auffang`))),l=n.lies;for(let e of r)for(let t of Fs(e))Ns(t).forEach(e=>e.remove());for(let e of a){let a=i.cloneNode(!0),u=t===``?-1:Es(A(e,t),o),d=u>=0?r[u]:c>=0?r[c]:r[0];(Rs(d,e)??d).appendChild(a);for(let t of s){let n=a.getAttribute(li(t.prop))??``;n!==``&&(a[t.prop]=l(e,n))}let f=St(n.quelle,e);Z.set(a,{row:e,pindex:f}),a.draggable=!0}Is(e,r);let u=r.flatMap(e=>Fs(e).flatMap(Ns)),d=Ht(N(e),u,e=>Z.get(e)?.row);for(let e of d)u[e].setAttribute(`data-ff-auswahl`,``)}var Z=new WeakMap,Q=null,Bs=new WeakSet,Vs=`data-ff-zieht`,Hs=`data-ff-ziel`,Us=null;function Ws(e){Us!==e&&(Us?.removeAttribute(Hs),Us=e,Us?.setAttribute(Hs,``))}function Gs(){Q?.card.removeAttribute(Vs),Q=null,Ws(null)}function Ks(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function qs(e,t){return Ks(e,t,ks)}function Js(e,t,n){if(!Q||Q.board!==e)return;let r=Z.get(Q.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;B(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(z)}function Ys(e){Bs.has(e)||(Bs.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Z.has(e))??null;if(!n)return;let r=Z.get(n);r&&Ut(N(e),r.row),B(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(z)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Z.has(e))??null;n&&(Q={card:n,board:e},t.dataTransfer?.setData(`text/plain`,Z.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{Q?.card===n&&n.setAttribute(Vs,``)},0))}),e.addEventListener(`dragend`,Gs),e.addEventListener(`dragover`,t=>{let n=qs(e,t);if(Q?.board!==e||!n){Ws(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),Ws(Ks(e,t,As)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&Ws(null)}),e.addEventListener(`drop`,t=>{let n=qs(e,t);n&&(t.preventDefault(),Js(e,n,Ks(e,t,As)),Gs())}))}var Xs=Ci({hydriere:zs,verdrahte:Ys}),Zs=Xs.connect,Qs=Xs.disconnect,$s=X.blockType,ec=class extends D{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[$s]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:$s}}static{this.templateChild={type:V.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:oa}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Feld, das die Spalte bestimmt. Leer: alle in die Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Einträge des gewählten Tages.`,kind:`field`},sa()]}static{this.defaultChildren=[{type:$s,props:{heading:`Offen`,variant:`warning`},children:[{type:V.blockType}]},{type:$s,props:{heading:`In Arbeit`,variant:`info`}},{type:$s,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[D.styles,o`
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(nc,{detail:e,bubbles:!0,composed:!0}))}render(){return v`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};E([w()],ic.prototype,`seite`,void 0),E([w()],ic.prototype,`seitename`,void 0),E([w({reflect:!0})],ic.prototype,`ton`,void 0),D.defineAndRegister(ic);var ac=`aktiv`;function oc(e){return Array.from(e.querySelectorAll(ic.tagName))}function sc(e,t){let n=oc(e),r=t??n.find(e=>e.hasAttribute(ac))??n[0];for(let e of n)e===r?e.setAttribute(ac,``):e.removeAttribute(ac)}function cc(e){let t=e.hasAttribute(`offen`);for(let n of oc(e))n.toggleAttribute(`breit`,t)}function lc(e){return e.getAttribute(`name`)??String(st.defaultProps.name)}function uc(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function dc(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(st.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=uc(e,i);if(!a)return;let o=r.find(e=>lc(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var fc=new WeakMap,pc=new WeakSet;function mc(e){let t=t=>{let n=t.detail;n&&(sc(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),cc(e),!e.hasAttribute(`data-ff-editor`)&&dc(e,n.ansicht))};e.addEventListener(nc,t),fc.set(e,t)}function hc(e){let t=fc.get(e);t&&(e.removeEventListener(nc,t),fc.delete(e))}function gc(e){if(sc(e),cc(e),e.hasAttribute(`data-ff-editor`)||pc.has(e))return;let t=oc(e)[0];if(!t)return;pc.add(e);let n=()=>dc(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var _c=ic.blockType,vc=class extends D{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[_c]}static{this.addChildButton={label:`Eintrag`,childType:_c}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[ot]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[D.styles,o`
      :host {
        height: 100%;
        width: ${tc.breite}px;
        transition: width var(--se-move);
      }
      :host([offen]) { width: ${tc.breiteOffen}px; }
      .leiste {
        box-sizing: border-box;
        height: 100%;
        width: 100%;
    ...
    `]}connectedCallback(){super.connectedCallback(),mc(this)}disconnectedCallback(){super.disconnectedCallback(),hc(this)}klappen(){this.toggleAttribute(`offen`),cc(this)}render(){return v`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
        ...
        <div class="eintraege">
          <slot @slotchange=${()=>gc(this)}></slot>
        </div>
      </div>`}};D.defineAndRegister(vc);var yc=li(`text`);function bc(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(yc)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function xc(e){let t=ki(e,yc);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function Sc(e){bc(e)&&(e.text=``)}var Cc=Ci({hydriere:xc,verdrahte:Sc}),wc=Cc.connect,Tc=Cc.disconnect,Ec=6,Dc=96,Oc=14,kc={duenn:`300`,normal:`400`,fett:`700`},Ac={links:`left`,mitte:`center`,rechts:`right`},jc={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},Mc=`standard`;function Nc(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(Dc,Math.max(Ec,t)):Oc}function Pc(e){return typeof e==`string`&&e in kc?e:`normal`}function Fc(e){return typeof e==`string`&&e in Ac?e:`links`}function Ic(e){return typeof e==`string`&&e in jc?e:Mc}var $=class extends D{constructor(...e){super(...e),this.groesse=Oc,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=Mc,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:Oc,gewicht:`normal`,ausrichtung:`links`,farbe:Mc,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Ec,max:Dc,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[D.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return v`<div
      class="text"
      style=${W({fontSize:`${Nc(this.groesse)}px`,fontWeight:kc[Pc(this.gewicht)],textAlign:Ac[Fc(this.ausrichtung)],color:jc[Ic(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),wc(this)}disconnectedCallback(){super.disconnectedCallback(),Tc(this)}};E([w({type:Number})],$.prototype,`groesse`,void 0),E([w()],$.prototype,`gewicht`,void 0),E([w()],$.prototype,`ausrichtung`,void 0),E([w()],$.prototype,`farbe`,void 0),E([w()],$.prototype,`text`,void 0),E([w()],$.prototype,`source`,void 0),E([w()],$.prototype,`textField`,void 0),D.defineAndRegister($);var Lc=[`waagerecht`,`senkrecht`],Rc=`waagerecht`;function zc(e){return Lc.includes(e)?e:Rc}var Bc=class extends D{constructor(...e){super(...e),this.richtung=Rc}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:Rc}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[D.styles,o`
    ...
    `]}render(){return v`<div class="flaeche ${zc(this.richtung)}"><div class="linie"></div></div>`}};E([w()],Bc.prototype,`richtung`,void 0),D.defineAndRegister(Bc),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;I(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();