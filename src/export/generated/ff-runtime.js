...
\f\r]`,ye=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,be=/-->/g,xe=/>/g,y=RegExp(`>|${ve}(?:([^\\s"'>=/]+)(${ve}*=${ve}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),Se=/'/g,Ce=/"/g,we=/^(?:script|style|textarea|title)$/i,Te=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),b=Te(1),Ee=Te(2),x=Symbol.for(`lit-noChange`),S=Symbol.for(`lit-nothing`),De=new WeakMap,C=v.createTreeWalker(v,129);function Oe(e,t){if(!ge(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return ue===void 0?t:ue.createHTML(t)}var ke=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=ye;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===ye?c[1]===`!--`?o=be:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=y):(we.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=y):o=xe:o===y?c[0]===`>`?(o=i??ye,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?y:c[3]===`"`?Ce:Se):o===Ce||o===Se?o=y:o===be||o===xe?o=ye:(o=y,i=void 0);let d=o===y&&e[t+1].startsWith(`/>`)?` `:``;a+=o===ye?n+pe:l>=0?(r.push(s),n.slice(0,l)+de+n.slice(l)+_+d):n+_+(l===-2?t:d)}return[Oe(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},Ae=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=ke(t,n);if(this.el=e.createElement(l,r),C.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=C.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(de)){let t=u[o++],n=i.getAttribute(e).split(_),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?Pe:r[1]===`?`?Fe:r[1]===`@`?Ie:Ne}),i.removeAttribute(e)}else e.startsWith(_)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(we.test(i.tagName)){let e=i.textContent.split(_),t=e.length-1;if(t>0){i.textContent=le?le.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],me()),C.nextNode(),c.push({type:2,index:++a});i.append(e[t],me())}}}else if(i.nodeType===8)if(i.data===fe)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(_,e+1))!==-1;)c.push({type:7,index:a}),e+=_.length-1}a++}}static createElement(e,t){let n=v.createElement(`template`);return n.innerHTML=e,n}};function w(e,t,n=e,r){if(t===x)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=he(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=w(e,i._$AS(e,t.values),i,r)),t}var je=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??v).importNode(t,!0);C.currentNode=r;let i=C.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new Me(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Le(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=C.nextNode(),a++)}return C.currentNode=v,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},Me=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=S,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=w(this,e,t),he(e)?e===S||e==null||e===``?(this._$AH!==S&&this._$AR(),this._$AH=S):e!==this._$AH&&e!==x&&this._(e):e._$litType$===void 0?e.nodeType===void 0?_e(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==S&&he(this._$AH)?this._$AA.nextSibling.data=e:this.T(v.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=Ae.createElement(Oe(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new je(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=De.get(e.strings);return t===void 0&&De.set(e.strings,t=new Ae(e)),t}k(t){ge(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(me()),this.O(me()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=ce(e).nextSibling;ce(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Ne=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=S,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=S}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=w(this,e,t,0),a=!he(e)||e!==this._$AH&&e!==x,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=w(this,r[n+o],t,o),s===x&&(s=this._$AH[o]),a||=!he(s)||s!==this._$AH[o],s===S?e=S:e!==S&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===S?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Pe=class extends Ne{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===S?void 0:e}},Fe=class extends Ne{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==S)}},Ie=class extends Ne{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=w(this,e,t,0)??S)===x)return;let n=this._$AH,r=e===S&&n!==S||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==S&&(n===S||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Le=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){w(this,e)}},Re=se.litHtmlPolyfillSupport;Re?.(Ae,Me),(se.litHtmlVersions??=[]).push(`3.3.3`);var ze=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new Me(t.insertBefore(me(),e),e,void 0,n??{})}return i._$AI(e),i},Be=globalThis,Ve=class extends g{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=ze(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return x}};Ve._$litElement$=!0,Ve.finalized=!0,Be.litElementHydrateSupport?.({LitElement:Ve});var He=Be.litElementPolyfillSupport;He?.({LitElement:Ve}),(Be.litElementVersions??=[]).push(`4.2.2`);var Ue={attribute:!0,type:String,converter:ie,reflect:!1,hasChanged:ae},We=(e=Ue,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e,!0,n)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e,!0,n)}}throw Error(`Unsupported decorator location: `+r)};function T(e){return(t,n)=>typeof n==`object`?We(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}function E(e){return T({...e,state:!0,attribute:!1})}var Ge=new Map;function Ke(e){Ge.has(e.type)&&console.warn(`Block-Typ "${e.type}" wird ueberschrieben.`),Ge.set(e.type,e)}function qe(){return Array.from(Ge.values())}var Je={width:`auto`};function Ye(e,t){if(!e)return!0;let n=t[e.attributeName];return e.keinesVon?!e.keinesVon.some(e=>Object.is(n,e)):`notEquals`in e?!Object.is(n,e.notEquals):Object.is(n,e.equals)}function Xe(e){return Object.entries(e).map(([e,t])=>`${e.replace(/[A-Z]/g,e=>`-`+e.toLowerCase())}:${t}`).join(`;`)}var Ze={spalten:24,spaltePx:40,zeilePx:12,gapPx:8},Qe={rasterX:0,rasterY:0,rasterW:Ze.spalten,rasterH:1};function $e(){return{display:`grid`,gridTemplateColumns:`repeat(${Ze.spalten}, 1fr)`,gridAutoRows:`${Ze.zeilePx}px`,gap:`${Ze.gapPx}px`,alignContent:`start`}}function et(){return Xe($e())}var tt=`weitereQuellen`,nt={[tt]:[]},rt=`folgtAuswahl`,it={[rt]:[]};function at(e,t){let n=e.textContent??``,r=Array.from(e.childNodes),i=r.map(e=>e.textContent??``);e.setAttribute(`contenteditable`,`plaintext-only`),e.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(e),a?.removeAllRanges(),a?.addRange(o);let s=()=>{e.replaceChildren(...r),r.forEach((e,t)=>{e.textContent!==i[t]&&(e.textContent=i[t])})},c=e.closest(`button`)!==null,l=()=>{let t=e.getRootNode().getSelection?.()??window.getSelection(),n=t?.rangeCount?t.getRangeAt(0):null;if(!t||!n||!e.contains(n.startContainer))return;n.collapsed||n.deleteContents();let r=n.startContainer;if(r instanceof Text){let e=n.startOffset;r.insertData(e,` `),t.collapse(r,e+1)}else{let e=document.createTextNode(` `);n.insertNode(e),t.collapse(e,1)}},u=!1,d=r=>{u||(u=!0,e.removeAttribute(`contenteditable`),e.removeEventListener(`blur`,f),e.removeEventListener(`keydown`,p),r&&t((e.textContent??``).trim(),n)||s())},f=()=>d(!0),p=t=>{if(t.key===`Enter`)t.preventDefault(),e.blur();else if(t.key===`Escape`)t.preventDefault(),d(!1);else if(t.key===` `&&c){if(t.ctrlKey||t.metaKey||t.altKey||t.isComposing)return;t.preventDefault(),l()}};e.addEventListener(`blur`,f),e.addEventListener(`keydown`,p)}function D(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var O=class extends Ve{constructor(...e){super(...e),this.editable=!1}static{this.styles=o`
  ...
  `}aktualisiereEscape(){let e=this.isConnected&&this.escapeSchliesst;e!==this.escapeRegistriert&&(e?document.addEventListener(`keydown`,this.aufTaste,!0):document.removeEventListener(`keydown`,this.aufTaste,!0),this.escapeRegistriert=e)}ziehe(e,t){if(!this.ziehbar)return;e.preventDefault(),e.stopPropagation();let n=t===`breite`?tn(this.breite,520):tn(this.hoehe,380),r=t===`breite`?240:160,i=t===`breite`?e.clientX:e.clientY,a=Math.max(r,Math.round(n)),o=!1,s=(e,n)=>{this.dispatchEvent(new CustomEvent(en,{detail:{achse:t,wert:e,geste:n},bubbles:!0,composed:!0}))},c=e=>{let c=t===`breite`?e.clientX:e.clientY,l=Math.max(r,Math.round(n+(c-i)*2));l!==a&&(a=l,s(l,o?`laeuft`:`beginn`),o=!0)},l=()=>{window.removeEventListener(`pointermove`,c),window.removeEventListener(`pointerup`,l),window.removeEventListener(`pointercancel`,l),window.removeEventListener(`blur`,l),o&&s(a,`ende`)};window.addEventListener(`pointermove`,c),window.addEventListener(`pointerup`,l),window.addEventListener(`pointercancel`,l),window.addEventListener(`blur`,l)}aufStandard(e,t){this.ziehbar&&(e.stopPropagation(),this.dispatchEvent(new CustomEvent(en,{detail:{achse:t,wert:0,geste:`standard`},bubbles:!0,composed:!0})))}schliesse(){this.dispatchEvent(new CustomEvent($t,{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.aktualisiereEscape()}updated(e){e.has(`escapeSchliesst`)&&this.aktualisiereEscape()}disconnectedCallback(){this.escapeRegistriert&&=(document.removeEventListener(`keydown`,this.aufTaste,!0),!1),super.disconnectedCallback()}render(){let e=tn(this.breite,520),t=tn(this.hoehe,380);return b`
    ...
    `]}onClose(){this.hasAttribute(`data-ff-editor`)||this.removeAttribute(`offen`)}updated(e){super.updated(e),!(!e.has(`offen`)||!this.offen)&&(this.hasAttribute(`data-ff-editor`)||this.updateComplete.then(()=>{!this.offen||!this.isConnected||(rn(this)??(this.shadowRoot?rn(this.shadowRoot):null))?.focus()}))}render(){return b`<ff-dialog-rahmen
        .breite=${this.breite}
        .hoehe=${this.hoehe}
        ohne-modal
        inhalt-fest
      ...
      </ff-dialog-rahmen>`}};D([T()],L.prototype,`name`,void 0),D([T()],L.prototype,`breite`,void 0),D([T()],L.prototype,`hoehe`,void 0),D([T({type:Boolean,reflect:!0})],L.prototype,`offen`,void 0),O.defineAndRegister(L);var an=[`GET_RELATION`,`PUT_RELATION`,`PUTADD_RELATION`];function on(e){return`${String(e.getDate()).padStart(2,`0`)}.${String(e.getMonth()+1).padStart(2,`0`)}.${e.getFullYear()}`}function sn(e,t){return e.params.map(e=>e.replace(/\{([A-Za-z0-9_]+)\}/g,(e,n)=>String(t[n]??``)))}var cn=8e3,R=null,ln=null;function un(){let e=document.createElement(`div`);return e.setAttribute(`data-ff-meldung`,``),e.setAttribute(`role`,`alert`),e.style.cssText=[`position:fixed`,`top:0`,`left:0`,`right:0`,`z-index:2147483647`,`padding:7px 12px`,`background:var(--se-red-soft,#fbe7e6)`,`color:var(--se-red,#c0201a)`,`border-bottom:1px solid var(--se-red,#c0201a)`,`font:500 12px/1.4 system-ui,sans-serif`,`cursor:pointer`].join(`;`),e.title=`Klicken zum Schließen`,e.addEventListener(`click`,dn),e}function dn(){ln&&=(clearTimeout(ln),null),R?.remove(),R=null}function z(e){typeof document>`u`||!document.body||(R||(R=un(),document.body.appendChild(R)),R.textContent=e,ln&&clearTimeout(ln),ln=setTimeout(dn,cn))}function B(){return globalThis}function fn(){let e=B();return A(e.SEDATA)&&A(e.SEDATA.Daten)}function pn(){let e=B();try{e.selib?.Json?.InitializeERPConnection?.()}catch{}try{typeof e.InitialisiereSchnittstelle==`function`&&e.InitialisiereSchnittstelle()}catch{}}function mn(){let e=B();try{typeof e.ResetDataBasis==`function`&&e.ResetDataBasis()}catch{}try{typeof e.InitialisiereDatenBasis==`function`&&e.InitialisiereDatenBasis()}catch{}}var hn=new Set,gn=new Set,_n=800,vn=!1,yn=!1,bn=null;function xn(){let e=document.activeElement;for(;e?.shadowRoot?.activeElement;)e=e.shadowRoot.activeElement;return e}function Sn(){let e=xn();return e instanceof HTMLElement?e.isContentEditable||e instanceof HTMLInputElement||e instanceof HTMLTextAreaElement||e instanceof HTMLSelectElement:!1}function Cn(){bn===null&&(bn=setInterval(()=>{if(Sn()||(wn(),!vn))return;vn=!1;let e=yn;yn=!1,Dn(e)},_n))}function wn(){bn!==null&&(clearInterval(bn),bn=null)}function Tn(e){hn.add(e)}function En(e){return gn.add(e),()=>{gn.delete(e)}}function Dn(e){let t=!0;hn.forEach(n=>{try{n(e)}catch{t=!1}}),t&&Pn!==null&&(Nn=Pn),Pn=null}function V(e){if(e&&(yn=!0),Sn()){vn=!0,Cn();return}vn=!1;let t=yn;yn=!1,Dn(t)}function On(){V(!1)}function kn(){mn(),V(!1)}function An(){let e=B(),t=A(e.SEDATA)?e.SEDATA.Daten:void 0;if(!A(t))return!1;let n=Fn(t);return n!==``&&n===Nn?!1:(Pn=n,!0)}function jn(e){gn.forEach(t=>{try{t(e)}catch{}})}var Mn=2e6,Nn=``,Pn=null;function Fn(e){try{let t=JSON.stringify(e);return t.length>Mn?``:t}catch{return``}}function In(e){let t=Dt(e);if(!t){jn(e);return}let n=B();A(n.SEDATA)||(n.SEDATA={}),n.SEDATA.Daten=t,mn();let r=Fn(t);r!==``&&r===Nn||(Pn=r,V(!0))}function Ln(e=0){let t=B();if(typeof t.basisHTML_REGISTER==`function`){try{t.basisHTML_SetConsoleLog?.(!0,!0)}catch{}try{t.basisHTML_REGISTER(e=>{In(e)},document.title,`1.0`);return}catch(t){if(e>=400){z(`SoftEngine-Anmeldung fehlgeschlagen: `+(t instanceof Error?t.message:String(t)));return}}}e<400?setTimeout(()=>{Ln(e+1)},25):z(`SoftEngine-Anschluss nicht gefunden — die Maske bleibt ohne Daten.`)}var Rn=`ff-se-fokus`;function zn(){B().basisHTML_DoSetFocusToHTML=()=>{let e=new CustomEvent(Rn,{cancelable:!0});return document.dispatchEvent(e),e.defaultPrevented}}var Bn=!1;function Vn(){if(Bn)return;Bn=!0,pn();let e=B();e.Erstellen=()=>{mn(),V(An())},e.initData=e.Erstellen,e.ReloadData=()=>{V(An())},zn(),Ln(),window.addEventListener(`message`,e=>{if(typeof B().basisHTML_REGISTER==`function`)return;let t=Ot(e.data);t!==void 0&&In(t)},!0);let t=0,n=setInterval(()=>{t+=1,fn()?(clearInterval(n),mn(),V(An())):t>100&&(clearInterval(n),z(`Keine Daten von SoftEngine empfangen — die Maske zeigt nichts an.`))},300)}function Hn(e){return e instanceof Error?e.message:String(e)}function Un(e,t){if(!(!Array.isArray(e)||t===``)){for(let n of e)if(!(!A(n)||n.id!==t)&&!(typeof n.verb!=`string`||!an.includes(n.verb))&&!(typeof n.nr!=`string`||n.nr===``)&&!(!Array.isArray(n.params)||n.params.some(e=>typeof e!=`string`)))return{id:t,verb:n.verb,nr:n.nr,params:n.params}}}var Wn=[`RESULT`,`result`,`PINDEX`,`pindex`,`INDEX`,`index`,`0_10`,`KEY`,`key`,`ID`,`id`,`VALUE`,`value`];function Gn(e){if(typeof e!=`string`)return e;try{return JSON.parse(e)}catch{return}}function Kn(e){if(typeof e==`string`){let t=e.trim();return t===``?void 0:t}if(typeof e==`number`||typeof e==`boolean`)return String(e)}function qn(e,t){if(t>12)return;let n=Kn(e);if(n!==void 0)return n;if(Array.isArray(e)){for(let n of e){let e=qn(n,t+1);if(e!==void 0)return e}return}if(A(e)){for(let n of Wn){if(!(n in e))continue;let r=qn(e[n],t+1);if(r!==void 0)return r}for(let n of Object.values(e)){let e=qn(n,t+1);if(e!==void 0)return e}}}function Jn(e){let t=Gn(e);if(A(t)){for(let e of Wn){if(!(e in t))continue;let n=qn(t[e],0);if(n!==void 0)return n}for(let e of Object.values(t))if(Array.isArray(e))for(let t of e){let e=Jn(t);if(e!==void 0)return e}else if(A(e)){let t=Jn(e);if(t!==void 0)return t}}}var Yn=[`RESULT`,`result`];function Xn(e,t=0){if(t>12)return;let n=typeof e==`string`?Gn(e):e;if(Array.isArray(n)){for(let e of n){let n=Xn(e,t+1);if(n!==void 0)return n}return}if(A(n)){for(let e of Yn){let t=n[e];if(typeof t==`string`)return t;if(typeof t==`number`||typeof t==`boolean`)return String(t)}for(let e of Object.values(n)){let n=Xn(e,t+1);if(n!==void 0)return n}}}function Zn(e,t,n=0){if(t.trim()===``||n>12)return``;let r=typeof e==`string`?Gn(e):e;if(Array.isArray(r)){for(let e of r){let r=Zn(e,t,n+1);if(r!==``)return r}return``}if(!A(r))return``;let i=M(r,t);if(i!==``)return i;for(let e of Object.values(r)){let r=Zn(e,t,n+1);if(r!==``)return r}return``}function Qn(e){return A(e)?Object.keys(e).filter(e=>/^Message\d+$/.test(e)):[]}function $n(e,t,n=!1){if(!A(e))return;let r=Qn(e).filter(e=>!t.has(e)).sort((e,t)=>Number(t.slice(7))-Number(e.slice(7)));for(let t of r){let r=n?Xn(e[t]):Jn(e[t]);if(r!==void 0)return{wert:r,roh:e[t],schluessel:t}}}var er=[],tr=!1,nr=2e4,rr=100,ir=nr,ar=0,or=!1,sr=!1;function cr(){return Date.now()<ar}function lr(){if(tr||er.length===0)return;tr=!0;let e=er.shift(),t=B(),n=new Set(Qn(t.SEDATA)),r=!1,i=!1,a=(t,n,i)=>{r||(r=!0,s(),clearInterval(c),clearTimeout(u),tr=!1,e.resolve(i===void 0?{wert:t,roh:n}:{wert:t,roh:n,fehler:i}),queueMicrotask(lr))},o=e.optionen.satzAntwort===!0,s=En(e=>{let t=o?Xn(e):Jn(e);if(t!==void 0){if(or&&cr()){or=!1,i=!0;return}a(t,e)}}),c=setInterval(()=>{let e=$n(B().SEDATA,n,o);if(e!==void 0){if(sr&&cr()){sr=!1,i=!0,n.add(e.schluessel);return}a(e.wert,e.roh)}},rr),l=t=>{e.optionen.still||z(t),a(``,void 0,t)},u=setTimeout(()=>{i||(or=!0,sr=!0,ar=Date.now()+ir),l(`Daten laden: SoftEngine hat nicht geantwortet (Relation Nr. ${e.template.nr}).`)},nr);if(typeof t.basisHTML_SND_MSG!=`function`){l(`Daten laden nicht möglich: keine Verbindung zu SoftEngine.`);return}try{t.basisHTML_SND_MSG(`GET_RELATION`,{NR:e.template.nr,PARAMS:e.params})}catch(t){l(`Daten laden fehlgeschlagen (Relation Nr. ${e.template.nr}): ${Hn(t)}`)}}function ur(e,t,n={}){Vn();let r=B();if(e.verb!==`GET_RELATION`){if(typeof r.basisHTML_SND_MSG!=`function`){let e=`Speichern nicht möglich: keine Verbindung zu SoftEngine. Die Eingabe wurde NICHT übernommen.`;return z(e),Promise.resolve({wert:``,roh:void 0,fehler:e})}try{r.basisHTML_SND_MSG(e.verb,{NR:e.nr,PARAMS:[...t]})}catch(t){let n=`Speichern fehlgeschlagen (Relation Nr. ${e.nr}): ${Hn(t)}`;return z(n),Promise.resolve({wert:``,roh:void 0,fehler:n})}return Promise.resolve({wert:``,roh:void 0})}return new Promise(r=>{er.push({template:e,params:[...t],resolve:r,optionen:n}),lr()})}function dr(e,t){if(!A(t))return``;let n=t.document;if(!n||typeof n.querySelectorAll!=`function`)return``;let r=Array.from(n.querySelectorAll(`[${lt}]`)).find(t=>t.getAttribute(lt)===e.blockId);if(!r)return``;let i=r[e.value];return i==null?``:String(i)}function fr(e,t,n=B()){if(e.source===`aus`)return``;if(e.source===`fixed`)return e.value;if(e.source===`context`)return t.context[e.value]??``;if(e.source===`previous_result`)return t.previousResult;if(e.source===`step_result`){let n=Number(e.value);if(!Number.isInteger(n)||n<0)return``;let r=e.ergebnisFeld??``;return r===``?t.stepResults?.[n]??``:Zn(t.stepRohErgebnisse?.[n],r)}if(e.source===`block_value`)return dr(e,n);if(e.source===`erfassungszelle`||e.source===`aenderungszelle`||e.source===`loeschzelle`){let n=Number(e.value);return!Number.isInteger(n)||n<0?``:t.zeilenZelle?.(e.blockId??``,n)??``}if(e.source===`gewaehlte_zeile`){let n=t.gewaehlteZeile?.(e.blockId??``);return n===void 0?``:M(n,e.value)}if(!A(n))return``;if(e.source===`se_variable`){let t=n.SEDATA;if(!A(t)||!A(t.Daten)||!A(t.Daten.VARArrays))return``;let r=t.Daten.VARArrays[e.value];return r==null?``:String(r)}let r=j(n.FF_DATA_SOURCES,e.dataSourceId??``);if(!r)return``;let i=Et(n.SEDATA,r.name,r.tableId,r.offenerSatz),a=t.context.PINDEX??``,o=a!==``&&r.indexField!==``?i.find(e=>M(e,r.indexField)===a):i[0];return o?M(o,e.value):``}function pr(e,t){let n=`0,START_TOOL,`+e;return t.length>0&&(n+=`,`+t.map(e=>encodeURIComponent(e)).join(`,`)),n}function mr(e){let t=e.trim();if(t===``)return;let n=B();try{if(typeof n.sendBWLink==`function`){n.sendBWLink(t);return}}catch{}try{typeof n.sendBWLinkIntern==`function`&&n.sendBWLinkIntern(t)}catch{}}function hr(e,t){if(e.trim()===``)return;let n=B();try{if(typeof n.sendBWLinkIntern==`function`){n.sendBWLinkIntern(pr(e,t));return}}catch{}try{if(typeof n.basisHTML_SND_MSG==`function`){let r={NR:e};t.length>0&&(r.PARAMS=[...t]),n.basisHTML_SND_MSG(`START_TOOL`,r)}}catch{}}function gr(e,t,n){if(t.trim()===``)return;let r=Array.from(e.querySelectorAll(L.tagName)),i=r.filter(e=>(e.getAttribute(`name`)??L.defaultProps.name)===t);if(i.length===0){z(`Fenster „`+t+`“ gibt es in dieser Maske nicht.`);return}if(i.length>1){z(`Fenster „`+t+`“ gibt es mehrfach — keines ist gemeint.`);return}let a=i[0];if(!n){a.removeAttribute(`offen`);return}for(let e of r)e!==a&&e.removeAttribute(`offen`);a.setAttribute(`offen`,``)}var _r=new WeakMap;function vr(e){z(`Aktionskette fehlgeschlagen: `+(e instanceof Error?e.message:String(e)))}var yr={erfassungszelle:`erfasst`,aenderungszelle:`geaendert`,loeschzelle:`geloescht`};function br(e){if(e.type!==`RELATION`)return null;let t=null;for(let n of[...e.params,...e.extraParams]){let e=yr[n.source],r=n.blockId??``;if(!(e===void 0||r===``)){if(t&&(t.art!==e||t.blockId!==r))return{art:e,blockId:``};t={art:e,blockId:r}}}return t}function xr(e){let t=[];for(let[n,r]of e.entries()){let e=br(r),i=t[t.length-1];if(e===null){i?i.plaetze.add(n):t.push({art:`einmal`,blockId:``,plaetze:new Set([n])});continue}if(i&&i.art===e.art&&i.blockId===e.blockId){i.plaetze.add(n);continue}t.push({art:e.art,blockId:e.blockId,plaetze:new Set([n])})}return t}function Sr(e,t){return Array.from(e.querySelectorAll(`[${lt}]`)).find(e=>e.getAttribute(lt)===t)}function Cr(e,t){if(t===`erfasst`){let t=e.erfassteZeilen;if(!Array.isArray(t))return;let n=e.erfassteSchluessel;return t.map((e,t)=>({satz:``,schluessel:Array.isArray(n)?n[t]??String(t):String(t),werte:e}))}let n=t===`geaendert`?e.geaenderteZeilen:e.geloeschteZeilen;if(Array.isArray(n))return n.map(e=>({satz:e.satz,schluessel:e.satz,werte:e.werte}))}function wr(e,t,n){return n.satz===``?e:t===`geloescht`?{...e,PINDEX:n.satz,DROP_PINDEX:n.satz}:{...e,PINDEX:n.satz}}async function Tr(e,t,n,r,i,a){let o=!1,s={...a?.values,...n,NOW_DATE:on(new Date)},c=a?.previousResult??``,l=t.map((e,t)=>a?.stepResults[t]??``),u=t.map((e,t)=>a?.rohErgebnisse[t]),d=()=>({values:s,stepResults:l,rohErgebnisse:u,previousResult:c});for(let[n,a]of t.entries()){if(i&&!i.has(n))continue;if(a.type===`START_TOOL`){hr(a.toolNr,sn({params:a.toolParams},s));continue}if(a.type===`BW_LINK`){mr(sn({params:[a.befehl]},s)[0]??``);continue}if(a.type===`POPUP_OPEN`||a.type===`POPUP_CLOSE`){gr(e.ownerDocument??document,a.popup??``,a.type===`POPUP_OPEN`);continue}let t=Un(B().FF_RELATIONS,a.relationId);if(!t){let e=`Schritt ${n+1} der Kette: seine Relation fehlt in dieser Maske.`;return z(e),{geschrieben:o,fehler:e,mitschrift:d()}}if([...a.params,...a.extraParams].some(e=>e.source===`context`&&e.value===`PINDEX`)&&(s.PINDEX??``)===``){let e=`Schritt ${n+1} der Kette braucht die Satznummer der Zeile — sie fehlt (Relation Nr. ${t.nr}). Nichts geschrieben.`;return z(e),{geschrieben:o,fehler:e,mitschrift:d()}}let f={context:s,previousResult:c,stepResults:l,stepRohErgebnisse:u,gewaehlteZeile:Bt,...r?{zeilenZelle:r}:{}},p=await ur(t,[...a.params,...a.extraParams].map(e=>fr(e,f))),m=p.wert;if(l[n]=m,u[n]=p.roh,t.verb===`GET_RELATION`?c=m:o=!0,p.fehler!==void 0&&p.fehler!==``)return{geschrieben:o,fehler:p.fehler,mitschrift:d()};a.resultKey!==``&&(s[a.resultKey]=m)}return{geschrieben:o,fehler:``,mitschrift:d()}}async function Er(e,t,n){if(e.hasAttribute(`data-ff-editor`))return;let r=mt(e.getAttribute(`data-ff-aktionen`))[t];if(!r||r.length===0)return;let i=_r.get(e);if(i||(i=new Set,_r.set(e,i)),!i.has(t)){i.add(t);try{let t=xr(r),i=[],a=!1,o=!1,s;for(let c of t){if(c.art===`einmal`){let t=await Tr(e,r,n,void 0,c.plaetze,s);if(s=t.mitschrift,t.geschrieben&&(a=!0),t.fehler!==``){o=!0;break}continue}if(c.blockId===``){z(`Ein Schritt liest Zellen aus zwei verschiedenen Listen — das geht nicht.`);break}let t=Sr(e.ownerDocument??document,c.blockId),l=t&&Cr(t,c.art);if(!t||!l){z(`Den Baustein, dessen Zellen die Kette liest, gibt es in dieser Maske nicht.`);break}if(l.length===0)continue;let u={traeger:t,art:c.art,fertige:[]};i.push(u);for(let i of l){t.zeileSchreibt?.(c.art,i.schluessel);let l=await Tr(e,r,wr(n,c.art,i),(e,t)=>e===c.blockId?String(i.werte[t]??``):``,c.plaetze,s);if(l.geschrieben&&(a=!0),l.fehler!==``){t.zeileGescheitert?.(c.art,i.schluessel,l.fehler),o=!0;break}u.fertige.push(i.schluessel)}if(o)break}for(let{traeger:e,art:t,fertige:n}of i)e.laufFertig?.(t,n);a&&kn()}finally{i.delete(t)}}}var Dr=new WeakSet;function Or(e,t){if(e.hasAttribute(`data-ff-editor`)||!e.hasAttribute(`data-ff-aktionen`)||Dr.has(e))return;Dr.add(e);let n=mt(e.getAttribute(`data-ff-aktionen`));Object.values(n).some(e=>e.some(e=>e.type===`RELATION`))&&Vn(),e.addEventListener(`click`,()=>{Er(e,t,{}).catch(vr)})}var kr=`ff-vormerkungen`;function Ar(e,t,n){let r=[];return e>0&&r.push(e===1?`1 neue Zeile`:`${e} neue Zeilen`),t>0&&r.push(t===1?`1 geänderte Zeile`:`${t} geänderte Zeilen`),n>0&&r.push(n===1?`1 Löschung`:`${n} Löschungen`),r.length===0?``:`${r.join(`, `)} vorgemerkt`}function jr(e){return e.erfasst+e.geaendert+e.geloescht}function Mr(e,t){return t===`erfasst`?e.erfassteZeilen?.length??0:t===`geaendert`?e.geaenderteZeilen?.length??0:e.geloeschteZeilen?.length??0}function Nr(e,t){let n=mt(e.getAttribute(`data-ff-aktionen`))[t];if(!n||n.length===0)return;let r={erfasst:0,geaendert:0,geloescht:0},i=new Set;for(let t of xr(n)){if(t.art===`einmal`||t.blockId===``)continue;let n=t.art+` `+t.blockId;if(i.has(n))continue;let a=Sr(e.ownerDocument??document,t.blockId);a&&(i.add(n),r[t.art]+=Mr(a,t.art))}return i.size===0?void 0:r}var Pr=new WeakMap;function Fr(e){let t=[Mr(e,`erfasst`),Mr(e,`geaendert`),Mr(e,`geloescht`)].join(` `);Pr.get(e)!==t&&(Pr.set(e,t),e.dispatchEvent(new CustomEvent(kr,{bubbles:!0,composed:!0})))}var Ir=class extends O{constructor(...e){super(...e),this.label=`Klick mich`,this.vormerkungen=void 0,this.zaehleVormerkungen=()=>{this.vormerkungen=Nr(this,`onClick`)}}static{this.blockType=`button`}static{this.tagName=`ff-button`}static{this.displayName=`Schaltfläche`}static{this.category=`eingabe`}static{this.defaultProps={label:`Klick mich`}}static{this.resizableWidth=!1}static{this.blockEvents=[{key:`onClick`,name:`Klick`}]}static{this.raster={startW:4,startH:2,minW:2,minH:2}}static{this.customProperties=[]}static{this.styles=[O.styles,o`
      button {
        box-sizing: border-box;
        padding: 7px 16px;
        cursor: pointer;
...
`,ia=[`text`,`number`,`textarea`,`select`,`date`,`time`,`checkbox`,`nachschlagen`];function aa(e){return ia.includes(e)?e:`text`}var oa=[`text`,`number`,`textarea`,`select`,`nachschlagen`,`date`,`time`],sa={select:`ph-select`,date:`ph-nativ`,time:`ph-nativ`,nachschlagen:`ph-nachschlag`};function ca(){return b`<svg viewBox="0 0 16 16" width="14" height="14" aria-hidden="true">
    ...
    </svg>`}var la=`Spalte {n}`;function ua(e){return la.replace(`{n}`,String(e+1))}function da(e){return{kennung:``,titel:ua(e),feld:``}}function fa(e){let t=vi(e.map(e=>e.kennung));return e.map((e,n)=>e.kennung===t[n]?e:{...e,kennung:t[n]})}function pa(e,t){let n=t.trim();return n===``?-1:e.findIndex(e=>e.kennung===n)}function ma(){return fa([da(0)])}function ha(e){let t=typeof e==`number`?e:Number(e);if(!Number.isFinite(t))return;let n=Math.round(t);return n<40?40:n}function ga(e,t){if(e&&typeof e==`object`){let n=e,r=n.breite===void 0?void 0:ha(n.breite);return{kennung:typeof n.kennung==`string`?n.kennung.trim():``,titel:typeof n.titel==`string`?n.titel:ua(t),feld:typeof n.feld==`string`?n.feld:``,...r===void 0?{}:{breite:r},...typeof n.summe==`boolean`?{summe:n.summe}:{},...typeof n.aenderbar==`boolean`?{aenderbar:n.aenderbar}:{},...typeof n.fuellFeld==`string`&&n.fuellFeld.trim()!==``?{fuellFeld:n.fuellFeld.trim()}:{}}}return typeof e==`string`?{...da(t),titel:e}:da(t)}function _a(e){let t;if(Array.isArray(e))t=e.map((e,t)=>ga(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>da(e))}else t=ma();return t.length>16&&(t=t.slice(0,16)),t.length<1&&(t=[da(0)]),fa(t)}function va(e){try{return _a(JSON.parse(e))}catch{return ma()}}function ya(e,t=()=>void 0){let n=e.map((e,n)=>t(n)??e.breite),r=n.filter(e=>e!==void 0),i=r.length===0?1:Math.max(1,Math.round(r.reduce((e,t)=>e+t,0)/r.length));return n.map(e=>`minmax(0, ${e??i}fr)`).join(` `)}var ba={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},xa=e=>(...t)=>({_$litDirective$:e,values:t}),Sa=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},Ca=`important`,wa=` !important`,W=xa(class extends Sa{constructor(e){if(super(e),e.type!==ba.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(wa);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?Ca:``):n[e]=r}}return x}}),Ta=[`menge`,`anzahl`,`dosis`,`tage`],Ea={stellen:3,richtung:`kfm`};function Da(){return{menge:{spalte:``,runden:{...Ea}},anzahl:{spalte:``,runden:{stellen:0,richtung:`auf`}},dosis:{spalte:``,runden:{...Ea}},tage:{spalte:``,runden:{...Ea}}}}var Oa=/^-?\d+(,\d+)?$|^-?[1-9]\d{0,2}(\.\d{3})+(,\d+)?$/;function ka(e){let t=e.trim();if(t===``||!Oa.test(t))return null;let n=Number(t.replace(/\./g,``).replace(`,`,`.`));return Number.isFinite(n)?n:null}function Aa(e,t){let n=10**Math.max(0,t.stellen),r=e*n;return(t.richtung===`auf`?Math.ceil(r-1e-9):t.richtung===`ab`?Math.floor(r+1e-9):Math.round(r))/n}function ja(e,t){return e.toLocaleString(`de-DE`,{useGrouping:!1,minimumFractionDigits:0,maximumFractionDigits:Math.max(0,t)})}function Ma(e,t,n){if(!n.has(`menge`))return null;let r=[`menge`];for(let e of[`anzahl`,`dosis`,`tage`])n.has(e)&&r.push(e);let i=[];for(let e of r){let n=t[e];if(n===`fehler`)return null;n===null&&i.push(e)}if(i.length!==1)return null;let a=i[0],o=e=>{let n=t[e];return typeof n==`number`?n:1},s=o(`anzahl`)*o(`dosis`)*o(`tage`),c;if(a===`menge`)c=s;else{if(s===0)return null;c=o(`menge`)/s}return Number.isFinite(c)?{platz:a,wert:Aa(c,e[a].runden)}:null}function Na(e,t){if(!e||typeof e!=`object`)return{...t};let n=e;return{stellen:typeof n.stellen==`number`&&Number.isInteger(n.stellen)&&n.stellen>=0&&n.stellen<=6?n.stellen:t.stellen,richtung:n.richtung===`auf`||n.richtung===`ab`||n.richtung===`kfm`?n.richtung:t.richtung}}function Pa(e,t){if(!e||typeof e!=`object`)return{spalte:``,runden:{...t}};let n=e;return{spalte:typeof n.spalte==`string`?n.spalte:``,runden:Na(n.runden,t)}}function Fa(e){let t=e;if(typeof e==`string`){let n=e.trim();if(n===``)return null;try{t=JSON.parse(n)}catch{return null}}if(!t||typeof t!=`object`||Array.isArray(t))return null;let n=t,r=Da();return{menge:Pa(n.menge,r.menge.runden),anzahl:Pa(n.anzahl,r.anzahl.runden),dosis:Pa(n.dosis,r.dosis.runden),tage:Pa(n.tage,r.tage.runden)}}function Ia(e,t){let n=new Set(t);if(!Ta.some(t=>n.has(e[t].spalte)))return e;let r={...e};for(let e of Ta)n.has(r[e].spalte)&&(r[e]={...r[e],spalte:``});return r}function La(e){return JSON.stringify(e)}var Ra=`Keine Datensätze.`;function za(){return{attributeName:`leerText`,name:`Text ohne Datensätze`,description:`Text, wenn die Quelle keine Zeilen liefert. Leer: gar nichts.`,kind:`text`,requiresDataSource:!0}}function Ba(e,t=!1){return e.trim()===``?S:b`<div class="leer${t?` leer--tafel`:``}">
    ${Ur()}
    <span>${e}</span>
  </div>`}var Va=o`
  .leer {
...
`;function Ha(e,t){let n=(e?.fuellFeld??``).trim(),r=n===``?(e?.feld??``).trim():n;if(r===``)return{art:`frei`,quelleId:``,code:``};let{quelleId:i,code:a}=hi(r);return i===``?{art:`eigen`,quelleId:t,code:a}:{art:`verknuepft`,quelleId:i,code:a}}function G(e,t){return Ha(e.spalten[t],e.quelleId)}function Ua(e){let t=[];for(let n of e.spalten){let r=Ha(n,e.quelleId);r.art!==`verknuepft`||r.quelleId===``||t.includes(r.quelleId)||t.push(r.quelleId)}return t}function Wa(e,t){let n=G(e,t);if(!(n.quelleId===``||n.code===``))for(let r=0;r<e.spalten.length;r++){if(r===t)continue;let i=e.spalten[r],a=Ha(i,e.quelleId);if(a.quelleId===n.quelleId&&!(a.code===``||a.code===n.code))return{titel:i.titel,code:a.code}}}function Ga(e,t){let n=G(e,t);if(n.art!==`verknuepft`||n.quelleId===``||n.code===``)return[];let r=[];for(let t of e.spalten){let i=Ha(t,e.quelleId);i.quelleId!==n.quelleId||i.code===``||r.some(e=>e.feld===i.code)||r.push({kennung:``,titel:t.titel,feld:i.code})}return r}function Ka(e,t,n){let r=e.map(e=>({toField:e.toField,soll:t(e.fromField)})).filter(e=>e.soll!==void 0);return r.length===0?[...n]:n.filter(e=>r.every(t=>t.soll!==``&&t.soll===M(e,t.toField)))}function qa(e,t,n){return b`<input
    class="erf-eingabe"
    type="text"
    ...
    @blur=${()=>t.verlassen(n)}
  />`}function Ja(e,t,n,r){if(r)return b`<div class="erf-halter">
      ${qa(e,t,n)}
...
`;function ho(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen])}}function go(e,t,n){return t===``||n===``?[...e]:e.filter(e=>Xr(M(e,t))===n)}function _o(e){let t=e.getAttribute(`source`)??``;if(t===``)return null;let n=j(B().FF_DATA_SOURCES,t);return n?{quelle:n,zeilen:go(Et(B().SEDATA,n.name,n.tableId,n.offenerSatz),e.getAttribute(`tagfield`)??``,ti()),lies:Wi(e)}:null}function vo(e){return va(e.getAttribute(`spalten`)??``)}function yo(e,t){let n=j(B().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?xt(n,t):``}function bo(e){let t=j(B().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return t!==void 0&&t.indexField!==``}function xo(e,t){t&&e.vergissGeschriebene();let n=_o(e);if(!n){e.datenzeilen=[];return}let r=vo(e),{rows:i,gefiltert:a}=Xt(e,n.zeilen),o=Ut(F(e),i,e=>e)[0]??-1,s=n.lies;e.datenGeliefert=!0,e.rohzeilen=i,e.auswahlIndex=o,e.durchAuswahlGefiltert=a,e.datenzeilen=i.map(e=>r.map(t=>t.feld===``?``:s(e,t.feld)))}var So=zi({hydriere:xo}),Co=So.connect,wo=So.disconnect;function To(e,t){let n=[];return e.forEach((e,r)=>{oi(e,t)&&n.push(r)}),n}function Eo(e,t){return!e&&t.trim()!==``}function Do(e,t,n){return e&&t&&n===0}function Oo(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function ko(e){return fa([...e,da(e.length)])}function Ao(e,t,n){let r=Fa(e);if(!r)return null;let i=new Set(n.map(e=>e.kennung)),a=Ia(r,t.map(e=>e.kennung).filter(e=>e!==``&&!i.has(e)));return a===r?null:La(a)}function jo(e,t,n){let r=t();r.length<=1||e<0||e>=r.length||(r.splice(e,1),n(r))}function Mo(e,t,n){return b`<div class="steuerung">
    <button
      title="Letzte Spalte entfernen"
      @click=${r=>{n(r),jo(e().length-1,e,t)}}
    >−</button>
    <button
      title="Spalte hinzufügen"
      @click=${r=>{n(r);let i=e();i.length<16&&t(ko(i))}}
    >+</button>
  </div>`}function No(e,t,n,r){let i=n();if(e<0||e>=i.length)return;let a=Math.max(0,Math.min(t,i.length-1));if(a===e)return;let[o]=i.splice(e,1);i.splice(a,0,o),r(i)}var Po=5;function Fo(e,t,n){if(e.button!==0||!n.editable()||e.target instanceof HTMLElement&&e.target.isContentEditable)return;let r=e.currentTarget?.parentElement;if(!r)return;let i=[...r.children].filter(e=>e instanceof HTMLElement&&e.tagName===`DIV`);if(i.length<2)return;e.stopPropagation();let a=e.clientX,o=!1,s=t,c=e=>{for(let t=0;t<i.length;t++){let n=i[t].getBoundingClientRect();if(e<n.left+n.width/2)return t}return i.length},l=e=>{i.forEach((n,r)=>{n.classList.toggle(`zug-quelle`,o&&r===t),n.classList.toggle(`zug-slot`,o&&r===e),n.classList.toggle(`zug-slot-ende`,o&&e===i.length&&r===i.length-1)})},u=e=>{e.stopPropagation(),e.preventDefault()},d=()=>{window.removeEventListener(`pointermove`,f),window.removeEventListener(`pointerup`,p),window.removeEventListener(`pointercancel`,m),window.removeEventListener(`blur`,m);let e=o;o=!1,l(-1),e&&(document.body.style.cursor=``)};function f(e){if(!o){if(Math.abs(e.clientX-a)<Po)return;o=!0,n.vorZug(),document.body.style.cursor=`grabbing`,window.addEventListener(`click`,u,{capture:!0,once:!0})}e.preventDefault(),s=c(e.clientX),l(s)}function p(){let e=o,r=s;d(),e&&No(t,r>t?r-1:r,n.liste,n.aendere)}function m(){o&&window.removeEventListener(`click`,u,!0),d()}window.addEventListener(`pointermove`,f),window.addEventListener(`pointerup`,p),window.addEventListener(`pointercancel`,m),window.addEventListener(`blur`,m)}function Io(e,t){let n=e.currentTarget;n&&(e.stopPropagation(),e.preventDefault(),at(n,(e,n)=>e===``||e===n.trim()?!1:(t(e),!0)))}function Lo(e,t,n,r){Io(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var Ro=220,zo=new WeakMap;function Bo(e){let t=zo.get(e);t!==void 0&&(clearTimeout(t),zo.delete(e))}function Vo(e,t,n){return b`<button
    class="kopf-weg"
    type="button"
  ...
  >&#x2715;</button>`}function Ho(e){return{dblklickKopf:(t,n)=>{e.editable()&&(Bo(e.baustein),Lo(t,n,e.liste,e.aendere))},klickKopf:(t,n)=>{e.editable()&&Uo(e.baustein,t,{prop:e.prop,index:n,liste:e.liste}),e.sortiere(n)}}}function Uo(e,t,n){t.stopPropagation();let r=t.currentTarget.getBoundingClientRect();Bo(e),zo.set(e,setTimeout(()=>{zo.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n.prop,index:n.index,top:r.bottom+4,left:r.left,...n.liste?{liste:n.liste()}:{}},bubbles:!0,composed:!0}))},Ro))}var Wo=`\0`;function Go(e,t){return e+Wo+String(t)}var Ko=class{constructor(){this.werte=new Map}setze(e,t,n){if(e===``)return!1;let r=Go(e,t);return this.werte.get(r)===n?!1:(this.werte.set(r,n),!0)}nimmZurueck(e,t){return this.werte.delete(Go(e,t))}wert(e,t){return e===``?void 0:this.werte.get(Go(e,t))}get anzahl(){return this.werte.size}proSatz(){let e=[];for(let[t,n]of this.werte){let[r,i]=t.split(Wo),a=Number(i),o=e.find(e=>e.satz===r),s={satz:r,spalte:a,wert:n};o?o.aenderungen.push(s):e.push({satz:r,aenderungen:[s]})}return e}nimmSatzZurueck(e){let t=!1;for(let n of[...this.werte.keys()])n.slice(0,n.indexOf(Wo))===e&&this.werte.delete(n)&&(t=!0);return t}},qo=class{constructor(e){this.aenderungen=new Ko,this.geloescht=new Set,this.wirt=e}get geaenderteZeilen(){if(this.aenderungen.anzahl===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let{satz:r}of this.aenderungen.proSatz()){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}get geloeschteZeilen(){if(this.geloescht.size===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let r of this.geloescht){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}austragen(e,t){let n=!1;for(let r of t)n=e===`geaendert`?this.aenderungen.nimmSatzZurueck(r)||n:this.geloescht.delete(r)||n;n&&this.wirt.melde()}vorgemerkteAenderungen(){return this.geaenderteZeilen.length}vorgemerkteLoeschungen(){return this.geloeschteZeilen.length}statusVon(e){let t=this.satzVon(e);if(t===``)return{status:`gebucht`,titel:``};if(this.geloescht.has(t))return this.wirt.lauf.zeigt(`geloescht`,t,`loeschung`);let n=this.wirt.spalten().some((e,n)=>this.aenderungen.wert(t,n)!==void 0);return this.wirt.lauf.zeigt(`geaendert`,t,n?`geaendert`:`gebucht`)}satzPlaetze(){let e=new Map;return this.wirt.rohzeilen().forEach((t,n)=>{let r=yo(this.wirt.baustein,t);r!==``&&!e.has(r)&&e.set(r,n)}),e}satzVon(e){let t=this.wirt.rohzeilen()[e];return t===void 0?``:yo(this.wirt.baustein,t)}schalteLoeschung(e){let t=this.satzVon(e);t!==``&&(this.geloescht.has(t)?this.geloescht.delete(t):(this.geloescht.add(t),this.wirt.spalten().forEach((e,n)=>{this.aenderungen.nimmZurueck(t,n)})),this.wirt.melde())}istGeloescht(e){let t=this.satzVon(e);return t!==``&&this.geloescht.has(t)}zellWert(e,t){let n=this.aenderungen.wert(this.satzVon(e),t);return n===void 0?this.wirt.datenzeilen()[e]?.[t]??``:n}istGeaendert(e,t){return this.aenderungen.wert(this.satzVon(e),t)!==void 0}tippeZelle(e,t,n){this.aenderungen.setze(this.satzVon(e),t,n)&&this.wirt.melde()}verlasseZelle(e,t,n){let r=this.satzVon(e);(n===(this.wirt.datenzeilen()[e]?.[t]??``)?this.aenderungen.nimmZurueck(r,t):this.aenderungen.setze(r,t,n))&&this.wirt.melde()}zelleNachbar(e,t,n,r){let i=Array.from(this.wirt.baustein.shadowRoot?.querySelectorAll(`.koerper > .zeile:not(.erfassung) .zell-eingabe[data-spalte="${e}"]`)??[]),a=i.indexOf(t);if(a<0)return;let o=a+n;if(o>i.length-1){if(r&&this.wirt.erfassungAn()){this.wirt.fokussiereErfassungsZelle(0);return}o=i.length-1}o<0&&(o=0);let s=i[o];!s||s===t||(s.focus(),s.select(),s.scrollIntoView({block:`nearest`}))}tasteZelle(e,t,n){let r=n.target;if(n.key===`Escape`){n.preventDefault(),n.stopPropagation(),this.aenderungen.nimmZurueck(this.satzVon(e),t)&&this.wirt.melde();return}let i={Enter:1,ArrowDown:1,ArrowUp:-1,PageDown:10,PageUp:-10}[n.key];i!==void 0&&(n.preventDefault(),n.stopPropagation(),this.zelleNachbar(t,r,i,n.key===`Enter`))}},Jo={gebucht:``,erfasst:`Neue Zeile — noch nicht geschrieben`,geaendert:`Geändert — noch nicht geschrieben`,loeschung:`Zum Löschen vorgemerkt — noch nicht geschrieben`,schreibt:`Wird geschrieben …`,geschrieben:`Hinausgeschickt — bleibt stehen, bis neue Daten kommen`,fehler:`Nicht geschrieben`},Yo=class{constructor(e){this.schreibend=new Map,this.fehler=new Map,this.melde=e}schreibt(e,t){this.fehler.get(e)?.delete(t);let n=this.schreibend.get(e)??new Set;n.add(t),this.schreibend.set(e,n),this.melde()}gescheitert(e,t,n){this.schreibend.get(e)?.delete(t);let r=this.fehler.get(e)??new Map;r.set(t,n),this.fehler.set(e,r),this.melde()}fertig(e,t){this.schreibend.get(e)?.clear();let n=this.fehler.get(e);if(n)for(let e of t)n.delete(e);this.melde()}zeigt(e,t,n){let r=this.fehler.get(e)?.get(t);return r===void 0?this.schreibend.get(e)?.has(t)===!0?{status:`schreibt`,titel:Jo.schreibt}:{status:n,titel:Jo[n]}:{status:`fehler`,titel:Jo.fehler+`: `+r}}},Xo=4;function Zo(e){return e??Xo}function Qo(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function $o(e,t,n){let r=Qo(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function es(e,t){return e===null?null:Math.max(0,e-t)}function ts({sichtbar:e,hatQuelle:t,platzhalterZeilen:n}){return t?{seiten:1,seite:0,zeilen:[...e]}:{seiten:1,seite:0,zeilen:Array.from({length:n},()=>null)}}function ns({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function rs(e){if(!e.hasAttribute(`fuellt`))return-1;let t=e.renderRoot.querySelector(`.koerper`);return t instanceof HTMLElement?t.clientHeight:-1}function is(e){let t=e.renderRoot.querySelector(`.kopf`);return t instanceof HTMLElement?t.offsetHeight:0}function as(e,t){let n=rs(e);if(n===-1)return{mass:null,hoehe:n,kopf:0};let r=is(e);return{mass:$o(n,r,t),hoehe:n,kopf:r}}function os(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}var ss=`ff-zeile-aktiviert`,cs=`data-ff-roh`;function ls(e,t){e.dispatchEvent(new CustomEvent(ss,{detail:t,bubbles:!0,composed:!0}))}function us(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(cs);return r===null||r===``?null:Number(r)}function ds(e,t){if(!(e instanceof HTMLElement))return!1;let n=e.closest(`.zeile`),r=n?.parentElement;if(!n||!r)return!1;let i=[...r.querySelectorAll(`.zeile[${cs}]`)],a=i.indexOf(n),o=a===-1?void 0:i[a+t];return o?(o.focus(),!0):!1}function fs(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.zeile[${cs}]`);return t?(t.focus(),!0):!1}function ps(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.suchzeile input`);return t?(t.focus(),!0):!1}function ms(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var hs=class{constructor(e){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._rumpfGemessen=-1,this._kopfGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this.wirt=e}get suchtext(){return this._suchtext}get suchtAktiv(){return this._suchtext.trim()!==``}get sortSpalte(){return this._sortSpalte}get sortAuf(){return this._sortAuf}get seite(){return this._seite}get mass(){return this._mass}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.wirt.melde()}klickSortiere(e){this.wirt.editable()||(this.merkeZeilenFokus(),this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.wirt.melde())}blaettere(e){this.merkeZeilenFokus(),this._seite=e,this.wirt.melde()}fokussiereSuche(){let e=this.wirt.baustein.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}merkeZeilenFokus(){let e=us(this.wirt.baustein.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.wirt.zeilenHoehe();this._taktGemessen=e;let{mass:t,hoehe:n,kopf:r}=as(this.wirt.baustein,e);this._rumpfGemessen=n,this._kopfGemessen=r,!(t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe)&&(this._mass=t,this.wirt.melde())}beobachte(){this._beobachter||(this._beobachter=os(this.wirt.baustein,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}nachRendern(){(this._taktGemessen!==this.wirt.zeilenHoehe()||this._rumpfGemessen!==rs(this.wirt.baustein)||this._kopfGemessen!==is(this.wirt.baustein))&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,ms(this.wirt.baustein.shadowRoot,this._fokusZeile))}loese(){this._beobachter?.disconnect(),this._beobachter=null}nachPush(){this._seite=0,this._mass=null,this._taktGemessen=0,this._rumpfGemessen=-1,this._kopfGemessen=0}zuruecksetzen(){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this.nachPush(),this._fokusZeile=null,this._fokusHolen=!1}};function gs(e,t,n,r){if(n===null||e.hasAttribute(`data-ff-editor`))return;let i=t[n];i!==void 0&&(ls(e,{rohzeile:i,rohIndex:n,ansichtIndex:r}),vs(e,i),Er(e,`onRowClick`,{PINDEX:yo(e,i)}).catch(vr))}function _s(e,t,n){if(n===null||e.hasAttribute(`data-ff-editor`))return;let r=t[n];r!==void 0&&Er(e,`onRowDblClick`,{PINDEX:yo(e,r)}).catch(vr)}function vs(e,t){let n=F(e);n!==``&&Wt(n,t)}var ys={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,kennungKey:`kennung`,standardTitel:la,eintragsSchalter:[{key:`summe`,label:`Summe in der Fußzeile`,kurz:`Summe`},{key:`aenderbar`,label:`In der Zeile änderbar`,kurz:`änderbar`,standard:!0,nurEigeneQuelle:!0}],herkunftProp:`spaltenHerkunft`,eintragsFeldWahl:[{key:`fuellFeld`,label:`Nachschlagen`,hinweis:`Beim Erfassen füllt der gewählte Satz der Hilfsquelle diese Zelle.`,nurFremdeQuellen:!0}]};function bs(e){let t=e,n=ys.eintragsSchalter?.find(e=>e.key===`aenderbar`);return n!==void 0&&e.feld!==``&&_i(ys,t).includes(n)&&gi(n,t)}function xs(e,t,n){let r=0,i=0;for(let t of e){let e=ao(t);e!==null&&(r+=e,i++)}return i===0?``:r.toLocaleString(`de-DE`,{minimumFractionDigits:t,maximumFractionDigits:n})}var Ss={min:0,max:3};function Cs(e,t){let n=[];return e.spalten.forEach((r,i)=>{if(r.summe!==!0)return;let a=xs(t.map(t=>e.wertVon(t,i)),Ss.min,Ss.max);a!==``&&n.push({titel:r.titel,text:a})}),n}function ws(e){return e.datenzeilen.map((t,n)=>e.spalten.map((t,r)=>e.wertVon(n,r)))}function Ts(e){let t=ws(e),n=To(t,e.suchtext);return e.sortSpalte<0?n:uo(n.map(e=>t[e]),e.sortSpalte,e.sortAuf).map(e=>n[e])}function Es(e){let t={gridTemplateColumns:ya(e.spalten,e.breiteVon)},n=e.gemessen?.zeilenHoehe??28,r=e.hatQuelle,i=!e.erfassungAn&&Do(r,e.datenGeliefert,e.datenzeilen.length),a=Ts(e),o=e.erfassungAn?1+e.erfassteAnzahl:0,s=e.gemessen===null?null:Math.max(1,e.gemessen.passen-o),c={sichtbar:a,hatQuelle:r,proSeite:s??Math.max(1,10-o),wunschSeite:e.wunschSeite,platzhalterZeilen:Zo(s)},{seiten:l,seite:u,zeilen:d}=e.blaettert?ns(c):ts(c);return{cols:t,takt:28,zeilenHoehe:n,hatQuelle:r,leer:i,gesamt:a.length,seiten:l,seite:u,zeilen:d,linealTakte:es(s,d.length),summen:Cs(e,a)}}var Ds=[U(`suche`,`Suchzeile`,`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,{requiresDataSource:!0}),U(`erfassung`,`Erfassungszeile`,`Eine leere Zeile zum Tippen neuer Positionen.`),U(`loeschbar`,`Zeilen löschbar`,`Kreuz an jeder Zeile: merkt sie zum Löschen vor.`,{requiresDataSource:!0}),U(`blaettern`,`Blättern`,`Ja: Seiten mit Blätter-Knöpfen. Nein: alles untereinander, der Rumpf rollt.`),U(`kopfzeile`,`Kopfzeile`,`Aus: keine Titelzeile, kein Sortieren per Titelklick.`),{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Sätze des gewählten Tages.`,kind:`field`},za()];function Os(e,t){let n=e.erfasst+e.geaendert+e.geloescht,r=e.seiten>1||e.summen.length>0||n>0||e.suchtAktiv||e.auswahlAktiv;return e.leer||!r?S:b`<div class="fusszeile">
    <div class="seiten-info">${Oo({hatQuelle:e.hatQuelle,sichtbar:e.sichtbar,gesamt:e.gesamt,suchtAktiv:e.suchtAktiv,auswahlAktiv:e.auswahlAktiv})}</div>
  ...
  </div>`}var ks=/[.*+?^${}()|[\]\\]/g;function As(e,t){let n=ai(t);if(n.length===0||e===``)return e;let r;try{r=RegExp(`(${n.map(e=>e.replace(ks,`\\$&`)).join(`|`)})`,`ig`)}catch{return e}let i=e.split(r);return i.length<=1?e:b`${i.map((e,t)=>t%2==1?b`<mark>${e}</mark>`:e)}`}function js(e,t,n){let r=40-e,i=t-40,a=r>i?0:Math.min(i,Math.max(r,Math.round(n)));return{links:Math.round(e+a),rechts:Math.round(t-a)}}function Ms(e,t,n){if(e.button!==0)return;let r=[...e.currentTarget?.parentElement?.children??[]].filter(e=>e instanceof HTMLElement&&e.tagName===`DIV`),i=r[t],a=r[t+1];if(!i||!a)return;e.stopPropagation(),e.preventDefault();let o=e.clientX,s=i.getBoundingClientRect().width,c=a.getBoundingClientRect().width,l=js(s,c,0),u=()=>{window.removeEventListener(`pointermove`,p),window.removeEventListener(`pointerup`,m),window.removeEventListener(`pointercancel`,h),window.removeEventListener(`keydown`,ee),window.removeEventListener(`blur`,h)},d=r.map(e=>Math.max(1,Math.round(e.getBoundingClientRect().width))),f=()=>d.map((e,n)=>n===t?{index:n,breite:l.links}:n===t+1?{index:n,breite:l.rechts}:{index:n,breite:e});function p(e){l=js(s,c,e.clientX-o),n.zeige(f())}function m(){u(),n.uebernimm(f())}function h(){u(),n.verwirf()}function ee(e){e.key===`Escape`&&(e.preventDefault(),h())}window.addEventListener(`pointermove`,p),window.addEventListener(`pointerup`,m),window.addEventListener(`pointercancel`,h),window.addEventListener(`keydown`,ee),window.addEventListener(`blur`,h)}function Ns(e,t){return Array.from({length:Math.max(0,e-1)},(e,n)=>b`<span
    class="breite-griff"
    role="presentation"
    style="grid-row: 1; grid-column: ${n+1}"
    title="Linie ziehen: links breiter, rechts schmaler"
    @pointerdown=${e=>Ms(e,n,t)}
    @click=${e=>e.stopPropagation()}
    @dblclick=${e=>e.stopPropagation()}
  ></span>`)}function Ps(e){return e.linealTakte===0?S:b`<div class="lineal" role="presentation" style=${W(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>b`<div></div>`)}
        </div>`}function Fs(e,t){return b`
      ${e.zeigeSuche?b`<div class="suchzeile">
        <input
          ...
          @keydown=${e=>{e.key===`ArrowDown`&&fs(e.target)&&e.preventDefault()}}
        />
      </div>`:``}
      ...
      ${e.zeigeKopf?b`<div class="kopf" role="row" style=${W(e.cols)}>
        ${e.spalten.map((n,r)=>b`<div
          ...
          >${e.imEditor&&(e.herkunft[r]??``)!==``?b`<span class="kopf-titel">${n.titel}</span><span
                ...
                >${e.herkunft[r]}</span>`:n.titel}${e.tippbarZeigen&&bs(n)?b`<span class="kopf-tippbar" title="In der Maske tippbar">&#x270E;</span>`:S}${!e.editable&&e.sortSpalte===r?b`<span class="sort-pfeil">${e.sortAuf?` ▲`:` ▼`}</span>`:``}${e.imEditor&&e.editable&&e.spalten.length>1?Vo(n.titel,r,t.loescheSpalte):S}</div>`)}
        ${Ns(e.spalten.length,t.breiten)}
      </div>`:S}
        ${``}
        ...
        ${e.zeilen.map((n,r)=>{let i=n!==null&&!e.imEditor,a=n!==null&&e.zeilenStand.istGeloescht(n),o=n===null?{status:`gebucht`,titel:``}:e.zeilenStand.statusVon(n);return b`<div
            ...
            @keydown=${i=>{if(!i.target.closest(`.zell-eingabe`)){if(i.key===`ArrowDown`||i.key===`ArrowUp`){let e=i.key===`ArrowUp`;(ds(i.target,e?-1:1)||e&&ps(i.target))&&i.preventDefault();return}if(i.key===`Delete`&&e.loeschbar&&n!==null&&!e.imEditor){i.preventDefault(),t.schalteLoeschung(n);return}i.key===`Enter`&&(i.preventDefault(),t.aktiviereZeile(n,r))}}}
          >
            ${``}
            ${e.spalten.map((r,i)=>{let a=n===null?`—`:e.datenzeilen[n]?.[i]??``,o=e.imEditor&&!e.zeigeKopf&&e.editable;if(e.aendernMoeglich&&n!==null&&bs(r)){let t=e.zeilenStand;return b`<div class="tippbar" role="cell">
                <input
...
`,K=class e extends O{constructor(...e){super(...e),this.spalten=ma(),this.spaltenHerkunft=[],this.source=``,this.suche=`ja`,this.erfassung=`nein`,this.blaettern=`ja`,this.loeschbar=`nein`,this.kopfzeile=`ja`,this.leerText=Ra,this.rechnung=``,this.datenzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._besitz=`softengine`,this._breiten=new Map,this._breiteVorZug=null,this._ansicht=new hs({baustein:this,editable:()=>this.editable,zeilenHoehe:()=>this.zeilenHoehe,melde:()=>this.requestUpdate()}),this._erfassung=new po,this._lauf=new Yo(()=>this.requestUpdate()),this._zeilen=new qo({baustein:this,spalten:()=>this.spaltenListe(),rohzeilen:()=>this.rohzeilen,datenzeilen:()=>this.datenzeilen,melde:()=>this.requestUpdate(),lauf:this._lauf,erfassungAn:()=>this.erfassungAn,fokussiereErfassungsZelle:e=>this.fokussiereErfassungsZelle(e)}),this.nimmSeFokus=e=>{e.defaultPrevented||!this.erfassungAn||this.hasAttribute(`data-ff-editor`)||(e.preventDefault(),this.fokussiereErfassungsZelle(0))}}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.kannErfassen={wenn:{attributeName:`erfassung`,equals:`ja`}}}static{this.aenderungsSchluessel=`aenderbar`}static{this.kannLoeschen={wenn:{attributeName:`loeschbar`,equals:`ja`}}}static{this.blockEvents=[{key:`onRowClick`,name:`Zeile gewählt`},{key:`onRowDblClick`,name:`Zeile doppelt geklickt`}]}static{this.listenBindung=ys}static{this.defaultProps={width:`fill`,source:``,spalten:ma(),suche:`ja`,erfassung:`nein`,blaettern:`ja`,loeschbar:`nein`,kopfzeile:`ja`,tagField:``,rechnung:``,leerText:Ra}}static{this.customProperties=Ds}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?wo(this):Co(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=ho(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.nachPush(),this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.zuruecksetzen(),this._erfassung.zuruecksetzen()}get erfassteZeilen(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.werte)}get erfassteSchluessel(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.kennung)}get geaenderteZeilen(){return this._zeilen.geaenderteZeilen}get geloeschteZeilen(){return this._zeilen.geloeschteZeilen}zeileSchreibt(e,t){this._lauf.schreibt(e,t)}zeileGescheitert(e,t,n){this._lauf.gescheitert(e,t,n)}laufFertig(e,t){if(this._lauf.fertig(e,t),e===`erfasst`){this._erfassung.markiereGeschrieben(this.erfassungsUmfeld(),t)&&this.requestUpdate();return}this._zeilen.austragen(e,t)}vergissGeschriebene(){this._erfassung.vergissGeschriebene()&&this.requestUpdate()}erfasstStand(e){return this._lauf.zeigt(`erfasst`,this._erfassung.schluessel[e]??``,this._erfassung.istGeschrieben(e)?`geschrieben`:`erfasst`)}erfasseZeile(){return this._erfassung.erfasse(this.erfassungsUmfeld())?(this.requestUpdate(),this.fokussiereErfassungsZelle(0),this.zeigeLetzteErfasste(),!0):!1}zeigeLetzteErfasste(){this.updateComplete.then(()=>{let e=this.shadowRoot?.querySelector(`.koerper`);e&&(e.scrollTop=e.scrollHeight)})}fokussiereSuche(){return this._ansicht.fokussiereSuche()}setzeSuchtext(e){this._ansicht.setzeSuchtext(e),this.requestUpdate()}get hatQuelle(){return this._besitz===`provided`||Eo(this.hasAttribute(`data-ff-editor`),this.source)}spaltenListe(){return _a(this.spalten)}get zeilenHoehe(){return 28}breitenWirt(){let e=e=>{this._breiteVorZug===null&&(this._breiteVorZug=new Map(e.map(e=>[e.index,this._breiten.get(e.index)])))};return{zeige:t=>{e(t);for(let e of t)this._breiten.set(e.index,e.breite);this.requestUpdate()},uebernimm:e=>{this._breiteVorZug=null;let t=this.spaltenListe();if(!this.hasAttribute(`data-ff-editor`)){for(let t of e)this._breiten.set(t.index,t.breite);this.requestUpdate();return}for(let n of e)n.index>=t.length||(this._breiten.delete(n.index),t[n.index]={...t[n.index],breite:n.breite});this.aendere(t)},verwirf:()=>{let e=this._breiteVorZug;if(this._breiteVorZug=null,e){for(let[t,n]of e)n===void 0?this._breiten.delete(t):this._breiten.set(t,n);this.requestUpdate()}}}}get erfassungAn(){return this.erfassung===`ja`}erfassungsWirt(){return{baustein:this,lauf:this._erfassung.lauf,umfeld:()=>this.erfassungsUmfeld(),melde:()=>this.requestUpdate(),fokussiere:e=>this.fokussiereErfassungsZelle(e),erfasseZeile:()=>this.erfasseZeile()}}fokussiereErfassungsZelle(e){this.updateComplete.then(()=>{let t=this.shadowRoot?.querySelectorAll(`.zeile.erfassung .erf-eingabe`)?.[e];t&&(t.focus(),t.scrollIntoView({block:`nearest`}))})}erfassungsUmfeld(){return this._erfassung.umfeld(this,this.spaltenListe(),this.source,Fa(this.rechnung))}aendere(e){let t=Ao(this.rechnung,this.spaltenListe(),e);if(t===null){this.meldeProp(`spalten`,e);return}this.meldeProp(`rechnung`,t,`beginn`),this.meldeProp(`spalten`,e,`ende`)}meldeProp(e,t,n){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:e,value:t,...n===void 0?{}:{geste:n}},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&Co(this),document.addEventListener(Rn,this.nimmSeFokus),this._ansicht.beobachte()}firstUpdated(){this._ansicht.beobachte()}willUpdate(e){super.willUpdate(e),e.has(`spalten`)&&this._breiten.clear(),!(!this.erfassungAn||this.hasAttribute(`data-ff-editor`))&&this._erfassung.lauf.aktualisiereVorschlaege(this.erfassungsUmfeld())}updated(){this._ansicht.nachRendern(),Fr(this)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(Rn,this.nimmSeFokus),Bo(this),this._ansicht.loese(),tc(this),wo(this)}static{this.styles=[O.styles,Va,Is,fi,mo]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=Es({spalten:t,breiteVon:e=>this._breiten.get(e),hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._ansicht.suchtext,sortSpalte:this._ansicht.sortSpalte,sortAuf:this._ansicht.sortAuf,wunschSeite:this._ansicht.seite,gemessen:this._ansicht.mass,erfassungAn:this.erfassungAn,erfassteAnzahl:this._erfassung.zeilen.length,wertVon:(e,t)=>this._zeilen.zellWert(e,t),blaettert:this.blaettern===`ja`});return b`<div class="tabelle" style=${W({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
    ...
    </div>`}};D([T({converter:{fromAttribute:e=>e?va(e):ma(),toAttribute:e=>JSON.stringify(e)}})],K.prototype,`spalten`,void 0),D([T({attribute:!1})],K.prototype,`spaltenHerkunft`,void 0),D([T()],K.prototype,`source`,void 0),D([T()],K.prototype,`suche`,void 0),D([T()],K.prototype,`erfassung`,void 0),D([T()],K.prototype,`blaettern`,void 0),D([T()],K.prototype,`loeschbar`,void 0),D([T()],K.prototype,`kopfzeile`,void 0),D([T()],K.prototype,`leerText`,void 0),D([T()],K.prototype,`rechnung`,void 0),D([T({attribute:!1})],K.prototype,`datenzeilen`,void 0),D([T({attribute:!1})],K.prototype,`rohzeilen`,void 0),D([T({attribute:!1})],K.prototype,`auswahlIndex`,void 0),D([T({attribute:!1})],K.prototype,`durchAuswahlGefiltert`,void 0),D([T({attribute:!1})],K.prototype,`datenGeliefert`,void 0),O.defineAndRegister(K);function Ls(e){return Math.min(900,Math.max(520,160+180*e))}function Rs(e){return b`<div class="nachschlag">
    <input
      class="ctrl"
      type="text"
      .value=${e.wert}
    ...
    >${ca()}</button>
    ${e.liste}
  </div>`}var zs={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:la,quelleProp:`nachschlagQuelle`};function Bs(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?_a(e):[]}function Vs(e,t){let n=e[0];return n===void 0?t:n.feld}function Hs(e,t){let n=e.trim();return n===``||n===t.trim()}function Us(e,t,n){let r=t.trim(),i=[],a=Hs(t,n),o=new Set;for(let t of e){let e=M(t,n).trim(),s=r===``?e:M(t,r).trim();if(!(s===``&&e===``)){if(a){if(o.has(e))continue;o.add(e)}i.push({anzeige:s,wert:e,satz:t})}}return i}function Ws(e,t,n,r){return Us(Xt(e,t).rows,n,r)}function Gs(e){let t=j(B().FF_DATA_SOURCES,e);return t?Et(B().SEDATA,t.name,t.tableId,t.offenerSatz):null}function Ks(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=Gs(e.quelleId);if(t===null)return{ok:!1,grund:`quelleFehlt`};let n=Vs(Bs([...e.spalten]),e.speicherFeld);return{ok:!0,eintraege:Ws(e.el,t,n,e.speicherFeld)}}function qs(e,t){return t&&e.length===1?e[0]:null}function Js(e,t){let{rows:n,gefiltert:r}=Xt(e,[t]);return!r||n.length>0}function Ys(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var Xs=null,Zs=null,Qs=null;function $s(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function ec(e=!0){let t=e?Qs:null;Qs=null,Xs?.remove(),Xs=null,Zs=null,t?.focus()}function tc(e){Zs===e&&ec(!1)}function nc(e){return[{kennung:``,titel:e.speicherTitel===``?`Wert`:e.speicherTitel,feld:e.speicherFeld}]}function rc(e){let t=e=>e.stopPropagation(),n=e.editor;return b`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >${e.inhalt}</ff-dialog-rahmen>`}function ic(e,t){let n=Bs([...e.spalten]),r=Hs(Vs(n,e.speicherFeld),e.speicherFeld);return b`<ff-tabelle
    fuellt
    suche="ja"
    style="--se-r-lg:0px"
    .besitz=${`provided`}
  ...
  ></ff-tabelle>`}function ac(e){let t=e.eintraege;if(t===void 0){let n=Ks(e);if(!n.ok){z(n.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}t=n.eintraege}ec(!1);let n=document.createElement(`div`);n.style.display=`contents`,ze(rc({titel:e.titel,breite:e.breite,hoehe:e.hoehe,inhalt:ic(e,t),onSchliessen:()=>ec()}),n);let r=n.querySelector(Qt),i=n.querySelector(K.tagName);i?.addEventListener(ss,n=>{let r=n.detail,i=t[r.rohIndex];i&&(ec(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),Qs=e.rueckFokus??$s(e.el),document.body.appendChild(n),Xs=n,Zs=e.el;let a=e.suchtext??``;i&&a!==``&&i.setzeSuchtext(a),r&&i&&Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}function oc(e){return rc({titel:e.titel,breite:e.breite,hoehe:e.hoehe,onSchliessen:e.onSchliessen,editor:{onGroesse:e.onGroesse},inhalt:b`<ff-tabelle
      data-ff-editor
      fuellt
      suche="ja"
      style="--se-r-lg:0px"
      .spalten=${[...e.spalten]}
      .editable=${!0}
      @ff-prop-change=${t=>{t.stopPropagation();let n=t.detail;n?.attr===`spalten`&&e.onAendern(_a(n.value))}}
    ...
    </div>`}connectedCallback(){super.connectedCallback(),ta(this)}disconnectedCallback(){super.disconnectedCallback(),na(this),tc(this)}};D([T()],q.prototype,`fieldType`,void 0),D([T()],q.prototype,`placeholder`,void 0),D([T()],q.prototype,`options`,void 0),D([T()],q.prototype,`source`,void 0),D([T()],q.prototype,`value`,void 0),D([T()],q.prototype,`valueField`,void 0),D([T()],q.prototype,`nachschlagQuelle`,void 0),D([T()],q.prototype,`speicherFeld`,void 0),D([T()],q.prototype,`speicherTitel`,void 0),D([T({converter:{fromAttribute:e=>Bs(e??``),toAttribute:e=>JSON.stringify(e)}})],q.prototype,`nachschlagSpalten`,void 0),D([T({type:Number})],q.prototype,`fensterBreite`,void 0),D([T({type:Number})],q.prototype,`fensterHoehe`,void 0),D([T()],q.prototype,`einzigerTreffer`,void 0),D([E()],q.prototype,`spaltenDialog`,void 0),D([E()],q.prototype,`anzeige`,void 0),D([E()],q.prototype,`getippt`,void 0),D([E()],q.prototype,`marke`,void 0),D([E()],q.prototype,`listeZu`,void 0),D([E()],q.prototype,`angehakt`,void 0),D([E()],q.prototype,`imSteuerelement`,void 0),O.defineAndRegister(q);var sc=`ziel`,cc=o`
...
`,uc=`frei · hierher ziehen`,dc=`ff-zimmer-inhalt`,J=class extends O{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[H.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[O.styles,Va,lc,cc,o`
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(dc,{bubbles:!0,composed:!0}))}render(){return b`<div class="zimmer ${sc}">
      <div
        class="kopf"
        data-ff-editable
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(dc,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(H.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return b`<div class="col ${sc} v-${Rr(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};D([T()],Y.prototype,`variant`,void 0),D([T()],Y.prototype,`heading`,void 0),D([T({attribute:!1})],Y.prototype,`leerHinweis`,void 0),D([E()],Y.prototype,`_count`,void 0),O.defineAndRegister(Y);function fc(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function pc(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var mc=new WeakMap,hc=Y.tagName,gc=J.tagName,_c=H.tagName;function vc(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===hc)}function yc(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===_c)}function bc(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===gc)}function xc(e){return[e,...bc(e)]}function Sc(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=bc(e);for(let e of t)r(e,yc(e).length===0?uc:``);r(e,t.length===0&&yc(e).length===0?n:``)}}function Cc(e){return qe().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function wc(e,t){let n=bc(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??J.defaultProps.heading),a=fc(M(t,r),i);return a>=0?n[a]:n[0]}function Tc(e){Z?.board===e&&jc();let t=e.getAttribute(`statusfield`)??``,n=_o(e);if(!n)return;let r=vc(e);if(r.length===0)return;let i=mc.get(e);if(!i){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(_c);t&&(i=t.cloneNode(!0),mc.set(e,i))}if(!i)return;let a=n.zeilen,o=r.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),s=Cc(i.tagName),c=pc(r.map(e=>e.getAttribute(`auffang`))),l=n.lies;for(let e of r)for(let t of xc(e))yc(t).forEach(e=>e.remove());for(let e of a){let a=i.cloneNode(!0),u=t===``?-1:fc(M(e,t),o),d=u>=0?r[u]:c>=0?r[c]:r[0];(wc(d,e)??d).appendChild(a);for(let t of s){let n=a.getAttribute(yi(t.prop))??``;n!==``&&(a[t.prop]=l(e,n))}let f=xt(n.quelle,e);X.set(a,{row:e,pindex:f}),a.draggable=!0}Sc(e,r);let u=r.flatMap(e=>xc(e).flatMap(yc)),d=Ut(F(e),u,e=>X.get(e)?.row);for(let e of d)u[e].setAttribute(`data-ff-auswahl`,``)}var X=new WeakMap,Z=null,Ec=new WeakSet,Dc=`data-ff-zieht`,Oc=`data-ff-ziel`,kc=null;function Ac(e){kc!==e&&(kc?.removeAttribute(Oc),kc=e,kc?.setAttribute(Oc,``))}function jc(){Z?.card.removeAttribute(Dc),Z=null,Ac(null)}function Mc(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function Nc(e,t){return Mc(e,t,hc)}function Pc(e,t,n){if(!Z||Z.board!==e)return;let r=X.get(Z.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;Er(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(vr)}function Fc(e){Ec.has(e)||(Ec.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;if(!n)return;let r=X.get(n);r&&Wt(F(e),r.row),Er(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(vr)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{Z?.card===n&&n.setAttribute(Dc,``)},0))}),e.addEventListener(`dragend`,jc),e.addEventListener(`dragover`,t=>{let n=Nc(e,t);if(Z?.board!==e||!n){Ac(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),Ac(Mc(e,t,gc)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&Ac(null)}),e.addEventListener(`drop`,t=>{let n=Nc(e,t);n&&(t.preventDefault(),Pc(e,n,Mc(e,t,gc)),jc())}))}var Ic=zi({hydriere:Tc,verdrahte:Fc}),Lc=Ic.connect,Rc=Ic.disconnect,zc=Y.blockType,Bc=class extends O{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[zc]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:zc}}static{this.templateChild={type:H.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:Ra}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Feld, das die Spalte bestimmt. Leer: alle in die Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Einträge des gewählten Tages.`,kind:`field`},za()]}static{this.defaultChildren=[{type:zc,props:{heading:`Offen`,variant:`warning`},children:[{type:H.blockType}]},{type:zc,props:{heading:`In Arbeit`,variant:`info`}},{type:zc,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[O.styles,o`
    ...
    `]}render(){return b`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),Lc(this)}disconnectedCallback(){super.disconnectedCallback(),Rc(this)}};O.defineAndRegister(Bc);var Vc={breite:56,breiteOffen:224},Hc=`ff-seiten-wechsel`,Uc=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],Q=class extends O{static{this.blockType=`navi-eintrag`}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:Uc.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[O.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(Hc,{detail:e,bubbles:!0,composed:!0}))}render(){return b`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};D([T()],Q.prototype,`seite`,void 0),D([T()],Q.prototype,`seitename`,void 0),D([T({reflect:!0})],Q.prototype,`ton`,void 0),O.defineAndRegister(Q);var Wc=`aktiv`;function Gc(e){return Array.from(e.querySelectorAll(Q.tagName))}function Kc(e,t){let n=Gc(e),r=t??n.find(e=>e.hasAttribute(Wc))??n[0];for(let e of n)e===r?e.setAttribute(Wc,``):e.removeAttribute(Wc)}function qc(e){let t=e.hasAttribute(`offen`);for(let n of Gc(e))n.toggleAttribute(`breit`,t)}function Jc(e){return e.getAttribute(`name`)??String(st.defaultProps.name)}function Yc(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function Xc(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(st.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=Yc(e,i);if(!a)return;let o=r.find(e=>Jc(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var Zc=new WeakMap,Qc=new WeakSet;function $c(e){let t=t=>{let n=t.detail;n&&(Kc(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),qc(e),!e.hasAttribute(`data-ff-editor`)&&Xc(e,n.ansicht))};e.addEventListener(Hc,t),Zc.set(e,t)}function el(e){let t=Zc.get(e);t&&(e.removeEventListener(Hc,t),Zc.delete(e))}function tl(e){if(Kc(e),qc(e),e.hasAttribute(`data-ff-editor`)||Qc.has(e))return;let t=Gc(e)[0];if(!t)return;Qc.add(e);let n=()=>Xc(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var nl=Q.blockType,rl=class extends O{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[nl]}static{this.addChildButton={label:`Eintrag`,childType:nl}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[ot]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[O.styles,o`
      :host {
        height: 100%;
        width: ${Vc.breite}px;
    ...
    `]}connectedCallback(){super.connectedCallback(),$c(this)}disconnectedCallback(){super.disconnectedCallback(),el(this)}klappen(){this.toggleAttribute(`offen`),qc(this)}render(){return b`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
        ...
        <div class="eintraege">
          <slot @slotchange=${()=>tl(this)}></slot>
        </div>
      </div>`}};O.defineAndRegister(rl);var il=yi(`text`);function al(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(il)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function ol(e){let t=Gi(e,il);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function sl(e){al(e)&&(e.text=``)}var cl=zi({hydriere:ol,verdrahte:sl}),ll=cl.connect,ul=cl.disconnect,dl=6,fl=96,pl=14,ml={duenn:`300`,normal:`400`,fett:`700`},hl={links:`left`,mitte:`center`,rechts:`right`},gl={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},_l=`standard`;function vl(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(fl,Math.max(dl,t)):pl}function yl(e){return typeof e==`string`&&e in ml?e:`normal`}function bl(e){return typeof e==`string`&&e in hl?e:`links`}function xl(e){return typeof e==`string`&&e in gl?e:_l}var $=class extends O{constructor(...e){super(...e),this.groesse=pl,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=_l,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:pl,gewicht:`normal`,ausrichtung:`links`,farbe:_l,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:dl,max:fl,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[O.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return b`<div
      class="text"
      style=${W({fontSize:`${vl(this.groesse)}px`,fontWeight:ml[yl(this.gewicht)],textAlign:hl[bl(this.ausrichtung)],color:gl[xl(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),ll(this)}disconnectedCallback(){super.disconnectedCallback(),ul(this)}};D([T({type:Number})],$.prototype,`groesse`,void 0),D([T()],$.prototype,`gewicht`,void 0),D([T()],$.prototype,`ausrichtung`,void 0),D([T()],$.prototype,`farbe`,void 0),D([T()],$.prototype,`text`,void 0),D([T()],$.prototype,`source`,void 0),D([T()],$.prototype,`textField`,void 0),O.defineAndRegister($);var Sl=[`waagerecht`,`senkrecht`],Cl=`waagerecht`;function wl(e){return Sl.includes(e)?e:Cl}var Tl=class extends O{constructor(...e){super(...e),this.richtung=Cl}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:Cl}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[O.styles,o`
    ...
    `]}render(){return b`<div class="flaeche ${wl(this.richtung)}"><div class="linie"></div></div>`}};D([T()],Tl.prototype,`richtung`,void 0),O.defineAndRegister(Tl),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;z(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();