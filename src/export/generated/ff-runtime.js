...
`;function Na(e){if(!e.hasAttribute(`fuellt`))return-1;let t=e.renderRoot.querySelector(`.koerper`);return t instanceof HTMLElement?t.clientHeight:-1}function Pa(e,t){let n=Na(e);if(n===-1)return{mass:null,hoehe:n};let r=e.renderRoot.querySelector(`.kopf`);return{mass:Ri(n,r instanceof HTMLElement?r.offsetHeight:0,t),hoehe:n}}function Fa(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function Ia(e,t){let n=(e?.feld??``).trim();if(n===``)return{art:`frei`,quelleId:``,code:``};let{quelleId:r,code:i}=Zr(n);return r===``?{art:`eigen`,quelleId:t,code:i}:{art:`verknuepft`,quelleId:r,code:i}}function K(e,t){return Ia(e.spalten[t],e.quelleId)}function La(e){let t=[];for(let n of e.spalten){let r=Ia(n,e.quelleId);r.art!==`verknuepft`||r.quelleId===``||t.includes(r.quelleId)||t.push(r.quelleId)}return t}function Ra(e,t){let n=K(e,t);if(!(n.quelleId===``||n.code===``))for(let r=0;r<e.spalten.length;r++){if(r===t)continue;let i=e.spalten[r],a=Ia(i,e.quelleId);if(a.quelleId===n.quelleId&&!(a.code===``||a.code===n.code))return{titel:i.titel,code:a.code}}}function za(e,t){let n=e.spalten[t],r=Ra(e,t);return n===void 0||r===void 0?[]:[{titel:r.titel,feld:r.code,art:H},{titel:n.titel,feld:K(e,t).code,art:H}]}function Ba(e,t,n){let r=e.map(e=>({toField:e.toField,soll:t(e.fromField)})).filter(e=>e.soll!==void 0);return r.length===0?[...n]:n.filter(e=>r.every(t=>t.soll!==``&&t.soll===O(e,t.toField)))}function Va(e,t,n){return g`<input
    class="erf-eingabe"
    type="text"
    ...
    @blur=${()=>t.verlassen(n)}
  />`}function Ha(e,t,n,r){if(r)return Va(e,t,n);let i=e.tippSpalte===n&&e.vorschlaege.length>0;return g`<div class=${e.listeNachOben?`erf-halter nach-oben`:`erf-halter`}>
    ${Va(e,t,n)}
    ${i?Kr({eintraege:e.vorschlaege,marke:e.marke,onWaehlen:e=>t.waehleVorschlag(e),onMarke:e=>t.setzeMarke(e)}):v}
  </div>`}function Ua(e,t){return g`<div class="zeile erfassung" role="row" style=${G(e.cols)}>
    ${e.spalten.map((n,r)=>{let i=U(n.art).klasse;return e.imEditor?g`<div class=${i} role="cell">${`—`}</div>`:g`<div class=${i} role="cell">${Ha(e,t,r,Ia(n,e.quelleId).art===`frei`)}</div>`})}
  </div>`}function Wa(e,t,n){let r=e.lauf.vorschlaege[n];r!==void 0&&(e.lauf.uebernimm(e.umfeld(),t,r.satz),e.melde())}function Ga(e,t){let n=e.umfeld(),r=n.spalten[t],i=K(n,t);r===void 0||i.quelleId===``||i.code===``||ds({el:e.baustein,quelleId:i.quelleId,speicherFeld:i.code,speicherTitel:r.titel,spalten:za(n,t),titel:r.titel,breite:520,hoehe:380,eintraege:e.lauf.eintraege(n,t),rueckFokus:null,onUebernehmen:(n,r,i)=>{e.lauf.uebernimm(e.umfeld(),t,i),e.melde()}})}function Ka(e,t,n){let r=e.umfeld();if(n===`Tab`){let n=t+1;return n>=r.spalten.length?!1:(e.fokussiere(n),!0)}let i=e.lauf.naechsteLeere(r,t);return i===-1?n===`Enter`&&e.erfasseZeile():e.fokussiere(i),!0}function qa(e,t,n){if(n.key===`Tab`&&n.shiftKey)return;let r=n.key===`ArrowDown`&&n.altKey?`F4`:n.key,i=e.lauf.entscheideTaste(e.umfeld(),t,r);if(i===`nichts`){n.key===`Enter`&&n.preventDefault();return}let a=!0;i===`uebernehmen`?(Wa(e,t,e.lauf.marke),a=Ka(e,t,n.key)):i===`fenster`?Ga(e,t):i===`liste-auf`?e.lauf.oeffneListe(t):i===`weiter`?a=Ka(e,t,n.key):i===`leeren`&&e.lauf.leere(e.umfeld(),t),a&&n.preventDefault(),e.melde()}function Ja(e,t,n){let r=e.umfeld();return Ua({spalten:r.spalten,quelleId:r.quelleId,cols:t,imEditor:e.baustein.hasAttribute(`data-ff-editor`),wert:t=>e.lauf.wertVon(r,t),tippSpalte:e.lauf.tippSpalte,vorschlaege:e.lauf.vorschlaege,marke:e.lauf.marke,listeNachOben:n},{tippen:(t,n)=>{e.lauf.tippe(t,n),e.melde()},taste:(t,n)=>qa(e,t,n),verlassen:t=>{e.lauf.verlasse(t),e.melde()},waehleVorschlag:t=>Wa(e,e.lauf.tippSpalte,t),setzeMarke:t=>{e.lauf.setzeMarke(t),e.melde()}})}var Ya=class{constructor(){this.getippt=new Map,this.gewaehlt=new Map,this.vonHand=new Set,this._tippSpalte=-1,this._marke=0,this._listeZu=!1,this._listeAuf=-1,this._vorschlaege=[]}get tippSpalte(){return this._tippSpalte}get marke(){return this._marke}get vorschlaege(){return this._vorschlaege}wertVon(e,t){let n=this.getippt.get(t);if(n!==void 0)return n;let r=K(e,t);if(r.quelleId===``||r.code===``)return``;let i=this.gewaehlt.get(r.quelleId);return i===void 0?``:O(i,r.code)}tippe(e,t){this.getippt.set(e,t),this._tippSpalte=e,this._marke=0,this._listeZu=!1}verlasse(e){this._tippSpalte===e&&(this._tippSpalte=-1,this._listeZu=!1,this._listeAuf=-1,this._marke=0)}entscheideTaste(e,t,n){let r=this._tippSpalte===t&&this._vorschlaege.length>0;if(n===`Tab`){if(!r)return`weiter`;n=`Enter`}if(n===`F4`)return K(e,t).art===`frei`||this.eintraege(e,t).length===0?`nichts`:`fenster`;let i=this.wertVon(e,t);if(n===`Escape`&&!r)return i===``?`nichts`:`leeren`;if(K(e,t).art===`frei`)return n===`Enter`?`weiter`:`nichts`;if(n===`ArrowDown`&&!r)return K(e,t).art===`verknuepft`?`liste-auf`:`nichts`;let a=Gr(n,{listeOffen:r,feldLeer:i===``});if(a===`marke-hoch`)this._marke=Ur(this._marke,this._vorschlaege.length,-1);else if(a===`marke-runter`)this._marke=Ur(this._marke,this._vorschlaege.length,1);else if(a===`liste-zu`)this._listeZu=!0,this._listeAuf=-1;else if(a===`fenster`&&this.eintraege(e,t).length===0)return`weiter`;else if(a===`nichts`&&n===`Enter`&&i!==``&&this.getippt.get(t)===void 0)return`weiter`;return a}oeffneListe(e){this._tippSpalte=e,this._listeZu=!1,this._listeAuf=e,this._marke=0}naechsteLeere(e,t){for(let n=t+1;n<e.spalten.length;n++)if(this.wertVon(e,n)===``)return n;return-1}leere(e,t){this.getippt.delete(t);let n=K(e,t);n.quelleId!==``&&this.gewaehlt.has(n.quelleId)&&this.setze(e,n.quelleId,void 0),this._listeZu=!1,this._marke=0}setzeMarke(e){this._marke=e}uebernimm(e,t,n){let r=K(e,t);if(r.quelleId!==``){if(this.setze(e,r.quelleId,n),this.vonHand.add(r.quelleId),r.art===`eigen`)for(let t of[...this.gewaehlt.keys()])t!==r.quelleId&&this.setze(e,t,void 0);this.gleicheAb(e),this._tippSpalte=-1,this._marke=0,this._listeZu=!1}}setze(e,t,n){n===void 0?(this.gewaehlt.delete(t),this.vonHand.delete(t)):this.gewaehlt.set(t,n);for(let n=0;n<e.spalten.length;n++)Ia(e.spalten[n],e.quelleId).quelleId===t&&this.getippt.delete(n)}schluesselWert(e,t,n,r){if(t!==``&&t!==e.quelleId){let e=this.gewaehlt.get(t);return e===void 0?void 0:O(e,n)}let i=this.gewaehlt.get(e.quelleId);if(i!==void 0)return O(i,n);for(let t of La(e)){if(t===r||!this.vonHand.has(t))continue;let i=e.partnerVon(t);if(i!==``&&i!==e.quelleId)continue;let a=this.gewaehlt.get(t);if(a!==void 0)for(let r of e.paareZu(t)){if(r.fromField!==n)continue;let e=O(a,r.toField);if(e!==``)return e}}}moegliche(e,t,n){let r=e.partnerVon(t);return Ba(e.paareZu(t),n=>this.schluesselWert(e,r,n,t),n)}gleicheAb(e){let t=La(e);for(let n=0;n<=t.length;n++){let n=!1;for(let r of t){let t=e.paareZu(r);if(t.length===0)continue;let i=e.partnerVon(r),a=this.gewaehlt.get(r);if(a!==void 0){t.every(t=>{let n=this.schluesselWert(e,i,t.fromField,r);return n===void 0||n!==``&&n===O(a,t.toField)})||(this.setze(e,r,void 0),n=!0);continue}if(!t.some(t=>this.schluesselWert(e,i,t.fromField,r)!==void 0))continue;let o=Zo(r);if(o===null)continue;let s=this.moegliche(e,r,o);s.length===1&&(this.setze(e,r,s[0]),this.vonHand.delete(r),n=!0)}if(!n)break}}zuruecksetzen(){this.getippt.clear(),this.gewaehlt.clear(),this.vonHand.clear(),this._tippSpalte=-1,this._marke=0,this._listeZu=!1,this._listeAuf=-1,this._vorschlaege=[]}aktualisiereVorschlaege(e){this._vorschlaege=this.berechne(e),this._marke=Wr(this._marke,this._vorschlaege.length)}berechne(e){let t=this._tippSpalte;if(this._listeZu||K(e,t).art===`frei`)return[];let n=this.getippt.get(t)??``;return n===``?this._listeAuf===t?this.eintraege(e,t).slice(0,8):[]:Hr(this.eintraege(e,t),n)}eintraege(e,t){let n=K(e,t);if(n.art!==`verknuepft`||n.quelleId===``||n.code===``)return[];let r=Zo(n.quelleId);return r===null?[]:Yo(this.moegliche(e,n.quelleId,r),Ra(e,t)?.code??``,n.code)}},Xa=class{constructor(){this.lauf=new Ya,this._zeilen=[]}get zeilen(){return this._zeilen}umfeld(e,t,n){let r=hi(e);return{spalten:t,quelleId:n,paareZu:e=>r.find(t=>t.quelleId===e)?.keyPairs??[],partnerVon:e=>r.find(t=>t.quelleId===e)?.partnerId??``}}erfasse(e){let t=e.spalten.map((t,n)=>this.lauf.wertVon(e,n));return t.every(e=>e===``)?!1:(this._zeilen=[...this._zeilen,t],this.lauf.zuruecksetzen(),!0)}entferne(e){return e<0||e>=this._zeilen.length?!1:(this._zeilen=this._zeilen.filter((t,n)=>n!==e),!0)}leeren(){return this._zeilen.length===0?!1:(this._zeilen=[],!0)}zuruecksetzen(){this._zeilen=[],this.lauf.zuruecksetzen()}},Za=o`
      .zeile.erfassung {
        flex: none;
        background: var(--se-panel-2);
...
`;function Qa(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen]),zusatzzeilen:e.map(e=>(e.zusatz??[]).map(e=>({...e})))}}function $a(e,t,n){return t===``||n===``?[...e]:e.filter(e=>jr(O(e,t))===n)}function eo(e){let t=e.getAttribute(`source`)??``;if(t===``)return null;let n=D(I().FF_DATA_SOURCES,t);return n?{quelle:n,zeilen:$a(kt(I().SEDATA,n.name,n.tableId,n.offenerSatz),e.getAttribute(`tagfield`)??``,Ir()),lies:gi(e)}:null}function to(e){return Ca(e.getAttribute(`spalten`)??``)}function no(e,t,n){let r={};for(let i of U(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function ro(e,t){let n=D(I().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?wt(n,t):``}function io(e){let t=D(I().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return t!==void 0&&t.indexField!==``}function ao(e){let t=eo(e);if(!t){e.datenzeilen=[],e.zusatzzeilen=[];return}let n=to(e),{rows:r,gefiltert:i}=Zt(e,t.zeilen),a=Wt(j(e),r,e=>e)[0]??-1,o=t.lies;e.datenGeliefert=!0,e.rohzeilen=r,e.auswahlIndex=a,e.durchAuswahlGefiltert=i,e.datenzeilen=r.map(e=>n.map(t=>t.feld===``?``:o(e,t.feld))),e.zusatzzeilen=r.map(e=>n.map(t=>no(t,e,o)))}var oo=di({hydriere:ao}),so=oo.connect,co=oo.disconnect;function lo(e,t){let n=[];return e.forEach((e,r)=>{Vr(e,t)&&n.push(r)}),n}function uo(e,t){return!e&&t.trim()!==``}function fo(e,t,n){return e&&t&&n===0}function po(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function mo(e,t,n){return g`<div class="steuerung">
    <button
    ...
    ${e.vorgemerkt===0&&e.loeschungen===0?v:g`<div class="vorgemerkt">${wo(e.vorgemerkt,e.loeschungen)}</div>`}
    ...
    ${e.blaettert?g`<div class="seiten-nav">
  ...
  </div>`}var jo=/[.*+?^${}()|[\]\\]/g;function Mo(e,t){let n=Br(t);if(n.length===0||e===``)return e;let r;try{r=RegExp(`(${n.map(e=>e.replace(jo,`\\$&`)).join(`|`)})`,`ig`)}catch{return e}let i=e.split(r);return i.length<=1?e:g`${i.map((e,t)=>t%2==1?g`<mark>${e}</mark>`:e)}`}var No=`ff-zeile-aktiviert`,Po=`data-ff-roh`;function Fo(e,t){e.dispatchEvent(new CustomEvent(No,{detail:t,bubbles:!0,composed:!0}))}function Io(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(Po);return r===null||r===``?null:Number(r)}function Lo(e,t){if(!(e instanceof HTMLElement))return!1;let n=e.closest(`.zeile`),r=n?.parentElement;if(!n||!r)return!1;let i=[...r.querySelectorAll(`.zeile[${Po}]`)],a=i.indexOf(n),o=a===-1?void 0:i[a+t];return o?(o.focus(),!0):!1}function Ro(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.zeile[${Po}]`);return t?(t.focus(),!0):!1}function zo(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.suchzeile input`);return t?(t.focus(),!0):!1}function Bo(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}function Vo(e){return e.linealTakte===0?v:g`<div class="lineal" role="presentation" style=${G(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>g`<div></div>`)}
        </div>`}function Ho(e,t){return g`
      ${e.zeigeSuche?g`<div class="suchzeile">
        <input
          ...
          @keydown=${e=>{e.key===`ArrowDown`&&Ro(e.target)&&e.preventDefault()}}
        />
      </div>`:``}
      ...
      ${e.zeigeKopf?g`<div class="kopf" role="row" style=${G(e.cols)}>
        ...
        ${e.zeilen.map((n,r)=>{let i=n!==null&&!e.imEditor,a=n!==null&&e.istGeloescht(n);return g`<div
            ...
            @keydown=${e=>{if(!e.target.closest(`.zell-eingabe`)){if(e.key===`ArrowDown`||e.key===`ArrowUp`){let t=e.key===`ArrowUp`;(Lo(e.target,t?-1:1)||t&&zo(e.target))&&e.preventDefault();return}e.key===`Enter`&&(e.preventDefault(),t.aktiviereZeile(n,r))}}}
          >
            ${``}
            ${e.spalten.map((r,i)=>{let a=U(r.art),o=n===null?`—`:e.datenzeilen[n]?.[i]??``,s=n===null?{}:e.zusatzzeilen[n]?.[i]??{},c=e.imEditor&&!e.zeigeKopf&&e.editable;if(e.aendernMoeglich&&r.aenderbar===!0&&n!==null)return g`<div class=${a.klasse} role="cell">
              ...
              >${typeof l==`string`?Mo(l,e.suchtext):l}</div>`})}
...
`,q=class e extends w{constructor(...e){super(...e),this.spalten=va(),this.source=``,this.suche=`ja`,this.erfassung=`nein`,this.blaettern=`ja`,this.loeschbar=`nein`,this.schlank=`nein`,this.kopfzeile=`ja`,this.leerText=ka,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._rumpfGemessen=-1,this._fokusZeile=null,this._fokusHolen=!1,this._besitz=`softengine`,this._erfassung=new Xa,this._aenderungen=new Co,this._geloescht=new Set,this.nimmSeFokus=e=>{e.defaultPrevented||!this.erfassungAn||this.hasAttribute(`data-ff-editor`)||(e.preventDefault(),this.fokussiereErfassungsZelle(0))}}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.kannErfassen={wenn:{attributeName:`erfassung`,equals:`ja`}}}static{this.aenderungsSchluessel=`aenderbar`}static{this.kannLoeschen={wenn:{attributeName:`loeschbar`,equals:`ja`}}}static{this.blockEvents=[{key:`onRowClick`,name:`Zeile gewählt`},{key:`onRowDblClick`,name:`Zeile doppelt geklickt`}]}static{this.listenBindung=To}static{this.defaultProps={width:`fill`,source:``,spalten:va(),suche:`ja`,erfassung:`nein`,blaettern:`ja`,loeschbar:`nein`,schlank:`nein`,kopfzeile:`ja`,tagField:``,leerText:ka}}static{this.customProperties=ko}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?co(this):so(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=Qa(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.zusatzzeilen=t.zusatzzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._seite=0,this._mass=null,this._taktGemessen=0,this._rumpfGemessen=-1,this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.zusatzzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._taktGemessen=0,this._rumpfGemessen=-1,this._fokusZeile=null,this._fokusHolen=!1,this._erfassung.zuruecksetzen()}get erfassteZeilen(){return this._erfassung.zeilen}erfassungLeeren(){this._erfassung.leeren()&&this.requestUpdate()}satzPlaetze(){let e=new Map;return this.rohzeilen.forEach((t,n)=>{let r=ro(this,t);r!==``&&!e.has(r)&&e.set(r,n)}),e}vorgemerkteAnzahl(){if(this._aenderungen.anzahl===0)return 0;let e=this.satzPlaetze(),t=0;for(let n of this._aenderungen.proSatz())e.has(n.satz)&&(t+=n.aenderungen.length);return t}get geaenderteZeilen(){let e=this.spaltenListe().length,t=this.satzPlaetze(),n=[];for(let{satz:r}of this._aenderungen.proSatz()){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}aenderungenLeeren(){this._aenderungen.leeren()&&this.requestUpdate()}get geloeschteZeilen(){let e=this.spaltenListe().length,t=this.satzPlaetze(),n=[];for(let r of this._geloescht){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}loeschungenLeeren(){this._geloescht.size!==0&&(this._geloescht.clear(),this.requestUpdate())}vorgemerkteLoeschungen(){return this.geloeschteZeilen.length}erfasseZeile(){this._erfassung.erfasse(this.erfassungsUmfeld())&&(this.requestUpdate(),this.fokussiereErfassungsZelle(0))}fokussiereSuche(){let e=this.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}get hatQuelle(){return this._besitz===`provided`||uo(this.hasAttribute(`data-ff-editor`),this.source)}merkeZeilenFokus(){let e=Io(this.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let{mass:t,hoehe:n}=Pa(this,e);this._rumpfGemessen=n,!(t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe)&&(this._mass=t,this.requestUpdate())}spaltenListe(){return Sa(this.spalten)}get zeilenHoehe(){return ua(this.spaltenListe())}satzVon(e){let t=this.rohzeilen[e];return t===void 0?``:ro(this,t)}zellAnzeige(e,t){let n=this.spaltenListe()[e];return n===void 0?t:pa(U(n.art),t)}schalteLoeschung(e){let t=this.satzVon(e);t!==``&&(this._geloescht.has(t)?this._geloescht.delete(t):(this._geloescht.add(t),this.spaltenListe().forEach((e,n)=>{this._aenderungen.nimmZurueck(t,n)})),this.requestUpdate())}istGeloescht(e){let t=this.satzVon(e);return t!==``&&this._geloescht.has(t)}zellWert(e,t){let n=this._aenderungen.wert(this.satzVon(e),t);return n===void 0?this.zellAnzeige(t,this.datenzeilen[e]?.[t]??``):n}istGeaendert(e,t){return this._aenderungen.wert(this.satzVon(e),t)!==void 0}tippeZelle(e,t,n){this._aenderungen.setze(this.satzVon(e),t,n)&&this.requestUpdate()}verlasseZelle(e,t,n){let r=this.satzVon(e),i=this.zellAnzeige(t,n);(i===this.zellAnzeige(t,this.datenzeilen[e]?.[t]??``)?this._aenderungen.nimmZurueck(r,t):this._aenderungen.setze(r,t,i))&&this.requestUpdate()}zelleNachbar(e,t,n,r){let i=Array.from(this.shadowRoot?.querySelectorAll(`.koerper > .zeile:not(.erfassung) .zell-eingabe[data-spalte="${e}"]`)??[]),a=i.indexOf(t);if(a<0)return;let o=a+n;if(o>i.length-1){if(r&&this.erfassungAn){this.fokussiereErfassungsZelle(0);return}o=i.length-1}o<0&&(o=0);let s=i[o];!s||s===t||(s.focus(),s.select(),s.scrollIntoView({block:`nearest`}))}tasteZelle(e,t,n){let r=n.target;if(n.key===`Escape`){n.preventDefault(),n.stopPropagation(),this._aenderungen.nimmZurueck(this.satzVon(e),t)&&this.requestUpdate();return}let i={Enter:1,ArrowDown:1,ArrowUp:-1,PageDown:10,PageUp:-10}[n.key];i!==void 0&&(n.preventDefault(),n.stopPropagation(),this.zelleNachbar(t,r,i,n.key===`Enter`))}zeileDoppelt(e){if(e===null||this.hasAttribute(`data-ff-editor`))return;let t=this.rohzeilen[e];t!==void 0&&z(this,`onRowDblClick`,{PINDEX:ro(this,t)}).catch(R)}aktiviereZeile(e,t){if(e===null||this.hasAttribute(`data-ff-editor`))return;let n=this.rohzeilen[e];n!==void 0&&(Fo(this,{rohzeile:n,rohIndex:e,ansichtIndex:t}),this.toggleAuswahl(n),z(this,`onRowClick`,{PINDEX:ro(this,n)}).catch(R))}toggleAuswahl(e){let t=j(this);t!==``&&Gt(t,e)}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this.merkeZeilenFokus(),this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}get erfassungAn(){return this.erfassung===`ja`}fussNoetig(e,t,n,r){return e>1||t>0||n>0||r>0||this._suchtext.trim()!==``||this.durchAuswahlGefiltert}erfassungsWirt(){return{baustein:this,lauf:this._erfassung.lauf,umfeld:()=>this.erfassungsUmfeld(),melde:()=>this.requestUpdate(),fokussiere:e=>this.fokussiereErfassungsZelle(e),erfasseZeile:()=>this.erfasseZeile()}}fokussiereErfassungsZelle(e){this.updateComplete.then(()=>{(this.shadowRoot?.querySelectorAll(`.zeile.erfassung .erf-eingabe`))?.[e]?.focus()})}erfassungsUmfeld(){return this._erfassung.umfeld(this,this.spaltenListe(),this.source)}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=Fa(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&so(this),document.addEventListener(Fn,this.nimmSeFokus),this.beobachte()}firstUpdated(){this.beobachte()}willUpdate(e){super.willUpdate(e),!(!this.erfassungAn||this.hasAttribute(`data-ff-editor`))&&this._erfassung.lauf.aktualisiereVorschlaege(this.erfassungsUmfeld())}updated(){(this._taktGemessen!==this.zeilenHoehe||this._rumpfGemessen!==Na(this))&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,Bo(this.shadowRoot,this._fokusZeile))}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(Fn,this.nimmSeFokus),yo(this),this._beobachter?.disconnect(),this._beobachter=null,ss(this),co(this)}static{this.styles=[w.styles,Sr,Ma,Uo,qr,Za]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=Oo({spalten:t,hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,wunschSeite:this._seite,gemessen:this._mass,erfassungAn:this.erfassungAn,erfassteAnzahl:this._erfassung.zeilen.length,wertVon:(e,t)=>this.zellWert(e,t),blaettert:this.blaettern===`ja`}),i=this.vorgemerkteAnzahl(),a=this.vorgemerkteLoeschungen(),o=[`tabelle`];return this.schlank===`ja`&&o.push(`schlank`),this.blaettern!==`ja`&&o.push(`rollt`),g`<div class=${o.join(` `)} style=${G({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
      ${mo(()=>this.spaltenListe(),e=>this.aendere(e),n)}
      ${Ho({spalten:t,cols:r.cols,editable:this.editable,imEditor:this.hasAttribute(`data-ff-editor`),zeigeKopf:this.kopfzeile===`ja`,auswahlSemantik:j(this)!==``,zeigeSuche:this.suche===`ja`,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,zeilen:r.zeilen,linealTakte:r.linealTakte,datenzeilen:this.datenzeilen,zusatzzeilen:this.zusatzzeilen,hatQuelle:r.hatQuelle,auswahlIndex:this.auswahlIndex,aendernMoeglich:!this.hasAttribute(`data-ff-editor`)&&r.hatQuelle&&io(this),loeschbar:this.loeschbar===`ja`&&!this.hasAttribute(`data-ff-editor`)&&r.hatQuelle&&io(this),istGeloescht:e=>this.istGeloescht(e),zellWert:(e,t)=>this.zellWert(e,t),istGeaendert:(e,t)=>this.istGeaendert(e,t),leer:r.leer,leerText:this.leerText,erfasste:this._erfassung.zeilen,erfassung:this.erfassungAn?Ja(this.erfassungsWirt(),r.cols,(r.linealTakte??1)<=0):v},{setzeSuchtext:e=>this.setzeSuchtext(e),dblklickKopf:(e,t)=>{this.editable&&(yo(this),go(e,t,()=>this.spaltenListe(),e=>this.aendere(e)))},klickKopf:(t,n)=>{this.editable&&bo(this,t,{prop:e.listenBindung.prop,index:n,liste:()=>this.spaltenListe()}),this.klickSortiere(n)},aktiviereZeile:(e,t)=>this.aktiviereZeile(e,t),zeileDoppelt:e=>this.zeileDoppelt(e),nimmErfassteZeile:e=>{this._erfassung.entferne(e)&&this.requestUpdate()},schalteLoeschung:e=>this.schalteLoeschung(e),tippeZelle:(e,t,n)=>this.tippeZelle(e,t,n),verlasseZelle:(e,t,n)=>this.verlasseZelle(e,t,n),tasteZelle:(e,t,n)=>this.tasteZelle(e,t,n)})}
      ${``}
      ${r.leer||!this.fussNoetig(r.seiten,r.summen.length,i,a)?v:Ao({hatQuelle:r.hatQuelle,sichtbar:r.gesamt,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,seite:r.seite,seiten:r.seiten,blaettert:this.blaettern===`ja`,summen:r.summen,vorgemerkt:i,loeschungen:a},{blaettere:e=>{this.merkeZeilenFokus(),this._seite=e,this.requestUpdate()}})}
    </div>`}};C([x({converter:{fromAttribute:e=>e?Ca(e):va(),toAttribute:e=>JSON.stringify(e)}})],q.prototype,`spalten`,void 0),C([x()],q.prototype,`source`,void 0),C([x()],q.prototype,`suche`,void 0),C([x()],q.prototype,`erfassung`,void 0),C([x()],q.prototype,`blaettern`,void 0),C([x()],q.prototype,`loeschbar`,void 0),C([x()],q.prototype,`schlank`,void 0),C([x()],q.prototype,`kopfzeile`,void 0),C([x()],q.prototype,`leerText`,void 0),C([x({attribute:!1})],q.prototype,`datenzeilen`,void 0),C([x({attribute:!1})],q.prototype,`zusatzzeilen`,void 0),C([x({attribute:!1})],q.prototype,`rohzeilen`,void 0),C([x({attribute:!1})],q.prototype,`auswahlIndex`,void 0),C([x({attribute:!1})],q.prototype,`durchAuswahlGefiltert`,void 0),C([x({attribute:!1})],q.prototype,`datenGeliefert`,void 0),w.defineAndRegister(q);function Wo(e){return g`<div class="nachschlag">
    <input
      class="ctrl"
      type="text"
      .value=${e.wert}
    ...
    >${Pi()}</button>
    ${e.liste}
  </div>`}var Go={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:ga,quelleProp:`nachschlagQuelle`};function Ko(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?Sa(e):[]}function qo(e,t){let n=e[0];return n===void 0?t:n.feld}function Jo(e,t){let n=e.trim();return n===``||n===t.trim()}function Yo(e,t,n){let r=t.trim(),i=[],a=Jo(t,n),o=new Set;for(let t of e){let e=O(t,n).trim(),s=r===``?e:O(t,r).trim();if(!(s===``&&e===``)){if(a){if(o.has(e))continue;o.add(e)}i.push({anzeige:s,wert:e,satz:t})}}return i}function Xo(e,t,n,r){return Yo(Zt(e,t).rows,n,r)}function Zo(e){let t=D(I().FF_DATA_SOURCES,e);return t?kt(I().SEDATA,t.name,t.tableId,t.offenerSatz):null}function Qo(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=Zo(e.quelleId);if(t===null)return{ok:!1,grund:`quelleFehlt`};let n=qo(Ko([...e.spalten]),e.speicherFeld);return{ok:!0,eintraege:Xo(e.el,t,n,e.speicherFeld)}}function $o(e,t){return t&&e.length===1?e[0]:null}function es(e,t){let{rows:n,gefiltert:r}=Zt(e,[t]);return!r||n.length>0}function ts(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var ns=null,rs=null,is=null;function as(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function os(e=!0){let t=e?is:null;is=null,ns?.remove(),ns=null,rs=null,t?.focus()}function ss(e){rs===e&&os(!1)}function cs(e){return[{titel:e.speicherTitel===``?`Wert`:e.speicherTitel,feld:e.speicherFeld,art:H}]}function ls(e){let t=e=>e.stopPropagation(),n=e.editor;return g`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >${e.inhalt}</ff-dialog-rahmen>`}function us(e,t){let n=Ko([...e.spalten]),r=Jo(qo(n,e.speicherFeld),e.speicherFeld);return g`<ff-tabelle
    fuellt
    suche="ja"
    style="--se-r-lg:0px"
    .besitz=${`provided`}
    .spalten=${n.length>0?n:cs(e)}
  ...
  ></ff-tabelle>`}function ds(e){let t=e.eintraege;if(t===void 0){let n=Qo(e);if(!n.ok){F(n.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}t=n.eintraege}os(!1);let n=document.createElement(`div`);n.style.display=`contents`,Ue(ls({titel:e.titel,breite:e.breite,hoehe:e.hoehe,inhalt:us(e,t),onSchliessen:()=>os()}),n);let r=n.querySelector($t),i=n.querySelector(q.tagName);i?.addEventListener(No,n=>{let r=n.detail,i=t[r.rohIndex];i&&(os(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),is=e.rueckFokus??as(e.el),document.body.appendChild(n),ns=n,rs=e.el,r&&i&&Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}function fs(e){return ls({titel:e.titel,breite:e.breite,hoehe:e.hoehe,onSchliessen:e.onSchliessen,editor:{onGroesse:e.onGroesse},inhalt:g`<ff-tabelle
      data-ff-editor
      fuellt
      suche="ja"
      style="--se-r-lg:0px"
...
`,gs=`frei · hierher ziehen`,_s=`ff-zimmer-inhalt`,Y=class extends w{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[B.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[w.styles,Ma,hs,ms,o`
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(_s,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(B.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return g`<div class="col ${ps} v-${yr(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};C([x()],X.prototype,`variant`,void 0),C([x()],X.prototype,`heading`,void 0),C([x({attribute:!1})],X.prototype,`leerHinweis`,void 0),C([S()],X.prototype,`_count`,void 0),w.defineAndRegister(X);function vs(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function ys(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var bs=new WeakMap,xs=X.tagName,Ss=Y.tagName,Cs=B.tagName;function ws(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===xs)}function Ts(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Cs)}function Es(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Ss)}function Ds(e){return[e,...Es(e)]}function Os(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=Es(e);for(let e of t)r(e,Ts(e).length===0?gs:``);r(e,t.length===0&&Ts(e).length===0?n:``)}}function ks(e){return Ze().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function As(e,t){let n=Es(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),a=vs(O(t,r),i);return a>=0?n[a]:n[0]}function js(e){Q?.board===e&&Ls();let t=e.getAttribute(`statusfield`)??``,n=eo(e);if(!n)return;let r=ws(e);if(r.length===0)return;let i=bs.get(e);if(!i){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(Cs);t&&(i=t.cloneNode(!0),bs.set(e,i))}if(!i)return;let a=n.zeilen,o=r.map(e=>e.getAttribute(`heading`)??X.defaultProps.heading),s=ks(i.tagName),c=ys(r.map(e=>e.getAttribute(`auffang`))),l=n.lies;for(let e of r)for(let t of Ds(e))Ts(t).forEach(e=>e.remove());for(let e of a){let a=i.cloneNode(!0),u=t===``?-1:vs(O(e,t),o),d=u>=0?r[u]:c>=0?r[c]:r[0];(As(d,e)??d).appendChild(a);for(let t of s){let n=a.getAttribute(Xr(t.prop))??``;n!==``&&(a[t.prop]=l(e,n))}let ee=wt(n.quelle,e);Z.set(a,{row:e,pindex:ee}),a.draggable=!0}Os(e,r);let u=r.flatMap(e=>Ds(e).flatMap(Ts)),d=Wt(j(e),u,e=>Z.get(e)?.row);for(let e of d)u[e].setAttribute(`data-ff-auswahl`,``)}var Z=new WeakMap,Q=null,Ms=new WeakSet,Ns=`data-ff-zieht`,Ps=`data-ff-ziel`,Fs=null;function Is(e){Fs!==e&&(Fs?.removeAttribute(Ps),Fs=e,Fs?.setAttribute(Ps,``))}function Ls(){Q?.card.removeAttribute(Ns),Q=null,Is(null)}function Rs(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function zs(e,t){return Rs(e,t,xs)}function Bs(e,t,n){if(!Q||Q.board!==e)return;let r=Z.get(Q.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;z(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(R)}function Vs(e){Ms.has(e)||(Ms.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Z.has(e))??null;if(!n)return;let r=Z.get(n);r&&Gt(j(e),r.row),z(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(R)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Z.has(e))??null;n&&(Q={card:n,board:e},t.dataTransfer?.setData(`text/plain`,Z.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{Q?.card===n&&n.setAttribute(Ns,``)},0))}),e.addEventListener(`dragend`,Ls),e.addEventListener(`dragover`,t=>{let n=zs(e,t);if(Q?.board!==e||!n){Is(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),Is(Rs(e,t,Ss)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&Is(null)}),e.addEventListener(`drop`,t=>{let n=zs(e,t);n&&(t.preventDefault(),Bs(e,n,Rs(e,t,Ss)),Ls())}))}var Hs=di({hydriere:js,verdrahte:Vs}),Us=Hs.connect,Ws=Hs.disconnect,Gs=X.blockType,Ks=class extends w{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Gs]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:Gs}}static{this.templateChild={type:B.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:ka}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`},Aa()]}static{this.defaultChildren=[{type:Gs,props:{heading:`Offen`,variant:`warning`},children:[{type:B.blockType}]},{type:Gs,props:{heading:`In Arbeit`,variant:`info`}},{type:Gs,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[w.styles,o`
    ...
    `]}render(){return g`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),Us(this)}disconnectedCallback(){super.disconnectedCallback(),Ws(this)}};w.defineAndRegister(Ks);var qs={breite:56,breiteOffen:224},Js=`ff-seiten-wechsel`,Ys=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],Xs=class extends w{static{this.blockType=`navi-eintrag`}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:Ys.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[w.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(Js,{detail:e,bubbles:!0,composed:!0}))}render(){return g`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};C([x()],Xs.prototype,`seite`,void 0),C([x()],Xs.prototype,`seitename`,void 0),C([x({reflect:!0})],Xs.prototype,`ton`,void 0),w.defineAndRegister(Xs);var Zs=`aktiv`;function Qs(e){return Array.from(e.querySelectorAll(Xs.tagName))}function $s(e,t){let n=Qs(e),r=t??n.find(e=>e.hasAttribute(Zs))??n[0];for(let e of n)e===r?e.setAttribute(Zs,``):e.removeAttribute(Zs)}function ec(e){let t=e.hasAttribute(`offen`);for(let n of Qs(e))n.toggleAttribute(`breit`,t)}function tc(e){return e.getAttribute(`name`)??String(ut.defaultProps.name)}function nc(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function rc(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(ut.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=nc(e,i);if(!a)return;let o=r.find(e=>tc(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var ic=new WeakMap,ac=new WeakSet;function oc(e){let t=t=>{let n=t.detail;n&&($s(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),ec(e),!e.hasAttribute(`data-ff-editor`)&&rc(e,n.ansicht))};e.addEventListener(Js,t),ic.set(e,t)}function sc(e){let t=ic.get(e);t&&(e.removeEventListener(Js,t),ic.delete(e))}function cc(e){if($s(e),ec(e),e.hasAttribute(`data-ff-editor`)||ac.has(e))return;let t=Qs(e)[0];if(!t)return;ac.add(e);let n=()=>rc(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var lc=Xs.blockType,uc=class extends w{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[lc]}static{this.addChildButton={label:`Eintrag`,childType:lc}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[lt]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[w.styles,o`
      :host {
        height: 100%;
        width: ${qs.breite}px;
    ...
    `]}connectedCallback(){super.connectedCallback(),oc(this)}disconnectedCallback(){super.disconnectedCallback(),sc(this)}klappen(){this.toggleAttribute(`offen`),ec(this)}render(){return g`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
      ...
      </div>`}};w.defineAndRegister(uc);var dc=Xr(`text`);function fc(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(dc)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function pc(e){let t=_i(e,dc);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function mc(e){fc(e)&&(e.text=``)}var hc=di({hydriere:pc,verdrahte:mc}),gc=hc.connect,_c=hc.disconnect,vc=6,yc=96,bc=14,xc={duenn:`300`,normal:`400`,fett:`700`},Sc={links:`left`,mitte:`center`,rechts:`right`},Cc={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},wc=`standard`;function Tc(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(yc,Math.max(vc,t)):bc}function Ec(e){return typeof e==`string`&&e in xc?e:`normal`}function Dc(e){return typeof e==`string`&&e in Sc?e:`links`}function Oc(e){return typeof e==`string`&&e in Cc?e:wc}var $=class extends w{constructor(...e){super(...e),this.groesse=bc,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=wc,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:bc,gewicht:`normal`,ausrichtung:`links`,farbe:wc,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:vc,max:yc,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[w.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return g`<div
      class="text"
      style=${G({fontSize:`${Tc(this.groesse)}px`,fontWeight:xc[Ec(this.gewicht)],textAlign:Sc[Dc(this.ausrichtung)],color:Cc[Oc(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),gc(this)}disconnectedCallback(){super.disconnectedCallback(),_c(this)}};C([x({type:Number})],$.prototype,`groesse`,void 0),C([x()],$.prototype,`gewicht`,void 0),C([x()],$.prototype,`ausrichtung`,void 0),C([x()],$.prototype,`farbe`,void 0),C([x()],$.prototype,`text`,void 0),C([x()],$.prototype,`source`,void 0),C([x()],$.prototype,`textField`,void 0),w.defineAndRegister($);var kc=[`waagerecht`,`senkrecht`],Ac=`waagerecht`;function jc(e){return kc.includes(e)?e:Ac}var Mc=class extends w{constructor(...e){super(...e),this.richtung=Ac}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:Ac}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[w.styles,o`
    ...
    `]}render(){return g`<div class="flaeche ${jc(this.richtung)}"><div class="linie"></div></div>`}};C([x()],Mc.prototype,`richtung`,void 0),w.defineAndRegister(Mc),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;F(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();