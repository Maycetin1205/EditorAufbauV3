...
`,Vi=[`text`,`number`,`textarea`,`select`,`date`,`time`,`checkbox`,`nachschlagen`];function Hi(e){return Vi.includes(e)?e:`text`}var Ui=[`text`,`number`,`textarea`,`select`,`nachschlagen`,`date`,`time`],Wi={select:`ph-select`,date:`ph-nativ`,time:`ph-nativ`,nachschlagen:`ph-nachschlag`};function Gi(){return y`<svg viewBox="0 0 16 16" width="14" height="14" aria-hidden="true">
    ...
    </svg>`}var Ki=`Spalte {n}`;function qi(e){return Ki.replace(`{n}`,String(e+1))}function Ji(e){return{titel:qi(e),feld:``}}function Yi(){return[0,1,2].map(e=>Ji(e))}function Xi(e){let t=typeof e==`number`?e:Number(e);if(!Number.isFinite(t))return;let n=Math.round(t);return n<40?40:n}function Zi(e,t){if(e&&typeof e==`object`){let n=e,r=n.breite===void 0?void 0:Xi(n.breite);return{titel:typeof n.titel==`string`?n.titel:qi(t),feld:typeof n.feld==`string`?n.feld:``,...r===void 0?{}:{breite:r},...typeof n.summe==`boolean`?{summe:n.summe}:{},...typeof n.aenderbar==`boolean`?{aenderbar:n.aenderbar}:{},...typeof n.fuellFeld==`string`&&n.fuellFeld.trim()!==``?{fuellFeld:n.fuellFeld.trim()}:{}}}return typeof e==`string`?{...Ji(t),titel:e}:Ji(t)}function Qi(e){let t;if(Array.isArray(e))t=e.map((e,t)=>Zi(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>Ji(e))}else t=Yi();return t.length>16&&(t=t.slice(0,16)),t.length<1&&(t=[Ji(0)]),t}function $i(e){try{return Qi(JSON.parse(e))}catch{return Yi()}}function ea(e,t=()=>void 0){let n=e.map((e,n)=>t(n)??e.breite),r=n.filter(e=>e!==void 0),i=r.length===0?1:Math.max(1,Math.round(r.reduce((e,t)=>e+t,0)/r.length));return n.map(e=>`minmax(0, ${e??i}fr)`).join(` `)}var ta={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},na=e=>(...t)=>({_$litDirective$:e,values:t}),ra=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},ia=`important`,aa=` !important`,W=na(class extends ra{constructor(e){if(super(e),e.type!==ta.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(aa);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?ia:``):n[e]=r}}return b}}),oa=[`menge`,`anzahl`,`dosis`,`gewicht`,`bezug`,`tage`],sa={stellen:3,richtung:`kfm`};function ca(){return{menge:{feld:``,runden:{...sa}},anzahl:{feld:``,runden:{stellen:0,richtung:`auf`}},dosis:{feld:``,runden:{...sa}},gewicht:{feld:``,runden:{...sa}},bezug:{feld:``,runden:{...sa}},tage:{feld:``,runden:{...sa}}}}var la=/^-?\d+(,\d+)?$|^-?[1-9]\d{0,2}(\.\d{3})+(,\d+)?$/;function ua(e){let t=e.trim();if(t===``||!la.test(t))return null;let n=Number(t.replace(/\./g,``).replace(`,`,`.`));return Number.isFinite(n)?n:null}function da(e,t){let n=10**Math.max(0,t.stellen),r=e*n;return(t.richtung===`auf`?Math.ceil(r-1e-9):t.richtung===`ab`?Math.floor(r+1e-9):Math.round(r))/n}function fa(e,t){return e.toLocaleString(`de-DE`,{useGrouping:!1,minimumFractionDigits:0,maximumFractionDigits:Math.max(0,t)})}function pa(e,t,n){if(!n.has(`menge`))return null;let r=n.has(`bezug`)?t.bezug:null;if(r===`fehler`)return null;let i=typeof r==`number`;if(i&&r===0||i&&!n.has(`gewicht`))return null;let a=[`menge`];for(let e of[`anzahl`,`dosis`,`tage`])n.has(e)&&a.push(e);i&&n.has(`gewicht`)&&a.push(`gewicht`);let o=[];for(let e of a){let n=t[e];if(n===`fehler`)return null;n===null&&o.push(e)}if(o.length!==1)return null;let s=o[0],c=e=>{let n=t[e];return typeof n==`number`?n:1},l;if(s===`gewicht`){let e=c(`anzahl`)*c(`dosis`)*c(`tage`);if(e===0)return null;l=c(`menge`)/e*r}else{let e=i?c(`gewicht`)/r:1,t=c(`anzahl`)*c(`dosis`)*c(`tage`)*e;if(s===`menge`)l=t;else{if(t===0)return null;l=c(`menge`)/t}}return Number.isFinite(l)?{platz:s,wert:da(l,e[s].runden)}:null}function ma(e,t){if(!e||typeof e!=`object`)return{...t};let n=e;return{stellen:typeof n.stellen==`number`&&Number.isInteger(n.stellen)&&n.stellen>=0&&n.stellen<=6?n.stellen:t.stellen,richtung:n.richtung===`auf`||n.richtung===`ab`||n.richtung===`kfm`?n.richtung:t.richtung}}function ha(e,t){if(!e||typeof e!=`object`)return{feld:``,runden:{...t}};let n=e;return{feld:typeof n.feld==`string`?n.feld:``,runden:ma(n.runden,t)}}function ga(e){let t=e;if(typeof e==`string`){let n=e.trim();if(n===``)return null;try{t=JSON.parse(n)}catch{return null}}if(!t||typeof t!=`object`||Array.isArray(t))return null;let n=t,r=ca();return{menge:ha(n.menge,r.menge.runden),anzahl:ha(n.anzahl,r.anzahl.runden),dosis:ha(n.dosis,r.dosis.runden),gewicht:ha(n.gewicht,r.gewicht.runden),bezug:ha(n.bezug,r.bezug.runden),tage:ha(n.tage,r.tage.runden)}}var _a=`Keine Datensätze.`;function va(){return{attributeName:`leerText`,name:`Text ohne Datensätze`,description:`Text, wenn die Quelle keine Zeilen liefert. Leer: gar nichts.`,kind:`text`,requiresDataSource:!0}}function ya(e,t=!1){return e.trim()===``?x:y`<div class="leer${t?` leer--tafel`:``}">
    ${Nr()}
    <span>${e}</span>
  </div>`}var ba=o`
  .leer {
...
`;function xa(e,t){let n=t.trim();return n===``?-1:e.findIndex(e=>e.feld===n)}function Sa(e,t){let n=(e?.fuellFeld??``).trim(),r=n===``?(e?.feld??``).trim():n;if(r===``)return{art:`frei`,quelleId:``,code:``};let{quelleId:i,code:a}=ai(r);return i===``?{art:`eigen`,quelleId:t,code:a}:{art:`verknuepft`,quelleId:i,code:a}}function G(e,t){return Sa(e.spalten[t],e.quelleId)}function Ca(e){let t=[];for(let n of e.spalten){let r=Sa(n,e.quelleId);r.art!==`verknuepft`||r.quelleId===``||t.includes(r.quelleId)||t.push(r.quelleId)}return t}function wa(e,t){let n=G(e,t);if(!(n.quelleId===``||n.code===``))for(let r=0;r<e.spalten.length;r++){if(r===t)continue;let i=e.spalten[r],a=Sa(i,e.quelleId);if(a.quelleId===n.quelleId&&!(a.code===``||a.code===n.code))return{titel:i.titel,code:a.code}}}function Ta(e,t){let n=G(e,t);if(n.art!==`verknuepft`||n.quelleId===``||n.code===``)return[];let r=[];for(let t of e.spalten){let i=Sa(t,e.quelleId);i.quelleId!==n.quelleId||i.code===``||r.some(e=>e.feld===i.code)||r.push({titel:t.titel,feld:i.code})}return r}function Ea(e,t,n){let r=e.map(e=>({toField:e.toField,soll:t(e.fromField)})).filter(e=>e.soll!==void 0);return r.length===0?[...n]:n.filter(e=>r.every(t=>t.soll!==``&&t.soll===A(e,t.toField)))}function Da(e,t,n){return y`<input
    class="erf-eingabe"
    type="text"
...
`;function Ja(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen])}}function Ya(e,t,n){return t===``||n===``?[...e]:e.filter(e=>Br(A(e,t))===n)}function Xa(e){let t=e.getAttribute(`source`)??``;if(t===``)return null;let n=k(R().FF_DATA_SOURCES,t);return n?{quelle:n,zeilen:Ya(Dt(R().SEDATA,n.name,n.tableId,n.offenerSatz),e.getAttribute(`tagfield`)??``,Gr()),lies:Di(e)}:null}function Za(e){return $i(e.getAttribute(`spalten`)??``)}function Qa(e,t){let n=k(R().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?St(n,t):``}function $a(e){let t=k(R().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return t!==void 0&&t.indexField!==``}function eo(e,t){t&&e.vergissGeschriebene();let n=Xa(e);if(!n){e.datenzeilen=[];return}let r=Za(e),{rows:i,gefiltert:a}=Yt(e,n.zeilen),o=Ht(N(e),i,e=>e)[0]??-1,s=n.lies;e.datenGeliefert=!0,e.rohzeilen=i,e.auswahlIndex=o,e.durchAuswahlGefiltert=a,e.datenzeilen=i.map(e=>r.map(t=>t.feld===``?``:s(e,t.feld)))}var to=Si({hydriere:eo}),no=to.connect,ro=to.disconnect;function io(e,t){let n=[];return e.forEach((e,r)=>{Xr(e,t)&&n.push(r)}),n}function ao(e,t){return!e&&t.trim()!==``}function oo(e,t,n){return e&&t&&n===0}function so(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function co(e){return[...e,Ji(e.length)]}function lo(e,t,n){let r=t();r.length<=1||e<0||e>=r.length||(r.splice(e,1),n(r))}function uo(e,t,n){return y`<div class="steuerung">
    <button
    ...
    >+</button>
  </div>`}function fo(e,t){let n=e.currentTarget;n&&(e.stopPropagation(),e.preventDefault(),ot(n,(e,n)=>e===``||e===n.trim()?!1:(t(e),!0)))}function po(e,t,n,r){fo(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var mo=220,ho=new WeakMap;function go(e){let t=ho.get(e);t!==void 0&&(clearTimeout(t),ho.delete(e))}function _o(e,t,n){return y`<button
    class="kopf-weg"
    type="button"
  ...
  </div>`}var is=/[.*+?^${}()|[\]\\]/g;function as(e,t){let n=Yr(t);if(n.length===0||e===``)return e;let r;try{r=RegExp(`(${n.map(e=>e.replace(is,`\\$&`)).join(`|`)})`,`ig`)}catch{return e}let i=e.split(r);return i.length<=1?e:y`${i.map((e,t)=>t%2==1?y`<mark>${e}</mark>`:e)}`}function os(e,t,n){let r=40-e,i=t-40,a=r>i?0:Math.min(i,Math.max(r,Math.round(n)));return{links:Math.round(e+a),rechts:Math.round(t-a)}}function ss(e,t,n){if(e.button!==0)return;let r=[...e.currentTarget?.parentElement?.children??[]].filter(e=>e instanceof HTMLElement&&e.tagName===`DIV`),i=r[t],a=r[t+1];if(!i||!a)return;e.stopPropagation(),e.preventDefault();let o=e.clientX,s=i.getBoundingClientRect().width,c=a.getBoundingClientRect().width,l=os(s,c,0),u=()=>{window.removeEventListener(`pointermove`,p),window.removeEventListener(`pointerup`,ee),window.removeEventListener(`pointercancel`,m),window.removeEventListener(`keydown`,te),window.removeEventListener(`blur`,m)},d=r.map(e=>Math.max(1,Math.round(e.getBoundingClientRect().width))),f=()=>d.map((e,n)=>n===t?{index:n,breite:l.links}:n===t+1?{index:n,breite:l.rechts}:{index:n,breite:e});function p(e){l=os(s,c,e.clientX-o),n.zeige(f())}function ee(){u(),n.uebernimm(f())}function m(){u(),n.verwirf()}function te(e){e.key===`Escape`&&(e.preventDefault(),m())}window.addEventListener(`pointermove`,p),window.addEventListener(`pointerup`,ee),window.addEventListener(`pointercancel`,m),window.addEventListener(`keydown`,te),window.addEventListener(`blur`,m)}function cs(e,t){return Array.from({length:Math.max(0,e-1)},(e,n)=>y`<span
    class="breite-griff"
    role="presentation"
    style="grid-row: 1; grid-column: ${n+1}"
    title="Linie ziehen: links breiter, rechts schmaler"
    @pointerdown=${e=>ss(e,n,t)}
    @click=${e=>e.stopPropagation()}
    @dblclick=${e=>e.stopPropagation()}
  ></span>`)}function ls(e){return e.linealTakte===0?x:y`<div class="lineal" role="presentation" style=${W(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>y`<div></div>`)}
        </div>`}function us(e,t){return y`
      ...
      ${e.zeigeKopf?y`<div class="kopf" role="row" style=${W(e.cols)}>
        ${e.spalten.map((n,r)=>y`<div
          ...
          >${e.imEditor&&(e.herkunft[r]??``)!==``?y`<span class="kopf-titel">${n.titel}</span><span
                ...
                >${e.herkunft[r]}</span>`:n.titel}${!e.editable&&e.sortSpalte===r?y`<span class="sort-pfeil">${e.sortAuf?` ▲`:` ▼`}</span>`:``}${e.imEditor&&e.editable&&e.spalten.length>1?_o(n.titel,r,t.loescheSpalte):x}</div>`)}
        ${cs(e.spalten.length,t.breiten)}
      </div>`:x}
        ${``}
        ${e.leer?ya(e.leerText,!0):y`
        ...
        ${e.zeilen.map((n,r)=>{let i=n!==null&&!e.imEditor,a=n!==null&&e.zeilenStand.istGeloescht(n),o=n===null?{status:`gebucht`,titel:``}:e.zeilenStand.statusVon(n);return y`<div
          ...
          >
            ${``}
            ${e.spalten.map((r,i)=>{let a=n===null?`—`:e.datenzeilen[n]?.[i]??``,o=e.imEditor&&!e.zeigeKopf&&e.editable;if(e.aendernMoeglich&&n!==null&&Xo(r)){let t=e.zeilenStand;return y`<div class="tippbar" role="cell">
                <input
...
`,K=class e extends E{constructor(...e){super(...e),this.spalten=Yi(),this.spaltenHerkunft=[],this.source=``,this.suche=`ja`,this.erfassung=`nein`,this.blaettern=`ja`,this.loeschbar=`nein`,this.kopfzeile=`ja`,this.leerText=_a,this.rechnung=``,this.datenzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._besitz=`softengine`,this._breiten=new Map,this._breiteVorZug=null,this._ansicht=new Go({baustein:this,editable:()=>this.editable,zeilenHoehe:()=>this.zeilenHoehe,melde:()=>this.requestUpdate()}),this._erfassung=new Ka,this._lauf=new To(()=>this.requestUpdate()),this._zeilen=new Co({baustein:this,spalten:()=>this.spaltenListe(),rohzeilen:()=>this.rohzeilen,datenzeilen:()=>this.datenzeilen,melde:()=>this.requestUpdate(),lauf:this._lauf,erfassungAn:()=>this.erfassungAn,fokussiereErfassungsZelle:e=>this.fokussiereErfassungsZelle(e)}),this.nimmSeFokus=e=>{e.defaultPrevented||!this.erfassungAn||this.hasAttribute(`data-ff-editor`)||(e.preventDefault(),this.fokussiereErfassungsZelle(0))}}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.kannErfassen={wenn:{attributeName:`erfassung`,equals:`ja`}}}static{this.aenderungsSchluessel=`aenderbar`}static{this.kannLoeschen={wenn:{attributeName:`loeschbar`,equals:`ja`}}}static{this.blockEvents=[{key:`onRowClick`,name:`Zeile gewählt`},{key:`onRowDblClick`,name:`Zeile doppelt geklickt`}]}static{this.listenBindung=Yo}static{this.defaultProps={width:`fill`,source:``,spalten:Yi(),suche:`ja`,erfassung:`nein`,blaettern:`ja`,loeschbar:`nein`,kopfzeile:`ja`,tagField:``,rechnung:``,leerText:_a}}static{this.customProperties=ns}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?ro(this):no(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=Ja(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.nachPush(),this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.zuruecksetzen(),this._erfassung.zuruecksetzen()}get erfassteZeilen(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.werte)}get erfassteSchluessel(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.kennung)}get geaenderteZeilen(){return this._zeilen.geaenderteZeilen}get geloeschteZeilen(){return this._zeilen.geloeschteZeilen}zeileSchreibt(e,t){this._lauf.schreibt(e,t)}zeileGescheitert(e,t,n){this._lauf.gescheitert(e,t,n)}laufFertig(e,t){if(this._lauf.fertig(e,t),e===`erfasst`){this._erfassung.markiereGeschrieben(this.erfassungsUmfeld(),t)&&this.requestUpdate();return}this._zeilen.austragen(e,t)}vergissGeschriebene(){this._erfassung.vergissGeschriebene()&&this.requestUpdate()}erfasstStand(e){return this._lauf.zeigt(`erfasst`,this._erfassung.schluessel[e]??``,this._erfassung.istGeschrieben(e)?`geschrieben`:`erfasst`)}erfasseZeile(){return this._erfassung.erfasse(this.erfassungsUmfeld())?(this.requestUpdate(),this.fokussiereErfassungsZelle(0),this.zeigeLetzteErfasste(),!0):!1}zeigeLetzteErfasste(){this.updateComplete.then(()=>{let e=this.shadowRoot?.querySelector(`.koerper`);e&&(e.scrollTop=e.scrollHeight)})}fokussiereSuche(){return this._ansicht.fokussiereSuche()}setzeSuchtext(e){this._ansicht.setzeSuchtext(e),this.requestUpdate()}get hatQuelle(){return this._besitz===`provided`||ao(this.hasAttribute(`data-ff-editor`),this.source)}spaltenListe(){return Qi(this.spalten)}get zeilenHoehe(){return 28}breitenWirt(){let e=e=>{this._breiteVorZug===null&&(this._breiteVorZug=new Map(e.map(e=>[e.index,this._breiten.get(e.index)])))};return{zeige:t=>{e(t);for(let e of t)this._breiten.set(e.index,e.breite);this.requestUpdate()},uebernimm:e=>{this._breiteVorZug=null;let t=this.spaltenListe();if(!this.hasAttribute(`data-ff-editor`)){for(let t of e)this._breiten.set(t.index,t.breite);this.requestUpdate();return}for(let n of e)n.index>=t.length||(this._breiten.delete(n.index),t[n.index]={...t[n.index],breite:n.breite});this.aendere(t)},verwirf:()=>{let e=this._breiteVorZug;if(this._breiteVorZug=null,e){for(let[t,n]of e)n===void 0?this._breiten.delete(t):this._breiten.set(t,n);this.requestUpdate()}}}}get erfassungAn(){return this.erfassung===`ja`}erfassungsWirt(){return{baustein:this,lauf:this._erfassung.lauf,umfeld:()=>this.erfassungsUmfeld(),melde:()=>this.requestUpdate(),fokussiere:e=>this.fokussiereErfassungsZelle(e),erfasseZeile:()=>this.erfasseZeile()}}fokussiereErfassungsZelle(e){this.updateComplete.then(()=>{let t=this.shadowRoot?.querySelectorAll(`.zeile.erfassung .erf-eingabe`)?.[e];t&&(t.focus(),t.scrollIntoView({block:`nearest`}))})}erfassungsUmfeld(){return this._erfassung.umfeld(this,this.spaltenListe(),this.source,ga(this.rechnung))}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&no(this),document.addEventListener(Fn,this.nimmSeFokus),this._ansicht.beobachte()}firstUpdated(){this._ansicht.beobachte()}willUpdate(e){super.willUpdate(e),e.has(`spalten`)&&this._breiten.clear(),!(!this.erfassungAn||this.hasAttribute(`data-ff-editor`))&&this._erfassung.lauf.aktualisiereVorschlaege(this.erfassungsUmfeld())}updated(){this._ansicht.nachRendern(),Tr(this)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(Fn,this.nimmSeFokus),go(this),this._ansicht.loese(),As(this),ro(this)}static{this.styles=[E.styles,ba,ds,ni,qa]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=ts({spalten:t,breiteVon:e=>this._breiten.get(e),hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._ansicht.suchtext,sortSpalte:this._ansicht.sortSpalte,sortAuf:this._ansicht.sortAuf,wunschSeite:this._ansicht.seite,gemessen:this._ansicht.mass,erfassungAn:this.erfassungAn,erfassteAnzahl:this._erfassung.zeilen.length,wertVon:(e,t)=>this._zeilen.zellWert(e,t),blaettert:this.blaettern===`ja`});return y`<div class="tabelle" style=${W({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
  ...
  >${e.inhalt}</ff-dialog-rahmen>`}function Ns(e,t){let n=hs([...e.spalten]),r=_s(gs(n,e.speicherFeld),e.speicherFeld);return y`<ff-tabelle
    fuellt
    suche="ja"
    style="--se-r-lg:0px"
    .besitz=${`provided`}
  ...
  ></ff-tabelle>`}function Ps(e){let t=e.eintraege;if(t===void 0){let n=xs(e);if(!n.ok){L(n.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}t=n.eintraege}ks(!1);let n=document.createElement(`div`);n.style.display=`contents`,Ve(Ms({titel:e.titel,breite:e.breite,hoehe:e.hoehe,inhalt:Ns(e,t),onSchliessen:()=>ks()}),n);let r=n.querySelector(Zt),i=n.querySelector(K.tagName);i?.addEventListener(Lo,n=>{let r=n.detail,i=t[r.rohIndex];i&&(ks(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),Ds=e.rueckFokus??Os(e.el),document.body.appendChild(n),Ts=n,Es=e.el;let a=e.suchtext??``;i&&a!==``&&i.setzeSuchtext(a),r&&i&&Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}function Fs(e){return Ms({titel:e.titel,breite:e.breite,hoehe:e.hoehe,onSchliessen:e.onSchliessen,editor:{onGroesse:e.onGroesse},inhalt:y`<ff-tabelle
      data-ff-editor
      fuellt
      suche="ja"
      style="--se-r-lg:0px"
    ...
    </div>`}connectedCallback(){super.connectedCallback(),Ri(this)}disconnectedCallback(){super.disconnectedCallback(),zi(this),As(this)}};T([C()],q.prototype,`fieldType`,void 0),T([C()],q.prototype,`placeholder`,void 0),T([C()],q.prototype,`options`,void 0),T([C()],q.prototype,`source`,void 0),T([C()],q.prototype,`value`,void 0),T([C()],q.prototype,`valueField`,void 0),T([C()],q.prototype,`nachschlagQuelle`,void 0),T([C()],q.prototype,`speicherFeld`,void 0),T([C()],q.prototype,`speicherTitel`,void 0),T([C({converter:{fromAttribute:e=>hs(e??``),toAttribute:e=>JSON.stringify(e)}})],q.prototype,`nachschlagSpalten`,void 0),T([C({type:Number})],q.prototype,`fensterBreite`,void 0),T([C({type:Number})],q.prototype,`fensterHoehe`,void 0),T([C()],q.prototype,`einzigerTreffer`,void 0),T([w()],q.prototype,`spaltenDialog`,void 0),T([w()],q.prototype,`anzeige`,void 0),T([w()],q.prototype,`getippt`,void 0),T([w()],q.prototype,`marke`,void 0),T([w()],q.prototype,`listeZu`,void 0),T([w()],q.prototype,`angehakt`,void 0),T([w()],q.prototype,`imSteuerelement`,void 0),E.defineAndRegister(q);var Is=`ziel`,Ls=o`
...
`,zs=`frei · hierher ziehen`,Bs=`ff-zimmer-inhalt`,J=class extends E{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[H.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[E.styles,ba,Rs,Ls,o`
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(Bs,{bubbles:!0,composed:!0}))}render(){return y`<div class="zimmer ${Is}">
      <div
        class="kopf"
        data-ff-editable
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(Bs,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(H.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return y`<div class="col ${Is} v-${Or(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};T([C()],Y.prototype,`variant`,void 0),T([C()],Y.prototype,`heading`,void 0),T([C({attribute:!1})],Y.prototype,`leerHinweis`,void 0),T([w()],Y.prototype,`_count`,void 0),E.defineAndRegister(Y);function Vs(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function Hs(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var Us=new WeakMap,Ws=Y.tagName,Gs=J.tagName,Ks=H.tagName;function qs(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Ws)}function Js(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Ks)}function Ys(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Gs)}function Xs(e){return[e,...Ys(e)]}function Zs(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=Ys(e);for(let e of t)r(e,Js(e).length===0?zs:``);r(e,t.length===0&&Js(e).length===0?n:``)}}function Qs(e){return Ye().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function $s(e,t){let n=Ys(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??J.defaultProps.heading),a=Vs(A(t,r),i);return a>=0?n[a]:n[0]}function ec(e){Z?.board===e&&oc();let t=e.getAttribute(`statusfield`)??``,n=Xa(e);if(!n)return;let r=qs(e);if(r.length===0)return;let i=Us.get(e);if(!i){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(Ks);t&&(i=t.cloneNode(!0),Us.set(e,i))}if(!i)return;let a=n.zeilen,o=r.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),s=Qs(i.tagName),c=Hs(r.map(e=>e.getAttribute(`auffang`))),l=n.lies;for(let e of r)for(let t of Xs(e))Js(t).forEach(e=>e.remove());for(let e of a){let a=i.cloneNode(!0),u=t===``?-1:Vs(A(e,t),o),d=u>=0?r[u]:c>=0?r[c]:r[0];($s(d,e)??d).appendChild(a);for(let t of s){let n=a.getAttribute(ci(t.prop))??``;n!==``&&(a[t.prop]=l(e,n))}let f=St(n.quelle,e);X.set(a,{row:e,pindex:f}),a.draggable=!0}Zs(e,r);let u=r.flatMap(e=>Xs(e).flatMap(Js)),d=Ht(N(e),u,e=>X.get(e)?.row);for(let e of d)u[e].setAttribute(`data-ff-auswahl`,``)}var X=new WeakMap,Z=null,tc=new WeakSet,nc=`data-ff-zieht`,rc=`data-ff-ziel`,ic=null;function ac(e){ic!==e&&(ic?.removeAttribute(rc),ic=e,ic?.setAttribute(rc,``))}function oc(){Z?.card.removeAttribute(nc),Z=null,ac(null)}function sc(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function cc(e,t){return sc(e,t,Ws)}function lc(e,t,n){if(!Z||Z.board!==e)return;let r=X.get(Z.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;V(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(B)}function uc(e){tc.has(e)||(tc.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;if(!n)return;let r=X.get(n);r&&Ut(N(e),r.row),V(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(B)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{Z?.card===n&&n.setAttribute(nc,``)},0))}),e.addEventListener(`dragend`,oc),e.addEventListener(`dragover`,t=>{let n=cc(e,t);if(Z?.board!==e||!n){ac(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),ac(sc(e,t,Gs)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&ac(null)}),e.addEventListener(`drop`,t=>{let n=cc(e,t);n&&(t.preventDefault(),lc(e,n,sc(e,t,Gs)),oc())}))}var dc=Si({hydriere:ec,verdrahte:uc}),fc=dc.connect,pc=dc.disconnect,mc=Y.blockType,hc=class extends E{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[mc]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:mc}}static{this.templateChild={type:H.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:_a}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Feld, das die Spalte bestimmt. Leer: alle in die Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Einträge des gewählten Tages.`,kind:`field`},va()]}static{this.defaultChildren=[{type:mc,props:{heading:`Offen`,variant:`warning`},children:[{type:H.blockType}]},{type:mc,props:{heading:`In Arbeit`,variant:`info`}},{type:mc,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[E.styles,o`
    ...
    `]}render(){return y`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),fc(this)}disconnectedCallback(){super.disconnectedCallback(),pc(this)}};E.defineAndRegister(hc);var gc={breite:56,breiteOffen:224},_c=`ff-seiten-wechsel`,vc=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],Q=class extends E{static{this.blockType=`navi-eintrag`}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:vc.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[E.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(_c,{detail:e,bubbles:!0,composed:!0}))}render(){return y`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};T([C()],Q.prototype,`seite`,void 0),T([C()],Q.prototype,`seitename`,void 0),T([C({reflect:!0})],Q.prototype,`ton`,void 0),E.defineAndRegister(Q);var yc=`aktiv`;function bc(e){return Array.from(e.querySelectorAll(Q.tagName))}function xc(e,t){let n=bc(e),r=t??n.find(e=>e.hasAttribute(yc))??n[0];for(let e of n)e===r?e.setAttribute(yc,``):e.removeAttribute(yc)}function Sc(e){let t=e.hasAttribute(`offen`);for(let n of bc(e))n.toggleAttribute(`breit`,t)}function Cc(e){return e.getAttribute(`name`)??String(ct.defaultProps.name)}function wc(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function Tc(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(ct.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=wc(e,i);if(!a)return;let o=r.find(e=>Cc(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var Ec=new WeakMap,Dc=new WeakSet;function Oc(e){let t=t=>{let n=t.detail;n&&(xc(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),Sc(e),!e.hasAttribute(`data-ff-editor`)&&Tc(e,n.ansicht))};e.addEventListener(_c,t),Ec.set(e,t)}function kc(e){let t=Ec.get(e);t&&(e.removeEventListener(_c,t),Ec.delete(e))}function Ac(e){if(xc(e),Sc(e),e.hasAttribute(`data-ff-editor`)||Dc.has(e))return;let t=bc(e)[0];if(!t)return;Dc.add(e);let n=()=>Tc(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var jc=Q.blockType,Mc=class extends E{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[jc]}static{this.addChildButton={label:`Eintrag`,childType:jc}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[st]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[E.styles,o`
      :host {
        height: 100%;
        width: ${gc.breite}px;
    ...
    `]}connectedCallback(){super.connectedCallback(),Oc(this)}disconnectedCallback(){super.disconnectedCallback(),kc(this)}klappen(){this.toggleAttribute(`offen`),Sc(this)}render(){return y`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
        ...
        <div class="eintraege">
          <slot @slotchange=${()=>Ac(this)}></slot>
        </div>
      </div>`}};E.defineAndRegister(Mc);var Nc=ci(`text`);function Pc(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(Nc)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function Fc(e){let t=Oi(e,Nc);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function Ic(e){Pc(e)&&(e.text=``)}var Lc=Si({hydriere:Fc,verdrahte:Ic}),Rc=Lc.connect,zc=Lc.disconnect,Bc=6,Vc=96,Hc=14,Uc={duenn:`300`,normal:`400`,fett:`700`},Wc={links:`left`,mitte:`center`,rechts:`right`},Gc={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},Kc=`standard`;function qc(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(Vc,Math.max(Bc,t)):Hc}function Jc(e){return typeof e==`string`&&e in Uc?e:`normal`}function Yc(e){return typeof e==`string`&&e in Wc?e:`links`}function Xc(e){return typeof e==`string`&&e in Gc?e:Kc}var $=class extends E{constructor(...e){super(...e),this.groesse=Hc,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=Kc,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:Hc,gewicht:`normal`,ausrichtung:`links`,farbe:Kc,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Bc,max:Vc,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[E.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return y`<div
      class="text"
      style=${W({fontSize:`${qc(this.groesse)}px`,fontWeight:Uc[Jc(this.gewicht)],textAlign:Wc[Yc(this.ausrichtung)],color:Gc[Xc(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),Rc(this)}disconnectedCallback(){super.disconnectedCallback(),zc(this)}};T([C({type:Number})],$.prototype,`groesse`,void 0),T([C()],$.prototype,`gewicht`,void 0),T([C()],$.prototype,`ausrichtung`,void 0),T([C()],$.prototype,`farbe`,void 0),T([C()],$.prototype,`text`,void 0),T([C()],$.prototype,`source`,void 0),T([C()],$.prototype,`textField`,void 0),E.defineAndRegister($);var Zc=[`waagerecht`,`senkrecht`],Qc=`waagerecht`;function $c(e){return Zc.includes(e)?e:Qc}var el=class extends E{constructor(...e){super(...e),this.richtung=Qc}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:Qc}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[E.styles,o`
    ...
    `]}render(){return y`<div class="flaeche ${$c(this.richtung)}"><div class="linie"></div></div>`}};T([C()],el.prototype,`richtung`,void 0),E.defineAndRegister(el),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;L(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();