...
`,H=class extends E{constructor(...e){super(...e),this.chipVariant=`info`,this.heading=``,this.heading2=``,this.time=``,this.date=``,this.avatar=``,this.meta=``,this.text=``,this.chipText=``,this.headingField=``,this.heading2Field=``,this.timeField=``,this.dateField=``,this.avatarField=``,this.metaField=``,this.textField=``,this.chipTextField=``}static{this.blockType=`card`}static{this.tagName=`ff-card`}static{this.displayName=`Karte`}static{this.category=`anzeige`}static{this.allowedParentTypes=[`kanban-spalte`,`kanban-zimmer`]}static{this.showInPalette=!1}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={chipVariant:`info`,heading:``,heading2:``,time:``,date:``,avatar:``,meta:``,text:``,chipText:``,headingField:``,heading2Field:``,timeField:``,dateField:``,avatarField:``,metaField:``,textField:``,chipTextField:``}}static{this.bindableSpots=[{prop:`time`,label:`Zeit`},{prop:`date`,label:`Datum`},{prop:`avatar`,label:`Avatar`},{prop:`heading`,label:`Titel`},{prop:`heading2`,label:`Titel 2`},{prop:`meta`,label:`Unterzeile`},{prop:`text`,label:`Textzeile`},{prop:`chipText`,label:`Chip`}]}static{this.customProperties=[Ar(`chipVariant`,`Bedeutung des Chips auf der Karte — bestimmt die Chip-Farbe.`)]}static{this.styles=[E.styles,jr,zr]}stelle(e,t){return y`<span
    ...
    >${this[e]}</span>`}hatReiter(){return this.hasAttribute(`data-ff-editor`)||this.date.trim()!==``||this.time.trim()!==``}updated(e){super.updated(e),this.toggleAttribute(`hat-reiter`,this.hatReiter())}render(){let e=Or(this.chipVariant),t=this.hasAttribute(`data-ff-editor`),n=e=>t||e.trim()!==``,r=this.hatReiter(),i=n(this.avatar)||n(this.heading)||n(this.meta),a=n(this.heading2)||n(this.chipText);return y`<div class="card v-${e}${r?``:` ohne-reiter`}">
      ...
      ${i?y`<div class="kopf">
            ${n(this.avatar)?y`<span
                ...
                >${this.avatar.trim()===``?x:Rr(this.avatar)}</span>`:x}
            <div class="namen">
  ...
  >${e.eintraege.map((t,n)=>y`<li
    ...
    ><span class="vorschlag-anzeige">${t.anzeige===``?t.wert:t.anzeige}</span>${t.wert!==``&&t.wert!==t.anzeige?y`<span class="vorschlag-wert">${t.wert}</span>`:x}</li>`)}</ul>`}var ni=o`
  .vorschlaege {
    position: absolute;
    top: 100%;
    left: 0;
...
`;function U(e,t,n,r){return{attributeName:e,name:t,description:n,kind:`jaNein`,options:[{value:`nein`,label:`Nein`},{value:`ja`,label:`Ja`}],...r}}var ri={attributeName:`fieldType`,equals:`nachschlagen`},ii=[{attributeName:`fieldType`,name:`Feldtyp`,description:`Welche Art Eingabe das Feld annimmt.`,kind:`select`,options:[{value:`text`,label:`Text`},{value:`number`,label:`Zahl`},{value:`textarea`,label:`Mehrzeilig`},{value:`select`,label:`Auswahl`},{value:`date`,label:`Datum`},{value:`time`,label:`Uhrzeit`},{value:`checkbox`,label:`Ankreuzfeld`},{value:`nachschlagen`,label:`Nachschlagen`}]},{attributeName:`options`,name:`Auswahl-Optionen`,description:`Einträge durch Komma getrennt, z. B. "Zimmer 1, Zimmer 2".`,kind:`text`,visibleWhen:{attributeName:`fieldType`,equals:`select`}},{attributeName:`nachschlagQuelle`,name:`Quelle`,description:`Quelle, aus der der Bediener eine Zeile wählt.`,kind:`quelle`,visibleWhen:ri},{attributeName:`speicherFeld`,name:`Gespeichert wird`,description:`Feld, dessen Wert die Maske sich merkt (z. B. die Nummer).`,kind:`field`,quelleProp:`nachschlagQuelle`,klarnameProp:`speicherTitel`,visibleWhen:ri},U(`einzigerTreffer`,`Einzigen Treffer übernehmen`,`Bleibt genau ein Satz übrig, übernimmt das Feld ihn von selbst.`,{visibleWhen:ri}),{attributeName:`valueField`,name:`Feld`,description:`Feld, dessen Wert angezeigt wird.`,kind:`field`,visibleWhen:{attributeName:`fieldType`,keinesVon:[`checkbox`,`nachschlagen`]}}];function ai(e){let t=e.split(`::`);if(t.length!==2)return{quelleId:``,code:e};let[n,r]=t;return n===``||r===``?{quelleId:``,code:e}:{quelleId:n,code:r}}function oi(e,t){let n=t[e.key];return typeof n==`boolean`?n:e.standard===!0}function si(e,t){let n=t[e.feldKey],r=typeof n==`string`&&ai(n).quelleId!==``;return(e.eintragsSchalter??[]).filter(e=>!(e.nurEigeneQuelle===!0&&r))}function ci(e){return`${e.toLowerCase()}field`}var li=999,ui=`0`,di=`255`,fi=new Map;function pi(e){let t=bt(e);yt(e,[]),t!==void 0&&t.length>0&&En()}async function mi(e,t,n,r,i){return(await nr({id:`relation-lader`,verb:`GET_RELATION`,nr:e.nr,params:[]},[t.belegart,r,i,t.belegnummer,t.jahr,t.archiv,``,String(n),``,``,``,``],{still:!0,satzAntwort:!0})).wert}function hi(e,t,n){let r=(fi.get(e.id)??0)+1;if(fi.set(e.id,r),n===void 0){pi(e.name);return}let i={belegart:A(n,t.belegartFeld),belegnummer:A(n,t.belegnummerFeld),jahr:t.jahrFeld===``?``:A(n,t.jahrFeld),archiv:t.archivFeld===``?``:A(n,t.archivFeld)};if(i.belegart===``||i.belegnummer===``){pi(e.name);return}pi(e.name),(async()=>{let n=[],a=!1;for(let o=1;o<=li;o+=1){let s=await mi(t,i,o,ui,di);if(fi.get(e.id)!==r)return;if(t.endeFelder.every(e=>A({SATZ:s},e)===``)){a=!0;break}let c={SATZ:s};for(let n of t.zusatzFelder){let a=n.indexOf(`_`),s=await mi(t,i,o,n.slice(0,a),n.slice(a+1));if(fi.get(e.id)!==r)return;c[n]=s}n.push(c)}a||L(`Positionen laden: nach ${li} Zeilen ohne Ende-Kennung abgebrochen (Relation Nr. ${t.nr}) — die Liste ist wahrscheinlich unvollständig, vermutlich passen Relationsnummer oder Ende-Felder nicht.`),fi.get(e.id)===r&&(yt(e.name,n),En())})()}var gi=new Map,_i=!1;function vi(){let e=new Map;for(let t of Ye())t.satzWahl&&e.set(t.tagName.toLowerCase(),(t.satzWahl.quelleProp??`source`).toLowerCase());return e}function yi(e,t,n=typeof document>`u`?void 0:document){if(e===``||n===void 0)return;let r=null;for(let i of Array.from(n.querySelectorAll(`[data-ff-id]`))){let n=t.get(i.tagName.toLowerCase());if(n===void 0||i.getAttribute(n)!==e)continue;let a=i.getAttribute(`data-ff-id`)??``,o=zt(a);if(o===void 0)continue;let s=Vt(a);(r===null||s>r.nummer)&&(r={zeile:o,nummer:s})}return r?.zeile}function bi(){let e=R().FF_DATA_SOURCES;if(!Array.isArray(e))return;let t=vi();for(let n of e){if(!O(n)||typeof n.id!=`string`)continue;let r=k(e,n.id);if(!r?.ladeRelation)continue;let i=yi(r.ladeRelation.geberQuelleId,t),a=jt(i);gi.get(r.id)!==a&&(gi.set(r.id,a),hi(r,r.ladeRelation,i))}}function xi(){_i||(_i=!0,Rt(bi),Kt(()=>gi.clear()))}function Si(e){let t=new Set,n=!1,r=n=>{dn()&&t.forEach(t=>{e.hydriere(t,n)})};return{connect:i=>{i.hasAttribute(`data-ff-editor`)||(t.add(i),e.verdrahte?.(i),n||(n=!0,wn(r),qr(()=>{r(!1)}),Rt(()=>{r(!1)}),xi()),Rn(),dn()&&e.hydriere(i,!1))},disconnect:e=>{t.delete(e)}}}var Ci=nt.toLowerCase(),wi=``;function Ti(e){if(e.length===0)return``;let t=[];for(let n of e){let e=n.trim();if(e===``)return``;t.push(e)}return t.join(wi)}function Ei(e){return At(e,Ci,`quelleId`,{ohnePaareBehalten:!0}).map(e=>({quelleId:e.id,partnerId:e.partnerId,keyPairs:e.keyPairs}))}function Di(e){let t=Ei(e);if(t.length===0)return(e,t)=>A(e,ai(t).code);let n=R().SEDATA,r=R().FF_DATA_SOURCES,i=new Map;for(let e of t){if(e.keyPairs.length===0)continue;let t=k(r,e.quelleId);if(!t)continue;let a=Dt(n,t.name,t.tableId,t.offenerSatz),o=new Map;for(let t of a){let n=Ti(e.keyPairs.map(e=>A(t,e.toField)));n!==``&&!o.has(n)&&o.set(n,t)}i.set(e.quelleId,{nachSchluessel:o,partnerId:e.partnerId,hierFelder:e.keyPairs.map(e=>e.fromField)})}let a=(e,t,n)=>{if(e===``)return t;let r=i.get(e);if(!r||n.has(e))return;n.add(e);let o=a(r.partnerId,t,n);if(n.delete(e),o===void 0)return;let s=Ti(r.hierFelder.map(e=>A(o,e)));return s===``?void 0:r.nachSchluessel.get(s)};return(e,t)=>{let{quelleId:n,code:r}=ai(t);if(n===``)return A(e,r);let i=a(n,e,new Set);return i===void 0?``:A(i,r)}}function Oi(e,t){let n=e.getAttribute(`source`)??``,r=e.getAttribute(t)??``;if(n===``||r===``)return{art:`ungebunden`};let i=k(R().FF_DATA_SOURCES,n);if(!i)return{art:`ohneQuelle`};let a=Xt(e,Dt(R().SEDATA,i.name,i.tableId,i.offenerSatz));if(a===void 0)return{art:`ohneZeile`};let{quelleId:o,code:s}=ai(r);return{art:`wert`,wert:o===``?A(a,s):Di(e)(a,r),zeile:a,quelle:i,quelleId:o,reinerCode:s}}var ki=new WeakMap,Ai=new WeakSet;function ji(e){let t=/^(\d{2})\.(\d{2})\.(\d{4})$/.exec(e);return t?`${t[3]}-${t[2]}-${t[1]}`:e}function Mi(e){let t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);return t?`${t[3]}.${t[2]}.${t[1]}`:e}function Ni(e){return typeof e.value==`string`?e.value:``}function Pi(e){if(e.pruefeEigenenWert?.(),e.getAttribute(`fieldtype`)===`nachschlagen`){ki.delete(e);return}let t=Oi(e,ci(`value`));if(t.art!==`wert`){ki.delete(e),t.art===`ohneZeile`&&(e.value=``);return}let{zeile:n,quelle:r,quelleId:i,reinerCode:a,wert:o}=t,s=St(r,n);i===``?ki.set(e,{row:n,code:a,pindex:s}):ki.delete(e),e.value=o}function Fi(e){let t=ki.get(e);return t&&Ct(t.row,t.code,Ni(e)),t}function Ii(e){Ai.has(e)||(Ai.add(e),e.addEventListener(`input`,()=>{Fi(e)}),e.addEventListener(`change`,()=>{let t=Fi(e);V(e,`onChange`,{VALUE:Ni(e),PINDEX:t?.pindex??``}).catch(B)}))}var Li=Si({hydriere:Pi,verdrahte:Ii}),Ri=Li.connect,zi=Li.disconnect,Bi=o`
  .feld {
    font-family: var(--se-font);
...
`,Vi=[`text`,`number`,`textarea`,`select`,`date`,`time`,`checkbox`,`nachschlagen`];function Hi(e){return Vi.includes(e)?e:`text`}var Ui=[`text`,`number`,`textarea`,`select`,`nachschlagen`,`date`,`time`],Wi={select:`ph-select`,date:`ph-nativ`,time:`ph-nativ`,nachschlagen:`ph-nachschlag`};function Gi(){return y`<svg viewBox="0 0 16 16" width="14" height="14" aria-hidden="true">
    ...
    </svg>`}var Ki=`Spalte {n}`;function qi(e){return Ki.replace(`{n}`,String(e+1))}function W(e){return{titel:qi(e),feld:``}}function Ji(){return[0,1,2].map(e=>W(e))}function Yi(e){let t=typeof e==`number`?e:Number(e);if(!Number.isFinite(t))return;let n=Math.round(t);return n<40?40:n}function Xi(e,t){if(e&&typeof e==`object`){let n=e,r=n.breite===void 0?void 0:Yi(n.breite);return{titel:typeof n.titel==`string`?n.titel:qi(t),feld:typeof n.feld==`string`?n.feld:``,...r===void 0?{}:{breite:r},...typeof n.summe==`boolean`?{summe:n.summe}:{},...typeof n.aenderbar==`boolean`?{aenderbar:n.aenderbar}:{},...typeof n.fuellFeld==`string`&&n.fuellFeld.trim()!==``?{fuellFeld:n.fuellFeld.trim()}:{}}}return typeof e==`string`?{...W(t),titel:e}:W(t)}function Zi(e){let t;if(Array.isArray(e))t=e.map((e,t)=>Xi(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>W(e))}else t=Ji();return t.length>16&&(t=t.slice(0,16)),t.length<1&&(t=[W(0)]),t}function Qi(e){try{return Zi(JSON.parse(e))}catch{return Ji()}}function $i(e,t=()=>void 0){return e.map((e,n)=>{let r=t(n)??e.breite;return r===void 0?`minmax(0, 1fr)`:`${r}px`}).join(` `)}var ea={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ta=e=>(...t)=>({_$litDirective$:e,values:t}),na=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},ra=`important`,ia=` !important`,G=ta(class extends na{constructor(e){if(super(e),e.type!==ea.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(ia);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?ra:``):n[e]=r}}return b}}),aa=`Keine Datensätze.`;function oa(){return{attributeName:`leerText`,name:`Text ohne Datensätze`,description:`Text, wenn die Quelle keine Zeilen liefert. Leer: gar nichts.`,kind:`text`,requiresDataSource:!0}}function sa(e,t=!1){return e.trim()===``?x:y`<div class="leer${t?` leer--tafel`:``}">
    ${Nr()}
    <span>${e}</span>
  </div>`}var ca=o`
  .leer {
...
`;function la(e,t){let n=(e?.fuellFeld??``).trim(),r=n===``?(e?.feld??``).trim():n;if(r===``)return{art:`frei`,quelleId:``,code:``};let{quelleId:i,code:a}=ai(r);return i===``?{art:`eigen`,quelleId:t,code:a}:{art:`verknuepft`,quelleId:i,code:a}}function K(e,t){return la(e.spalten[t],e.quelleId)}function ua(e){let t=[];for(let n of e.spalten){let r=la(n,e.quelleId);r.art!==`verknuepft`||r.quelleId===``||t.includes(r.quelleId)||t.push(r.quelleId)}return t}function da(e,t){let n=K(e,t);if(!(n.quelleId===``||n.code===``))for(let r=0;r<e.spalten.length;r++){if(r===t)continue;let i=e.spalten[r],a=la(i,e.quelleId);if(a.quelleId===n.quelleId&&!(a.code===``||a.code===n.code))return{titel:i.titel,code:a.code}}}function fa(e,t){let n=K(e,t);if(n.art!==`verknuepft`||n.quelleId===``||n.code===``)return[];let r=[];for(let t of e.spalten){let i=la(t,e.quelleId);i.quelleId!==n.quelleId||i.code===``||r.some(e=>e.feld===i.code)||r.push({titel:t.titel,feld:i.code})}return r}function pa(e,t,n){let r=e.map(e=>({toField:e.toField,soll:t(e.fromField)})).filter(e=>e.soll!==void 0);return r.length===0?[...n]:n.filter(e=>r.every(t=>t.soll!==``&&t.soll===A(e,t.toField)))}function ma(e,t,n){return y`<input
    class="erf-eingabe"
    type="text"
...
`;function Ta(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen])}}function Ea(e,t,n){return t===``||n===``?[...e]:e.filter(e=>Br(A(e,t))===n)}function Da(e){let t=e.getAttribute(`source`)??``;if(t===``)return null;let n=k(R().FF_DATA_SOURCES,t);return n?{quelle:n,zeilen:Ea(Dt(R().SEDATA,n.name,n.tableId,n.offenerSatz),e.getAttribute(`tagfield`)??``,Gr()),lies:Di(e)}:null}function Oa(e){return Qi(e.getAttribute(`spalten`)??``)}function ka(e,t){let n=k(R().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?St(n,t):``}function Aa(e){let t=k(R().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return t!==void 0&&t.indexField!==``}function ja(e,t){t&&e.vergissGeschriebene();let n=Da(e);if(!n){e.datenzeilen=[];return}let r=Oa(e),{rows:i,gefiltert:a}=Yt(e,n.zeilen),o=Ht(N(e),i,e=>e)[0]??-1,s=n.lies;e.datenGeliefert=!0,e.rohzeilen=i,e.auswahlIndex=o,e.durchAuswahlGefiltert=a,e.datenzeilen=i.map(e=>r.map(t=>t.feld===``?``:s(e,t.feld)))}var Ma=Si({hydriere:ja}),Na=Ma.connect,Pa=Ma.disconnect;function Fa(e,t){let n=[];return e.forEach((e,r)=>{Xr(e,t)&&n.push(r)}),n}function Ia(e,t){return!e&&t.trim()!==``}function La(e,t,n){return e&&t&&n===0}function Ra(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function za(e){return e.reduce((e,t)=>e+(t.breite??0),0)}function Ba(e){let t={...e};return delete t.breite,t}function Va(e,t){let n=za(e);if(n<=0)return[...e];let r=t/n;return e.map(e=>({...e,breite:Math.max(40,Math.round((e.breite??0)*r))}))}function Ha(e){return e.length>0&&e.every(e=>e.breite!==void 0)}function Ua(e){let t=W(e.length);if(!Ha(e))return[...e,t];let n=za(e),r=Math.max(40,Math.round(n/(e.length+1))),i=n-r;return i<e.length*40?[...e.map(Ba),t]:[...Va(e,i),{...t,breite:r}]}function Wa(e,t,n){let r=t();if(r.length<=1||e<0||e>=r.length)return;let i=za(r);r.splice(e,1),n(Ha(r)?Va(r,i):r)}function Ga(e,t,n){return y`<div class="steuerung">
    <button
      title="Letzte Spalte entfernen"
      @click=${r=>{n(r),Wa(e().length-1,e,t)}}
    >−</button>
    <button
      title="Spalte hinzufügen"
      @click=${r=>{n(r);let i=e();i.length<16&&t(Ua(i))}}
    >+</button>
  </div>`}function Ka(e,t){let n=e.currentTarget;n&&(e.stopPropagation(),e.preventDefault(),ot(n,(e,n)=>e===``||e===n.trim()?!1:(t(e),!0)))}function qa(e,t,n,r){Ka(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var Ja=220,Ya=new WeakMap;function Xa(e){let t=Ya.get(e);t!==void 0&&(clearTimeout(t),Ya.delete(e))}function Za(e,t,n){return y`<button
    class="kopf-weg"
    type="button"
  ...
  >&#x2715;</button>`}function Qa(e){return{dblklickKopf:(t,n)=>{e.editable()&&(Xa(e.baustein),qa(t,n,e.liste,e.aendere))},klickKopf:(t,n)=>{e.editable()&&$a(e.baustein,t,{prop:e.prop,index:n,liste:e.liste}),e.sortiere(n)}}}function $a(e,t,n){t.stopPropagation();let r=t.currentTarget.getBoundingClientRect();Xa(e),Ya.set(e,setTimeout(()=>{Ya.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n.prop,index:n.index,top:r.bottom+4,left:r.left,...n.liste?{liste:n.liste()}:{}},bubbles:!0,composed:!0}))},Ja))}var eo=`\0`;function to(e,t){return e+eo+String(t)}var no=class{constructor(){this.werte=new Map}setze(e,t,n){if(e===``)return!1;let r=to(e,t);return this.werte.get(r)===n?!1:(this.werte.set(r,n),!0)}nimmZurueck(e,t){return this.werte.delete(to(e,t))}wert(e,t){return e===``?void 0:this.werte.get(to(e,t))}get anzahl(){return this.werte.size}proSatz(){let e=[];for(let[t,n]of this.werte){let[r,i]=t.split(eo),a=Number(i),o=e.find(e=>e.satz===r),s={satz:r,spalte:a,wert:n};o?o.aenderungen.push(s):e.push({satz:r,aenderungen:[s]})}return e}nimmSatzZurueck(e){let t=!1;for(let n of[...this.werte.keys()])n.slice(0,n.indexOf(eo))===e&&this.werte.delete(n)&&(t=!0);return t}},ro=class{constructor(e){this.aenderungen=new no,this.geloescht=new Set,this.wirt=e}get geaenderteZeilen(){if(this.aenderungen.anzahl===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let{satz:r}of this.aenderungen.proSatz()){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}get geloeschteZeilen(){if(this.geloescht.size===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let r of this.geloescht){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}austragen(e,t){let n=!1;for(let r of t)n=e===`geaendert`?this.aenderungen.nimmSatzZurueck(r)||n:this.geloescht.delete(r)||n;n&&this.wirt.melde()}vorgemerkteAenderungen(){return this.geaenderteZeilen.length}vorgemerkteLoeschungen(){return this.geloeschteZeilen.length}statusVon(e){let t=this.satzVon(e);if(t===``)return{status:`gebucht`,titel:``};if(this.geloescht.has(t))return this.wirt.lauf.zeigt(`geloescht`,t,`loeschung`);let n=this.wirt.spalten().some((e,n)=>this.aenderungen.wert(t,n)!==void 0);return this.wirt.lauf.zeigt(`geaendert`,t,n?`geaendert`:`gebucht`)}satzPlaetze(){let e=new Map;return this.wirt.rohzeilen().forEach((t,n)=>{let r=ka(this.wirt.baustein,t);r!==``&&!e.has(r)&&e.set(r,n)}),e}satzVon(e){let t=this.wirt.rohzeilen()[e];return t===void 0?``:ka(this.wirt.baustein,t)}schalteLoeschung(e){let t=this.satzVon(e);t!==``&&(this.geloescht.has(t)?this.geloescht.delete(t):(this.geloescht.add(t),this.wirt.spalten().forEach((e,n)=>{this.aenderungen.nimmZurueck(t,n)})),this.wirt.melde())}istGeloescht(e){let t=this.satzVon(e);return t!==``&&this.geloescht.has(t)}zellWert(e,t){let n=this.aenderungen.wert(this.satzVon(e),t);return n===void 0?this.wirt.datenzeilen()[e]?.[t]??``:n}istGeaendert(e,t){return this.aenderungen.wert(this.satzVon(e),t)!==void 0}tippeZelle(e,t,n){this.aenderungen.setze(this.satzVon(e),t,n)&&this.wirt.melde()}verlasseZelle(e,t,n){let r=this.satzVon(e);(n===(this.wirt.datenzeilen()[e]?.[t]??``)?this.aenderungen.nimmZurueck(r,t):this.aenderungen.setze(r,t,n))&&this.wirt.melde()}zelleNachbar(e,t,n,r){let i=Array.from(this.wirt.baustein.shadowRoot?.querySelectorAll(`.koerper > .zeile:not(.erfassung) .zell-eingabe[data-spalte="${e}"]`)??[]),a=i.indexOf(t);if(a<0)return;let o=a+n;if(o>i.length-1){if(r&&this.wirt.erfassungAn()){this.wirt.fokussiereErfassungsZelle(0);return}o=i.length-1}o<0&&(o=0);let s=i[o];!s||s===t||(s.focus(),s.select(),s.scrollIntoView({block:`nearest`}))}tasteZelle(e,t,n){let r=n.target;if(n.key===`Escape`){n.preventDefault(),n.stopPropagation(),this.aenderungen.nimmZurueck(this.satzVon(e),t)&&this.wirt.melde();return}let i={Enter:1,ArrowDown:1,ArrowUp:-1,PageDown:10,PageUp:-10}[n.key];i!==void 0&&(n.preventDefault(),n.stopPropagation(),this.zelleNachbar(t,r,i,n.key===`Enter`))}},io={gebucht:``,erfasst:`Neue Zeile — noch nicht geschrieben`,geaendert:`Geändert — noch nicht geschrieben`,loeschung:`Zum Löschen vorgemerkt — noch nicht geschrieben`,schreibt:`Wird geschrieben …`,geschrieben:`Hinausgeschickt — bleibt stehen, bis neue Daten kommen`,fehler:`Nicht geschrieben`},ao=class{constructor(e){this.schreibend=new Map,this.fehler=new Map,this.melde=e}schreibt(e,t){this.fehler.get(e)?.delete(t);let n=this.schreibend.get(e)??new Set;n.add(t),this.schreibend.set(e,n),this.melde()}gescheitert(e,t,n){this.schreibend.get(e)?.delete(t);let r=this.fehler.get(e)??new Map;r.set(t,n),this.fehler.set(e,r),this.melde()}fertig(e,t){this.schreibend.get(e)?.clear();let n=this.fehler.get(e);if(n)for(let e of t)n.delete(e);this.melde()}zeigt(e,t,n){let r=this.fehler.get(e)?.get(t);return r===void 0?this.schreibend.get(e)?.has(t)===!0?{status:`schreibt`,titel:io.schreibt}:{status:n,titel:io[n]}:{status:`fehler`,titel:io.fehler+`: `+r}}},oo=4;function so(e){return e??oo}function co(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function lo(e,t,n){let r=co(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function uo(e,t){return e===null?null:Math.max(0,e-t)}function fo({sichtbar:e,hatQuelle:t,platzhalterZeilen:n}){return t?{seiten:1,seite:0,zeilen:[...e]}:{seiten:1,seite:0,zeilen:Array.from({length:n},()=>null)}}function po({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function mo(e){if(!e.hasAttribute(`fuellt`))return-1;let t=e.renderRoot.querySelector(`.koerper`);return t instanceof HTMLElement?t.clientHeight:-1}function ho(e,t){let n=mo(e);if(n===-1)return{mass:null,hoehe:n};let r=e.renderRoot.querySelector(`.kopf`);return{mass:lo(n,r instanceof HTMLElement?r.offsetHeight:0,t),hoehe:n}}function go(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}var _o=`ff-zeile-aktiviert`,vo=`data-ff-roh`;function yo(e,t){e.dispatchEvent(new CustomEvent(_o,{detail:t,bubbles:!0,composed:!0}))}function bo(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(vo);return r===null||r===``?null:Number(r)}function xo(e,t){if(!(e instanceof HTMLElement))return!1;let n=e.closest(`.zeile`),r=n?.parentElement;if(!n||!r)return!1;let i=[...r.querySelectorAll(`.zeile[${vo}]`)],a=i.indexOf(n),o=a===-1?void 0:i[a+t];return o?(o.focus(),!0):!1}function So(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.zeile[${vo}]`);return t?(t.focus(),!0):!1}function Co(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.suchzeile input`);return t?(t.focus(),!0):!1}function wo(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var To=class{constructor(e){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._rumpfGemessen=-1,this._fokusZeile=null,this._fokusHolen=!1,this.wirt=e}get suchtext(){return this._suchtext}get suchtAktiv(){return this._suchtext.trim()!==``}get sortSpalte(){return this._sortSpalte}get sortAuf(){return this._sortAuf}get seite(){return this._seite}get mass(){return this._mass}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.wirt.melde()}klickSortiere(e){this.wirt.editable()||(this.merkeZeilenFokus(),this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.wirt.melde())}blaettere(e){this.merkeZeilenFokus(),this._seite=e,this.wirt.melde()}fokussiereSuche(){let e=this.wirt.baustein.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}merkeZeilenFokus(){let e=bo(this.wirt.baustein.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.wirt.zeilenHoehe();this._taktGemessen=e;let{mass:t,hoehe:n}=ho(this.wirt.baustein,e);this._rumpfGemessen=n,!(t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe)&&(this._mass=t,this.wirt.melde())}beobachte(){this._beobachter||(this._beobachter=go(this.wirt.baustein,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}nachRendern(){(this._taktGemessen!==this.wirt.zeilenHoehe()||this._rumpfGemessen!==mo(this.wirt.baustein))&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,wo(this.wirt.baustein.shadowRoot,this._fokusZeile))}loese(){this._beobachter?.disconnect(),this._beobachter=null}nachPush(){this._seite=0,this._mass=null,this._taktGemessen=0,this._rumpfGemessen=-1}zuruecksetzen(){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this.nachPush(),this._fokusZeile=null,this._fokusHolen=!1}};function Eo(e,t,n,r){if(n===null||e.hasAttribute(`data-ff-editor`))return;let i=t[n];i!==void 0&&(yo(e,{rohzeile:i,rohIndex:n,ansichtIndex:r}),Oo(e,i),V(e,`onRowClick`,{PINDEX:ka(e,i)}).catch(B))}function Do(e,t,n){if(n===null||e.hasAttribute(`data-ff-editor`))return;let r=t[n];r!==void 0&&V(e,`onRowDblClick`,{PINDEX:ka(e,r)}).catch(B)}function Oo(e,t){let n=N(e);n!==``&&Ut(n,t)}var ko={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Ki,eintragsSchalter:[{key:`summe`,label:`Summe in der Fußzeile`,kurz:`Summe`},{key:`aenderbar`,label:`In der Zeile änderbar`,kurz:`änderbar`,standard:!0,nurEigeneQuelle:!0}],herkunftProp:`spaltenHerkunft`,eintragsFeldWahl:[{key:`fuellFeld`,label:`Nachschlagen`,hinweis:`Beim Erfassen füllt der gewählte Satz der Hilfsquelle diese Zelle.`,nurFremdeQuellen:!0}]};function Ao(e){let t=e,n=ko.eintragsSchalter?.find(e=>e.key===`aenderbar`);return n!==void 0&&e.feld!==``&&si(ko,t).includes(n)&&oi(n,t)}var jo=1,Mo=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,No=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,Po=/^(\d{4})-(\d{2})-(\d{2})$/;function Fo(e){let t=e.trim();if(t===``||!Mo.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function Io(e){let t=e.trim();if(t===``)return null;let n=Po.exec(t);if(n){let[,e,t,r]=n;return Lo(Number(e),Number(t),Number(r))}let r=No.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return Lo(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function Lo(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function Ro(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,Fo(i)!==null&&n++,Io(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var zo=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function Bo(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=Ro(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return jo;if(o===``)return-1;let s=i===`zahl`?(Fo(n)??0)-(Fo(o)??0):i===`datum`?(Io(n)??0)-(Io(o)??0):zo.compare(n,o);return s===0?e-t:s*a})}function Vo(e,t,n){let r=0,i=0;for(let t of e){let e=Fo(t);e!==null&&(r+=e,i++)}return i===0?``:r.toLocaleString(`de-DE`,{minimumFractionDigits:t,maximumFractionDigits:n})}var Ho={min:0,max:3};function Uo(e,t){let n=[];return e.spalten.forEach((r,i)=>{if(r.summe!==!0)return;let a=Vo(t.map(t=>e.wertVon(t,i)),Ho.min,Ho.max);a!==``&&n.push({titel:r.titel,text:a})}),n}function Wo(e){let t=Fa(e.datenzeilen,e.suchtext);return e.sortSpalte<0?t:Bo(t.map(t=>e.datenzeilen[t]),e.sortSpalte,e.sortAuf).map(e=>t[e])}function Go(e){let t={gridTemplateColumns:$i(e.spalten,e.breiteVon)},n=e.gemessen?.zeilenHoehe??28,r=e.hatQuelle,i=!e.erfassungAn&&La(r,e.datenGeliefert,e.datenzeilen.length),a=Wo(e),o=e.erfassungAn?1+e.erfassteAnzahl:0,s=e.gemessen===null?null:Math.max(1,e.gemessen.passen-o),c={sichtbar:a,hatQuelle:r,proSeite:s??Math.max(1,10-o),wunschSeite:e.wunschSeite,platzhalterZeilen:so(s)},{seiten:l,seite:u,zeilen:d}=e.blaettert?po(c):fo(c);return{cols:t,takt:28,zeilenHoehe:n,hatQuelle:r,leer:i,gesamt:a.length,seiten:l,seite:u,zeilen:d,linealTakte:uo(s,d.length),summen:Uo(e,a)}}var Ko=[U(`suche`,`Suchzeile`,`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,{requiresDataSource:!0}),U(`erfassung`,`Erfassungszeile`,`Eine leere Zeile zum Tippen neuer Positionen.`),U(`loeschbar`,`Zeilen löschbar`,`Kreuz an jeder Zeile: merkt sie zum Löschen vor.`,{requiresDataSource:!0}),U(`blaettern`,`Blättern`,`Ja: Seiten mit Blätter-Knöpfen. Nein: alles untereinander, der Rumpf rollt.`),U(`kopfzeile`,`Kopfzeile`,`Aus: keine Titelzeile, kein Sortieren per Titelklick.`),{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Sätze des gewählten Tages.`,kind:`field`},oa()];function qo(e,t){let n=e.erfasst+e.geaendert+e.geloescht,r=e.seiten>1||e.summen.length>0||n>0||e.suchtAktiv||e.auswahlAktiv;return e.leer||!r?x:y`<div class="fusszeile">
    ...
    ${n===0?x:y`<div class="vorgemerkt">${br(e.erfasst,e.geaendert,e.geloescht)}</div>`}
  ...
  </div>`}var Jo=/[.*+?^${}()|[\]\\]/g;function Yo(e,t){let n=Yr(t);if(n.length===0||e===``)return e;let r;try{r=RegExp(`(${n.map(e=>e.replace(Jo,`\\$&`)).join(`|`)})`,`ig`)}catch{return e}let i=e.split(r);return i.length<=1?e:y`${i.map((e,t)=>t%2==1?y`<mark>${e}</mark>`:e)}`}function Xo(e,t,n){let r=40-e,i=t-40,a=r>i?0:Math.min(i,Math.max(r,Math.round(n)));return{links:Math.round(e+a),rechts:Math.round(t-a)}}function Zo(e,t,n){if(e.button!==0)return;let r=e.currentTarget?.parentElement,i=r?.nextElementSibling;if(!r||!(i instanceof HTMLElement))return;e.stopPropagation(),e.preventDefault();let a=e.clientX,o=r.getBoundingClientRect().width,s=i.getBoundingClientRect().width,c=Xo(o,s,0),l=()=>{window.removeEventListener(`pointermove`,d),window.removeEventListener(`pointerup`,f),window.removeEventListener(`pointercancel`,p),window.removeEventListener(`keydown`,m),window.removeEventListener(`blur`,p)},u=()=>[{index:t,breite:c.links},{index:t+1,breite:c.rechts}];function d(e){c=Xo(o,s,e.clientX-a),n.zeige(u())}function f(){l(),n.uebernimm(u())}function p(){l(),n.verwirf()}function m(e){e.key===`Escape`&&(e.preventDefault(),p())}window.addEventListener(`pointermove`,d),window.addEventListener(`pointerup`,f),window.addEventListener(`pointercancel`,p),window.addEventListener(`keydown`,m),window.addEventListener(`blur`,p)}function Qo(e,t){return y`<span
    class="breite-griff"
    role="presentation"
    title="Linie ziehen: links breiter, rechts schmaler"
    @pointerdown=${n=>Zo(n,e,t)}
    @click=${e=>e.stopPropagation()}
    @dblclick=${e=>e.stopPropagation()}
  ></span>`}function $o(e){return e.linealTakte===0?x:y`<div class="lineal" role="presentation" style=${G(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>y`<div></div>`)}
        </div>`}function es(e,t){return y`
      ${e.zeigeSuche?y`<div class="suchzeile">
        <input
          ...
          @keydown=${e=>{e.key===`ArrowDown`&&So(e.target)&&e.preventDefault()}}
        />
      </div>`:``}
      ...
      ${e.zeigeKopf?y`<div class="kopf" role="row" style=${G(e.cols)}>
        ${e.spalten.map((n,r)=>y`<div
          ...
          >${e.imEditor&&(e.herkunft[r]??``)!==``?y`<span class="kopf-titel">${n.titel}</span><span
                ...
                >${e.herkunft[r]}</span>`:n.titel}${!e.editable&&e.sortSpalte===r?y`<span class="sort-pfeil">${e.sortAuf?` ▲`:` ▼`}</span>`:``}${e.imEditor&&e.editable&&e.spalten.length>1?Za(n.titel,r,t.loescheSpalte):x}${r<e.spalten.length-1?Qo(r,t.breiten):x}</div>`)}
      </div>`:x}
        ${``}
        ${e.leer?sa(e.leerText,!0):y`
        ...
        ${e.zeilen.map((n,r)=>{let i=n!==null&&!e.imEditor,a=n!==null&&e.zeilenStand.istGeloescht(n),o=n===null?{status:`gebucht`,titel:``}:e.zeilenStand.statusVon(n);return y`<div
            ...
            @keydown=${e=>{if(!e.target.closest(`.zell-eingabe`)){if(e.key===`ArrowDown`||e.key===`ArrowUp`){let t=e.key===`ArrowUp`;(xo(e.target,t?-1:1)||t&&Co(e.target))&&e.preventDefault();return}e.key===`Enter`&&(e.preventDefault(),t.aktiviereZeile(n,r))}}}
          >
            ${``}
            ${e.spalten.map((r,i)=>{let a=n===null?`—`:e.datenzeilen[n]?.[i]??``,o=e.imEditor&&!e.zeigeKopf&&e.editable;if(e.aendernMoeglich&&n!==null&&Ao(r)){let t=e.zeilenStand;return y`<div class="tippbar" role="cell">
                <input
...
`,q=class e extends E{constructor(...e){super(...e),this.spalten=Ji(),this.spaltenHerkunft=[],this.source=``,this.suche=`ja`,this.erfassung=`nein`,this.blaettern=`ja`,this.loeschbar=`nein`,this.kopfzeile=`ja`,this.leerText=aa,this.datenzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._besitz=`softengine`,this._breiten=new Map,this._breiteVorZug=null,this._ansicht=new To({baustein:this,editable:()=>this.editable,zeilenHoehe:()=>this.zeilenHoehe,melde:()=>this.requestUpdate()}),this._erfassung=new Ca,this._lauf=new ao(()=>this.requestUpdate()),this._zeilen=new ro({baustein:this,spalten:()=>this.spaltenListe(),rohzeilen:()=>this.rohzeilen,datenzeilen:()=>this.datenzeilen,melde:()=>this.requestUpdate(),lauf:this._lauf,erfassungAn:()=>this.erfassungAn,fokussiereErfassungsZelle:e=>this.fokussiereErfassungsZelle(e)}),this.nimmSeFokus=e=>{e.defaultPrevented||!this.erfassungAn||this.hasAttribute(`data-ff-editor`)||(e.preventDefault(),this.fokussiereErfassungsZelle(0))}}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.kannErfassen={wenn:{attributeName:`erfassung`,equals:`ja`}}}static{this.aenderungsSchluessel=`aenderbar`}static{this.kannLoeschen={wenn:{attributeName:`loeschbar`,equals:`ja`}}}static{this.blockEvents=[{key:`onRowClick`,name:`Zeile gewählt`},{key:`onRowDblClick`,name:`Zeile doppelt geklickt`}]}static{this.listenBindung=ko}static{this.defaultProps={width:`fill`,source:``,spalten:Ji(),suche:`ja`,erfassung:`nein`,blaettern:`ja`,loeschbar:`nein`,kopfzeile:`ja`,tagField:``,leerText:aa}}static{this.customProperties=Ko}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?Pa(this):Na(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=Ta(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.nachPush(),this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.zuruecksetzen(),this._erfassung.zuruecksetzen()}get erfassteZeilen(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.werte)}get erfassteSchluessel(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.kennung)}get geaenderteZeilen(){return this._zeilen.geaenderteZeilen}get geloeschteZeilen(){return this._zeilen.geloeschteZeilen}zeileSchreibt(e,t){this._lauf.schreibt(e,t)}zeileGescheitert(e,t,n){this._lauf.gescheitert(e,t,n)}laufFertig(e,t){if(this._lauf.fertig(e,t),e===`erfasst`){this._erfassung.markiereGeschrieben(this.erfassungsUmfeld(),t)&&this.requestUpdate();return}this._zeilen.austragen(e,t)}vergissGeschriebene(){this._erfassung.vergissGeschriebene()&&this.requestUpdate()}erfasstStand(e){return this._lauf.zeigt(`erfasst`,this._erfassung.schluessel[e]??``,this._erfassung.istGeschrieben(e)?`geschrieben`:`erfasst`)}erfasseZeile(){return this._erfassung.erfasse(this.erfassungsUmfeld())?(this.requestUpdate(),this.fokussiereErfassungsZelle(0),this.zeigeLetzteErfasste(),!0):!1}zeigeLetzteErfasste(){this.updateComplete.then(()=>{let e=this.shadowRoot?.querySelector(`.koerper`);e&&(e.scrollTop=e.scrollHeight)})}fokussiereSuche(){return this._ansicht.fokussiereSuche()}setzeSuchtext(e){this._ansicht.setzeSuchtext(e),this.requestUpdate()}get hatQuelle(){return this._besitz===`provided`||Ia(this.hasAttribute(`data-ff-editor`),this.source)}spaltenListe(){return Zi(this.spalten)}get zeilenHoehe(){return 28}breitenWirt(){let e=e=>{this._breiteVorZug===null&&(this._breiteVorZug=new Map(e.map(e=>[e.index,this._breiten.get(e.index)])))};return{zeige:t=>{e(t);for(let e of t)this._breiten.set(e.index,e.breite);this.requestUpdate()},uebernimm:e=>{this._breiteVorZug=null;let t=this.spaltenListe();if(!this.hasAttribute(`data-ff-editor`)){for(let t of e)this._breiten.set(t.index,t.breite);this.requestUpdate();return}for(let n of e)n.index>=t.length||(this._breiten.delete(n.index),t[n.index]={...t[n.index],breite:n.breite});this.aendere(t)},verwirf:()=>{let e=this._breiteVorZug;if(this._breiteVorZug=null,e){for(let[t,n]of e)n===void 0?this._breiten.delete(t):this._breiten.set(t,n);this.requestUpdate()}}}}get erfassungAn(){return this.erfassung===`ja`}erfassungsWirt(){return{baustein:this,lauf:this._erfassung.lauf,umfeld:()=>this.erfassungsUmfeld(),melde:()=>this.requestUpdate(),fokussiere:e=>this.fokussiereErfassungsZelle(e),erfasseZeile:()=>this.erfasseZeile()}}fokussiereErfassungsZelle(e){this.updateComplete.then(()=>{let t=this.shadowRoot?.querySelectorAll(`.zeile.erfassung .erf-eingabe`)?.[e];t&&(t.focus(),t.scrollIntoView({block:`nearest`}))})}erfassungsUmfeld(){return this._erfassung.umfeld(this,this.spaltenListe(),this.source)}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&Na(this),document.addEventListener(Fn,this.nimmSeFokus),this._ansicht.beobachte()}firstUpdated(){this._ansicht.beobachte()}willUpdate(e){super.willUpdate(e),e.has(`spalten`)&&this._breiten.clear(),!(!this.erfassungAn||this.hasAttribute(`data-ff-editor`))&&this._erfassung.lauf.aktualisiereVorschlaege(this.erfassungsUmfeld())}updated(){this._ansicht.nachRendern(),Tr(this)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(Fn,this.nimmSeFokus),Xa(this),this._ansicht.loese(),bs(this),Pa(this)}static{this.styles=[E.styles,ca,ts,ni,wa]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=Go({spalten:t,breiteVon:e=>this._breiten.get(e),hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._ansicht.suchtext,sortSpalte:this._ansicht.sortSpalte,sortAuf:this._ansicht.sortAuf,wunschSeite:this._ansicht.seite,gemessen:this._ansicht.mass,erfassungAn:this.erfassungAn,erfassteAnzahl:this._erfassung.zeilen.length,wertVon:(e,t)=>this._zeilen.zellWert(e,t),blaettert:this.blaettern===`ja`});return y`<div class="tabelle" style=${G({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
    ...
    >${Gi()}</button>
    ${e.liste}
  </div>`}var is={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Ki,quelleProp:`nachschlagQuelle`};function as(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?Zi(e):[]}function os(e,t){let n=e[0];return n===void 0?t:n.feld}function ss(e,t){let n=e.trim();return n===``||n===t.trim()}function cs(e,t,n){let r=t.trim(),i=[],a=ss(t,n),o=new Set;for(let t of e){let e=A(t,n).trim(),s=r===``?e:A(t,r).trim();if(!(s===``&&e===``)){if(a){if(o.has(e))continue;o.add(e)}i.push({anzeige:s,wert:e,satz:t})}}return i}function ls(e,t,n,r){return cs(Yt(e,t).rows,n,r)}function us(e){let t=k(R().FF_DATA_SOURCES,e);return t?Dt(R().SEDATA,t.name,t.tableId,t.offenerSatz):null}function ds(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=us(e.quelleId);if(t===null)return{ok:!1,grund:`quelleFehlt`};let n=os(as([...e.spalten]),e.speicherFeld);return{ok:!0,eintraege:ls(e.el,t,n,e.speicherFeld)}}function fs(e,t){return t&&e.length===1?e[0]:null}function ps(e,t){let{rows:n,gefiltert:r}=Yt(e,[t]);return!r||n.length>0}function ms(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var hs=null,gs=null,_s=null;function vs(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function ys(e=!0){let t=e?_s:null;_s=null,hs?.remove(),hs=null,gs=null,t?.focus()}function bs(e){gs===e&&ys(!1)}function xs(e){return[{titel:e.speicherTitel===``?`Wert`:e.speicherTitel,feld:e.speicherFeld}]}function Ss(e){let t=e=>e.stopPropagation(),n=e.editor;return y`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >${e.inhalt}</ff-dialog-rahmen>`}function Cs(e,t){let n=as([...e.spalten]),r=ss(os(n,e.speicherFeld),e.speicherFeld);return y`<ff-tabelle
    fuellt
    suche="ja"
    style="--se-r-lg:0px"
    .besitz=${`provided`}
  ...
  ></ff-tabelle>`}function ws(e){let t=e.eintraege;if(t===void 0){let n=ds(e);if(!n.ok){L(n.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}t=n.eintraege}ys(!1);let n=document.createElement(`div`);n.style.display=`contents`,Ve(Ss({titel:e.titel,breite:e.breite,hoehe:e.hoehe,inhalt:Cs(e,t),onSchliessen:()=>ys()}),n);let r=n.querySelector(Zt),i=n.querySelector(q.tagName);i?.addEventListener(_o,n=>{let r=n.detail,i=t[r.rohIndex];i&&(ys(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),_s=e.rueckFokus??vs(e.el),document.body.appendChild(n),hs=n,gs=e.el;let a=e.suchtext??``;i&&a!==``&&i.setzeSuchtext(a),r&&i&&Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}function Ts(e){return Ss({titel:e.titel,breite:e.breite,hoehe:e.hoehe,onSchliessen:e.onSchliessen,editor:{onGroesse:e.onGroesse},inhalt:y`<ff-tabelle
      data-ff-editor
      fuellt
      suche="ja"
      style="--se-r-lg:0px"
    ...
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}setzeHaken(e){this.angehakt!==e&&(this.angehakt=e,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return y`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return y`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
        ...
        </select>`}case`nachschlagen`:return rs({wert:this.getippt??this.anzeige,onTippen:e=>{this.getippt=e,this.marke=0,this.markeVonHand=!1,this.listeZu=!1},onTaste:e=>this.onNachschlagTaste(e),onVerlassen:()=>this.onNachschlagVerlassen(),onLupe:()=>this.onLupe(),liste:this.vorschlaege.length===0?x:ti({eintraege:this.vorschlaege,marke:this.marke,onWaehlen:e=>this.uebernimmVorschlag(e),onMarke:e=>{this.marke=e}})});default:return y`<input
          class="ctrl"
          type=${e}
        ...
        />`}}onLupe(e=``){if(this.hasAttribute(`data-ff-editor`)){this.spaltenDialog=!0;return}ws({el:this,quelleId:this.nachschlagQuelle,speicherFeld:this.speicherFeld,speicherTitel:this.speicherTitel,spalten:this.nachschlagSpalten,titel:this.placeholder,breite:this.fensterBreite,hoehe:this.fensterHoehe,suchtext:e,onUebernehmen:(e,t,n)=>this.uebernimmUndMelde(e,t,n)})}spaltenEffektiv(){let e=as(this.nachschlagSpalten);return e.length>0?e:xs({speicherFeld:this.speicherFeld,speicherTitel:this.speicherTitel})}meldeProp(e,t,n){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:e,value:t,...n===void 0?{}:{geste:n}},bubbles:!0,composed:!0}))}spaltenDialogTpl(){return Ts({titel:this.placeholder,spalten:this.spaltenEffektiv(),breite:this.fensterBreite,hoehe:this.fensterHoehe,onGroesse:t=>{let n=t.achse===`breite`?`fensterBreite`:`fensterHoehe`;if(t.geste===`standard`){this.meldeProp(n,e.defaultProps[n]);return}this.meldeProp(n,t.wert,t.geste===`laeuft`?void 0:t.geste)},onAendern:e=>{this.meldeProp(`nachschlagSpalten`,e)},onFeldWahl:e=>{this.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:`nachschlagSpalten`,...e},bubbles:!0,composed:!0}))},onSchliessen:()=>{this.spaltenDialog=!1}})}willUpdate(e){super.willUpdate(e),e.has(`fieldType`)&&Hi(this.fieldType)!==`nachschlagen`&&(this.spaltenDialog=!1),this.vorschlaege=this.berechneVorschlaege(),this.marke=$r(this.marke,this.vorschlaege.length)}updated(e){super.updated(e),this.toggleAttribute(`data-ff-liste`,this.vorschlaege.length>0)}berechneVorschlaege(){if(this.getippt===null||this.listeZu||Hi(this.fieldType)!==`nachschlagen`||this.hasAttribute(`data-ff-editor`))return[];let e=ds({el:this,quelleId:this.nachschlagQuelle,speicherFeld:this.speicherFeld,spalten:this.nachschlagSpalten});return e.ok?Zr(e.eintraege,this.getippt):[]}onNachschlagTaste(e){if(this.hasAttribute(`data-ff-editor`))return;let t=this.vorschlaege.length,n=ei(e.key,{listeOffen:t>0,feldLeer:(this.getippt??this.anzeige)===``,treffer:t,markeVonHand:this.markeVonHand});if(n===`nichts`){e.key===`Enter`&&e.preventDefault();return}e.preventDefault(),n===`marke-hoch`||n===`marke-runter`?(this.marke=Qr(this.marke,t,n===`marke-hoch`?-1:1),this.markeVonHand=!0):n===`uebernehmen`?this.uebernimmVorschlag(this.marke):n===`liste-zu`?this.listeZu=!0:this.onLupe(this.getippt??``)}uebernimmVorschlag(e){let t=this.vorschlaege[e];t&&this.uebernimmUndMelde(t.anzeige,t.wert,t.satz)}leereNachschlagen(){this.satz=void 0,this.anzeige=``,this.value=``,Gt(N(this))}uebernimmUndMelde(e,t,n){this.getippt=null,this.listeZu=!1,this.marke=0,this.markeVonHand=!1,this.uebernimmSatz(e,t,n),this.dispatchEvent(new Event(`change`))}uebernimmSatz(e,t,n){this.anzeige=e===``?t:e,this.value=t,this.satz=n,Wt(N(this),n)}onNachschlagVerlassen(){if(this.hasAttribute(`data-ff-editor`))return;let e=ms(this.getippt??this.anzeige,this.anzeige,this.value);this.getippt=null,this.listeZu=!1,this.marke=0,this.markeVonHand=!1,e===`leeren`&&(this.leereNachschlagen(),this.dispatchEvent(new Event(`change`)))}pruefeEigenenWert(){Hi(this.fieldType)===`nachschlagen`&&(this.getippt!==null&&this.requestUpdate(),this.satz!==void 0&&!ps(this,this.satz)&&this.leereNachschlagen(),this.uebernimmEinzigenTreffer())}uebernimmEinzigenTreffer(){if(this.einzigerTreffer!==`ja`)return;let e=ds({el:this,quelleId:this.nachschlagQuelle,speicherFeld:this.speicherFeld,spalten:this.nachschlagSpalten});if(!e.ok)return;let t=fs(e.eintraege,this.satz===void 0);t&&this.uebernimmSatz(t.anzeige,t.wert,t.satz)}render(){let e=Hi(this.fieldType);if(e===`checkbox`)return y`<div class="feld">
        <div class="zeile">
          <input
            class="ctrl"
            type="checkbox"
...
`,ks=`frei · hierher ziehen`,As=`ff-zimmer-inhalt`,Y=class extends E{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[H.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[E.styles,ca,Os,Ds,o`
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(As,{bubbles:!0,composed:!0}))}render(){return y`<div class="zimmer ${Es}">
      <div
        class="kopf"
        data-ff-editable
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(As,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(H.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return y`<div class="col ${Es} v-${Or(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};T([C()],X.prototype,`variant`,void 0),T([C()],X.prototype,`heading`,void 0),T([C({attribute:!1})],X.prototype,`leerHinweis`,void 0),T([w()],X.prototype,`_count`,void 0),E.defineAndRegister(X);function js(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function Ms(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var Ns=new WeakMap,Ps=X.tagName,Fs=Y.tagName,Is=H.tagName;function Ls(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Ps)}function Rs(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Is)}function zs(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Fs)}function Bs(e){return[e,...zs(e)]}function Vs(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=zs(e);for(let e of t)r(e,Rs(e).length===0?ks:``);r(e,t.length===0&&Rs(e).length===0?n:``)}}function Hs(e){return Ye().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Us(e,t){let n=zs(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),a=js(A(t,r),i);return a>=0?n[a]:n[0]}function Ws(e){Q?.board===e&&Xs();let t=e.getAttribute(`statusfield`)??``,n=Da(e);if(!n)return;let r=Ls(e);if(r.length===0)return;let i=Ns.get(e);if(!i){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(Is);t&&(i=t.cloneNode(!0),Ns.set(e,i))}if(!i)return;let a=n.zeilen,o=r.map(e=>e.getAttribute(`heading`)??X.defaultProps.heading),s=Hs(i.tagName),c=Ms(r.map(e=>e.getAttribute(`auffang`))),l=n.lies;for(let e of r)for(let t of Bs(e))Rs(t).forEach(e=>e.remove());for(let e of a){let a=i.cloneNode(!0),u=t===``?-1:js(A(e,t),o),d=u>=0?r[u]:c>=0?r[c]:r[0];(Us(d,e)??d).appendChild(a);for(let t of s){let n=a.getAttribute(ci(t.prop))??``;n!==``&&(a[t.prop]=l(e,n))}let f=St(n.quelle,e);Z.set(a,{row:e,pindex:f}),a.draggable=!0}Vs(e,r);let u=r.flatMap(e=>Bs(e).flatMap(Rs)),d=Ht(N(e),u,e=>Z.get(e)?.row);for(let e of d)u[e].setAttribute(`data-ff-auswahl`,``)}var Z=new WeakMap,Q=null,Gs=new WeakSet,Ks=`data-ff-zieht`,qs=`data-ff-ziel`,Js=null;function Ys(e){Js!==e&&(Js?.removeAttribute(qs),Js=e,Js?.setAttribute(qs,``))}function Xs(){Q?.card.removeAttribute(Ks),Q=null,Ys(null)}function Zs(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function Qs(e,t){return Zs(e,t,Ps)}function $s(e,t,n){if(!Q||Q.board!==e)return;let r=Z.get(Q.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;V(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(B)}function ec(e){Gs.has(e)||(Gs.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Z.has(e))??null;if(!n)return;let r=Z.get(n);r&&Ut(N(e),r.row),V(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(B)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Z.has(e))??null;n&&(Q={card:n,board:e},t.dataTransfer?.setData(`text/plain`,Z.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{Q?.card===n&&n.setAttribute(Ks,``)},0))}),e.addEventListener(`dragend`,Xs),e.addEventListener(`dragover`,t=>{let n=Qs(e,t);if(Q?.board!==e||!n){Ys(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),Ys(Zs(e,t,Fs)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&Ys(null)}),e.addEventListener(`drop`,t=>{let n=Qs(e,t);n&&(t.preventDefault(),$s(e,n,Zs(e,t,Fs)),Xs())}))}var tc=Si({hydriere:Ws,verdrahte:ec}),nc=tc.connect,rc=tc.disconnect,ic=X.blockType,ac=class extends E{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[ic]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:ic}}static{this.templateChild={type:H.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:aa}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Feld, das die Spalte bestimmt. Leer: alle in die Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Einträge des gewählten Tages.`,kind:`field`},oa()]}static{this.defaultChildren=[{type:ic,props:{heading:`Offen`,variant:`warning`},children:[{type:H.blockType}]},{type:ic,props:{heading:`In Arbeit`,variant:`info`}},{type:ic,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[E.styles,o`
    ...
    `]}render(){return y`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),nc(this)}disconnectedCallback(){super.disconnectedCallback(),rc(this)}};E.defineAndRegister(ac);var oc={breite:56,breiteOffen:224},sc=`ff-seiten-wechsel`,cc=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],lc=class extends E{static{this.blockType=`navi-eintrag`}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:cc.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[E.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(sc,{detail:e,bubbles:!0,composed:!0}))}render(){return y`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};T([C()],lc.prototype,`seite`,void 0),T([C()],lc.prototype,`seitename`,void 0),T([C({reflect:!0})],lc.prototype,`ton`,void 0),E.defineAndRegister(lc);var uc=`aktiv`;function dc(e){return Array.from(e.querySelectorAll(lc.tagName))}function fc(e,t){let n=dc(e),r=t??n.find(e=>e.hasAttribute(uc))??n[0];for(let e of n)e===r?e.setAttribute(uc,``):e.removeAttribute(uc)}function pc(e){let t=e.hasAttribute(`offen`);for(let n of dc(e))n.toggleAttribute(`breit`,t)}function mc(e){return e.getAttribute(`name`)??String(ct.defaultProps.name)}function hc(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function gc(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(ct.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=hc(e,i);if(!a)return;let o=r.find(e=>mc(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var _c=new WeakMap,vc=new WeakSet;function yc(e){let t=t=>{let n=t.detail;n&&(fc(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),pc(e),!e.hasAttribute(`data-ff-editor`)&&gc(e,n.ansicht))};e.addEventListener(sc,t),_c.set(e,t)}function bc(e){let t=_c.get(e);t&&(e.removeEventListener(sc,t),_c.delete(e))}function xc(e){if(fc(e),pc(e),e.hasAttribute(`data-ff-editor`)||vc.has(e))return;let t=dc(e)[0];if(!t)return;vc.add(e);let n=()=>gc(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var Sc=lc.blockType,Cc=class extends E{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Sc]}static{this.addChildButton={label:`Eintrag`,childType:Sc}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[st]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[E.styles,o`
      :host {
        height: 100%;
        width: ${oc.breite}px;
    ...
    `]}connectedCallback(){super.connectedCallback(),yc(this)}disconnectedCallback(){super.disconnectedCallback(),bc(this)}klappen(){this.toggleAttribute(`offen`),pc(this)}render(){return y`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
      ...
      </div>`}};E.defineAndRegister(Cc);var wc=ci(`text`);function Tc(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(wc)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function Ec(e){let t=Oi(e,wc);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function Dc(e){Tc(e)&&(e.text=``)}var Oc=Si({hydriere:Ec,verdrahte:Dc}),kc=Oc.connect,Ac=Oc.disconnect,jc=6,Mc=96,Nc=14,Pc={duenn:`300`,normal:`400`,fett:`700`},Fc={links:`left`,mitte:`center`,rechts:`right`},Ic={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},Lc=`standard`;function Rc(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(Mc,Math.max(jc,t)):Nc}function zc(e){return typeof e==`string`&&e in Pc?e:`normal`}function Bc(e){return typeof e==`string`&&e in Fc?e:`links`}function Vc(e){return typeof e==`string`&&e in Ic?e:Lc}var $=class extends E{constructor(...e){super(...e),this.groesse=Nc,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=Lc,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:Nc,gewicht:`normal`,ausrichtung:`links`,farbe:Lc,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:jc,max:Mc,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[E.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return y`<div
      class="text"
      style=${G({fontSize:`${Rc(this.groesse)}px`,fontWeight:Pc[zc(this.gewicht)],textAlign:Fc[Bc(this.ausrichtung)],color:Ic[Vc(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),kc(this)}disconnectedCallback(){super.disconnectedCallback(),Ac(this)}};T([C({type:Number})],$.prototype,`groesse`,void 0),T([C()],$.prototype,`gewicht`,void 0),T([C()],$.prototype,`ausrichtung`,void 0),T([C()],$.prototype,`farbe`,void 0),T([C()],$.prototype,`text`,void 0),T([C()],$.prototype,`source`,void 0),T([C()],$.prototype,`textField`,void 0),E.defineAndRegister($);var Hc=[`waagerecht`,`senkrecht`],Uc=`waagerecht`;function Wc(e){return Hc.includes(e)?e:Uc}var Gc=class extends E{constructor(...e){super(...e),this.richtung=Uc}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:Uc}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[E.styles,o`
    ...
    `]}render(){return y`<div class="flaeche ${Wc(this.richtung)}"><div class="linie"></div></div>`}};T([C()],Gc.prototype,`richtung`,void 0),E.defineAndRegister(Gc),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;L(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();