...
`,B=class extends w{constructor(...e){super(...e),this.chipVariant=`info`,this.heading=``,this.heading2=``,this.time=``,this.date=``,this.avatar=``,this.meta=``,this.text=``,this.chipText=``,this.headingField=``,this.heading2Field=``,this.timeField=``,this.dateField=``,this.avatarField=``,this.metaField=``,this.textField=``,this.chipTextField=``}static{this.blockType=`card`}static{this.tagName=`ff-card`}static{this.displayName=`Karte`}static{this.category=`anzeige`}static{this.allowedParentTypes=[`kanban-spalte`,`kanban-zimmer`]}static{this.showInPalette=!1}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={chipVariant:`info`,heading:``,heading2:``,time:``,date:``,avatar:``,meta:``,text:``,chipText:``,headingField:``,heading2Field:``,timeField:``,dateField:``,avatarField:``,metaField:``,textField:``,chipTextField:``}}static{this.bindableSpots=[{prop:`time`,label:`Zeit`},{prop:`date`,label:`Datum`},{prop:`avatar`,label:`Avatar`},{prop:`heading`,label:`Titel`},{prop:`heading2`,label:`Titel 2`},{prop:`meta`,label:`Unterzeile`},{prop:`text`,label:`Textzeile`},{prop:`chipText`,label:`Chip`}]}static{this.customProperties=[Ar(`chipVariant`,`Bedeutung des Chips auf der Karte — bestimmt die Chip-Farbe.`)]}static{this.styles=[w.styles,jr,zr]}stelle(e,t){return g`<span
    ...
    >${this[e]}</span>`}hatReiter(){return this.hasAttribute(`data-ff-editor`)||this.date.trim()!==``||this.time.trim()!==``}updated(e){super.updated(e),this.toggleAttribute(`hat-reiter`,this.hatReiter())}render(){let e=Or(this.chipVariant),t=this.hasAttribute(`data-ff-editor`),n=e=>t||e.trim()!==``,r=this.hatReiter(),i=n(this.avatar)||n(this.heading)||n(this.meta),a=n(this.heading2)||n(this.chipText);return g`<div class="card v-${e}${r?``:` ohne-reiter`}">
      ...
      ${i?g`<div class="kopf">
            ${n(this.avatar)?g`<span
                ...
                >${this.avatar.trim()===``?v:Rr(this.avatar)}</span>`:v}
            <div class="namen">
    ...
    `]}setzeTag(e){Kr(e),this.tag=Gr()}render(){return g`<div class="waehler">
      <div class="riegel">
  ...
  >${e.eintraege.map((t,n)=>g`<li
    ...
    ><span class="vorschlag-anzeige">${t.anzeige===``?t.wert:t.anzeige}</span>${t.wert!==``&&t.wert!==t.anzeige?g`<span class="vorschlag-wert">${t.wert}</span>`:v}</li>`)}</ul>`}var ni=o`
  .vorschlaege {
    position: absolute;
    top: 100%;
    left: 0;
...
`,Hi=[`text`,`number`,`textarea`,`select`,`date`,`time`,`checkbox`,`nachschlagen`];function Ui(e){return Hi.includes(e)?e:`text`}var Wi=[`text`,`number`,`textarea`,`select`,`nachschlagen`,`date`,`time`],Gi={select:`ph-select`,date:`ph-nativ`,time:`ph-nativ`,nachschlagen:`ph-nachschlag`};function Ki(){return g`<svg viewBox="0 0 16 16" width="14" height="14" aria-hidden="true">
    ...
    </svg>`}var qi=4;function Ji(e){return e??qi}function Yi(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function Xi(e,t,n){let r=Yi(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function Zi(e,t){return e===null?null:Math.max(0,e-t)}function Qi({sichtbar:e,hatQuelle:t,platzhalterZeilen:n}){return t?{seiten:1,seite:0,zeilen:[...e]}:{seiten:1,seite:0,zeilen:Array.from({length:n},()=>null)}}function $i({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}var ea=1,ta=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,na=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,ra=/^(\d{4})-(\d{2})-(\d{2})$/;function ia(e){let t=e.trim();if(t===``||!ta.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function aa(e){let t=e.trim();if(t===``)return null;let n=ra.exec(t);if(n){let[,e,t,r]=n;return oa(Number(e),Number(t),Number(r))}let r=na.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return oa(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function oa(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function sa(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,ia(i)!==null&&n++,aa(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var ca=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function la(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=sa(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return ea;if(o===``)return-1;let s=i===`zahl`?(ia(n)??0)-(ia(o)??0):i===`datum`?(aa(n)??0)-(aa(o)??0):ca.compare(n,o);return s===0?e-t:s*a})}function ua(e,t,n){let r=ia(e);return r===null?e:r.toLocaleString(`de-DE`,{minimumFractionDigits:t,maximumFractionDigits:n})}var da={min:0,max:3},fa={min:2,max:2};function pa(e,t,n){let r=0,i=0;for(let t of e){let e=ia(t);e!==null&&(r+=e,i++)}return i===0?``:r.toLocaleString(`de-DE`,{minimumFractionDigits:t,maximumFractionDigits:n})}function ma(e,t){let n=t.trim().toLowerCase();return e.find(e=>e.wert.trim().toLowerCase()===n)}var H=`text`,ha=`status`,ga=`bild`,_a=`zahl`,va=`betrag`,ya=`bild`,ba=`unter`,xa=[{wert:H,name:`Text`,spur:`minmax(0, 1fr)`,klasse:``,aenderbar:!0,zelle:e=>e},{wert:_a,name:`Zahl`,spur:`90px`,klasse:`zahl`,summe:da,aenderbar:!0,zelle:e=>ua(e,da.min,da.max)},{wert:va,name:`Betrag`,spur:`100px`,klasse:`zahl`,summe:fa,aenderbar:!0,zelle:e=>ua(e,fa.min,fa.max)},{wert:`datum`,name:`Datum`,spur:`100px`,klasse:`zahl`,aenderbar:!0,zelle:e=>e},{wert:ha,name:`Status`,spur:`120px`,klasse:`status`,zelle:(e,t)=>{let n=ma(t,e);return n?g`<span class="chip v-${Or(n.bedeutung)}">${n.name.trim()===``?e:n.name}</span>`:g`<span class="chip">${e}</span>`}},{wert:ga,name:`Bild + Name`,spur:`minmax(0, 1fr)`,klasse:`bild`,zusatzFelder:[{key:ya,label:`Bild`},{key:ba,label:`Unterzeile`}],hoehe:e=>(e[ya]??``)!==``||(e[ba]??``)!==``?44:28,zelle:(e,t,n)=>{let r=Lr(n[ya]??``),i=n[ba]??``;return g`<div class="bild-name">
        ${r===void 0?v:g`<span class="bild-zeichen">${r}</span>`}
        <div class="bild-text">
          <div class="bild-titel">${e}</div>
          ${i===``?v:g`<div class="bild-unter">${i}</div>`}
        </div>
      </div>`}}];function Sa(e){return e.reduce((e,t)=>{let n=U(t.art);return Math.max(e,n.hoehe?.(t.felder??{})??28)},28)}var Ca=xa.filter(e=>e.summe!==void 0).map(e=>e.wert),wa=xa.filter(e=>e.aenderbar===!0).map(e=>e.wert);function Ta(e,t){let n=e.zelle(t,[],{});return typeof n==`string`?n:t}function U(e){return xa.find(t=>t.wert===e)??xa[0]}var Ea=xa.map(e=>({wert:e.wert,name:e.name,...e.zusatzFelder?{felder:e.zusatzFelder}:{}})),Da=`felder`,Oa=`Spalte {n}`;function ka(e){return Oa.replace(`{n}`,String(e+1))}function Aa(e){return{titel:ka(e),feld:``,art:H}}function ja(){return[0,1,2].map(e=>Aa(e))}function Ma(e){return Array.isArray(e)?e.filter(e=>!!e&&typeof e==`object`).map(e=>({wert:typeof e.wert==`string`?e.wert:``,name:typeof e.name==`string`?e.name:``,bedeutung:typeof e.bedeutung==`string`?e.bedeutung:``})).filter(e=>e.wert.trim()!==``):[]}function Na(e){if(!e||typeof e!=`object`||Array.isArray(e))return{};let t={};for(let[n,r]of Object.entries(e))typeof r==`string`&&r!==``&&(t[n]=r);return t}function Pa(e,t){if(e&&typeof e==`object`){let n=e,r=Ma(n.zuordnung),i=Na(n.felder);return{titel:typeof n.titel==`string`?n.titel:ka(t),feld:typeof n.feld==`string`?n.feld:``,art:typeof n.art==`string`?n.art:H,...r.length>0?{zuordnung:r}:{},...Object.keys(i).length>0?{felder:i}:{},...typeof n.summe==`boolean`?{summe:n.summe}:{},...typeof n.aenderbar==`boolean`?{aenderbar:n.aenderbar}:{},...typeof n.fuellFeld==`string`&&n.fuellFeld.trim()!==``?{fuellFeld:n.fuellFeld.trim()}:{}}}return typeof e==`string`?{...Aa(t),titel:e}:Aa(t)}function Fa(e){let t;if(Array.isArray(e))t=e.map((e,t)=>Pa(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>Aa(e))}else t=ja();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[Aa(0)]),t}function Ia(e){try{return Fa(JSON.parse(e))}catch{return ja()}}var La={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ra=e=>(...t)=>({_$litDirective$:e,values:t}),za=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},Ba=`important`,Va=` !important`,W=Ra(class extends za{constructor(e){if(super(e),e.type!==La.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(Va);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?Ba:``):n[e]=r}}return _}}),Ha=`Keine Datensätze.`;function Ua(){return{attributeName:`leerText`,name:`Text ohne Datensätze`,description:`Steht in der Maske dort, wo sonst die Zeilen stehen — wenn die Datenquelle keine liefert. Leer lassen: dann steht dort gar nichts.`,kind:`text`,requiresDataSource:!0}}function Wa(e,t=!1){return e.trim()===``?v:g`<div class="leer${t?` leer--tafel`:``}">
    ${Nr()}
    <span>${e}</span>
  </div>`}var Ga=o`
  .leer {
...
`;function Ka(e,t){let n=(e?.fuellFeld??``).trim(),r=n===``?(e?.feld??``).trim():n;if(r===``)return{art:`frei`,quelleId:``,code:``};let{quelleId:i,code:a}=ai(r);return i===``?{art:`eigen`,quelleId:t,code:a}:{art:`verknuepft`,quelleId:i,code:a}}function G(e,t){return Ka(e.spalten[t],e.quelleId)}function qa(e){let t=[];for(let n of e.spalten){let r=Ka(n,e.quelleId);r.art!==`verknuepft`||r.quelleId===``||t.includes(r.quelleId)||t.push(r.quelleId)}return t}function Ja(e,t){let n=G(e,t);if(!(n.quelleId===``||n.code===``))for(let r=0;r<e.spalten.length;r++){if(r===t)continue;let i=e.spalten[r],a=Ka(i,e.quelleId);if(a.quelleId===n.quelleId&&!(a.code===``||a.code===n.code))return{titel:i.titel,code:a.code}}}function Ya(e,t){let n=e.spalten[t],r=Ja(e,t);return n===void 0||r===void 0?[]:[{titel:r.titel,feld:r.code,art:H},{titel:n.titel,feld:G(e,t).code,art:H}]}function Xa(e,t,n){let r=e.map(e=>({toField:e.toField,soll:t(e.fromField)})).filter(e=>e.soll!==void 0);return r.length===0?[...n]:n.filter(e=>r.every(t=>t.soll!==``&&t.soll===O(e,t.toField)))}function Za(e,t,n){return g`<input
    class="erf-eingabe"
    type="text"
    ...
    @blur=${()=>t.verlassen(n)}
  />`}function Qa(e,t,n,r){if(r)return Za(e,t,n);let i=e.tippSpalte===n&&e.vorschlaege.length>0;return g`<div class=${e.listeNachOben?`erf-halter nach-oben`:`erf-halter`}>
    ${Za(e,t,n)}
    ${i?ti({eintraege:e.vorschlaege,marke:e.marke,onWaehlen:e=>t.waehleVorschlag(e),onMarke:e=>t.setzeMarke(e)}):v}
  </div>`}function $a(e,t){return g`<div class="zeile erfassung" role="row" style=${W(e.cols)}>
    ${e.spalten.map((n,r)=>{let i=U(n.art).klasse;return e.imEditor?g`<div class=${i} role="cell">${`—`}</div>`:g`<div class=${i} role="cell">${Qa(e,t,r,Ka(n,e.quelleId).art===`frei`)}</div>`})}
  </div>`}function eo(e,t,n){let r=e.lauf.vorschlaege[n];r!==void 0&&(e.lauf.uebernimm(e.umfeld(),t,r.satz),e.melde())}function to(e,t){let n=e.umfeld(),r=n.spalten[t],i=G(n,t);r===void 0||i.quelleId===``||i.code===``||Ms({el:e.baustein,quelleId:i.quelleId,speicherFeld:i.code,speicherTitel:r.titel,spalten:Ya(n,t),titel:r.titel,breite:520,hoehe:380,eintraege:e.lauf.eintraege(n,t),rueckFokus:null,onUebernehmen:(n,r,i)=>{e.lauf.uebernimm(e.umfeld(),t,i),e.melde(),no(e,t,`Enter`)}})}function no(e,t,n){let r=e.umfeld();if(n===`Tab`){let n=t+1;return n<r.spalten.length?(e.fokussiere(n),!0):e.erfasseZeile()}let i=e.lauf.naechsteLeere(r,t);return i===-1?n===`Enter`&&e.erfasseZeile():e.fokussiere(i),!0}function ro(e,t,n){if(n.key===`Tab`&&n.shiftKey)return;let r=n.key===`ArrowDown`&&n.altKey?`F4`:n.key,i=e.lauf.entscheideTaste(e.umfeld(),t,r);if(i===`nichts`){n.key===`Enter`&&n.preventDefault();return}let a=!0;i===`uebernehmen`?(eo(e,t,e.lauf.marke),a=no(e,t,n.key)):i===`fenster`?to(e,t):i===`liste-auf`?e.lauf.oeffneListe(t):i===`weiter`?a=no(e,t,n.key):i===`leeren`&&e.lauf.leere(e.umfeld(),t),a&&n.preventDefault(),e.melde()}function io(e,t,n){let r=e.umfeld();return $a({spalten:r.spalten,quelleId:r.quelleId,cols:t,imEditor:e.baustein.hasAttribute(`data-ff-editor`),wert:t=>e.lauf.wertVon(r,t),tippSpalte:e.lauf.tippSpalte,vorschlaege:e.lauf.vorschlaege,marke:e.lauf.marke,listeNachOben:n},{tippen:(t,n)=>{e.lauf.tippe(t,n),e.melde()},taste:(t,n)=>ro(e,t,n),verlassen:t=>{e.lauf.verlasse(t),e.melde()},waehleVorschlag:t=>eo(e,e.lauf.tippSpalte,t),setzeMarke:t=>{e.lauf.setzeMarke(t),e.melde()}})}var ao=class{constructor(){this.getippt=new Map,this.gewaehlt=new Map,this.vonHand=new Set,this._tippSpalte=-1,this._marke=0,this._listeZu=!1,this._listeAuf=-1,this._vorschlaege=[]}get tippSpalte(){return this._tippSpalte}get marke(){return this._marke}get vorschlaege(){return this._vorschlaege}wertVon(e,t){let n=this.getippt.get(t);if(n!==void 0)return n;let r=G(e,t);if(r.quelleId===``||r.code===``)return``;let i=this.gewaehlt.get(r.quelleId);return i===void 0?``:O(i,r.code)}tippe(e,t){this.getippt.set(e,t),this._tippSpalte=e,this._marke=0,this._listeZu=!1}verlasse(e){this._tippSpalte===e&&(this._tippSpalte=-1,this._listeZu=!1,this._listeAuf=-1,this._marke=0)}entscheideTaste(e,t,n){let r=this._tippSpalte===t&&this._vorschlaege.length>0;if(n===`Tab`){if(!r)return`weiter`;n=`Enter`}if(n===`F4`)return G(e,t).art===`frei`||this.eintraege(e,t).length===0?`nichts`:`fenster`;let i=this.wertVon(e,t);if(n===`Escape`&&!r)return i===``?`nichts`:`leeren`;if(G(e,t).art===`frei`)return n===`Enter`?`weiter`:`nichts`;if(n===`ArrowDown`&&!r)return G(e,t).art===`verknuepft`?`liste-auf`:`nichts`;let a=ei(n,{listeOffen:r,feldLeer:i===``});if(a===`marke-hoch`)this._marke=Qr(this._marke,this._vorschlaege.length,-1);else if(a===`marke-runter`)this._marke=Qr(this._marke,this._vorschlaege.length,1);else if(a===`liste-zu`)this._listeZu=!0,this._listeAuf=-1;else if(a===`fenster`&&this.eintraege(e,t).length===0)return`weiter`;else if(a===`nichts`&&n===`Enter`&&i!==``&&(this.getippt.get(t)===void 0||G(e,t).art!==`verknuepft`))return`weiter`;return a}oeffneListe(e){this._tippSpalte=e,this._listeZu=!1,this._listeAuf=e,this._marke=0}naechsteLeere(e,t){for(let n=t+1;n<e.spalten.length;n++)if(this.wertVon(e,n)===``)return n;return-1}leere(e,t){this.getippt.delete(t);let n=G(e,t);n.quelleId!==``&&this.gewaehlt.has(n.quelleId)&&this.setze(e,n.quelleId,void 0),this._listeZu=!1,this._marke=0}setzeMarke(e){this._marke=e}uebernimm(e,t,n){let r=G(e,t);if(r.quelleId!==``){if(this.setze(e,r.quelleId,n),this.vonHand.add(r.quelleId),r.art===`eigen`)for(let t of[...this.gewaehlt.keys()])t!==r.quelleId&&this.setze(e,t,void 0);this.gleicheAb(e),this._tippSpalte=-1,this._marke=0,this._listeZu=!1}}setze(e,t,n){n===void 0?(this.gewaehlt.delete(t),this.vonHand.delete(t)):this.gewaehlt.set(t,n);for(let n=0;n<e.spalten.length;n++)Ka(e.spalten[n],e.quelleId).quelleId===t&&this.getippt.delete(n)}schluesselWert(e,t,n,r){if(t!==``&&t!==e.quelleId){let e=this.gewaehlt.get(t);return e===void 0?void 0:O(e,n)}let i=this.gewaehlt.get(e.quelleId);if(i!==void 0)return O(i,n);for(let t of qa(e)){if(t===r||!this.vonHand.has(t))continue;let i=e.partnerVon(t);if(i!==``&&i!==e.quelleId)continue;let a=this.gewaehlt.get(t);if(a!==void 0)for(let r of e.paareZu(t)){if(r.fromField!==n)continue;let e=O(a,r.toField);if(e!==``)return e}}}moegliche(e,t,n){let r=e.partnerVon(t);return Xa(e.paareZu(t),n=>this.schluesselWert(e,r,n,t),n)}gleicheAb(e){let t=qa(e);for(let n=0;n<=t.length;n++){let n=!1;for(let r of t){let t=e.paareZu(r);if(t.length===0)continue;let i=e.partnerVon(r),a=this.gewaehlt.get(r);if(a!==void 0){t.every(t=>{let n=this.schluesselWert(e,i,t.fromField,r);return n===void 0||n!==``&&n===O(a,t.toField)})||(this.setze(e,r,void 0),n=!0);continue}if(!t.some(t=>this.schluesselWert(e,i,t.fromField,r)!==void 0))continue;let o=vs(r);if(o===null)continue;let s=this.moegliche(e,r,o);s.length===1&&(this.setze(e,r,s[0]),this.vonHand.delete(r),n=!0)}if(!n)break}}uebernimmWerte(e){this.zuruecksetzen(),e.forEach((e,t)=>{e!==``&&this.getippt.set(t,e)})}zuruecksetzen(){this.getippt.clear(),this.gewaehlt.clear(),this.vonHand.clear(),this._tippSpalte=-1,this._marke=0,this._listeZu=!1,this._listeAuf=-1,this._vorschlaege=[]}aktualisiereVorschlaege(e){this._vorschlaege=this.berechne(e),this._marke=$r(this._marke,this._vorschlaege.length)}berechne(e){let t=this._tippSpalte;if(this._listeZu||G(e,t).art===`frei`)return[];let n=this.getippt.get(t)??``;return n===``?this._listeAuf===t?this.eintraege(e,t).slice(0,8):[]:Zr(this.eintraege(e,t),n)}eintraege(e,t){let n=G(e,t);if(n.art!==`verknuepft`||n.quelleId===``||n.code===``)return[];let r=vs(n.quelleId);return r===null?[]:gs(this.moegliche(e,n.quelleId,r),Ja(e,t)?.code??``,n.code)}},oo=class{constructor(){this.lauf=new ao,this._zeilen=[],this.naechsteKennung=1,this._zurueck=null}get zeilen(){return this._zeilen.map(e=>e.werte)}vormerkungen(e){let t=this._zeilen.map(e=>({kennung:e.kennung,werte:e.werte})),n=this._zurueck;if(!n)return t;let r=e.spalten.map((t,n)=>this.lauf.wertVon(e,n));return r.every(e=>e===``)?t:[...t.slice(0,n.platz),{kennung:n.kennung,werte:r},...t.slice(n.platz)]}get schluessel(){return this._zeilen.map(e=>e.kennung)}umfeld(e,t,n){let r=Di(e);return{spalten:t,quelleId:n,paareZu:e=>r.find(t=>t.quelleId===e)?.keyPairs??[],partnerVon:e=>r.find(t=>t.quelleId===e)?.partnerId??``}}erfasse(e){let t=e.spalten.map((t,n)=>this.lauf.wertVon(e,n)),n=this._zurueck;return t.every(e=>e===``)?n?(this._zurueck=null,this.lauf.zuruecksetzen(),!0):!1:(n?(this._zeilen=[...this._zeilen.slice(0,n.platz),{kennung:n.kennung,werte:t},...this._zeilen.slice(n.platz)],this._zurueck=null):(this._zeilen=[...this._zeilen,{kennung:`e${this.naechsteKennung}`,werte:t}],this.naechsteKennung+=1),this.lauf.zuruecksetzen(),!0)}zurueckholen(e,t){let n=this._zeilen[t];if(!n)return!1;this.erfasse(e);let r=this._zeilen.indexOf(n);return r===-1?!1:(this._zeilen=this._zeilen.filter((e,t)=>t!==r),this._zurueck={kennung:n.kennung,platz:r},this.lauf.uebernimmWerte(n.werte),!0)}entferne(e){return e<0||e>=this._zeilen.length?!1:(this._zeilen=this._zeilen.filter((t,n)=>n!==e),!0)}austragen(e){if(e.length===0)return!1;let t=this._zeilen.filter(t=>!e.includes(t.kennung)),n=this._zurueck!==null&&e.includes(this._zurueck.kennung);return n&&(this._zurueck=null,this.lauf.zuruecksetzen()),t.length===this._zeilen.length?n:(this._zeilen=t,!0)}zuruecksetzen(){this._zeilen=[],this._zurueck=null,this.lauf.zuruecksetzen()}},so=o`
      .zeile.erfassung {
        flex: none;
        background: var(--se-panel-2);
...
`;function co(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen]),zusatzzeilen:e.map(e=>(e.zusatz??[]).map(e=>({...e})))}}function lo(e,t,n){return t===``||n===``?[...e]:e.filter(e=>Br(O(e,t))===n)}function uo(e){let t=e.getAttribute(`source`)??``;if(t===``)return null;let n=D(I().FF_DATA_SOURCES,t);return n?{quelle:n,zeilen:lo(kt(I().SEDATA,n.name,n.tableId,n.offenerSatz),e.getAttribute(`tagfield`)??``,Gr()),lies:Oi(e)}:null}function fo(e){return Ia(e.getAttribute(`spalten`)??``)}function po(e,t,n){let r={};for(let i of U(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function mo(e,t){let n=D(I().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?wt(n,t):``}function ho(e){let t=D(I().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return t!==void 0&&t.indexField!==``}function go(e){let t=uo(e);if(!t){e.datenzeilen=[],e.zusatzzeilen=[];return}let n=fo(e),{rows:r,gefiltert:i}=Zt(e,t.zeilen),a=Wt(j(e),r,e=>e)[0]??-1,o=t.lies;e.datenGeliefert=!0,e.rohzeilen=r,e.auswahlIndex=a,e.durchAuswahlGefiltert=i,e.datenzeilen=r.map(e=>n.map(t=>t.feld===``?``:o(e,t.feld))),e.zusatzzeilen=r.map(e=>n.map(t=>po(t,e,o)))}var _o=Ci({hydriere:go}),vo=_o.connect,yo=_o.disconnect;function bo(e,t){let n=[];return e.forEach((e,r)=>{Xr(e,t)&&n.push(r)}),n}function xo(e,t){return!e&&t.trim()!==``}function So(e,t,n){return e&&t&&n===0}function Co(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function wo(e,t,n){return g`<div class="steuerung">
    <button
    ...
    <button
      ...
      @click=${r=>{n(r);let i=e();i.length<8&&(i.push(Aa(i.length)),t(i))}}
    >+</button>
  </div>`}function To(e,t){let n=e.currentTarget;n&&(e.stopPropagation(),e.preventDefault(),ct(n,(e,n)=>e===``||e===n.trim()?!1:(t(e),!0)))}function Eo(e,t,n,r){To(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var Do=220,Oo=new WeakMap;function ko(e){let t=Oo.get(e);t!==void 0&&(clearTimeout(t),Oo.delete(e))}function Ao(e){return{dblklickKopf:(t,n)=>{e.editable()&&(ko(e.baustein),Eo(t,n,e.liste,e.aendere))},klickKopf:(t,n)=>{e.editable()&&jo(e.baustein,t,{prop:e.prop,index:n,liste:e.liste}),e.sortiere(n)}}}function jo(e,t,n){t.stopPropagation();let r=t.currentTarget.getBoundingClientRect();ko(e),Oo.set(e,setTimeout(()=>{Oo.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n.prop,index:n.index,top:r.bottom+4,left:r.left,...n.liste?{liste:n.liste()}:{}},bubbles:!0,composed:!0}))},Do))}var Mo=`\0`;function No(e,t){return e+Mo+String(t)}var Po=class{constructor(){this.werte=new Map}setze(e,t,n){if(e===``)return!1;let r=No(e,t);return this.werte.get(r)===n?!1:(this.werte.set(r,n),!0)}nimmZurueck(e,t){return this.werte.delete(No(e,t))}wert(e,t){return e===``?void 0:this.werte.get(No(e,t))}get anzahl(){return this.werte.size}proSatz(){let e=[];for(let[t,n]of this.werte){let[r,i]=t.split(Mo),a=Number(i),o=e.find(e=>e.satz===r),s={satz:r,spalte:a,wert:n};o?o.aenderungen.push(s):e.push({satz:r,aenderungen:[s]})}return e}nimmSatzZurueck(e){let t=!1;for(let n of[...this.werte.keys()])n.slice(0,n.indexOf(Mo))===e&&this.werte.delete(n)&&(t=!0);return t}},Fo=class{constructor(e){this.aenderungen=new Po,this.geloescht=new Set,this.wirt=e}get geaenderteZeilen(){if(this.aenderungen.anzahl===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let{satz:r}of this.aenderungen.proSatz()){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}get geloeschteZeilen(){if(this.geloescht.size===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let r of this.geloescht){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}austragen(e,t){let n=!1;for(let r of t)n=e===`geaendert`?this.aenderungen.nimmSatzZurueck(r)||n:this.geloescht.delete(r)||n;n&&this.wirt.melde()}vorgemerkteAenderungen(){return this.geaenderteZeilen.length}vorgemerkteLoeschungen(){return this.geloeschteZeilen.length}statusVon(e){let t=this.satzVon(e);if(t===``)return{status:`gebucht`,titel:``};if(this.geloescht.has(t))return this.wirt.lauf.zeigt(`geloescht`,t,`loeschung`);let n=this.wirt.spalten().some((e,n)=>this.aenderungen.wert(t,n)!==void 0);return this.wirt.lauf.zeigt(`geaendert`,t,n?`geaendert`:`gebucht`)}satzPlaetze(){let e=new Map;return this.wirt.rohzeilen().forEach((t,n)=>{let r=mo(this.wirt.baustein,t);r!==``&&!e.has(r)&&e.set(r,n)}),e}satzVon(e){let t=this.wirt.rohzeilen()[e];return t===void 0?``:mo(this.wirt.baustein,t)}zellAnzeige(e,t){let n=this.wirt.spalten()[e];return n===void 0?t:Ta(U(n.art),t)}schalteLoeschung(e){let t=this.satzVon(e);t!==``&&(this.geloescht.has(t)?this.geloescht.delete(t):(this.geloescht.add(t),this.wirt.spalten().forEach((e,n)=>{this.aenderungen.nimmZurueck(t,n)})),this.wirt.melde())}istGeloescht(e){let t=this.satzVon(e);return t!==``&&this.geloescht.has(t)}zellWert(e,t){let n=this.aenderungen.wert(this.satzVon(e),t);return n===void 0?this.zellAnzeige(t,this.wirt.datenzeilen()[e]?.[t]??``):n}istGeaendert(e,t){return this.aenderungen.wert(this.satzVon(e),t)!==void 0}tippeZelle(e,t,n){this.aenderungen.setze(this.satzVon(e),t,n)&&this.wirt.melde()}verlasseZelle(e,t,n){let r=this.satzVon(e),i=this.zellAnzeige(t,n);(i===this.zellAnzeige(t,this.wirt.datenzeilen()[e]?.[t]??``)?this.aenderungen.nimmZurueck(r,t):this.aenderungen.setze(r,t,i))&&this.wirt.melde()}zelleNachbar(e,t,n,r){let i=Array.from(this.wirt.baustein.shadowRoot?.querySelectorAll(`.koerper > .zeile:not(.erfassung) .zell-eingabe[data-spalte="${e}"]`)??[]),a=i.indexOf(t);if(a<0)return;let o=a+n;if(o>i.length-1){if(r&&this.wirt.erfassungAn()){this.wirt.fokussiereErfassungsZelle(0);return}o=i.length-1}o<0&&(o=0);let s=i[o];!s||s===t||(s.focus(),s.select(),s.scrollIntoView({block:`nearest`}))}tasteZelle(e,t,n){let r=n.target;if(n.key===`Escape`){n.preventDefault(),n.stopPropagation(),this.aenderungen.nimmZurueck(this.satzVon(e),t)&&this.wirt.melde();return}let i={Enter:1,ArrowDown:1,ArrowUp:-1,PageDown:10,PageUp:-10}[n.key];i!==void 0&&(n.preventDefault(),n.stopPropagation(),this.zelleNachbar(t,r,i,n.key===`Enter`))}},Io={gebucht:``,erfasst:`Neue Zeile — noch nicht geschrieben`,geaendert:`Geändert — noch nicht geschrieben`,loeschung:`Zum Löschen vorgemerkt — noch nicht geschrieben`,schreibt:`Wird geschrieben …`,fehler:`Nicht geschrieben`},Lo=class{constructor(e){this.schreibend=new Map,this.fehler=new Map,this.melde=e}schreibt(e,t){this.fehler.get(e)?.delete(t);let n=this.schreibend.get(e)??new Set;n.add(t),this.schreibend.set(e,n),this.melde()}gescheitert(e,t,n){this.schreibend.get(e)?.delete(t);let r=this.fehler.get(e)??new Map;r.set(t,n),this.fehler.set(e,r),this.melde()}fertig(e,t){this.schreibend.get(e)?.clear();let n=this.fehler.get(e);if(n)for(let e of t)n.delete(e);this.melde()}zeigt(e,t,n){let r=this.fehler.get(e)?.get(t);return r===void 0?this.schreibend.get(e)?.has(t)===!0?{status:`schreibt`,titel:Io.schreibt}:{status:n,titel:Io[n]}:{status:`fehler`,titel:Io.fehler+`: `+r}}};function Ro(e){if(!e.hasAttribute(`fuellt`))return-1;let t=e.renderRoot.querySelector(`.koerper`);return t instanceof HTMLElement?t.clientHeight:-1}function zo(e,t){let n=Ro(e);if(n===-1)return{mass:null,hoehe:n};let r=e.renderRoot.querySelector(`.kopf`);return{mass:Xi(n,r instanceof HTMLElement?r.offsetHeight:0,t),hoehe:n}}function Bo(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}var Vo=`ff-zeile-aktiviert`,Ho=`data-ff-roh`;function Uo(e,t){e.dispatchEvent(new CustomEvent(Vo,{detail:t,bubbles:!0,composed:!0}))}function Wo(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(Ho);return r===null||r===``?null:Number(r)}function Go(e,t){if(!(e instanceof HTMLElement))return!1;let n=e.closest(`.zeile`),r=n?.parentElement;if(!n||!r)return!1;let i=[...r.querySelectorAll(`.zeile[${Ho}]`)],a=i.indexOf(n),o=a===-1?void 0:i[a+t];return o?(o.focus(),!0):!1}function Ko(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.zeile[${Ho}]`);return t?(t.focus(),!0):!1}function qo(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.suchzeile input`);return t?(t.focus(),!0):!1}function Jo(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var Yo=class{constructor(e){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._rumpfGemessen=-1,this._fokusZeile=null,this._fokusHolen=!1,this.wirt=e}get suchtext(){return this._suchtext}get suchtAktiv(){return this._suchtext.trim()!==``}get sortSpalte(){return this._sortSpalte}get sortAuf(){return this._sortAuf}get seite(){return this._seite}get mass(){return this._mass}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.wirt.melde()}klickSortiere(e){this.wirt.editable()||(this.merkeZeilenFokus(),this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.wirt.melde())}blaettere(e){this.merkeZeilenFokus(),this._seite=e,this.wirt.melde()}fokussiereSuche(){let e=this.wirt.baustein.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}merkeZeilenFokus(){let e=Wo(this.wirt.baustein.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.wirt.zeilenHoehe();this._taktGemessen=e;let{mass:t,hoehe:n}=zo(this.wirt.baustein,e);this._rumpfGemessen=n,!(t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe)&&(this._mass=t,this.wirt.melde())}beobachte(){this._beobachter||(this._beobachter=Bo(this.wirt.baustein,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}nachRendern(){(this._taktGemessen!==this.wirt.zeilenHoehe()||this._rumpfGemessen!==Ro(this.wirt.baustein))&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,Jo(this.wirt.baustein.shadowRoot,this._fokusZeile))}loese(){this._beobachter?.disconnect(),this._beobachter=null}nachPush(){this._seite=0,this._mass=null,this._taktGemessen=0,this._rumpfGemessen=-1}zuruecksetzen(){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this.nachPush(),this._fokusZeile=null,this._fokusHolen=!1}};function Xo(e,t,n,r){if(n===null||e.hasAttribute(`data-ff-editor`))return;let i=t[n];i!==void 0&&(Uo(e,{rohzeile:i,rohIndex:n,ansichtIndex:r}),Qo(e,i),z(e,`onRowClick`,{PINDEX:mo(e,i)}).catch(R))}function Zo(e,t,n){if(n===null||e.hasAttribute(`data-ff-editor`))return;let r=t[n];r!==void 0&&z(e,`onRowDblClick`,{PINDEX:mo(e,r)}).catch(R)}function Qo(e,t){let n=j(e);n!==``&&Gt(n,t)}var $o={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Oa,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:Ea,standard:H,felderKey:Da},eintragsSchalter:[{key:`summe`,label:`Summe in der Fußzeile`,nurBeiWahl:Ca},{key:`aenderbar`,label:`In der Zeile änderbar`,nurBeiWahl:wa,standard:!0,nurEigeneQuelle:!0}],eintragsFeldWahl:[{key:`fuellFeld`,label:`Füllfeld`,hinweis:`Beim Erfassen füllt der gewählte Satz der Hilfsquelle diese Zelle. Die gebuchte Zeile zeigt weiter das Feld oben.`,nurFremdeQuellen:!0}],eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:ha,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:kr}};function es(e){let t=e,n=$o.eintragsSchalter?.find(e=>e.key===`aenderbar`);return n!==void 0&&e.feld!==``&&ci($o,t).includes(n)&&si(n,t)}function ts(e,t){let n=[];return e.spalten.forEach((r,i)=>{let a=U(r.art).summe;if(r.summe!==!0||a===void 0)return;let o=pa(t.map(t=>e.wertVon(t,i)),a.min,a.max);o!==``&&n.push({titel:r.titel,text:o})}),n}function ns(e){let t=bo(e.datenzeilen,e.suchtext);return e.sortSpalte<0?t:la(t.map(t=>e.datenzeilen[t]),e.sortSpalte,e.sortAuf).map(e=>t[e])}function rs(e){let t={gridTemplateColumns:e.spalten.map(e=>U(e.art).spur).join(` `)},n=Sa(e.spalten),r=e.gemessen?.zeilenHoehe??n,i=e.hatQuelle,a=!e.erfassungAn&&So(i,e.datenGeliefert,e.datenzeilen.length),o=ns(e),s=e.erfassungAn?1+e.erfassteAnzahl:0,c=e.gemessen===null?null:Math.max(1,e.gemessen.passen-s),l={sichtbar:o,hatQuelle:i,proSeite:c??Math.max(1,10-s),wunschSeite:e.wunschSeite,platzhalterZeilen:Ji(c)},{seiten:u,seite:d,zeilen:ee}=e.blaettert?$i(l):Qi(l);return{cols:t,takt:n,zeilenHoehe:r,hatQuelle:i,leer:a,gesamt:o.length,seiten:u,seite:d,zeilen:ee,linealTakte:Zi(c,ee.length),summen:ts(e,o)}}var is=[V(`suche`,`Suchzeile`,`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,{requiresDataSource:!0}),V(`erfassung`,`Erfassungszeile`,`Zeigt als nächste freie Zeile eine leere Zeile, in der der Bediener neue Positionen tippt. Eingestellt wird an ihr nichts: Was eine Zelle tut, ergibt sich aus der Bindung ihrer Spalte (Spaltenkopf) und der Verknüpfung des Bausteins. Enter am Zeilenende lässt die Zeile stehen; geschrieben wird über einen Knopf, dessen Kette „Wert aus Erfassungszelle“ liest — einmal je Zeile.`),V(`loeschbar`,`Zeilen löschbar`,`Zeigt an jeder gebuchten Zeile ein Kreuz. Ein Klick merkt die Zeile zum Löschen vor — sie bleibt durchgestrichen stehen, bis eine Kette sie schreibt, und ein zweiter Klick nimmt die Vormerkung zurück. Geschrieben wird nichts von allein.`,{requiresDataSource:!0}),V(`blaettern`,`Blättern`,`Ja: lange Listen werden in Seiten geschnitten, unten stehen die Blätter-Knöpfe. Nein: alle Treffer stehen untereinander und der Rumpf rollt. Titelzeile und Erfassungszeile bleiben in beiden Fällen stehen.`),V(`schlank`,`Schlank`,`Nimmt den Rahmen der Tafel weg und macht die Polster enger — die Tabelle liegt bündig auf der Maske. Die Fußzeile erscheint ohnehin nur noch, wenn geblättert wird oder ein Filter greift.`),V(`kopfzeile`,`Kopfzeile`,`Aus: Die Titelzeile fällt weg, die Spaltennamen stehen blass in den Zellen der Erfassungszeile. Gebunden wird dann per Klick auf eine Zelle; zum Umbenennen die Kopfzeile kurz einschalten. An der fertigen Maske entfällt ohne Kopf das Sortieren per Titelklick.`),{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Sätze des Tages, den der Tageswähler zeigt. Leer = alle Sätze.`,kind:`field`},Ua()];function as(e,t){let n=e.erfasst+e.geaendert+e.geloescht,r=e.seiten>1||e.summen.length>0||n>0||e.suchtAktiv||e.auswahlAktiv;return e.leer||!r?v:g`<div class="fusszeile">
    <div class="seiten-info">${Co({hatQuelle:e.hatQuelle,sichtbar:e.sichtbar,gesamt:e.gesamt,suchtAktiv:e.suchtAktiv,auswahlAktiv:e.auswahlAktiv})}</div>
    ${n===0?v:g`<div class="vorgemerkt">${br(e.erfasst,e.geaendert,e.geloescht)}</div>`}
    ...
    ${e.blaettert?g`<div class="seiten-nav">
  ...
  </div>`}var os=/[.*+?^${}()|[\]\\]/g;function ss(e,t){let n=Yr(t);if(n.length===0||e===``)return e;let r;try{r=RegExp(`(${n.map(e=>e.replace(os,`\\$&`)).join(`|`)})`,`ig`)}catch{return e}let i=e.split(r);return i.length<=1?e:g`${i.map((e,t)=>t%2==1?g`<mark>${e}</mark>`:e)}`}function cs(e){return e.linealTakte===0?v:g`<div class="lineal" role="presentation" style=${W(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>g`<div></div>`)}
        </div>`}function ls(e,t){return g`
      ${e.zeigeSuche?g`<div class="suchzeile">
        <input
          ...
          @keydown=${e=>{e.key===`ArrowDown`&&Ko(e.target)&&e.preventDefault()}}
        />
      </div>`:``}
      ...
      ${e.zeigeKopf?g`<div class="kopf" role="row" style=${W(e.cols)}>
        ...
        ${e.zeilen.map((n,r)=>{let i=n!==null&&!e.imEditor,a=n!==null&&e.zeilenStand.istGeloescht(n),o=n===null?{status:`gebucht`,titel:``}:e.zeilenStand.statusVon(n);return g`<div
          ...
          >
            ...
            ${e.spalten.map((r,i)=>{let a=U(r.art),o=n===null?`—`:e.datenzeilen[n]?.[i]??``,s=n===null?{}:e.zusatzzeilen[n]?.[i]??{},c=e.imEditor&&!e.zeigeKopf&&e.editable;if(e.aendernMoeglich&&n!==null&&es(r)){let t=e.zeilenStand;return g`<div class=${a.klasse} role="cell">
              ...
              >${typeof l==`string`?ss(l,e.suchtext):l}</div>`})}
        ...
        ${e.erfasste.map((n,r)=>{let i=e.erfasstStand(r);return g`<div
          class="zeile erfasst"
          role="row"
          data-status=${i.status}
          title=${e.imEditor?i.titel:`${i.titel} — zum Korrigieren anklicken`}
          style=${W(e.cols)}
          @click=${e.imEditor?v:()=>t.holeErfassteZeile(r)}
        >
          ${e.spalten.map((e,t)=>{let r=U(e.art);return g`<div class=${r.klasse} role="cell">${r.zelle(n[t]??``,e.zuordnung??[],{})}</div>`})}
          ${e.imEditor?v:g`<button
              class="zeile-weg"
              type="button"
...
`,K=class e extends w{constructor(...e){super(...e),this.spalten=ja(),this.source=``,this.suche=`ja`,this.erfassung=`nein`,this.blaettern=`ja`,this.loeschbar=`nein`,this.schlank=`nein`,this.kopfzeile=`ja`,this.leerText=Ha,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._besitz=`softengine`,this._ansicht=new Yo({baustein:this,editable:()=>this.editable,zeilenHoehe:()=>this.zeilenHoehe,melde:()=>this.requestUpdate()}),this._erfassung=new oo,this._lauf=new Lo(()=>this.requestUpdate()),this._zeilen=new Fo({baustein:this,spalten:()=>this.spaltenListe(),rohzeilen:()=>this.rohzeilen,datenzeilen:()=>this.datenzeilen,melde:()=>this.requestUpdate(),lauf:this._lauf,erfassungAn:()=>this.erfassungAn,fokussiereErfassungsZelle:e=>this.fokussiereErfassungsZelle(e)}),this.nimmSeFokus=e=>{e.defaultPrevented||!this.erfassungAn||this.hasAttribute(`data-ff-editor`)||(e.preventDefault(),this.fokussiereErfassungsZelle(0))}}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.kannErfassen={wenn:{attributeName:`erfassung`,equals:`ja`}}}static{this.aenderungsSchluessel=`aenderbar`}static{this.kannLoeschen={wenn:{attributeName:`loeschbar`,equals:`ja`}}}static{this.blockEvents=[{key:`onRowClick`,name:`Zeile gewählt`},{key:`onRowDblClick`,name:`Zeile doppelt geklickt`}]}static{this.listenBindung=$o}static{this.defaultProps={width:`fill`,source:``,spalten:ja(),suche:`ja`,erfassung:`nein`,blaettern:`ja`,loeschbar:`nein`,schlank:`nein`,kopfzeile:`ja`,tagField:``,leerText:Ha}}static{this.customProperties=is}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?yo(this):vo(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=co(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.zusatzzeilen=t.zusatzzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.nachPush(),this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.zusatzzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.zuruecksetzen(),this._erfassung.zuruecksetzen()}get erfassteZeilen(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.werte)}get erfassteSchluessel(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.kennung)}get geaenderteZeilen(){return this._zeilen.geaenderteZeilen}get geloeschteZeilen(){return this._zeilen.geloeschteZeilen}zeileSchreibt(e,t){this._lauf.schreibt(e,t)}zeileGescheitert(e,t,n){this._lauf.gescheitert(e,t,n)}laufFertig(e,t){if(this._lauf.fertig(e,t),e===`erfasst`){this._erfassung.austragen(t)&&this.requestUpdate();return}this._zeilen.austragen(e,t)}erfasstStand(e){return this._lauf.zeigt(`erfasst`,this._erfassung.schluessel[e]??``,`erfasst`)}erfasseZeile(){return this._erfassung.erfasse(this.erfassungsUmfeld())?(this.requestUpdate(),this.fokussiereErfassungsZelle(0),this.zeigeLetzteErfasste(),!0):!1}zeigeLetzteErfasste(){this.updateComplete.then(()=>{let e=this.shadowRoot?.querySelector(`.koerper`);e&&(e.scrollTop=e.scrollHeight)})}fokussiereSuche(){return this._ansicht.fokussiereSuche()}get hatQuelle(){return this._besitz===`provided`||xo(this.hasAttribute(`data-ff-editor`),this.source)}spaltenListe(){return Fa(this.spalten)}get zeilenHoehe(){return Sa(this.spaltenListe())}get erfassungAn(){return this.erfassung===`ja`}erfassungsWirt(){return{baustein:this,lauf:this._erfassung.lauf,umfeld:()=>this.erfassungsUmfeld(),melde:()=>this.requestUpdate(),fokussiere:e=>this.fokussiereErfassungsZelle(e),erfasseZeile:()=>this.erfasseZeile()}}fokussiereErfassungsZelle(e){this.updateComplete.then(()=>{let t=this.shadowRoot?.querySelectorAll(`.zeile.erfassung .erf-eingabe`)?.[e];t&&(t.focus(),t.scrollIntoView({block:`nearest`}))})}erfassungsUmfeld(){return this._erfassung.umfeld(this,this.spaltenListe(),this.source)}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&vo(this),document.addEventListener(Fn,this.nimmSeFokus),this._ansicht.beobachte()}firstUpdated(){this._ansicht.beobachte()}willUpdate(e){super.willUpdate(e),!(!this.erfassungAn||this.hasAttribute(`data-ff-editor`))&&this._erfassung.lauf.aktualisiereVorschlaege(this.erfassungsUmfeld())}updated(){this._ansicht.nachRendern(),Tr(this)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(Fn,this.nimmSeFokus),ko(this),this._ansicht.loese(),Os(this),yo(this)}static{this.styles=[w.styles,jr,Ga,us,ni,so]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=rs({spalten:t,hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._ansicht.suchtext,sortSpalte:this._ansicht.sortSpalte,sortAuf:this._ansicht.sortAuf,wunschSeite:this._ansicht.seite,gemessen:this._ansicht.mass,erfassungAn:this.erfassungAn,erfassteAnzahl:this._erfassung.zeilen.length,wertVon:(e,t)=>this._zeilen.zellWert(e,t),blaettert:this.blaettern===`ja`}),i=[`tabelle`];return this.schlank===`ja`&&i.push(`schlank`),g`<div class=${i.join(` `)} style=${W({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
      ${wo(()=>this.spaltenListe(),e=>this.aendere(e),n)}
      ${ls({spalten:t,cols:r.cols,editable:this.editable,imEditor:this.hasAttribute(`data-ff-editor`),zeigeKopf:this.kopfzeile===`ja`,auswahlSemantik:j(this)!==``,zeigeSuche:this.suche===`ja`,suchtext:this._ansicht.suchtext,sortSpalte:this._ansicht.sortSpalte,sortAuf:this._ansicht.sortAuf,zeilen:r.zeilen,linealTakte:r.linealTakte,datenzeilen:this.datenzeilen,zusatzzeilen:this.zusatzzeilen,hatQuelle:r.hatQuelle,auswahlIndex:this.auswahlIndex,aendernMoeglich:!this.hasAttribute(`data-ff-editor`)&&r.hatQuelle&&ho(this),loeschbar:this.loeschbar===`ja`&&!this.hasAttribute(`data-ff-editor`)&&r.hatQuelle&&ho(this),zeilenStand:this._zeilen,leer:r.leer,leerText:this.leerText,erfasste:this._erfassung.zeilen,erfasstStand:e=>this.erfasstStand(e),erfassung:this.erfassungAn?io(this.erfassungsWirt(),r.cols,(r.linealTakte??1)<=0):v},{setzeSuchtext:e=>this._ansicht.setzeSuchtext(e),...Ao({baustein:this,editable:()=>this.editable,prop:e.listenBindung.prop,liste:()=>this.spaltenListe(),aendere:e=>this.aendere(e),sortiere:e=>this._ansicht.klickSortiere(e)}),aktiviereZeile:(e,t)=>Xo(this,this.rohzeilen,e,t),zeileDoppelt:e=>Zo(this,this.rohzeilen,e),nimmErfassteZeile:e=>{this._erfassung.entferne(e)&&this.requestUpdate()},holeErfassteZeile:e=>{this._erfassung.zurueckholen(this.erfassungsUmfeld(),e)&&(this.requestUpdate(),this.fokussiereErfassungsZelle(0))},schalteLoeschung:e=>this._zeilen.schalteLoeschung(e)})}
      ${as({hatQuelle:r.hatQuelle,sichtbar:r.gesamt,gesamt:this.datenzeilen.length,suchtAktiv:this._ansicht.suchtAktiv,auswahlAktiv:this.durchAuswahlGefiltert,seite:r.seite,seiten:r.seiten,blaettert:this.blaettern===`ja`,summen:r.summen,erfasst:this._erfassung.zeilen.length,geaendert:this._zeilen.vorgemerkteAenderungen(),geloescht:this._zeilen.vorgemerkteLoeschungen(),leer:r.leer},{blaettere:e=>this._ansicht.blaettere(e)})}
    </div>`}};C([x({converter:{fromAttribute:e=>e?Ia(e):ja(),toAttribute:e=>JSON.stringify(e)}})],K.prototype,`spalten`,void 0),C([x()],K.prototype,`source`,void 0),C([x()],K.prototype,`suche`,void 0),C([x()],K.prototype,`erfassung`,void 0),C([x()],K.prototype,`blaettern`,void 0),C([x()],K.prototype,`loeschbar`,void 0),C([x()],K.prototype,`schlank`,void 0),C([x()],K.prototype,`kopfzeile`,void 0),C([x()],K.prototype,`leerText`,void 0),C([x({attribute:!1})],K.prototype,`datenzeilen`,void 0),C([x({attribute:!1})],K.prototype,`zusatzzeilen`,void 0),C([x({attribute:!1})],K.prototype,`rohzeilen`,void 0),C([x({attribute:!1})],K.prototype,`auswahlIndex`,void 0),C([x({attribute:!1})],K.prototype,`durchAuswahlGefiltert`,void 0),C([x({attribute:!1})],K.prototype,`datenGeliefert`,void 0),w.defineAndRegister(K);function ds(e){return g`<div class="nachschlag">
    <input
      class="ctrl"
      type="text"
      .value=${e.wert}
    ...
    >${Ki()}</button>
    ${e.liste}
  </div>`}var fs={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Oa,quelleProp:`nachschlagQuelle`};function ps(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?Fa(e):[]}function ms(e,t){let n=e[0];return n===void 0?t:n.feld}function hs(e,t){let n=e.trim();return n===``||n===t.trim()}function gs(e,t,n){let r=t.trim(),i=[],a=hs(t,n),o=new Set;for(let t of e){let e=O(t,n).trim(),s=r===``?e:O(t,r).trim();if(!(s===``&&e===``)){if(a){if(o.has(e))continue;o.add(e)}i.push({anzeige:s,wert:e,satz:t})}}return i}function _s(e,t,n,r){return gs(Zt(e,t).rows,n,r)}function vs(e){let t=D(I().FF_DATA_SOURCES,e);return t?kt(I().SEDATA,t.name,t.tableId,t.offenerSatz):null}function ys(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=vs(e.quelleId);if(t===null)return{ok:!1,grund:`quelleFehlt`};let n=ms(ps([...e.spalten]),e.speicherFeld);return{ok:!0,eintraege:_s(e.el,t,n,e.speicherFeld)}}function bs(e,t){return t&&e.length===1?e[0]:null}function xs(e,t){let{rows:n,gefiltert:r}=Zt(e,[t]);return!r||n.length>0}function Ss(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var Cs=null,ws=null,Ts=null;function Es(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function Ds(e=!0){let t=e?Ts:null;Ts=null,Cs?.remove(),Cs=null,ws=null,t?.focus()}function Os(e){ws===e&&Ds(!1)}function ks(e){return[{titel:e.speicherTitel===``?`Wert`:e.speicherTitel,feld:e.speicherFeld,art:H}]}function As(e){let t=e=>e.stopPropagation(),n=e.editor;return g`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >${e.inhalt}</ff-dialog-rahmen>`}function js(e,t){let n=ps([...e.spalten]),r=hs(ms(n,e.speicherFeld),e.speicherFeld);return g`<ff-tabelle
    fuellt
    suche="ja"
    style="--se-r-lg:0px"
    .besitz=${`provided`}
    .spalten=${n.length>0?n:ks(e)}
  ...
  ></ff-tabelle>`}function Ms(e){let t=e.eintraege;if(t===void 0){let n=ys(e);if(!n.ok){F(n.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}t=n.eintraege}Ds(!1);let n=document.createElement(`div`);n.style.display=`contents`,Ue(As({titel:e.titel,breite:e.breite,hoehe:e.hoehe,inhalt:js(e,t),onSchliessen:()=>Ds()}),n);let r=n.querySelector($t),i=n.querySelector(K.tagName);i?.addEventListener(Vo,n=>{let r=n.detail,i=t[r.rohIndex];i&&(Ds(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),Ts=e.rueckFokus??Es(e.el),document.body.appendChild(n),Cs=n,ws=e.el,r&&i&&Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}function Ns(e){return As({titel:e.titel,breite:e.breite,hoehe:e.hoehe,onSchliessen:e.onSchliessen,editor:{onGroesse:e.onGroesse},inhalt:g`<ff-tabelle
      data-ff-editor
      fuellt
      suche="ja"
      style="--se-r-lg:0px"
      .spalten=${[...e.spalten]}
      .editable=${!0}
      @ff-prop-change=${t=>{t.stopPropagation();let n=t.detail;n?.attr===`spalten`&&e.onAendern(Fa(n.value))}}
    ...
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}setzeHaken(e){this.angehakt!==e&&(this.angehakt=e,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return g`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return g`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
        ...
        </select>`}case`nachschlagen`:return ds({wert:this.getippt??this.anzeige,onTippen:e=>{this.getippt=e,this.marke=0,this.listeZu=!1},onTaste:e=>this.onNachschlagTaste(e),onVerlassen:()=>this.onNachschlagVerlassen(),onLupe:()=>this.onLupe(),liste:this.vorschlaege.length===0?v:ti({eintraege:this.vorschlaege,marke:this.marke,onWaehlen:e=>this.uebernimmVorschlag(e),onMarke:e=>{this.marke=e}})});default:return g`<input
          class="ctrl"
          type=${e}
      ...
      >
        ${this.controlTpl(e)}
        ${Wi.includes(e)?this.textTpl(`ph ${Gi[e]??``}`.trim(),!n):v}
      </div>
      ${this.spaltenDialog&&this.hasAttribute(`data-ff-editor`)?this.spaltenDialogTpl():v}
    </div>`}connectedCallback(){super.connectedCallback(),zi(this)}disconnectedCallback(){super.disconnectedCallback(),Bi(this),Os(this)}};C([x()],q.prototype,`fieldType`,void 0),C([x()],q.prototype,`placeholder`,void 0),C([x()],q.prototype,`options`,void 0),C([x()],q.prototype,`source`,void 0),C([x()],q.prototype,`value`,void 0),C([x()],q.prototype,`valueField`,void 0),C([x()],q.prototype,`nachschlagQuelle`,void 0),C([x()],q.prototype,`speicherFeld`,void 0),C([x()],q.prototype,`speicherTitel`,void 0),C([x({converter:{fromAttribute:e=>ps(e??``),toAttribute:e=>JSON.stringify(e)}})],q.prototype,`nachschlagSpalten`,void 0),C([x({type:Number})],q.prototype,`fensterBreite`,void 0),C([x({type:Number})],q.prototype,`fensterHoehe`,void 0),C([x()],q.prototype,`einzigerTreffer`,void 0),C([S()],q.prototype,`spaltenDialog`,void 0),C([S()],q.prototype,`anzeige`,void 0),C([S()],q.prototype,`getippt`,void 0),C([S()],q.prototype,`marke`,void 0),C([S()],q.prototype,`listeZu`,void 0),C([S()],q.prototype,`angehakt`,void 0),C([S()],q.prototype,`imSteuerelement`,void 0),w.defineAndRegister(q);var Ps=`ziel`,Fs=o`
...
`,Ls=`frei · hierher ziehen`,Rs=`ff-zimmer-inhalt`,J=class extends w{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[B.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[w.styles,Ga,Is,Fs,o`
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(Rs,{bubbles:!0,composed:!0}))}render(){return g`<div class="zimmer ${Ps}">
      <div
        class="kopf"
        data-ff-editable
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(Rs,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(B.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return g`<div class="col ${Ps} v-${Or(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};C([x()],Y.prototype,`variant`,void 0),C([x()],Y.prototype,`heading`,void 0),C([x({attribute:!1})],Y.prototype,`leerHinweis`,void 0),C([S()],Y.prototype,`_count`,void 0),w.defineAndRegister(Y);function zs(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function Bs(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var Vs=new WeakMap,Hs=Y.tagName,Us=J.tagName,Ws=B.tagName;function Gs(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Hs)}function Ks(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Ws)}function qs(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Us)}function Js(e){return[e,...qs(e)]}function Ys(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=qs(e);for(let e of t)r(e,Ks(e).length===0?Ls:``);r(e,t.length===0&&Ks(e).length===0?n:``)}}function Xs(e){return Ze().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Zs(e,t){let n=qs(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??J.defaultProps.heading),a=zs(O(t,r),i);return a>=0?n[a]:n[0]}function Qs(e){Z?.board===e&&ic();let t=e.getAttribute(`statusfield`)??``,n=uo(e);if(!n)return;let r=Gs(e);if(r.length===0)return;let i=Vs.get(e);if(!i){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(Ws);t&&(i=t.cloneNode(!0),Vs.set(e,i))}if(!i)return;let a=n.zeilen,o=r.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),s=Xs(i.tagName),c=Bs(r.map(e=>e.getAttribute(`auffang`))),l=n.lies;for(let e of r)for(let t of Js(e))Ks(t).forEach(e=>e.remove());for(let e of a){let a=i.cloneNode(!0),u=t===``?-1:zs(O(e,t),o),d=u>=0?r[u]:c>=0?r[c]:r[0];(Zs(d,e)??d).appendChild(a);for(let t of s){let n=a.getAttribute(li(t.prop))??``;n!==``&&(a[t.prop]=l(e,n))}let ee=wt(n.quelle,e);X.set(a,{row:e,pindex:ee}),a.draggable=!0}Ys(e,r);let u=r.flatMap(e=>Js(e).flatMap(Ks)),d=Wt(j(e),u,e=>X.get(e)?.row);for(let e of d)u[e].setAttribute(`data-ff-auswahl`,``)}var X=new WeakMap,Z=null,$s=new WeakSet,ec=`data-ff-zieht`,tc=`data-ff-ziel`,nc=null;function rc(e){nc!==e&&(nc?.removeAttribute(tc),nc=e,nc?.setAttribute(tc,``))}function ic(){Z?.card.removeAttribute(ec),Z=null,rc(null)}function ac(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function oc(e,t){return ac(e,t,Hs)}function sc(e,t,n){if(!Z||Z.board!==e)return;let r=X.get(Z.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;z(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(R)}function cc(e){$s.has(e)||($s.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;if(!n)return;let r=X.get(n);r&&Gt(j(e),r.row),z(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(R)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{Z?.card===n&&n.setAttribute(ec,``)},0))}),e.addEventListener(`dragend`,ic),e.addEventListener(`dragover`,t=>{let n=oc(e,t);if(Z?.board!==e||!n){rc(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),rc(ac(e,t,Us)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&rc(null)}),e.addEventListener(`drop`,t=>{let n=oc(e,t);n&&(t.preventDefault(),sc(e,n,ac(e,t,Us)),ic())}))}var lc=Ci({hydriere:Qs,verdrahte:cc}),uc=lc.connect,dc=lc.disconnect,fc=Y.blockType,pc=class extends w{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[fc]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:fc}}static{this.templateChild={type:B.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:Ha}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`},Ua()]}static{this.defaultChildren=[{type:fc,props:{heading:`Offen`,variant:`warning`},children:[{type:B.blockType}]},{type:fc,props:{heading:`In Arbeit`,variant:`info`}},{type:fc,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[w.styles,o`
    ...
    `]}render(){return g`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),uc(this)}disconnectedCallback(){super.disconnectedCallback(),dc(this)}};w.defineAndRegister(pc);var mc={breite:56,breiteOffen:224},hc=`ff-seiten-wechsel`,gc=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],Q=class extends w{static{this.blockType=`navi-eintrag`}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:gc.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[w.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(hc,{detail:e,bubbles:!0,composed:!0}))}render(){return g`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};C([x()],Q.prototype,`seite`,void 0),C([x()],Q.prototype,`seitename`,void 0),C([x({reflect:!0})],Q.prototype,`ton`,void 0),w.defineAndRegister(Q);var _c=`aktiv`;function vc(e){return Array.from(e.querySelectorAll(Q.tagName))}function yc(e,t){let n=vc(e),r=t??n.find(e=>e.hasAttribute(_c))??n[0];for(let e of n)e===r?e.setAttribute(_c,``):e.removeAttribute(_c)}function bc(e){let t=e.hasAttribute(`offen`);for(let n of vc(e))n.toggleAttribute(`breit`,t)}function xc(e){return e.getAttribute(`name`)??String(ut.defaultProps.name)}function Sc(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function Cc(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(ut.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=Sc(e,i);if(!a)return;let o=r.find(e=>xc(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var wc=new WeakMap,Tc=new WeakSet;function Ec(e){let t=t=>{let n=t.detail;n&&(yc(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),bc(e),!e.hasAttribute(`data-ff-editor`)&&Cc(e,n.ansicht))};e.addEventListener(hc,t),wc.set(e,t)}function Dc(e){let t=wc.get(e);t&&(e.removeEventListener(hc,t),wc.delete(e))}function Oc(e){if(yc(e),bc(e),e.hasAttribute(`data-ff-editor`)||Tc.has(e))return;let t=vc(e)[0];if(!t)return;Tc.add(e);let n=()=>Cc(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var kc=Q.blockType,Ac=class extends w{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[kc]}static{this.addChildButton={label:`Eintrag`,childType:kc}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[lt]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[w.styles,o`
      :host {
        height: 100%;
        width: ${mc.breite}px;
        transition: width var(--se-move);
      }
      :host([offen]) { width: ${mc.breiteOffen}px; }
      .leiste {
        box-sizing: border-box;
        height: 100%;
        width: 100%;
    ...
    `]}connectedCallback(){super.connectedCallback(),Ec(this)}disconnectedCallback(){super.disconnectedCallback(),Dc(this)}klappen(){this.toggleAttribute(`offen`),bc(this)}render(){return g`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
      ...
      </div>`}};w.defineAndRegister(Ac);var jc=li(`text`);function Mc(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(jc)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function Nc(e){let t=ki(e,jc);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function Pc(e){Mc(e)&&(e.text=``)}var Fc=Ci({hydriere:Nc,verdrahte:Pc}),Ic=Fc.connect,Lc=Fc.disconnect,Rc=6,zc=96,Bc=14,Vc={duenn:`300`,normal:`400`,fett:`700`},Hc={links:`left`,mitte:`center`,rechts:`right`},Uc={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},Wc=`standard`;function Gc(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(zc,Math.max(Rc,t)):Bc}function Kc(e){return typeof e==`string`&&e in Vc?e:`normal`}function qc(e){return typeof e==`string`&&e in Hc?e:`links`}function Jc(e){return typeof e==`string`&&e in Uc?e:Wc}var $=class extends w{constructor(...e){super(...e),this.groesse=Bc,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=Wc,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:Bc,gewicht:`normal`,ausrichtung:`links`,farbe:Wc,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Rc,max:zc,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[w.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return g`<div
      class="text"
      style=${W({fontSize:`${Gc(this.groesse)}px`,fontWeight:Vc[Kc(this.gewicht)],textAlign:Hc[qc(this.ausrichtung)],color:Uc[Jc(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),Ic(this)}disconnectedCallback(){super.disconnectedCallback(),Lc(this)}};C([x({type:Number})],$.prototype,`groesse`,void 0),C([x()],$.prototype,`gewicht`,void 0),C([x()],$.prototype,`ausrichtung`,void 0),C([x()],$.prototype,`farbe`,void 0),C([x()],$.prototype,`text`,void 0),C([x()],$.prototype,`source`,void 0),C([x()],$.prototype,`textField`,void 0),w.defineAndRegister($);var Yc=[`waagerecht`,`senkrecht`],Xc=`waagerecht`;function Zc(e){return Yc.includes(e)?e:Xc}var Qc=class extends w{constructor(...e){super(...e),this.richtung=Xc}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:Xc}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[w.styles,o`
    ...
    `]}render(){return g`<div class="flaeche ${Zc(this.richtung)}"><div class="linie"></div></div>`}};C([x()],Qc.prototype,`richtung`,void 0),w.defineAndRegister(Qc),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;F(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();