...
`;function ho(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen])}}function go(e,t,n){return t===``||n===``?[...e]:e.filter(e=>Xr(M(e,t))===n)}function _o(e){let t=e.getAttribute(`source`)??``;if(t===``)return null;let n=j(B().FF_DATA_SOURCES,t);return n?{quelle:n,zeilen:go(Et(B().SEDATA,n.name,n.tableId,n.offenerSatz),e.getAttribute(`tagfield`)??``,ti()),lies:Ui(e)}:null}function vo(e){return va(e.getAttribute(`spalten`)??``)}function yo(e,t){let n=j(B().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?xt(n,t):``}function bo(e){let t=j(B().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return t!==void 0&&t.indexField!==``}function xo(e,t){t&&e.vergissGeschriebene();let n=_o(e);if(!n){e.datenzeilen=[];return}let r=vo(e),{rows:i,gefiltert:a}=Xt(e,n.zeilen),o=Ut(F(e),i,e=>e)[0]??-1,s=n.lies;e.datenGeliefert=!0,e.rohzeilen=i,e.auswahlIndex=o,e.durchAuswahlGefiltert=a,e.datenzeilen=i.map(e=>r.map(t=>t.feld===``?``:s(e,t.feld)))}var So=Ri({hydriere:xo}),Co=So.connect,wo=So.disconnect;function To(e,t){let n=[];return e.forEach((e,r)=>{oi(e,t)&&n.push(r)}),n}function Eo(e,t){return!e&&t.trim()!==``}function Do(e,t,n){return e&&t&&n===0}function Oo(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function ko(e){return fa([...e,ua(e.length)])}function Ao(e,t,n){let r=Fa(e);if(!r)return null;let i=new Set(n.map(e=>e.kennung)),a=Ia(r,t.map(e=>e.kennung).filter(e=>e!==``&&!i.has(e)));return a===r?null:La(a)}function jo(e,t,n){let r=t();r.length<=1||e<0||e>=r.length||(r.splice(e,1),n(r))}function Mo(e,t,n){return b`<div class="steuerung">
    <button
