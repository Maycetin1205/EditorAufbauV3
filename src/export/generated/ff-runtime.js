...
`;function Ja(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen])}}function Ya(e,t,n){return t===``||n===``?[...e]:e.filter(e=>Vr(A(e,t))===n)}function Xa(e){let t=e.getAttribute(`source`)??``;if(t===``)return null;let n=k(L().FF_DATA_SOURCES,t);return n?{quelle:n,zeilen:Ya(Dt(L().SEDATA,n.name,n.tableId,n.offenerSatz),e.getAttribute(`tagfield`)??``,Kr()),lies:Oi(e)}:null}function Za(e){return ta(e.getAttribute(`spalten`)??``)}function Qa(e,t){let n=k(L().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?St(n,t):``}function $a(e){let t=k(L().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return t!==void 0&&t.indexField!==``}function eo(e,t){t&&e.vergissGeschriebene();let n=Xa(e);if(!n){e.datenzeilen=[];return}let r=Za(e),{rows:i,gefiltert:a}=Yt(e,n.zeilen),o=Ht(N(e),i,e=>e)[0]??-1,s=n.lies;e.datenGeliefert=!0,e.rohzeilen=i,e.auswahlIndex=o,e.durchAuswahlGefiltert=a,e.datenzeilen=i.map(e=>r.map(t=>t.feld===``?``:s(e,t.feld)))}var to=Ci({hydriere:eo}),no=to.connect,ro=to.disconnect;function io(e,t){let n=[];return e.forEach((e,r)=>{Zr(e,t)&&n.push(r)}),n}function ao(e,t){return!e&&t.trim()!==``}function oo(e,t,n){return e&&t&&n===0}function so(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function co(e){return Yi([...e,U(e.length)])}function lo(e,t,n){let r=t();r.length<=1||e<0||e>=r.length||(r.splice(e,1),n(r))}function uo(e,t,n){return y`<div class="steuerung">
    ...
    >+</button>
  </div>`}function fo(e,t,n,r){let i=n(),a=e+t;if(e<0||e>=i.length||a<0||a>=i.length)return;let[o]=i.splice(e,1);i.splice(a,0,o),r(i)}function po(e,t,n,r){let i=(i,a)=>{let o=t+i;if(o<0||o>=n)return x;let s=i===-1?`nach links`:`nach rechts`;return y`<button
      class=${i===-1?`kopf-schieb links`:`kopf-schieb rechts`}
      type="button"
      title=${`Spalte „${e}" ${s} schieben`}
      aria-label=${`Spalte „${e}" ${s} schieben`}
      @pointerdown=${e=>e.stopPropagation()}
      @click=${e=>{e.stopPropagation(),r(t,i)}}
      @dblclick=${e=>e.stopPropagation()}
    >${a}</button>`};return y`${i(-1,`‹`)}${i(1,`›`)}`}function mo(e,t){let n=e.currentTarget;n&&(e.stopPropagation(),e.preventDefault(),at(n,(e,n)=>e===``||e===n.trim()?!1:(t(e),!0)))}function ho(e,t,n,r){mo(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var go=220,_o=new WeakMap;function vo(e){let t=_o.get(e);t!==void 0&&(clearTimeout(t),_o.delete(e))}function yo(e,t,n){return y`<button
    class="kopf-weg"
    type="button"
    ...
    @dblclick=${e=>e.stopPropagation()}
  >&#x2715;</button>`}function bo(e){return{dblklickKopf:(t,n)=>{e.editable()&&(vo(e.baustein),ho(t,n,e.liste,e.aendere))},klickKopf:(t,n)=>{e.editable()&&xo(e.baustein,t,{prop:e.prop,index:n,liste:e.liste}),e.sortiere(n)}}}function xo(e,t,n){t.stopPropagation();let r=t.currentTarget.getBoundingClientRect();vo(e),_o.set(e,setTimeout(()=>{_o.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n.prop,index:n.index,top:r.bottom+4,left:r.left,...n.liste?{liste:n.liste()}:{}},bubbles:!0,composed:!0}))},go))}var So=`\0`;function Co(e,t){return e+So+String(t)}var wo=class{constructor(){this.werte=new Map}setze(e,t,n){if(e===``)return!1;let r=Co(e,t);return this.werte.get(r)===n?!1:(this.werte.set(r,n),!0)}nimmZurueck(e,t){return this.werte.delete(Co(e,t))}wert(e,t){return e===``?void 0:this.werte.get(Co(e,t))}get anzahl(){return this.werte.size}proSatz(){let e=[];for(let[t,n]of this.werte){let[r,i]=t.split(So),a=Number(i),o=e.find(e=>e.satz===r),s={satz:r,spalte:a,wert:n};o?o.aenderungen.push(s):e.push({satz:r,aenderungen:[s]})}return e}nimmSatzZurueck(e){let t=!1;for(let n of[...this.werte.keys()])n.slice(0,n.indexOf(So))===e&&this.werte.delete(n)&&(t=!0);return t}},To=class{constructor(e){this.aenderungen=new wo,this.geloescht=new Set,this.wirt=e}get geaenderteZeilen(){if(this.aenderungen.anzahl===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let{satz:r}of this.aenderungen.proSatz()){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}get geloeschteZeilen(){if(this.geloescht.size===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let r of this.geloescht){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}austragen(e,t){let n=!1;for(let r of t)n=e===`geaendert`?this.aenderungen.nimmSatzZurueck(r)||n:this.geloescht.delete(r)||n;n&&this.wirt.melde()}vorgemerkteAenderungen(){return this.geaenderteZeilen.length}vorgemerkteLoeschungen(){return this.geloeschteZeilen.length}statusVon(e){let t=this.satzVon(e);if(t===``)return{status:`gebucht`,titel:``};if(this.geloescht.has(t))return this.wirt.lauf.zeigt(`geloescht`,t,`loeschung`);let n=this.wirt.spalten().some((e,n)=>this.aenderungen.wert(t,n)!==void 0);return this.wirt.lauf.zeigt(`geaendert`,t,n?`geaendert`:`gebucht`)}satzPlaetze(){let e=new Map;return this.wirt.rohzeilen().forEach((t,n)=>{let r=Qa(this.wirt.baustein,t);r!==``&&!e.has(r)&&e.set(r,n)}),e}satzVon(e){let t=this.wirt.rohzeilen()[e];return t===void 0?``:Qa(this.wirt.baustein,t)}schalteLoeschung(e){let t=this.satzVon(e);t!==``&&(this.geloescht.has(t)?this.geloescht.delete(t):(this.geloescht.add(t),this.wirt.spalten().forEach((e,n)=>{this.aenderungen.nimmZurueck(t,n)})),this.wirt.melde())}istGeloescht(e){let t=this.satzVon(e);return t!==``&&this.geloescht.has(t)}zellWert(e,t){let n=this.aenderungen.wert(this.satzVon(e),t);return n===void 0?this.wirt.datenzeilen()[e]?.[t]??``:n}istGeaendert(e,t){return this.aenderungen.wert(this.satzVon(e),t)!==void 0}tippeZelle(e,t,n){this.aenderungen.setze(this.satzVon(e),t,n)&&this.wirt.melde()}verlasseZelle(e,t,n){let r=this.satzVon(e);(n===(this.wirt.datenzeilen()[e]?.[t]??``)?this.aenderungen.nimmZurueck(r,t):this.aenderungen.setze(r,t,n))&&this.wirt.melde()}zelleNachbar(e,t,n,r){let i=Array.from(this.wirt.baustein.shadowRoot?.querySelectorAll(`.koerper > .zeile:not(.erfassung) .zell-eingabe[data-spalte="${e}"]`)??[]),a=i.indexOf(t);if(a<0)return;let o=a+n;if(o>i.length-1){if(r&&this.wirt.erfassungAn()){this.wirt.fokussiereErfassungsZelle(0);return}o=i.length-1}o<0&&(o=0);let s=i[o];!s||s===t||(s.focus(),s.select(),s.scrollIntoView({block:`nearest`}))}tasteZelle(e,t,n){let r=n.target;if(n.key===`Escape`){n.preventDefault(),n.stopPropagation(),this.aenderungen.nimmZurueck(this.satzVon(e),t)&&this.wirt.melde();return}let i={Enter:1,ArrowDown:1,ArrowUp:-1,PageDown:10,PageUp:-10}[n.key];i!==void 0&&(n.preventDefault(),n.stopPropagation(),this.zelleNachbar(t,r,i,n.key===`Enter`))}},Eo={gebucht:``,erfasst:`Neue Zeile — noch nicht geschrieben`,geaendert:`Geändert — noch nicht geschrieben`,loeschung:`Zum Löschen vorgemerkt — noch nicht geschrieben`,schreibt:`Wird geschrieben …`,geschrieben:`Hinausgeschickt — bleibt stehen, bis neue Daten kommen`,fehler:`Nicht geschrieben`},Do=class{constructor(e){this.schreibend=new Map,this.fehler=new Map,this.melde=e}schreibt(e,t){this.fehler.get(e)?.delete(t);let n=this.schreibend.get(e)??new Set;n.add(t),this.schreibend.set(e,n),this.melde()}gescheitert(e,t,n){this.schreibend.get(e)?.delete(t);let r=this.fehler.get(e)??new Map;r.set(t,n),this.fehler.set(e,r),this.melde()}fertig(e,t){this.schreibend.get(e)?.clear();let n=this.fehler.get(e);if(n)for(let e of t)n.delete(e);this.melde()}zeigt(e,t,n){let r=this.fehler.get(e)?.get(t);return r===void 0?this.schreibend.get(e)?.has(t)===!0?{status:`schreibt`,titel:Eo.schreibt}:{status:n,titel:Eo[n]}:{status:`fehler`,titel:Eo.fehler+`: `+r}}},Oo=4;function ko(e){return e??Oo}function Ao(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function jo(e,t,n){let r=Ao(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function Mo(e,t){return e===null?null:Math.max(0,e-t)}function No({sichtbar:e,hatQuelle:t,platzhalterZeilen:n}){return t?{seiten:1,seite:0,zeilen:[...e]}:{seiten:1,seite:0,zeilen:Array.from({length:n},()=>null)}}function Po({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function Fo(e){if(!e.hasAttribute(`fuellt`))return-1;let t=e.renderRoot.querySelector(`.koerper`);return t instanceof HTMLElement?t.clientHeight:-1}function Io(e){let t=e.renderRoot.querySelector(`.kopf`);return t instanceof HTMLElement?t.offsetHeight:0}function Lo(e,t){let n=Fo(e);if(n===-1)return{mass:null,hoehe:n,kopf:0};let r=Io(e);return{mass:jo(n,r,t),hoehe:n,kopf:r}}function Ro(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}var zo=`ff-zeile-aktiviert`,Bo=`data-ff-roh`;function Vo(e,t){e.dispatchEvent(new CustomEvent(zo,{detail:t,bubbles:!0,composed:!0}))}function Ho(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(Bo);return r===null||r===``?null:Number(r)}function Uo(e,t){if(!(e instanceof HTMLElement))return!1;let n=e.closest(`.zeile`),r=n?.parentElement;if(!n||!r)return!1;let i=[...r.querySelectorAll(`.zeile[${Bo}]`)],a=i.indexOf(n),o=a===-1?void 0:i[a+t];return o?(o.focus(),!0):!1}function Wo(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.zeile[${Bo}]`);return t?(t.focus(),!0):!1}function Go(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.suchzeile input`);return t?(t.focus(),!0):!1}function Ko(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var qo=class{constructor(e){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._rumpfGemessen=-1,this._kopfGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this.wirt=e}get suchtext(){return this._suchtext}get suchtAktiv(){return this._suchtext.trim()!==``}get sortSpalte(){return this._sortSpalte}get sortAuf(){return this._sortAuf}get seite(){return this._seite}get mass(){return this._mass}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.wirt.melde()}klickSortiere(e){this.wirt.editable()||(this.merkeZeilenFokus(),this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.wirt.melde())}blaettere(e){this.merkeZeilenFokus(),this._seite=e,this.wirt.melde()}fokussiereSuche(){let e=this.wirt.baustein.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}merkeZeilenFokus(){let e=Ho(this.wirt.baustein.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.wirt.zeilenHoehe();this._taktGemessen=e;let{mass:t,hoehe:n,kopf:r}=Lo(this.wirt.baustein,e);this._rumpfGemessen=n,this._kopfGemessen=r,!(t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe)&&(this._mass=t,this.wirt.melde())}beobachte(){this._beobachter||(this._beobachter=Ro(this.wirt.baustein,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}nachRendern(){(this._taktGemessen!==this.wirt.zeilenHoehe()||this._rumpfGemessen!==Fo(this.wirt.baustein)||this._kopfGemessen!==Io(this.wirt.baustein))&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,Ko(this.wirt.baustein.shadowRoot,this._fokusZeile))}loese(){this._beobachter?.disconnect(),this._beobachter=null}nachPush(){this._seite=0,this._mass=null,this._taktGemessen=0,this._rumpfGemessen=-1,this._kopfGemessen=0}zuruecksetzen(){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this.nachPush(),this._fokusZeile=null,this._fokusHolen=!1}};function Jo(e,t,n,r){if(n===null||e.hasAttribute(`data-ff-editor`))return;let i=t[n];i!==void 0&&(Vo(e,{rohzeile:i,rohIndex:n,ansichtIndex:r}),Xo(e,i),B(e,`onRowClick`,{PINDEX:Qa(e,i)}).catch(z))}function Yo(e,t,n){if(n===null||e.hasAttribute(`data-ff-editor`))return;let r=t[n];r!==void 0&&B(e,`onRowDblClick`,{PINDEX:Qa(e,r)}).catch(z)}function Xo(e,t){let n=N(e);n!==``&&Ut(n,t)}var Zo={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,kennungKey:`kennung`,standardTitel:qi,eintragsSchalter:[{key:`summe`,label:`Summe in der Fußzeile`,kurz:`Summe`},{key:`aenderbar`,label:`In der Zeile änderbar`,kurz:`änderbar`,standard:!0,nurEigeneQuelle:!0}],herkunftProp:`spaltenHerkunft`,eintragsFeldWahl:[{key:`fuellFeld`,label:`Nachschlagen`,hinweis:`Beim Erfassen füllt der gewählte Satz der Hilfsquelle diese Zelle.`,nurFremdeQuellen:!0}]};function Qo(e){let t=e,n=Zo.eintragsSchalter?.find(e=>e.key===`aenderbar`);return n!==void 0&&e.feld!==``&&ci(Zo,t).includes(n)&&si(n,t)}function $o(e,t,n){let r=0,i=0;for(let t of e){let e=za(t);e!==null&&(r+=e,i++)}return i===0?``:r.toLocaleString(`de-DE`,{minimumFractionDigits:t,maximumFractionDigits:n})}var es={min:0,max:3};function ts(e,t){let n=[];return e.spalten.forEach((r,i)=>{if(r.summe!==!0)return;let a=$o(t.map(t=>e.wertVon(t,i)),es.min,es.max);a!==``&&n.push({titel:r.titel,text:a})}),n}function ns(e){let t=io(e.datenzeilen,e.suchtext);return e.sortSpalte<0?t:Wa(t.map(t=>e.datenzeilen[t]),e.sortSpalte,e.sortAuf).map(e=>t[e])}function rs(e){let t={gridTemplateColumns:na(e.spalten,e.breiteVon)},n=e.gemessen?.zeilenHoehe??28,r=e.hatQuelle,i=!e.erfassungAn&&oo(r,e.datenGeliefert,e.datenzeilen.length),a=ns(e),o=e.erfassungAn?1+e.erfassteAnzahl:0,s=e.gemessen===null?null:Math.max(1,e.gemessen.passen-o),c={sichtbar:a,hatQuelle:r,proSeite:s??Math.max(1,10-o),wunschSeite:e.wunschSeite,platzhalterZeilen:ko(s)},{seiten:l,seite:u,zeilen:d}=e.blaettert?Po(c):No(c);return{cols:t,takt:28,zeilenHoehe:n,hatQuelle:r,leer:i,gesamt:a.length,seiten:l,seite:u,zeilen:d,linealTakte:Mo(s,d.length),summen:ts(e,a)}}var is=[H(`suche`,`Suchzeile`,`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,{requiresDataSource:!0}),H(`erfassung`,`Erfassungszeile`,`Eine leere Zeile zum Tippen neuer Positionen.`),H(`loeschbar`,`Zeilen löschbar`,`Kreuz an jeder Zeile: merkt sie zum Löschen vor.`,{requiresDataSource:!0}),H(`blaettern`,`Blättern`,`Ja: Seiten mit Blätter-Knöpfen. Nein: alles untereinander, der Rumpf rollt.`),H(`kopfzeile`,`Kopfzeile`,`Aus: keine Titelzeile, kein Sortieren per Titelklick.`),{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Sätze des gewählten Tages.`,kind:`field`},ya()];function as(e,t){let n=e.erfasst+e.geaendert+e.geloescht,r=e.seiten>1||e.summen.length>0||n>0||e.suchtAktiv||e.auswahlAktiv;return e.leer||!r?x:y`<div class="fusszeile">
  ...
  </div>`}var os=/[.*+?^${}()|[\]\\]/g;function ss(e,t){let n=Xr(t);if(n.length===0||e===``)return e;let r;try{r=RegExp(`(${n.map(e=>e.replace(os,`\\$&`)).join(`|`)})`,`ig`)}catch{return e}let i=e.split(r);return i.length<=1?e:y`${i.map((e,t)=>t%2==1?y`<mark>${e}</mark>`:e)}`}function cs(e,t,n){let r=40-e,i=t-40,a=r>i?0:Math.min(i,Math.max(r,Math.round(n)));return{links:Math.round(e+a),rechts:Math.round(t-a)}}function ls(e,t,n){if(e.button!==0)return;let r=[...e.currentTarget?.parentElement?.children??[]].filter(e=>e instanceof HTMLElement&&e.tagName===`DIV`),i=r[t],a=r[t+1];if(!i||!a)return;e.stopPropagation(),e.preventDefault();let o=e.clientX,s=i.getBoundingClientRect().width,c=a.getBoundingClientRect().width,l=cs(s,c,0),u=()=>{window.removeEventListener(`pointermove`,p),window.removeEventListener(`pointerup`,ee),window.removeEventListener(`pointercancel`,m),window.removeEventListener(`keydown`,te),window.removeEventListener(`blur`,m)},d=r.map(e=>Math.max(1,Math.round(e.getBoundingClientRect().width))),f=()=>d.map((e,n)=>n===t?{index:n,breite:l.links}:n===t+1?{index:n,breite:l.rechts}:{index:n,breite:e});function p(e){l=cs(s,c,e.clientX-o),n.zeige(f())}function ee(){u(),n.uebernimm(f())}function m(){u(),n.verwirf()}function te(e){e.key===`Escape`&&(e.preventDefault(),m())}window.addEventListener(`pointermove`,p),window.addEventListener(`pointerup`,ee),window.addEventListener(`pointercancel`,m),window.addEventListener(`keydown`,te),window.addEventListener(`blur`,m)}function us(e,t){return Array.from({length:Math.max(0,e-1)},(e,n)=>y`<span
    class="breite-griff"
    role="presentation"
    style="grid-row: 1; grid-column: ${n+1}"
    title="Linie ziehen: links breiter, rechts schmaler"
    @pointerdown=${e=>ls(e,n,t)}
    @click=${e=>e.stopPropagation()}
    @dblclick=${e=>e.stopPropagation()}
  ></span>`)}function ds(e){return e.linealTakte===0?x:y`<div class="lineal" role="presentation" style=${W(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>y`<div></div>`)}
        </div>`}function fs(e,t){return y`
      ...
      ${e.zeigeKopf?y`<div class="kopf" role="row" style=${W(e.cols)}>
        ${e.spalten.map((n,r)=>y`<div
          ...
          >${e.imEditor&&(e.herkunft[r]??``)!==``?y`<span class="kopf-titel">${n.titel}</span><span
                ...
                >${e.herkunft[r]}</span>`:n.titel}${!e.editable&&e.sortSpalte===r?y`<span class="sort-pfeil">${e.sortAuf?` ▲`:` ▼`}</span>`:``}${e.imEditor&&e.editable&&e.spalten.length>1?y`${po(n.titel,r,e.spalten.length,t.verschiebeSpalte)}${yo(n.titel,r,t.loescheSpalte)}`:x}</div>`)}
        ${us(e.spalten.length,t.breiten)}
      </div>`:x}
        ${``}
        ${e.leer?ba(e.leerText,!0):y`
        ${e.hatQuelle?x:e.erfassung}
        ${e.zeilen.map((n,r)=>{let i=n!==null&&!e.imEditor,a=n!==null&&e.zeilenStand.istGeloescht(n),o=n===null?{status:`gebucht`,titel:``}:e.zeilenStand.statusVon(n);return y`<div
            ...
            @keydown=${e=>{if(!e.target.closest(`.zell-eingabe`)){if(e.key===`ArrowDown`||e.key===`ArrowUp`){let t=e.key===`ArrowUp`;(Uo(e.target,t?-1:1)||t&&Go(e.target))&&e.preventDefault();return}e.key===`Enter`&&(e.preventDefault(),t.aktiviereZeile(n,r))}}}
          >
            ${``}
            ${e.spalten.map((r,i)=>{let a=n===null?`—`:e.datenzeilen[n]?.[i]??``,o=e.imEditor&&!e.zeigeKopf&&e.editable;if(e.aendernMoeglich&&n!==null&&Qo(r)){let t=e.zeilenStand;return y`<div class="tippbar" role="cell">
                <input
        ...
        ${e.erfasste.map((n,r)=>{let i=e.erfasstStand(r),a=i.status===`geschrieben`;return y`<div
          class="zeile erfasst"
          role="row"
...
`,q=class e extends D{constructor(...e){super(...e),this.spalten=Zi(),this.spaltenHerkunft=[],this.source=``,this.suche=`ja`,this.erfassung=`nein`,this.blaettern=`ja`,this.loeschbar=`nein`,this.kopfzeile=`ja`,this.leerText=va,this.rechnung=``,this.datenzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._besitz=`softengine`,this._breiten=new Map,this._breiteVorZug=null,this._ansicht=new qo({baustein:this,editable:()=>this.editable,zeilenHoehe:()=>this.zeilenHoehe,melde:()=>this.requestUpdate()}),this._erfassung=new Ka,this._lauf=new Do(()=>this.requestUpdate()),this._zeilen=new To({baustein:this,spalten:()=>this.spaltenListe(),rohzeilen:()=>this.rohzeilen,datenzeilen:()=>this.datenzeilen,melde:()=>this.requestUpdate(),lauf:this._lauf,erfassungAn:()=>this.erfassungAn,fokussiereErfassungsZelle:e=>this.fokussiereErfassungsZelle(e)}),this.nimmSeFokus=e=>{e.defaultPrevented||!this.erfassungAn||this.hasAttribute(`data-ff-editor`)||(e.preventDefault(),this.fokussiereErfassungsZelle(0))}}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.kannErfassen={wenn:{attributeName:`erfassung`,equals:`ja`}}}static{this.aenderungsSchluessel=`aenderbar`}static{this.kannLoeschen={wenn:{attributeName:`loeschbar`,equals:`ja`}}}static{this.blockEvents=[{key:`onRowClick`,name:`Zeile gewählt`},{key:`onRowDblClick`,name:`Zeile doppelt geklickt`}]}static{this.listenBindung=Zo}static{this.defaultProps={width:`fill`,source:``,spalten:Zi(),suche:`ja`,erfassung:`nein`,blaettern:`ja`,loeschbar:`nein`,kopfzeile:`ja`,tagField:``,rechnung:``,leerText:va}}static{this.customProperties=is}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?ro(this):no(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=Ja(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.nachPush(),this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.zuruecksetzen(),this._erfassung.zuruecksetzen()}get erfassteZeilen(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.werte)}get erfassteSchluessel(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.kennung)}get geaenderteZeilen(){return this._zeilen.geaenderteZeilen}get geloeschteZeilen(){return this._zeilen.geloeschteZeilen}zeileSchreibt(e,t){this._lauf.schreibt(e,t)}zeileGescheitert(e,t,n){this._lauf.gescheitert(e,t,n)}laufFertig(e,t){if(this._lauf.fertig(e,t),e===`erfasst`){this._erfassung.markiereGeschrieben(this.erfassungsUmfeld(),t)&&this.requestUpdate();return}this._zeilen.austragen(e,t)}vergissGeschriebene(){this._erfassung.vergissGeschriebene()&&this.requestUpdate()}erfasstStand(e){return this._lauf.zeigt(`erfasst`,this._erfassung.schluessel[e]??``,this._erfassung.istGeschrieben(e)?`geschrieben`:`erfasst`)}erfasseZeile(){return this._erfassung.erfasse(this.erfassungsUmfeld())?(this.requestUpdate(),this.fokussiereErfassungsZelle(0),this.zeigeLetzteErfasste(),!0):!1}zeigeLetzteErfasste(){this.updateComplete.then(()=>{let e=this.shadowRoot?.querySelector(`.koerper`);e&&(e.scrollTop=e.scrollHeight)})}fokussiereSuche(){return this._ansicht.fokussiereSuche()}setzeSuchtext(e){this._ansicht.setzeSuchtext(e),this.requestUpdate()}get hatQuelle(){return this._besitz===`provided`||ao(this.hasAttribute(`data-ff-editor`),this.source)}spaltenListe(){return ea(this.spalten)}get zeilenHoehe(){return 28}breitenWirt(){let e=e=>{this._breiteVorZug===null&&(this._breiteVorZug=new Map(e.map(e=>[e.index,this._breiten.get(e.index)])))};return{zeige:t=>{e(t);for(let e of t)this._breiten.set(e.index,e.breite);this.requestUpdate()},uebernimm:e=>{this._breiteVorZug=null;let t=this.spaltenListe();if(!this.hasAttribute(`data-ff-editor`)){for(let t of e)this._breiten.set(t.index,t.breite);this.requestUpdate();return}for(let n of e)n.index>=t.length||(this._breiten.delete(n.index),t[n.index]={...t[n.index],breite:n.breite});this.aendere(t)},verwirf:()=>{let e=this._breiteVorZug;if(this._breiteVorZug=null,e){for(let[t,n]of e)n===void 0?this._breiten.delete(t):this._breiten.set(t,n);this.requestUpdate()}}}}get erfassungAn(){return this.erfassung===`ja`}erfassungsWirt(){return{baustein:this,lauf:this._erfassung.lauf,umfeld:()=>this.erfassungsUmfeld(),melde:()=>this.requestUpdate(),fokussiere:e=>this.fokussiereErfassungsZelle(e),erfasseZeile:()=>this.erfasseZeile()}}fokussiereErfassungsZelle(e){this.updateComplete.then(()=>{let t=this.shadowRoot?.querySelectorAll(`.zeile.erfassung .erf-eingabe`)?.[e];t&&(t.focus(),t.scrollIntoView({block:`nearest`}))})}erfassungsUmfeld(){return this._erfassung.umfeld(this,this.spaltenListe(),this.source,_a(this.rechnung))}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&no(this),document.addEventListener(In,this.nimmSeFokus),this._ansicht.beobachte()}firstUpdated(){this._ansicht.beobachte()}willUpdate(e){super.willUpdate(e),e.has(`spalten`)&&this._breiten.clear(),!(!this.erfassungAn||this.hasAttribute(`data-ff-editor`))&&this._erfassung.lauf.aktualisiereVorschlaege(this.erfassungsUmfeld())}updated(){this._ansicht.nachRendern(),Er(this)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(In,this.nimmSeFokus),vo(this),this._ansicht.loese(),Ms(this),ro(this)}static{this.styles=[D.styles,xa,ps,ri,qa]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=rs({spalten:t,breiteVon:e=>this._breiten.get(e),hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._ansicht.suchtext,sortSpalte:this._ansicht.sortSpalte,sortAuf:this._ansicht.sortAuf,wunschSeite:this._ansicht.seite,gemessen:this._ansicht.mass,erfassungAn:this.erfassungAn,erfassteAnzahl:this._erfassung.zeilen.length,wertVon:(e,t)=>this._zeilen.zellWert(e,t),blaettert:this.blaettern===`ja`});return y`<div class="tabelle" style=${W({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
    ...
    >${Ki()}</button>
    ${e.liste}
  </div>`}var gs={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:qi,quelleProp:`nachschlagQuelle`};function _s(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?ea(e):[]}function vs(e,t){let n=e[0];return n===void 0?t:n.feld}function ys(e,t){let n=e.trim();return n===``||n===t.trim()}function bs(e,t,n){let r=t.trim(),i=[],a=ys(t,n),o=new Set;for(let t of e){let e=A(t,n).trim(),s=r===``?e:A(t,r).trim();if(!(s===``&&e===``)){if(a){if(o.has(e))continue;o.add(e)}i.push({anzeige:s,wert:e,satz:t})}}return i}function xs(e,t,n,r){return bs(Yt(e,t).rows,n,r)}function Ss(e){let t=k(L().FF_DATA_SOURCES,e);return t?Dt(L().SEDATA,t.name,t.tableId,t.offenerSatz):null}function Cs(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=Ss(e.quelleId);if(t===null)return{ok:!1,grund:`quelleFehlt`};let n=vs(_s([...e.spalten]),e.speicherFeld);return{ok:!0,eintraege:xs(e.el,t,n,e.speicherFeld)}}function ws(e,t){return t&&e.length===1?e[0]:null}function Ts(e,t){let{rows:n,gefiltert:r}=Yt(e,[t]);return!r||n.length>0}function Es(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var Ds=null,Os=null,ks=null;function As(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function js(e=!0){let t=e?ks:null;ks=null,Ds?.remove(),Ds=null,Os=null,t?.focus()}function Ms(e){Os===e&&js(!1)}function Ns(e){return[{kennung:``,titel:e.speicherTitel===``?`Wert`:e.speicherTitel,feld:e.speicherFeld}]}function Ps(e){let t=e=>e.stopPropagation(),n=e.editor;return y`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >${e.inhalt}</ff-dialog-rahmen>`}function Fs(e,t){let n=_s([...e.spalten]),r=ys(vs(n,e.speicherFeld),e.speicherFeld);return y`<ff-tabelle
    fuellt
    suche="ja"
    style="--se-r-lg:0px"
    .besitz=${`provided`}
    .spalten=${n.length>0?n:Ns(e)}
  ...
  ></ff-tabelle>`}function Is(e){let t=e.eintraege;if(t===void 0){let n=Cs(e);if(!n.ok){I(n.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}t=n.eintraege}js(!1);let n=document.createElement(`div`);n.style.display=`contents`,Be(Ps({titel:e.titel,breite:e.breite,hoehe:e.hoehe,inhalt:Fs(e,t),onSchliessen:()=>js()}),n);let r=n.querySelector(Zt),i=n.querySelector(q.tagName);i?.addEventListener(zo,n=>{let r=n.detail,i=t[r.rohIndex];i&&(js(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),ks=e.rueckFokus??As(e.el),document.body.appendChild(n),Ds=n,Os=e.el;let a=e.suchtext??``;i&&a!==``&&i.setzeSuchtext(a),r&&i&&Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}function Ls(e){return Ps({titel:e.titel,breite:e.breite,hoehe:e.hoehe,onSchliessen:e.onSchliessen,editor:{onGroesse:e.onGroesse},inhalt:y`<ff-tabelle
      data-ff-editor
      fuellt
      suche="ja"
      style="--se-r-lg:0px"
...
`,Vs=`frei · hierher ziehen`,Hs=`ff-zimmer-inhalt`,Y=class extends D{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[V.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[D.styles,xa,Bs,zs,o`
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(Hs,{bubbles:!0,composed:!0}))}render(){return y`<div class="zimmer ${Rs}">
      <div
        class="kopf"
        data-ff-editable
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(Hs,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(V.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return y`<div class="col ${Rs} v-${kr(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};E([w()],X.prototype,`variant`,void 0),E([w()],X.prototype,`heading`,void 0),E([w({attribute:!1})],X.prototype,`leerHinweis`,void 0),E([T()],X.prototype,`_count`,void 0),D.defineAndRegister(X);function Us(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function Ws(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var Gs=new WeakMap,Ks=X.tagName,qs=Y.tagName,Js=V.tagName;function Ys(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Ks)}function Xs(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Js)}function Zs(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===qs)}function Qs(e){return[e,...Zs(e)]}function $s(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=Zs(e);for(let e of t)r(e,Xs(e).length===0?Vs:``);r(e,t.length===0&&Xs(e).length===0?n:``)}}function ec(e){return Je().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function tc(e,t){let n=Zs(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),a=Us(A(t,r),i);return a>=0?n[a]:n[0]}function nc(e){Q?.board===e&&cc();let t=e.getAttribute(`statusfield`)??``,n=Xa(e);if(!n)return;let r=Ys(e);if(r.length===0)return;let i=Gs.get(e);if(!i){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(Js);t&&(i=t.cloneNode(!0),Gs.set(e,i))}if(!i)return;let a=n.zeilen,o=r.map(e=>e.getAttribute(`heading`)??X.defaultProps.heading),s=ec(i.tagName),c=Ws(r.map(e=>e.getAttribute(`auffang`))),l=n.lies;for(let e of r)for(let t of Qs(e))Xs(t).forEach(e=>e.remove());for(let e of a){let a=i.cloneNode(!0),u=t===``?-1:Us(A(e,t),o),d=u>=0?r[u]:c>=0?r[c]:r[0];(tc(d,e)??d).appendChild(a);for(let t of s){let n=a.getAttribute(li(t.prop))??``;n!==``&&(a[t.prop]=l(e,n))}let f=St(n.quelle,e);Z.set(a,{row:e,pindex:f}),a.draggable=!0}$s(e,r);let u=r.flatMap(e=>Qs(e).flatMap(Xs)),d=Ht(N(e),u,e=>Z.get(e)?.row);for(let e of d)u[e].setAttribute(`data-ff-auswahl`,``)}var Z=new WeakMap,Q=null,rc=new WeakSet,ic=`data-ff-zieht`,ac=`data-ff-ziel`,oc=null;function sc(e){oc!==e&&(oc?.removeAttribute(ac),oc=e,oc?.setAttribute(ac,``))}function cc(){Q?.card.removeAttribute(ic),Q=null,sc(null)}function lc(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function uc(e,t){return lc(e,t,Ks)}function dc(e,t,n){if(!Q||Q.board!==e)return;let r=Z.get(Q.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;B(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(z)}function fc(e){rc.has(e)||(rc.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Z.has(e))??null;if(!n)return;let r=Z.get(n);r&&Ut(N(e),r.row),B(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(z)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Z.has(e))??null;n&&(Q={card:n,board:e},t.dataTransfer?.setData(`text/plain`,Z.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{Q?.card===n&&n.setAttribute(ic,``)},0))}),e.addEventListener(`dragend`,cc),e.addEventListener(`dragover`,t=>{let n=uc(e,t);if(Q?.board!==e||!n){sc(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),sc(lc(e,t,qs)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&sc(null)}),e.addEventListener(`drop`,t=>{let n=uc(e,t);n&&(t.preventDefault(),dc(e,n,lc(e,t,qs)),cc())}))}var pc=Ci({hydriere:nc,verdrahte:fc}),mc=pc.connect,hc=pc.disconnect,gc=X.blockType,_c=class extends D{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[gc]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:gc}}static{this.templateChild={type:V.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:va}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Feld, das die Spalte bestimmt. Leer: alle in die Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Einträge des gewählten Tages.`,kind:`field`},ya()]}static{this.defaultChildren=[{type:gc,props:{heading:`Offen`,variant:`warning`},children:[{type:V.blockType}]},{type:gc,props:{heading:`In Arbeit`,variant:`info`}},{type:gc,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[D.styles,o`
    ...
    `]}render(){return y`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),mc(this)}disconnectedCallback(){super.disconnectedCallback(),hc(this)}};D.defineAndRegister(_c);var vc={breite:56,breiteOffen:224},yc=`ff-seiten-wechsel`,bc=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],xc=class extends D{static{this.blockType=`navi-eintrag`}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:bc.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[D.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(yc,{detail:e,bubbles:!0,composed:!0}))}render(){return y`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};E([w()],xc.prototype,`seite`,void 0),E([w()],xc.prototype,`seitename`,void 0),E([w({reflect:!0})],xc.prototype,`ton`,void 0),D.defineAndRegister(xc);var Sc=`aktiv`;function Cc(e){return Array.from(e.querySelectorAll(xc.tagName))}function wc(e,t){let n=Cc(e),r=t??n.find(e=>e.hasAttribute(Sc))??n[0];for(let e of n)e===r?e.setAttribute(Sc,``):e.removeAttribute(Sc)}function Tc(e){let t=e.hasAttribute(`offen`);for(let n of Cc(e))n.toggleAttribute(`breit`,t)}function Ec(e){return e.getAttribute(`name`)??String(st.defaultProps.name)}function Dc(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function Oc(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(st.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=Dc(e,i);if(!a)return;let o=r.find(e=>Ec(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var kc=new WeakMap,Ac=new WeakSet;function jc(e){let t=t=>{let n=t.detail;n&&(wc(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),Tc(e),!e.hasAttribute(`data-ff-editor`)&&Oc(e,n.ansicht))};e.addEventListener(yc,t),kc.set(e,t)}function Mc(e){let t=kc.get(e);t&&(e.removeEventListener(yc,t),kc.delete(e))}function Nc(e){if(wc(e),Tc(e),e.hasAttribute(`data-ff-editor`)||Ac.has(e))return;let t=Cc(e)[0];if(!t)return;Ac.add(e);let n=()=>Oc(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var Pc=xc.blockType,Fc=class extends D{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Pc]}static{this.addChildButton={label:`Eintrag`,childType:Pc}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[ot]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[D.styles,o`
      :host {
        height: 100%;
        width: ${vc.breite}px;
        transition: width var(--se-move);
      }
      :host([offen]) { width: ${vc.breiteOffen}px; }
      .leiste {
        box-sizing: border-box;
        height: 100%;
        width: 100%;
    ...
    `]}connectedCallback(){super.connectedCallback(),jc(this)}disconnectedCallback(){super.disconnectedCallback(),Mc(this)}klappen(){this.toggleAttribute(`offen`),Tc(this)}render(){return y`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
      ...
      </div>`}};D.defineAndRegister(Fc);var Ic=li(`text`);function Lc(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(Ic)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function Rc(e){let t=ki(e,Ic);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function zc(e){Lc(e)&&(e.text=``)}var Bc=Ci({hydriere:Rc,verdrahte:zc}),Vc=Bc.connect,Hc=Bc.disconnect,Uc=6,Wc=96,Gc=14,Kc={duenn:`300`,normal:`400`,fett:`700`},qc={links:`left`,mitte:`center`,rechts:`right`},Jc={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},Yc=`standard`;function Xc(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(Wc,Math.max(Uc,t)):Gc}function Zc(e){return typeof e==`string`&&e in Kc?e:`normal`}function Qc(e){return typeof e==`string`&&e in qc?e:`links`}function $c(e){return typeof e==`string`&&e in Jc?e:Yc}var $=class extends D{constructor(...e){super(...e),this.groesse=Gc,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=Yc,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:Gc,gewicht:`normal`,ausrichtung:`links`,farbe:Yc,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Uc,max:Wc,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[D.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return y`<div
      class="text"
      style=${W({fontSize:`${Xc(this.groesse)}px`,fontWeight:Kc[Zc(this.gewicht)],textAlign:qc[Qc(this.ausrichtung)],color:Jc[$c(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),Vc(this)}disconnectedCallback(){super.disconnectedCallback(),Hc(this)}};E([w({type:Number})],$.prototype,`groesse`,void 0),E([w()],$.prototype,`gewicht`,void 0),E([w()],$.prototype,`ausrichtung`,void 0),E([w()],$.prototype,`farbe`,void 0),E([w()],$.prototype,`text`,void 0),E([w()],$.prototype,`source`,void 0),E([w()],$.prototype,`textField`,void 0),D.defineAndRegister($);var el=[`waagerecht`,`senkrecht`],tl=`waagerecht`;function nl(e){return el.includes(e)?e:tl}var rl=class extends D{constructor(...e){super(...e),this.richtung=tl}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:tl}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[D.styles,o`
    ...
    `]}render(){return y`<div class="flaeche ${nl(this.richtung)}"><div class="linie"></div></div>`}};E([w()],rl.prototype,`richtung`,void 0),D.defineAndRegister(rl),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;I(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();