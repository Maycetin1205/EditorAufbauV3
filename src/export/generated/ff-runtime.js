...
\f\r]`,xe=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Se=/-->/g,Ce=/>/g,_=RegExp(`>|${be}(?:([^\\s"'>=/]+)(${be}*=${be}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),we=/'/g,Te=/"/g,Ee=/^(?:script|style|textarea|title)$/i,De=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),v=De(1),Oe=De(2),y=Symbol.for(`lit-noChange`),b=Symbol.for(`lit-nothing`),ke=new WeakMap,x=g.createTreeWalker(g,129);function Ae(e,t){if(!ve(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return fe===void 0?t:fe.createHTML(t)}var je=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=xe;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===xe?c[1]===`!--`?o=Se:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=_):(Ee.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=_):o=Ce:o===_?c[0]===`>`?(o=i??xe,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?_:c[3]===`"`?Te:we):o===Te||o===we?o=_:o===Se||o===Ce?o=xe:(o=_,i=void 0);let d=o===_&&e[t+1].startsWith(`/>`)?` `:``;a+=o===xe?n+he:l>=0?(r.push(s),n.slice(0,l)+pe+n.slice(l)+h+d):n+h+(l===-2?t:d)}return[Ae(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},Me=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=je(t,n);if(this.el=e.createElement(l,r),x.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=x.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(pe)){let t=u[o++],n=i.getAttribute(e).split(h),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?Ie:r[1]===`?`?Le:r[1]===`@`?Re:Fe}),i.removeAttribute(e)}else e.startsWith(h)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(Ee.test(i.tagName)){let e=i.textContent.split(h),t=e.length-1;if(t>0){i.textContent=de?de.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],ge()),x.nextNode(),c.push({type:2,index:++a});i.append(e[t],ge())}}}else if(i.nodeType===8){if(i.data===me)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(h,e+1))!==-1;)c.push({type:7,index:a}),e+=h.length-1}}a++}}static createElement(e,t){let n=g.createElement(`template`);return n.innerHTML=e,n}};function S(e,t,n=e,r){if(t===y)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=_e(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=S(e,i._$AS(e,t.values),i,r)),t}var Ne=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??g).importNode(t,!0);x.currentNode=r;let i=x.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new Pe(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new ze(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=x.nextNode(),a++)}return x.currentNode=g,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},Pe=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=S(this,e,t),_e(e)?e===b||e==null||e===``?(this._$AH!==b&&this._$AR(),this._$AH=b):e!==this._$AH&&e!==y&&this._(e):e._$litType$===void 0?e.nodeType===void 0?ye(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==b&&_e(this._$AH)?this._$AA.nextSibling.data=e:this.T(g.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=Me.createElement(Ae(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new Ne(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=ke.get(e.strings);return t===void 0&&ke.set(e.strings,t=new Me(e)),t}k(t){ve(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(ge()),this.O(ge()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=ue(e).nextSibling;ue(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Fe=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=b,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=b}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=S(this,e,t,0),a=!_e(e)||e!==this._$AH&&e!==y,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=S(this,r[n+o],t,o),s===y&&(s=this._$AH[o]),a||=!_e(s)||s!==this._$AH[o],s===b?e=b:e!==b&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Ie=class extends Fe{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===b?void 0:e}},Le=class extends Fe{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==b)}},Re=class extends Fe{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=S(this,e,t,0)??b)===y)return;let n=this._$AH,r=e===b&&n!==b||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==b&&(n===b||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},ze=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){S(this,e)}},Be=le.litHtmlPolyfillSupport;Be?.(Me,Pe),(le.litHtmlVersions??=[]).push(`3.3.3`);var Ve=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new Pe(t.insertBefore(ge(),e),e,void 0,n??{})}return i._$AI(e),i},He=globalThis,Ue=class extends ce{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ve(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return y}};Ue._$litElement$=!0,Ue.finalized=!0,He.litElementHydrateSupport?.({LitElement:Ue});var We=He.litElementPolyfillSupport;We?.({LitElement:Ue}),(He.litElementVersions??=[]).push(`4.2.2`);var Ge={attribute:!0,type:String,converter:ae,reflect:!1,hasChanged:oe},Ke=(e=Ge,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e,!0,n)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e,!0,n)}}throw Error(`Unsupported decorator location: `+r)};function C(e){return(t,n)=>typeof n==`object`?Ke(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}function w(e){return C({...e,state:!0,attribute:!1})}var qe=new Map;function Je(e){qe.has(e.type)&&console.warn(`Block-Typ "${e.type}" wird ueberschrieben.`),qe.set(e.type,e)}function Ye(){return Array.from(qe.values())}var Xe={width:`auto`};function Ze(e,t){if(!e)return!0;let n=t[e.attributeName];return e.keinesVon?!e.keinesVon.some(e=>Object.is(n,e)):`notEquals`in e?!Object.is(n,e.notEquals):Object.is(n,e.equals)}function Qe(e){return Object.entries(e).map(([e,t])=>`${e.replace(/[A-Z]/g,e=>`-`+e.toLowerCase())}:${t}`).join(`;`)}var $e={spalten:24,spaltePx:40,zeilePx:12,gapPx:8},et={rasterX:0,rasterY:0,rasterW:$e.spalten,rasterH:1};function tt(){return{display:`grid`,gridTemplateColumns:`repeat(${$e.spalten}, 1fr)`,gridAutoRows:`${$e.zeilePx}px`,gap:`${$e.gapPx}px`,alignContent:`start`}}function nt(){return Qe(tt())}var rt=`weitereQuellen`,it={[rt]:[]},at=`folgtAuswahl`,ot={[at]:[]};function st(e,t){let n=e.textContent??``,r=Array.from(e.childNodes),i=r.map(e=>e.textContent??``);e.setAttribute(`contenteditable`,`plaintext-only`),e.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(e),a?.removeAllRanges(),a?.addRange(o);let s=()=>{e.replaceChildren(...r),r.forEach((e,t)=>{e.textContent!==i[t]&&(e.textContent=i[t])})},c=e.closest(`button`)!==null,l=()=>{let t=e.getRootNode().getSelection?.()??window.getSelection(),n=t?.rangeCount?t.getRangeAt(0):null;if(!t||!n||!e.contains(n.startContainer))return;n.collapsed||n.deleteContents();let r=n.startContainer;if(r instanceof Text){let e=n.startOffset;r.insertData(e,` `),t.collapse(r,e+1)}else{let e=document.createTextNode(` `);n.insertNode(e),t.collapse(e,1)}},u=!1,d=r=>{u||(u=!0,e.removeAttribute(`contenteditable`),e.removeEventListener(`blur`,f),e.removeEventListener(`keydown`,p),r&&t((e.textContent??``).trim(),n)||s())},f=()=>d(!0),p=t=>{if(t.key===`Enter`)t.preventDefault(),e.blur();else if(t.key===`Escape`)t.preventDefault(),d(!1);else if(t.key===` `&&c){if(t.ctrlKey||t.metaKey||t.altKey||t.isComposing)return;t.preventDefault(),l()}};e.addEventListener(`blur`,f),e.addEventListener(`keydown`,p)}function T(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var E=class extends Ue{constructor(...e){super(...e),this.editable=!1}static{this.styles=o`
  ...
  `}aktualisiereEscape(){let e=this.isConnected&&this.escapeSchliesst;e!==this.escapeRegistriert&&(e?document.addEventListener(`keydown`,this.aufTaste,!0):document.removeEventListener(`keydown`,this.aufTaste,!0),this.escapeRegistriert=e)}ziehe(e,t){if(!this.ziehbar)return;e.preventDefault(),e.stopPropagation();let n=t===`breite`?on(this.breite,520):on(this.hoehe,380),r=t===`breite`?240:160,i=t===`breite`?e.clientX:e.clientY,a=Math.max(r,Math.round(n)),o=!1,s=(e,n)=>{this.dispatchEvent(new CustomEvent(an,{detail:{achse:t,wert:e,geste:n},bubbles:!0,composed:!0}))},c=e=>{let c=t===`breite`?e.clientX:e.clientY,l=Math.max(r,Math.round(n+(c-i)*2));l!==a&&(a=l,s(l,o?`laeuft`:`beginn`),o=!0)},l=()=>{window.removeEventListener(`pointermove`,c),window.removeEventListener(`pointerup`,l),window.removeEventListener(`pointercancel`,l),window.removeEventListener(`blur`,l),o&&s(a,`ende`)};window.addEventListener(`pointermove`,c),window.addEventListener(`pointerup`,l),window.addEventListener(`pointercancel`,l),window.addEventListener(`blur`,l)}aufStandard(e,t){this.ziehbar&&(e.stopPropagation(),this.dispatchEvent(new CustomEvent(an,{detail:{achse:t,wert:0,geste:`standard`},bubbles:!0,composed:!0})))}schliesse(){this.dispatchEvent(new CustomEvent(rn,{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.aktualisiereEscape()}updated(e){e.has(`escapeSchliesst`)&&this.aktualisiereEscape()}disconnectedCallback(){this.escapeRegistriert&&=(document.removeEventListener(`keydown`,this.aufTaste,!0),!1),super.disconnectedCallback()}render(){let e=on(this.breite,520),t=on(this.hoehe,380);return v`
    ...
    `]}onClose(){this.hasAttribute(`data-ff-editor`)||this.removeAttribute(`offen`)}updated(e){super.updated(e),e.has(`offen`)&&this.offen&&(this.hasAttribute(`data-ff-editor`)||this.updateComplete.then(()=>{this.offen&&this.isConnected&&(cn(this)??(this.shadowRoot?cn(this.shadowRoot):null))?.focus()}))}render(){return v`<ff-dialog-rahmen
        .breite=${this.breite}
        .hoehe=${this.hoehe}
        ohne-modal
        inhalt-fest
      ...
      </ff-dialog-rahmen>`}};T([C()],F.prototype,`name`,void 0),T([C()],F.prototype,`breite`,void 0),T([C()],F.prototype,`hoehe`,void 0),T([C({type:Boolean,reflect:!0})],F.prototype,`offen`,void 0),E.defineAndRegister(F);var ln=[`GET_RELATION`,`PUT_RELATION`,`PUTADD_RELATION`];function un(e){return`${String(e.getDate()).padStart(2,`0`)}.${String(e.getMonth()+1).padStart(2,`0`)}.${e.getFullYear()}`}function dn(e,t){return e.params.map(e=>e.replace(/\{([A-Za-z0-9_]+)\}/g,(e,n)=>String(t[n]??``)))}var fn=8e3,pn=null,mn=null;function hn(){let e=document.createElement(`div`);return e.setAttribute(`data-ff-meldung`,``),e.setAttribute(`role`,`alert`),e.style.cssText=[`position:fixed`,`top:0`,`left:0`,`right:0`,`z-index:2147483647`,`padding:7px 12px`,`background:var(--se-red-soft,#fbe7e6)`,`color:var(--se-red,#c0201a)`,`border-bottom:1px solid var(--se-red,#c0201a)`,`font:500 12px/1.4 system-ui,sans-serif`,`cursor:pointer`].join(`;`),e.title=`Klicken zum Schließen`,e.addEventListener(`click`,gn),e}function gn(){mn&&=(clearTimeout(mn),null),pn?.remove(),pn=null}function I(e){typeof document>`u`||!document.body||(pn||(pn=hn(),document.body.appendChild(pn)),pn.textContent=e,mn&&clearTimeout(mn),mn=setTimeout(gn,fn))}function L(){return globalThis}function _n(){let e=L();return O(e.SEDATA)&&O(e.SEDATA.Daten)}function vn(){let e=L();try{e.selib?.Json?.InitializeERPConnection?.()}catch{}try{typeof e.InitialisiereSchnittstelle==`function`&&e.InitialisiereSchnittstelle()}catch{}}function yn(){let e=L();try{typeof e.ResetDataBasis==`function`&&e.ResetDataBasis()}catch{}try{typeof e.InitialisiereDatenBasis==`function`&&e.InitialisiereDatenBasis()}catch{}}var bn=new Set,xn=new Set,Sn=800,Cn=!1,wn=!1,Tn=null;function En(){let e=document.activeElement;for(;e?.shadowRoot?.activeElement;)e=e.shadowRoot.activeElement;return e}function Dn(){let e=En();return e instanceof HTMLElement?e.isContentEditable||e instanceof HTMLInputElement||e instanceof HTMLTextAreaElement||e instanceof HTMLSelectElement:!1}function On(){Tn===null&&(Tn=setInterval(()=>{if(Dn()||(kn(),!Cn))return;Cn=!1;let e=wn;wn=!1,Mn(e)},Sn))}function kn(){Tn!==null&&(clearInterval(Tn),Tn=null)}function An(e){bn.add(e)}function jn(e){return xn.add(e),()=>{xn.delete(e)}}function Mn(e){let t=!0;bn.forEach(n=>{try{n(e)}catch{t=!1}}),t&&zn!==null&&(Rn=zn),zn=null}function R(e){if(e&&(wn=!0),Dn()){Cn=!0,On();return}Cn=!1;let t=wn;wn=!1,Mn(t)}function Nn(){R(!1)}function Pn(){yn(),R(!1)}function Fn(){let e=L(),t=O(e.SEDATA)?e.SEDATA.Daten:void 0;if(!O(t))return!1;let n=Bn(t);return n!==``&&n===Rn?!1:(zn=n,!0)}function In(e){xn.forEach(t=>{try{t(e)}catch{}})}var Ln=2e6,Rn=``,zn=null;function Bn(e){try{let t=JSON.stringify(e);return t.length>Ln?``:t}catch{return``}}function Vn(e){let t=Mt(e);if(!t){In(e);return}let n=L();O(n.SEDATA)||(n.SEDATA={}),n.SEDATA.Daten=t,yn();let r=Bn(t);(r===``||r!==Rn)&&(zn=r,R(!0))}function Hn(e=0){let t=L();if(typeof t.basisHTML_REGISTER==`function`){try{t.basisHTML_SetConsoleLog?.(!0,!0)}catch{}try{t.basisHTML_REGISTER(e=>{Vn(e)},document.title,`1.0`);return}catch(t){if(e>=400){I(`SoftEngine-Anmeldung fehlgeschlagen: `+(t instanceof Error?t.message:String(t)));return}}}e<400?setTimeout(()=>{Hn(e+1)},25):I(`SoftEngine-Anschluss nicht gefunden — die Maske bleibt ohne Daten.`)}var Un=`ff-se-fokus`;function Wn(){L().basisHTML_DoSetFocusToHTML=()=>{let e=new CustomEvent(Un,{cancelable:!0});return document.dispatchEvent(e),e.defaultPrevented}}var Gn=!1;function Kn(){if(Gn)return;Gn=!0,vn();let e=L();e.Erstellen=()=>{yn(),R(Fn())},e.initData=e.Erstellen,e.ReloadData=()=>{R(Fn())},Wn(),Hn(),window.addEventListener(`message`,e=>{if(typeof L().basisHTML_REGISTER==`function`)return;let t=Nt(e.data);t!==void 0&&Vn(t)},!0);let t=0,n=setInterval(()=>{t+=1,_n()?(clearInterval(n),yn(),R(Fn())):t>100&&(clearInterval(n),I(`Keine Daten von SoftEngine empfangen — die Maske zeigt nichts an.`))},300)}function qn(e){return e instanceof Error?e.message:String(e)}function Jn(e,t){if(Array.isArray(e)&&t!==``){for(let n of e)if(O(n)&&n.id===t&&typeof n.verb==`string`&&ln.includes(n.verb)&&typeof n.nr==`string`&&n.nr!==``&&Array.isArray(n.params)&&!n.params.some(e=>typeof e!=`string`))return{id:t,verb:n.verb,nr:n.nr,params:n.params}}}var Yn=[`RESULT`,`result`],Xn=[`RESULT`,`result`,`PINDEX`,`pindex`,`INDEX`,`index`,`0_10`,`KEY`,`key`,`ID`,`id`,`VALUE`,`value`];function Zn(e){if(typeof e!=`string`)return e;try{return JSON.parse(e)}catch{return}}function Qn(e){if(typeof e==`string`){let t=e.trim();return t===``?void 0:t}if(typeof e==`number`||typeof e==`boolean`)return String(e)}function $n(e,t){if(t>12)return;let n=Qn(e);if(n!==void 0)return n;if(Array.isArray(e)){for(let n of e){let e=$n(n,t+1);if(e!==void 0)return e}return}if(O(e)){for(let n of Xn){if(!(n in e))continue;let r=$n(e[n],t+1);if(r!==void 0)return r}for(let n of Object.values(e)){let e=$n(n,t+1);if(e!==void 0)return e}}}function er(e){let t=Zn(e);if(O(t)){for(let e of Xn){if(!(e in t))continue;let n=$n(t[e],0);if(n!==void 0)return n}for(let e of Yn)if(typeof t[e]==`string`)return``;for(let e of Object.values(t))if(Array.isArray(e))for(let t of e){let e=er(t);if(e!==void 0)return e}else if(O(e)){let t=er(e);if(t!==void 0)return t}}}function tr(e,t=0){if(t>12)return;let n=typeof e==`string`?Zn(e):e;if(Array.isArray(n)){for(let e of n){let n=tr(e,t+1);if(n!==void 0)return n}return}if(O(n)){for(let e of Yn){let t=n[e];if(typeof t==`string`)return t;if(typeof t==`number`||typeof t==`boolean`)return String(t)}for(let e of Object.values(n)){let n=tr(e,t+1);if(n!==void 0)return n}}}function nr(e,t,n=0){if(t.trim()===``||n>12)return``;let r=typeof e==`string`?Zn(e):e;if(Array.isArray(r)){for(let e of r){let r=nr(e,t,n+1);if(r!==``)return r}return``}if(!O(r))return``;let i=A(r,t);if(i!==``)return i;for(let e of Object.values(r)){let r=nr(e,t,n+1);if(r!==``)return r}return``}function rr(e){return O(e)?Object.keys(e).filter(e=>/^Message\d+$/.test(e)):[]}function ir(e,t,n=!1){if(!O(e))return;let r=rr(e).filter(e=>!t.has(e)).sort((e,t)=>Number(t.slice(7))-Number(e.slice(7)));for(let t of r){let r=n?tr(e[t]):er(e[t]);if(r!==void 0)return{wert:r,roh:e[t],schluessel:t}}}var ar=[],or=!1,sr=2e4,cr=100,lr=sr,ur=0,dr=!1,fr=!1;function pr(){return Date.now()<ur}function mr(){if(or||ar.length===0)return;or=!0;let e=ar.shift(),t=L(),n=new Set(rr(t.SEDATA)),r=!1,i=!1,a=(t,n,i)=>{r||(r=!0,s(),clearInterval(c),clearTimeout(u),or=!1,e.resolve(i===void 0?{wert:t,roh:n}:{wert:t,roh:n,fehler:i}),queueMicrotask(mr))},o=e.optionen.satzAntwort===!0,s=jn(e=>{let t=o?tr(e):er(e);if(t!==void 0){if(dr&&pr()){dr=!1,i=!0;return}a(t,e)}}),c=setInterval(()=>{let e=ir(L().SEDATA,n,o);if(e!==void 0){if(fr&&pr()){fr=!1,i=!0,n.add(e.schluessel);return}a(e.wert,e.roh)}},cr),l=t=>{e.optionen.still||I(t),a(``,void 0,t)},u=setTimeout(()=>{i||(dr=!0,fr=!0,ur=Date.now()+lr),l(`Daten laden: SoftEngine hat nicht geantwortet (Relation Nr. ${e.template.nr}).`)},sr);if(typeof t.basisHTML_SND_MSG!=`function`){l(`Daten laden nicht möglich: keine Verbindung zu SoftEngine.`);return}try{t.basisHTML_SND_MSG(`GET_RELATION`,{NR:e.template.nr,PARAMS:e.params})}catch(t){l(`Daten laden fehlgeschlagen (Relation Nr. ${e.template.nr}): ${qn(t)}`)}}function hr(e,t,n={}){Kn();let r=L();if(e.verb!==`GET_RELATION`){if(typeof r.basisHTML_SND_MSG!=`function`){let e=`Speichern nicht möglich: keine Verbindung zu SoftEngine. Die Eingabe wurde NICHT übernommen.`;return I(e),Promise.resolve({wert:``,roh:void 0,fehler:e})}try{r.basisHTML_SND_MSG(e.verb,{NR:e.nr,PARAMS:[...t]})}catch(t){let n=`Speichern fehlgeschlagen (Relation Nr. ${e.nr}): ${qn(t)}`;return I(n),Promise.resolve({wert:``,roh:void 0,fehler:n})}return Promise.resolve({wert:``,roh:void 0})}return new Promise(r=>{ar.push({template:e,params:[...t],resolve:r,optionen:n}),mr()})}function gr(e,t){if(!O(t))return``;let n=t.document;if(!n||typeof n.querySelectorAll!=`function`)return``;let r=Array.from(n.querySelectorAll(`[${D}]`)).find(t=>t.getAttribute(D)===e.blockId);if(!r)return``;let i=r[e.value];return i==null?``:String(i)}function _r(e,t,n=L()){if(e.source===`aus`)return``;if(e.source===`fixed`)return e.value;if(e.source===`context`)return t.context[e.value]??``;if(e.source===`previous_result`)return t.previousResult;if(e.source===`step_result`){let n=Number(e.value);if(!Number.isInteger(n)||n<0)return``;let r=e.ergebnisFeld??``;return r===``?t.stepResults?.[n]??``:nr(t.stepRohErgebnisse?.[n],r)}if(e.source===`block_value`)return gr(e,n);if(e.source===`erfassungszelle`||e.source===`aenderungszelle`||e.source===`loeschzelle`){let n=Number(e.value);return!Number.isInteger(n)||n<0?``:t.zeilenZelle?.(e.blockId??``,n)??``}if(e.source===`gewaehlte_zeile`){let n=t.gewaehlteZeile?.(e.blockId??``);return n===void 0?``:A(n,e.value)}if(!O(n))return``;if(e.source===`se_variable`){let t=n.SEDATA;if(!O(t)||!O(t.Daten)||!O(t.Daten.VARArrays))return``;let r=t.Daten.VARArrays[e.value];return r==null?``:String(r)}let r=k(n.FF_DATA_SOURCES,e.dataSourceId??``);if(!r)return``;let i=jt(n.SEDATA,r.name,r.tableId,r.offenerSatz),a=t.context.PINDEX??``,o=a!==``&&r.indexField!==``?i.find(e=>A(e,r.indexField)===a):i[0];return o?A(o,e.value):``}function vr(e,t){let n=`0,START_TOOL,`+e;return t.length>0&&(n+=`,`+t.map(e=>encodeURIComponent(e)).join(`,`)),n}function yr(e){let t=e.trim();if(t===``)return!1;let n=L();try{if(typeof n.sendBWLink==`function`)return n.sendBWLink(t),!0}catch{}try{if(typeof n.sendBWLinkIntern==`function`)return n.sendBWLinkIntern(t),!0}catch{}return!1}function br(e,t){if(e.trim()===``)return!1;let n=L();try{if(typeof n.sendBWLinkIntern==`function`)return n.sendBWLinkIntern(vr(e,t)),!0}catch{}try{if(typeof n.basisHTML_SND_MSG==`function`){let r={NR:e};return t.length>0&&(r.PARAMS=[...t]),n.basisHTML_SND_MSG(`START_TOOL`,r),!0}}catch{}return!1}function xr(e,t,n){if(t.trim()===``)return;let r=Array.from(e.querySelectorAll(F.tagName)),i=r.filter(e=>(e.getAttribute(`name`)??F.defaultProps.name)===t);if(i.length===0){I(`Fenster „`+t+`“ gibt es in dieser Maske nicht.`);return}if(i.length>1){I(`Fenster „`+t+`“ gibt es mehrfach — keines ist gemeint.`);return}let a=i[0];if(!n){a.removeAttribute(`offen`);return}for(let e of r)e!==a&&e.removeAttribute(`offen`);a.setAttribute(`offen`,``)}var Sr=new WeakMap;function z(e){I(`Aktionskette fehlgeschlagen: `+(e instanceof Error?e.message:String(e)))}var Cr={erfassungszelle:`erfasst`,aenderungszelle:`geaendert`,loeschzelle:`geloescht`};function wr(e){if(e.type!==`RELATION`)return null;let t=null;for(let n of[...e.params,...e.extraParams]){let e=Cr[n.source],r=n.blockId??``;if(e!==void 0&&r!==``){if(t&&(t.art!==e||t.blockId!==r))return{art:e,blockId:``};t={art:e,blockId:r}}}return t}function Tr(e){let t=[];for(let[n,r]of e.entries()){let e=wr(r),i=t[t.length-1];if(e===null){i?i.plaetze.add(n):t.push({art:`einmal`,blockId:``,plaetze:new Set([n])});continue}if(i&&i.art===e.art&&i.blockId===e.blockId){i.plaetze.add(n);continue}t.push({art:e.art,blockId:e.blockId,plaetze:new Set([n])})}return t}function Er(e,t){return Array.from(e.querySelectorAll(`[${D}]`)).find(e=>e.getAttribute(D)===t)}function Dr(e,t){if(t===`erfasst`){let t=e.erfassteZeilen;if(!Array.isArray(t))return;let n=e.erfassteSchluessel;return t.map((e,t)=>({satz:``,schluessel:Array.isArray(n)?n[t]??String(t):String(t),werte:e}))}let n=t===`geaendert`?e.geaenderteZeilen:e.geloeschteZeilen;if(Array.isArray(n))return n.map(e=>({satz:e.satz,schluessel:e.satz,werte:e.werte}))}function Or(e,t,n){return n.satz===``?e:t===`geloescht`?{...e,PINDEX:n.satz,DROP_PINDEX:n.satz}:{...e,PINDEX:n.satz}}async function kr(e,t,n,r,i,a){let o=!1,s={...a?.values,...n,NOW_DATE:un(new Date)},c=a?.previousResult??``,l=t.map((e,t)=>a?.stepResults[t]??``),u=t.map((e,t)=>a?.rohErgebnisse[t]),d=()=>({values:s,stepResults:l,rohErgebnisse:u,previousResult:c});for(let[n,a]of t.entries()){if(i&&!i.has(n))continue;if(a.type===`START_TOOL`){if(!br(a.toolNr,dn({params:a.toolParams},s))){let e=a.toolNr.trim()===``?`Schritt ${n+1} der Kette: START_TOOL ohne Werkzeug-Nummer.`:`Schritt ${n+1} der Kette: START_TOOL ${a.toolNr} ging nicht hinaus — keine Verbindung zu SoftEngine.`;return I(e),{geschrieben:o,fehler:e,mitschrift:d()}}continue}if(a.type===`BW_LINK`){let e=dn({params:[a.befehl]},s)[0]??``;if(!yr(e)){let t=e.trim()===``?`Schritt ${n+1} der Kette: BW_LINK ohne Befehl.`:`Schritt ${n+1} der Kette: BW_LINK ging nicht hinaus — keine Verbindung zu SoftEngine.`;return I(t),{geschrieben:o,fehler:t,mitschrift:d()}}continue}if(a.type===`POPUP_OPEN`||a.type===`POPUP_CLOSE`){xr(e.ownerDocument??document,a.popup??``,a.type===`POPUP_OPEN`);continue}let t=Jn(L().FF_RELATIONS,a.relationId);if(!t){let e=`Schritt ${n+1} der Kette: seine Relation fehlt in dieser Maske.`;return I(e),{geschrieben:o,fehler:e,mitschrift:d()}}if([...a.params,...a.extraParams].some(e=>e.source===`context`&&e.value===`PINDEX`)&&(s.PINDEX??``)===``){let e=`Schritt ${n+1} der Kette braucht die Satznummer der Zeile — sie fehlt (Relation Nr. ${t.nr}). Nichts geschrieben.`;return I(e),{geschrieben:o,fehler:e,mitschrift:d()}}let f={context:s,previousResult:c,stepResults:l,stepRohErgebnisse:u,gewaehlteZeile:Wt,...r?{zeilenZelle:r}:{}},p=await hr(t,[...a.params,...a.extraParams].map(e=>_r(e,f))),ee=p.wert;if(l[n]=ee,u[n]=p.roh,t.verb===`GET_RELATION`?c=ee:o=!0,p.fehler!==void 0&&p.fehler!==``)return{geschrieben:o,fehler:p.fehler,mitschrift:d()};a.resultKey!==``&&(s[a.resultKey]=ee)}return{geschrieben:o,fehler:``,mitschrift:d()}}async function B(e,t,n){if(e.hasAttribute(`data-ff-editor`))return;let r=ht(e.getAttribute(`data-ff-aktionen`))[t];if(!r||r.length===0)return;let i=Sr.get(e);if(i||(i=new Set,Sr.set(e,i)),!i.has(t)){i.add(t);try{let t=Tr(r),i=[],a=!1,o=!1,s;for(let c of t){if(c.art===`einmal`){let t=await kr(e,r,n,void 0,c.plaetze,s);if(s=t.mitschrift,t.geschrieben&&(a=!0),t.fehler!==``){o=!0;break}continue}if(c.blockId===``){I(`Ein Schritt liest Zellen aus zwei verschiedenen Listen — das geht nicht.`);break}let t=Er(e.ownerDocument??document,c.blockId),l=t&&Dr(t,c.art);if(!t||!l){I(`Den Baustein, dessen Zellen die Kette liest, gibt es in dieser Maske nicht.`);break}if(l.length===0)continue;let u={traeger:t,art:c.art,fertige:[]};i.push(u);for(let i of l){t.zeileSchreibt?.(c.art,i.schluessel);let l=await kr(e,r,Or(n,c.art,i),(e,t)=>e===c.blockId?String(i.werte[t]??``):``,c.plaetze,s);if(l.geschrieben&&(a=!0),l.fehler!==``){t.zeileGescheitert?.(c.art,i.schluessel,l.fehler),o=!0;break}u.fertige.push(i.schluessel)}if(o)break}for(let{traeger:e,art:t,fertige:n}of i)e.laufFertig?.(t,n);a&&Pn()}finally{i.delete(t)}}}var Ar=new WeakSet;function jr(e,t){if(e.hasAttribute(`data-ff-editor`)||!e.hasAttribute(`data-ff-aktionen`)||Ar.has(e))return;Ar.add(e);let n=ht(e.getAttribute(`data-ff-aktionen`));Object.values(n).some(e=>e.some(e=>e.type===`RELATION`))&&Kn(),e.addEventListener(`click`,()=>{B(e,t,{}).catch(z)})}var Mr=`ff-vormerkungen`;function Nr(e,t,n){let r=[];return e>0&&r.push(e===1?`1 neue Zeile`:`${e} neue Zeilen`),t>0&&r.push(t===1?`1 geänderte Zeile`:`${t} geänderte Zeilen`),n>0&&r.push(n===1?`1 Löschung`:`${n} Löschungen`),r.length===0?``:`${r.join(`, `)} vorgemerkt`}function Pr(e){return e.erfasst+e.geaendert+e.geloescht}function Fr(e,t){return t===`erfasst`?e.erfassteZeilen?.length??0:t===`geaendert`?e.geaenderteZeilen?.length??0:e.geloeschteZeilen?.length??0}function Ir(e,t){let n=ht(e.getAttribute(`data-ff-aktionen`))[t];if(!n||n.length===0)return;let r={erfasst:0,geaendert:0,geloescht:0},i=new Set;for(let t of Tr(n)){if(t.art===`einmal`||t.blockId===``)continue;let n=t.art+` `+t.blockId;if(i.has(n))continue;let a=Er(e.ownerDocument??document,t.blockId);a&&(i.add(n),r[t.art]+=Fr(a,t.art))}return i.size===0?void 0:r}var Lr=new WeakMap;function Rr(e){let t=[Fr(e,`erfasst`),Fr(e,`geaendert`),Fr(e,`geloescht`)].join(` `);Lr.get(e)!==t&&(Lr.set(e,t),e.dispatchEvent(new CustomEvent(Mr,{bubbles:!0,composed:!0})))}var zr=class extends E{constructor(...e){super(...e),this.label=`Klick mich`,this.vormerkungen=void 0,this.zaehleVormerkungen=()=>{this.vormerkungen=Ir(this,`onClick`)}}static{this.blockType=`button`}static{this.tagName=`ff-button`}static{this.displayName=`Schaltfläche`}static{this.category=`eingabe`}static{this.defaultProps={label:`Klick mich`}}static{this.resizableWidth=!1}static{this.blockEvents=[{key:`onClick`,name:`Klick`}]}static{this.raster={startW:4,startH:2,minW:2,minH:2}}static{this.customProperties=[]}static{this.styles=[E.styles,o`
      button {
        box-sizing: border-box;
        padding: 7px 16px;
        cursor: pointer;
    ...
    `]}render(){let e=this.vormerkungen,t=e===void 0?0:Pr(e);return v`<button
      data-ff-editable
      ?disabled=${e!==void 0&&t===0}
      title=${e===void 0||t===0?b:Nr(e.erfasst,e.geaendert,e.geloescht)}
      @dblclick=${e=>this.inlineEdit(e,`label`)}
    >${e===void 0?this.label:`${this.label} (${t})`}</button>`}connectedCallback(){super.connectedCallback(),jr(this,`onClick`),!this.hasAttribute(`data-ff-editor`)&&(document.addEventListener(Mr,this.zaehleVormerkungen),this.zaehleVormerkungen())}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(Mr,this.zaehleVormerkungen)}};T([C()],zr.prototype,`label`,void 0),T([C({attribute:!1})],zr.prototype,`vormerkungen`,void 0),E.defineAndRegister(zr);var Br=[`info`,`success`,`warning`,`danger`];function Vr(e){return Br.includes(e)?e:`info`}var Hr=[{wert:`info`,name:`Hinweis`},{wert:`success`,name:`Erfolg`},{wert:`warning`,name:`Warnung`},{wert:`danger`,name:`Fehler`}];function Ur(e,t){return{attributeName:e,name:`Bedeutung`,description:t,kind:`select`,options:Hr.map(e=>({value:e.wert,label:e.name}))}}var Wr=o`
...
`,V=class extends E{constructor(...e){super(...e),this.chipVariant=`info`,this.heading=``,this.heading2=``,this.time=``,this.date=``,this.avatar=``,this.meta=``,this.text=``,this.chipText=``,this.headingField=``,this.heading2Field=``,this.timeField=``,this.dateField=``,this.avatarField=``,this.metaField=``,this.textField=``,this.chipTextField=``}static{this.blockType=`card`}static{this.tagName=`ff-card`}static{this.displayName=`Karte`}static{this.category=`anzeige`}static{this.allowedParentTypes=[`kanban-spalte`,`kanban-zimmer`]}static{this.showInPalette=!1}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={chipVariant:`info`,heading:``,heading2:``,time:``,date:``,avatar:``,meta:``,text:``,chipText:``,headingField:``,heading2Field:``,timeField:``,dateField:``,avatarField:``,metaField:``,textField:``,chipTextField:``}}static{this.bindableSpots=[{prop:`time`,label:`Zeit`},{prop:`date`,label:`Datum`},{prop:`avatar`,label:`Avatar`},{prop:`heading`,label:`Titel`},{prop:`heading2`,label:`Titel 2`},{prop:`meta`,label:`Unterzeile`},{prop:`text`,label:`Textzeile`},{prop:`chipText`,label:`Chip`}]}static{this.customProperties=[Ur(`chipVariant`,`Bedeutung des Chips auf der Karte — bestimmt die Chip-Farbe.`)]}static{this.styles=[E.styles,Wr,Qr]}stelle(e,t){return v`<span
    ...
    >${this[e]}</span>`}hatReiter(){return this.hasAttribute(`data-ff-editor`)||this.date.trim()!==``||this.time.trim()!==``}updated(e){super.updated(e),this.toggleAttribute(`hat-reiter`,this.hatReiter())}render(){let e=Vr(this.chipVariant),t=this.hasAttribute(`data-ff-editor`),n=e=>t||e.trim()!==``,r=this.hatReiter(),i=n(this.avatar)||n(this.heading)||n(this.meta),a=n(this.heading2)||n(this.chipText);return v`<div class="card v-${e}${r?``:` ohne-reiter`}">
      ...
      ${i?v`<div class="kopf">
            ${n(this.avatar)?v`<span
                ...
                >${this.avatar.trim()===``?b:Zr(this.avatar)}</span>`:b}
            <div class="namen">
    ...
    `]}setzeTag(e){ai(e),this.tag=ii()}render(){return v`<div class="waehler">
      <div class="riegel">
        <button class="pfeil" title="Vortag" @click=${()=>this.setzeTag(ti(this.tag,-1))}>‹</button>
        <input
          class="feld"
          type="date"
          .value=${this.tag}
        ...
        />
        <button class="pfeil" title="Folgetag" @click=${()=>this.setzeTag(ti(this.tag,1))}>›</button>
      </div>
      <button class="heute" @click=${()=>this.setzeTag(ei(new Date))}>Heute</button>
    </div>`}connectedCallback(){super.connectedCallback(),this.tag=ii()||ei(new Date),!this.hasAttribute(`data-ff-editor`)&&(this.setzeTag(this.tag),this.tagAbmelden?.(),this.tagAbmelden=oi(()=>{this.tag=ii()}))}disconnectedCallback(){super.disconnectedCallback(),this.tagAbmelden?.(),this.tagAbmelden=null}};T([w()],si.prototype,`tag`,void 0),E.defineAndRegister(si);function ci(e){return e.trim().toLowerCase().split(/\s+/).filter(e=>e!==``)}function li(e,t){let n=ci(t);if(n.length===0)return!0;let r=e.join(` `).toLowerCase();return n.every(e=>r.includes(e))}function ui(e,t,n=8){if(t.trim()===``)return[];let r=[];for(let i of e)if(li([i.anzeige,i.wert],t)&&(r.push(i),r.length>=n))break;return r}function di(e,t,n){return t<=0?0:((e+n)%t+t)%t}function fi(e,t){return t<=0||e<0||e>=t?0:e}function pi(e,t){return e===`ArrowDown`?t.listeOffen?`marke-runter`:`nichts`:e===`ArrowUp`?t.listeOffen?`marke-hoch`:`nichts`:e===`Escape`?t.listeOffen?`liste-zu`:`nichts`:e===`Enter`?t.listeOffen?t.markeVonHand||t.treffer===1?`uebernehmen`:`fenster`:t.feldLeer?`fenster`:`nichts`:`nichts`}function mi(e){return v`<ul
    class="vorschlaege"
  ...
  >${e.eintraege.map((t,n)=>v`<li
    ...
    ><span class="vorschlag-anzeige">${t.anzeige===``?t.wert:t.anzeige}</span>${t.wert!==``&&t.wert!==t.anzeige?v`<span class="vorschlag-wert">${t.wert}</span>`:b}</li>`)}</ul>`}var hi=o`
  .vorschlaege {
    position: absolute;
    top: 100%;
    left: 0;
...
`;function H(e,t,n,r){return{attributeName:e,name:t,description:n,kind:`jaNein`,options:[{value:`nein`,label:`Nein`},{value:`ja`,label:`Ja`}],...r}}var gi={attributeName:`fieldType`,equals:`nachschlagen`},_i=[{attributeName:`fieldType`,name:`Feldtyp`,description:`Welche Art Eingabe das Feld annimmt.`,kind:`select`,options:[{value:`text`,label:`Text`},{value:`number`,label:`Zahl`},{value:`textarea`,label:`Mehrzeilig`},{value:`select`,label:`Auswahl`},{value:`date`,label:`Datum`},{value:`time`,label:`Uhrzeit`},{value:`checkbox`,label:`Ankreuzfeld`},{value:`nachschlagen`,label:`Nachschlagen`}]},{attributeName:`options`,name:`Auswahl-Optionen`,description:`Einträge durch Komma getrennt, z. B. "Zimmer 1, Zimmer 2".`,kind:`text`,visibleWhen:{attributeName:`fieldType`,equals:`select`}},{attributeName:`nachschlagQuelle`,name:`Quelle`,description:`Quelle, aus der der Bediener eine Zeile wählt.`,kind:`quelle`,visibleWhen:gi},{attributeName:`speicherFeld`,name:`Gespeichert wird`,description:`Feld, dessen Wert die Maske sich merkt (z. B. die Nummer).`,kind:`field`,quelleProp:`nachschlagQuelle`,klarnameProp:`speicherTitel`,visibleWhen:gi},H(`einzigerTreffer`,`Einzigen Treffer übernehmen`,`Bleibt genau ein Satz übrig, übernimmt das Feld ihn von selbst.`,{visibleWhen:gi}),{attributeName:`valueField`,name:`Feld`,description:`Feld, dessen Wert angezeigt wird.`,kind:`field`,visibleWhen:{attributeName:`fieldType`,keinesVon:[`checkbox`,`nachschlagen`]}}];function vi(e){let t=e.split(`::`);if(t.length!==2)return{quelleId:``,code:e};let[n,r]=t;return n===``||r===``?{quelleId:``,code:e}:{quelleId:n,code:r}}function yi(e,t){let n=t[e.key];return typeof n==`boolean`?n:e.standard===!0}function bi(e,t){let n=t[e.feldKey],r=typeof n==`string`&&vi(n).quelleId!==``;return(e.eintragsSchalter??[]).filter(e=>!(e.nurEigeneQuelle===!0&&r))}function xi(e){let t=new Set;for(let n of e){let e=n.trim();e!==``&&t.add(e)}let n=1;for(let e of t){let t=/^s(\d+)$/.exec(e);t&&(n=Math.max(n,Number(t[1])+1))}let r=new Set;return e.map(e=>{let i=e.trim();if(i!==``&&!r.has(i))return r.add(i),i;for(;t.has(`s${n}`);)n+=1;let a=`s${n}`;return t.add(a),r.add(a),a})}function Si(e){return`${e.toLowerCase()}field`}var Ci=`source`,wi=999,Ti=`0`,Ei=`255`,Di=new Map;function Oi(e){let t=wt(e);Ct(e,[]),t!==void 0&&t.length>0&&Nn()}async function ki(e,t,n,r,i){return hr({id:`relation-lader`,verb:`GET_RELATION`,nr:e.nr,params:[]},[t.belegart,r,i,t.belegnummer,t.jahr,t.archiv,``,String(n),``,``,``,``],{still:!0,satzAntwort:!0})}function Ai(e,t,n){I(`Positionen laden bei Zeile ${t} abgebrochen (Relation Nr. ${e}): ${n} Es werden keine Positionen angezeigt — die Liste wäre unvollständig.`)}function ji(e,t,n){let r=(Di.get(e.id)??0)+1;if(Di.set(e.id,r),n===void 0){Oi(e.name);return}let i={belegart:A(n,t.belegartFeld),belegnummer:A(n,t.belegnummerFeld),jahr:t.jahrFeld===``?``:A(n,t.jahrFeld),archiv:t.archivFeld===``?``:A(n,t.archivFeld)};if(i.belegart===``||i.belegnummer===``){Oi(e.name);return}Oi(e.name),(async()=>{let n=[],a=!1;for(let o=1;o<=wi;o+=1){let s=await ki(t,i,o,Ti,Ei);if(Di.get(e.id)!==r)return;if(s.fehler!==void 0){Ai(t.nr,o,s.fehler);return}let c=s.wert;if(t.endeFelder.every(e=>A({SATZ:c},e)===``)){a=!0;break}let l={SATZ:c};for(let n of t.zusatzFelder){let a=n.indexOf(`_`),s=await ki(t,i,o,n.slice(0,a),n.slice(a+1));if(Di.get(e.id)!==r)return;if(s.fehler!==void 0){Ai(t.nr,o,s.fehler);return}l[n]=s.wert}n.push(l)}a||I(`Positionen laden: nach ${wi} Zeilen ohne Ende-Kennung abgebrochen (Relation Nr. ${t.nr}) — die Liste ist wahrscheinlich unvollständig, vermutlich passen Relationsnummer oder Ende-Felder nicht.`),Di.get(e.id)===r&&(Ct(e.name,n),Nn())})()}var Mi=new Map;function Ni(e,t,n){let r={};return n.forEach((n,i)=>{let a=nr(t,n);r[n]=a===``?i===0?e:``:a}),r}function Pi(e,t){let n=(Mi.get(e.id)??0)+1;Mi.set(e.id,n);let r=Jn(L().FF_RELATIONS,t.relationId);if(!r){I(`Quelle „${e.name}“: ihre Relation fehlt in dieser Maske.`);return}if(r.verb!==`GET_RELATION`){I(`Quelle „${e.name}“ kann nur lesen — ${r.verb} liefert keinen Wert zurück.`);return}let i=t.params.map(e=>_r(e,{context:{},previousResult:``}));(async()=>{let a=await hr(r,i);Mi.get(e.id)===n&&(a.fehler===void 0||a.fehler===``)&&(Ct(e.name,[Ni(a.wert,a.roh,t.felder)]),Nn())})()}var Fi=new Map,Ii=new Map,Li=!1;function Ri(){let e=new Map;for(let t of Ye())t.satzWahl&&e.set(t.tagName.toLowerCase(),t);return e}function zi(e,t){let n=t.satzWahl;if(!n)return``;let r=!0;if(n.wenn){let i=n.wenn.attributeName,a=e.getAttribute(i.toLowerCase())??t.defaultProps[i];r=Ze(n.wenn,{[i]:a})}return(r?n.quelleProp??`source`:Ci).toLowerCase()}function Bi(e,t,n=typeof document>`u`?void 0:document){if(e===``||n===void 0)return;let r=null;for(let i of Array.from(n.querySelectorAll(`[${D}]`))){let n=t.get(i.tagName.toLowerCase());if(!n)continue;let a=zi(i,n);if(a===``||i.getAttribute(a)!==e)continue;let o=N(i),s=Wt(o);if(s===void 0)continue;let c=Kt(o);(r===null||c>r.nummer)&&(r={zeile:s,nummer:c})}return r?.zeile}function Vi(e,t,n){if(Fi.get(e)===t)return!1;if(n)Ii.set(e,new Set([t]));else{let n=Ii.get(e)??new Set;if(n.has(t))return!1;n.add(t),Ii.set(e,n)}return Fi.set(e,t),!0}function Hi(){Fi.clear(),Ii.clear()}function Ui(e){let t=L().FF_DATA_SOURCES;if(!Array.isArray(t))return;let n=Ri();for(let r of t){if(!O(r)||typeof r.id!=`string`)continue;let i=k(t,r.id);if(!i?.ladeRelation)continue;let a=Bi(i.ladeRelation.geberQuelleId,n);Vi(i.id,Ft(a),e)&&ji(i,i.ladeRelation,a)}}function Wi(){let e=L().FF_DATA_SOURCES;if(Array.isArray(e))for(let t of e){if(!O(t)||typeof t.id!=`string`)continue;let n=k(e,t.id);n?.holWert&&Pi(n,n.holWert)}}function Gi(){Li||(Li=!0,Ut(Ui),An(e=>{e&&Wi()}),_n()&&Wi(),Zt(Hi))}function Ki(e){let t=new Set,n=!1,r=n=>{_n()&&t.forEach(t=>{e.hydriere(t,n)})};return{connect:i=>{i.hasAttribute(`data-ff-editor`)||(t.add(i),e.verdrahte?.(i),n||(n=!0,An(r),oi(()=>{r(!1)}),Ut(()=>{r(!1)}),Gi()),Kn(),_n()&&e.hydriere(i,!1))},disconnect:e=>{t.delete(e)}}}var qi=rt.toLowerCase(),Ji=``;function Yi(e){if(e.length===0)return``;let t=[];for(let n of e){let e=n.trim();if(e===``)return``;t.push(e)}return t.join(Ji)}function Xi(e){return Pt(e,qi,`quelleId`,{ohnePaareBehalten:!0}).map(e=>({quelleId:e.id,partnerId:e.partnerId,keyPairs:e.keyPairs}))}function Zi(e){let t=Xi(e);if(t.length===0)return(e,t)=>A(e,vi(t).code);let n=L().SEDATA,r=L().FF_DATA_SOURCES,i=new Map;for(let e of t){if(e.keyPairs.length===0)continue;let t=k(r,e.quelleId);if(!t)continue;let a=jt(n,t.name,t.tableId,t.offenerSatz),o=new Map;for(let t of a){let n=Yi(e.keyPairs.map(e=>A(t,e.toField)));n!==``&&!o.has(n)&&o.set(n,t)}i.set(e.quelleId,{nachSchluessel:o,partnerId:e.partnerId,hierFelder:e.keyPairs.map(e=>e.fromField)})}let a=(e,t,n)=>{if(e===``)return t;let r=i.get(e);if(!r||n.has(e))return;n.add(e);let o=a(r.partnerId,t,n);if(n.delete(e),o===void 0)return;let s=Yi(r.hierFelder.map(e=>A(o,e)));return s===``?void 0:r.nachSchluessel.get(s)};return(e,t)=>{let{quelleId:n,code:r}=vi(t);if(n===``)return A(e,r);let i=a(n,e,new Set);return i===void 0?``:A(i,r)}}function Qi(e,t){let n=e.getAttribute(`source`)??``,r=e.getAttribute(t)??``;if(n===``||r===``)return{art:`ungebunden`};let i=k(L().FF_DATA_SOURCES,n);if(!i)return{art:`ohneQuelle`};let a=tn(e,jt(L().SEDATA,i.name,i.tableId,i.offenerSatz));if(a===void 0)return{art:`ohneZeile`};let{quelleId:o,code:s}=vi(r);return{art:`wert`,wert:o===``?A(a,s):Zi(e)(a,r),zeile:a,quelle:i,quelleId:o,reinerCode:s}}var $i=new WeakMap,ea=new WeakSet;function ta(e){let t=/^(\d{2})\.(\d{2})\.(\d{4})$/.exec(e);return t?`${t[3]}-${t[2]}-${t[1]}`:e}function na(e){let t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);return t?`${t[3]}.${t[2]}.${t[1]}`:e}function ra(e){return typeof e.value==`string`?e.value:``}function ia(e){if(e.pruefeEigenenWert?.(),e.getAttribute(`fieldtype`)===`nachschlagen`){$i.delete(e);return}let t=Qi(e,Si(`value`));if(t.art!==`wert`){$i.delete(e),Xt(N(e)),t.art===`ohneZeile`&&(e.value=``);return}let{zeile:n,quelle:r,quelleId:i,reinerCode:a,wert:o}=t,s=Et(r,n);i===``?$i.set(e,{row:n,code:a,pindex:s}):$i.delete(e),e.value=o,Yt(N(e),n)}function aa(e){let t=$i.get(e);return t&&Dt(t.row,t.code,ra(e)),t}function oa(e){ea.has(e)||(ea.add(e),e.addEventListener(`input`,()=>{aa(e)}),e.addEventListener(`change`,()=>{let t=aa(e);B(e,`onChange`,{VALUE:ra(e),PINDEX:t?.pindex??``}).catch(z)}))}var sa=Ki({hydriere:ia,verdrahte:oa}),ca=sa.connect,la=sa.disconnect,ua=o`
  .feld {
    font-family: var(--se-font);
...
`,da=[`text`,`number`,`textarea`,`select`,`date`,`time`,`checkbox`,`nachschlagen`];function fa(e){return da.includes(e)?e:`text`}var pa=[`text`,`number`,`textarea`,`select`,`nachschlagen`,`date`,`time`],ma={select:`ph-select`,date:`ph-nativ`,time:`ph-nativ`,nachschlagen:`ph-nachschlag`};function ha(){return v`<svg viewBox="0 0 16 16" width="14" height="14" aria-hidden="true">
    ...
    </svg>`}function ga(e,t,n=new Set){let r=e=>e.versteckt===!0||n.has(e.kennung);if(t||!e.some(r))return{spalten:e,plaetze:e.map((e,t)=>t)};let i=[],a=[];return e.forEach((e,t)=>{r(e)||(i.push(e),a.push(t))}),i.length===0&&e.length>0?{spalten:[e[0]],plaetze:[0]}:{spalten:i,plaetze:a}}var _a=`Spalte {n}`;function va(e){return _a.replace(`{n}`,String(e+1))}function U(e){return{kennung:``,titel:va(e),feld:``}}function ya(e){let t=xi(e.map(e=>e.kennung));return e.map((e,n)=>e.kennung===t[n]?e:{...e,kennung:t[n]})}function ba(e,t){let n=t.trim();return n===``?-1:e.findIndex(e=>e.kennung===n)}function xa(){return ya([U(0)])}function Sa(e){let t=typeof e==`number`?e:Number(e);if(!Number.isFinite(t))return;let n=Math.round(t);return n<40?40:n}function Ca(e,t){if(e&&typeof e==`object`){let n=e,r=n.breite===void 0?void 0:Sa(n.breite);return{kennung:typeof n.kennung==`string`?n.kennung.trim():``,titel:typeof n.titel==`string`?n.titel:va(t),feld:typeof n.feld==`string`?n.feld:``,...r===void 0?{}:{breite:r},...typeof n.summe==`boolean`?{summe:n.summe}:{},...typeof n.aenderbar==`boolean`?{aenderbar:n.aenderbar}:{},...typeof n.versteckt==`boolean`?{versteckt:n.versteckt}:{},...typeof n.fuellFeld==`string`&&n.fuellFeld.trim()!==``?{fuellFeld:n.fuellFeld.trim()}:{}}}return typeof e==`string`?{...U(t),titel:e}:U(t)}function W(e){let t;if(Array.isArray(e))t=e.map((e,t)=>Ca(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>U(e))}else t=xa();return t.length>16&&(t=t.slice(0,16)),t.length<1&&(t=[U(0)]),ya(t)}function wa(e){try{return W(JSON.parse(e))}catch{return xa()}}function Ta(e,t=()=>void 0){let n=e.map((e,n)=>t(n)??e.breite),r=n.filter(e=>e!==void 0),i=r.length===0?1:Math.max(1,Math.round(r.reduce((e,t)=>e+t,0)/r.length));return n.map(e=>`minmax(0, ${e??i}fr)`).join(` `)}var Ea={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Da=e=>(...t)=>({_$litDirective$:e,values:t}),Oa=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},ka=`important`,Aa=` !`+ka,G=Da(class extends Oa{constructor(e){if(super(e),e.type!==Ea.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(Aa);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?ka:``):n[e]=r}}return y}}),ja=[`menge`,`anzahl`,`dosis`,`tage`],Ma={stellen:3,richtung:`kfm`};function Na(){return{menge:{spalte:``,runden:{...Ma}},anzahl:{spalte:``,runden:{stellen:0,richtung:`auf`}},dosis:{spalte:``,runden:{...Ma}},tage:{spalte:``,runden:{...Ma}}}}var Pa=/^-?\d+(,\d+)?$|^-?[1-9]\d{0,2}(\.\d{3})+(,\d+)?$/;function Fa(e){let t=e.trim();if(t===``||!Pa.test(t))return null;let n=Number(t.replace(/\./g,``).replace(`,`,`.`));return Number.isFinite(n)?n:null}function Ia(e,t){let n=10**Math.max(0,t.stellen),r=e*n;return(t.richtung===`auf`?Math.ceil(r-1e-9):t.richtung===`ab`?Math.floor(r+1e-9):Math.round(r))/n}function La(e,t){return e.toLocaleString(`de-DE`,{useGrouping:!1,minimumFractionDigits:0,maximumFractionDigits:Math.max(0,t)})}function Ra(e,t,n){if(!n.has(`menge`))return null;let r=[`menge`];for(let e of[`anzahl`,`dosis`,`tage`])n.has(e)&&r.push(e);let i=[];for(let e of r){let n=t[e];if(n===`fehler`)return null;n===null&&i.push(e)}if(i.length!==1)return null;let a=i[0],o=e=>{let n=t[e];return typeof n==`number`?n:1},s=o(`anzahl`)*o(`dosis`)*o(`tage`),c;if(a===`menge`)c=s;else{if(s===0)return null;c=o(`menge`)/s}return Number.isFinite(c)?{platz:a,wert:Ia(c,e[a].runden)}:null}function za(e,t){if(!e||typeof e!=`object`)return{...t};let n=e;return{stellen:typeof n.stellen==`number`&&Number.isInteger(n.stellen)&&n.stellen>=0&&n.stellen<=6?n.stellen:t.stellen,richtung:n.richtung===`auf`||n.richtung===`ab`||n.richtung===`kfm`?n.richtung:t.richtung}}function Ba(e,t){if(!e||typeof e!=`object`)return{spalte:``,runden:{...t}};let n=e;return{spalte:typeof n.spalte==`string`?n.spalte:``,runden:za(n.runden,t)}}function Va(e){let t=e;if(typeof e==`string`){let n=e.trim();if(n===``)return null;try{t=JSON.parse(n)}catch{return null}}if(!t||typeof t!=`object`||Array.isArray(t))return null;let n=t,r=Na();return{menge:Ba(n.menge,r.menge.runden),anzahl:Ba(n.anzahl,r.anzahl.runden),dosis:Ba(n.dosis,r.dosis.runden),tage:Ba(n.tage,r.tage.runden)}}function Ha(e,t){let n=new Set(t);if(!ja.some(t=>n.has(e[t].spalte)))return e;let r={...e};for(let e of ja)n.has(r[e].spalte)&&(r[e]={...r[e],spalte:``});return r}function Ua(e){return JSON.stringify(e)}var Wa=`Keine Datensätze.`;function Ga(){return{attributeName:`leerText`,name:`Text ohne Datensätze`,description:`Text, wenn die Quelle keine Zeilen liefert. Leer: gar nichts.`,kind:`text`,requiresDataSource:!0}}function Ka(e,t=!1){return e.trim()===``?b:v`<div class="leer${t?` leer--tafel`:``}">
    ${Kr()}
    <span>${e}</span>
  </div>`}var qa=o`
  .leer {
...
`;function Ja(e,t){let n=(e?.fuellFeld??``).trim(),r=n===``?(e?.feld??``).trim():n;if(r===``)return{art:`frei`,quelleId:``,code:``};let{quelleId:i,code:a}=vi(r);return i===``?{art:`eigen`,quelleId:t,code:a}:{art:`verknuepft`,quelleId:i,code:a}}function K(e,t){return Ja(e.spalten[t],e.quelleId)}function Ya(e){let t=[];for(let n of e.spalten){let r=Ja(n,e.quelleId);r.art===`verknuepft`&&r.quelleId!==``&&(t.includes(r.quelleId)||t.push(r.quelleId))}return t}function Xa(e,t){let n=K(e,t);if(n.quelleId!==``&&n.code!==``)for(let r=0;r<e.spalten.length;r++){if(r===t)continue;let i=e.spalten[r],a=Ja(i,e.quelleId);if(a.quelleId===n.quelleId&&a.code!==``&&a.code!==n.code)return{titel:i.titel,code:a.code}}}function Za(e,t){let n=K(e,t);if(n.art!==`verknuepft`||n.quelleId===``||n.code===``)return[];let r=[];for(let t of e.spalten){let i=Ja(t,e.quelleId);i.quelleId===n.quelleId&&i.code!==``&&(r.some(e=>e.feld===i.code)||r.push({kennung:``,titel:t.titel,feld:i.code}))}return r}function Qa(e,t,n){let r=e.map(e=>({toField:e.toField,soll:t(e.fromField)})).filter(e=>e.soll!==void 0);return r.length===0?[...n]:n.filter(e=>r.every(t=>t.soll!==``&&t.soll===A(e,t.toField)))}function $a(e,t,n,r){return v`<input
    class="erf-eingabe"
    type="text"
    data-spalte=${r}
...
`;function xo(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen])}}function So(e,t,n){return t===``||n===``?[...e]:e.filter(e=>$r(A(e,t))===n)}function Co(e){let t=e.getAttribute(`source`)??``;if(t===``)return null;let n=k(L().FF_DATA_SOURCES,t);return n?{quelle:n,zeilen:So(jt(L().SEDATA,n.name,n.tableId,n.offenerSatz),e.getAttribute(`tagfield`)??``,ii()),lies:Zi(e)}:null}function wo(e){return wa(e.getAttribute(`spalten`)??``)}function To(e,t){let n=k(L().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?Et(n,t):``}function Eo(e){let t=k(L().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return t!==void 0&&t.indexField!==``}function Do(e,t){t&&e.vergissGeschriebene();let n=Co(e);if(!n){e.datenzeilen=[];return}let r=wo(e),{rows:i,gefiltert:a}=en(e,n.zeilen),o=qt(N(e),i,e=>e)[0]??-1,s=n.lies;e.datenGeliefert=!0,e.rohzeilen=i,e.auswahlIndex=o,e.durchAuswahlGefiltert=a,e.datenzeilen=i.map(e=>r.map(t=>t.feld===``?``:s(e,t.feld)))}var Oo=Ki({hydriere:Do}),ko=Oo.connect,Ao=Oo.disconnect;function jo(e,t){let n=[];return e.forEach((e,r)=>{li(e,t)&&n.push(r)}),n}function Mo(e,t){return!e&&t.trim()!==``}function No(e,t,n){return e&&t&&n===0}function Po(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function Fo(e){return ya([...e,U(e.length)])}function Io(e,t,n){let r=Va(e);if(!r)return null;let i=new Set(n.map(e=>e.kennung)),a=Ha(r,t.map(e=>e.kennung).filter(e=>e!==``&&!i.has(e)));return a===r?null:Ua(a)}function Lo(e,t){return e.length<=1||t<0||t>=e.length?e:e.filter((e,n)=>n!==t)}function Ro(e,t,n){if(t<0||t>=e.length)return e;let r=Math.max(0,Math.min(n,e.length-1));if(r===t)return e;let i=[...e],[a]=i.splice(t,1);return i.splice(r,0,a),i}var zo=`\0`;function Bo(e,t){return e+zo+String(t)}var Vo=class{constructor(){this.werte=new Map}setze(e,t,n){if(e===``)return!1;let r=Bo(e,t);return this.werte.get(r)!==n&&(this.werte.set(r,n),!0)}nimmZurueck(e,t){return this.werte.delete(Bo(e,t))}wert(e,t){return e===``?void 0:this.werte.get(Bo(e,t))}get anzahl(){return this.werte.size}proSatz(){let e=[];for(let[t,n]of this.werte){let[r,i]=t.split(zo),a=Number(i),o=e.find(e=>e.satz===r),s={satz:r,spalte:a,wert:n};o?o.aenderungen.push(s):e.push({satz:r,aenderungen:[s]})}return e}nimmSatzZurueck(e){let t=!1;for(let n of[...this.werte.keys()])n.slice(0,n.indexOf(zo))===e&&this.werte.delete(n)&&(t=!0);return t}},Ho=class{constructor(e){this.aenderungen=new Vo,this.geloescht=new Set,this.wirt=e}get geaenderteZeilen(){if(this.aenderungen.anzahl===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let{satz:r}of this.aenderungen.proSatz()){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}get geloeschteZeilen(){if(this.geloescht.size===0)return[];let e=this.wirt.spalten().length,t=this.satzPlaetze(),n=[];for(let r of this.geloescht){let i=t.get(r);i!==void 0&&n.push({satz:r,werte:Array.from({length:e},(e,t)=>this.zellWert(i,t))})}return n}austragen(e,t){let n=!1;for(let r of t)n=e===`geaendert`?this.aenderungen.nimmSatzZurueck(r)||n:this.geloescht.delete(r)||n;n&&this.wirt.melde()}vorgemerkteAenderungen(){return this.geaenderteZeilen.length}vorgemerkteLoeschungen(){return this.geloeschteZeilen.length}statusVon(e){let t=this.satzVon(e);if(t===``)return{status:`gebucht`,titel:``};if(this.geloescht.has(t))return this.wirt.lauf.zeigt(`geloescht`,t,`loeschung`);let n=this.wirt.spalten().some((e,n)=>this.aenderungen.wert(t,n)!==void 0);return this.wirt.lauf.zeigt(`geaendert`,t,n?`geaendert`:`gebucht`)}satzPlaetze(){let e=new Map;return this.wirt.rohzeilen().forEach((t,n)=>{let r=To(this.wirt.baustein,t);r!==``&&!e.has(r)&&e.set(r,n)}),e}satzVon(e){let t=this.wirt.rohzeilen()[e];return t===void 0?``:To(this.wirt.baustein,t)}schalteLoeschung(e){let t=this.satzVon(e);t!==``&&(this.geloescht.has(t)?this.geloescht.delete(t):(this.geloescht.add(t),this.wirt.spalten().forEach((e,n)=>{this.aenderungen.nimmZurueck(t,n)})),this.wirt.melde())}istGeloescht(e){let t=this.satzVon(e);return t!==``&&this.geloescht.has(t)}zellWert(e,t){let n=this.aenderungen.wert(this.satzVon(e),t);return n===void 0?this.wirt.datenzeilen()[e]?.[t]??``:n}istGeaendert(e,t){return this.aenderungen.wert(this.satzVon(e),t)!==void 0}tippeZelle(e,t,n){this.aenderungen.setze(this.satzVon(e),t,n)&&this.wirt.melde()}verlasseZelle(e,t,n){let r=this.satzVon(e);(n===(this.wirt.datenzeilen()[e]?.[t]??``)?this.aenderungen.nimmZurueck(r,t):this.aenderungen.setze(r,t,n))&&this.wirt.melde()}zelleNachbar(e,t,n,r){let i=Array.from(this.wirt.baustein.shadowRoot?.querySelectorAll(`.koerper > .zeile:not(.erfassung) .zell-eingabe[data-spalte="${e}"]`)??[]),a=i.indexOf(t);if(a<0)return;let o=a+n;if(o>i.length-1){if(r&&this.wirt.erfassungAn()){this.wirt.fokussiereErfassungsZelle(0);return}o=i.length-1}o<0&&(o=0);let s=i[o];s&&s!==t&&(s.focus(),s.select(),s.scrollIntoView({block:`nearest`}))}tasteZelle(e,t,n){let r=n.target;if(n.key===`Escape`){n.preventDefault(),n.stopPropagation(),this.aenderungen.nimmZurueck(this.satzVon(e),t)&&this.wirt.melde();return}let i={Enter:1,ArrowDown:1,ArrowUp:-1,PageDown:10,PageUp:-10}[n.key];i!==void 0&&(n.preventDefault(),n.stopPropagation(),this.zelleNachbar(t,r,i,n.key===`Enter`))}},Uo={gebucht:``,erfasst:`Neue Zeile — noch nicht geschrieben`,geaendert:`Geändert — noch nicht geschrieben`,loeschung:`Zum Löschen vorgemerkt — noch nicht geschrieben`,schreibt:`Wird geschrieben …`,geschrieben:`Hinausgeschickt — bleibt stehen, bis neue Daten kommen`,fehler:`Nicht geschrieben`},Wo=class{constructor(e){this.schreibend=new Map,this.fehler=new Map,this.melde=e}schreibt(e,t){this.fehler.get(e)?.delete(t);let n=this.schreibend.get(e)??new Set;n.add(t),this.schreibend.set(e,n),this.melde()}gescheitert(e,t,n){this.schreibend.get(e)?.delete(t);let r=this.fehler.get(e)??new Map;r.set(t,n),this.fehler.set(e,r),this.melde()}fertig(e,t){this.schreibend.get(e)?.clear();let n=this.fehler.get(e);if(n)for(let e of t)n.delete(e);this.melde()}zeigt(e,t,n){let r=this.fehler.get(e)?.get(t);return r===void 0?this.schreibend.get(e)?.has(t)===!0?{status:`schreibt`,titel:Uo.schreibt}:{status:n,titel:Uo[n]}:{status:`fehler`,titel:Uo.fehler+`: `+r}}},Go=4;function Ko(e){return e??Go}function qo(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function Jo(e,t,n){let r=qo(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function Yo(e,t){return e===null?null:Math.max(0,e-t)}function Xo({sichtbar:e,hatQuelle:t,platzhalterZeilen:n}){return t?{seiten:1,seite:0,zeilen:[...e]}:{seiten:1,seite:0,zeilen:Array.from({length:n},()=>null)}}function Zo({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function Qo(e){if(!e.hasAttribute(`fuellt`))return-1;let t=e.renderRoot.querySelector(`.koerper`);return t instanceof HTMLElement?t.clientHeight:-1}function $o(e){let t=e.renderRoot.querySelector(`.kopf`);return t instanceof HTMLElement?t.offsetHeight:0}function es(e,t){let n=Qo(e);if(n===-1)return{mass:null,hoehe:n,kopf:0};let r=$o(e);return{mass:Jo(n,r,t),hoehe:n,kopf:r}}function ts(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}var ns=`ff-zeile-aktiviert`,rs=`data-ff-roh`;function is(e,t){e.dispatchEvent(new CustomEvent(ns,{detail:t,bubbles:!0,composed:!0}))}function as(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(rs);return r===null||r===``?null:Number(r)}function os(e,t){if(!(e instanceof HTMLElement))return!1;let n=e.closest(`.zeile`),r=n?.parentElement;if(!n||!r)return!1;let i=[...r.querySelectorAll(`.zeile[${rs}]`)],a=i.indexOf(n),o=a===-1?void 0:i[a+t];return o?(o.focus(),!0):!1}function ss(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.zeile[${rs}]`);return t?(t.focus(),!0):!1}function cs(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.suchzeile input`);return t?(t.focus(),!0):!1}function ls(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var us=class{constructor(e){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._rumpfGemessen=-1,this._kopfGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this.wirt=e}get suchtext(){return this._suchtext}get suchtAktiv(){return this._suchtext.trim()!==``}get sortSpalte(){return this._sortSpalte}get sortAuf(){return this._sortAuf}get seite(){return this._seite}get mass(){return this._mass}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.wirt.melde()}klickSortiere(e){this.wirt.editable()||(this.merkeZeilenFokus(),this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.wirt.melde())}blaettere(e){this.merkeZeilenFokus(),this._seite=e,this.wirt.melde()}fokussiereSuche(){let e=this.wirt.baustein.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}merkeZeilenFokus(){let e=as(this.wirt.baustein.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.wirt.zeilenHoehe();this._taktGemessen=e;let{mass:t,hoehe:n,kopf:r}=es(this.wirt.baustein,e);this._rumpfGemessen=n,this._kopfGemessen=r,(t?.passen!==this._mass?.passen||t?.zeilenHoehe!==this._mass?.zeilenHoehe)&&(this._mass=t,this.wirt.melde())}beobachte(){this._beobachter||(this._beobachter=ts(this.wirt.baustein,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}nachRendern(){(this._taktGemessen!==this.wirt.zeilenHoehe()||this._rumpfGemessen!==Qo(this.wirt.baustein)||this._kopfGemessen!==$o(this.wirt.baustein))&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,ls(this.wirt.baustein.shadowRoot,this._fokusZeile))}loese(){this._beobachter?.disconnect(),this._beobachter=null}nachPush(){this._seite=0,this._mass=null,this._taktGemessen=0,this._rumpfGemessen=-1,this._kopfGemessen=0}zuruecksetzen(){this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this.nachPush(),this._fokusZeile=null,this._fokusHolen=!1}};function ds(e,t,n,r){if(n===null||e.hasAttribute(`data-ff-editor`))return;let i=t[n];i!==void 0&&(is(e,{rohzeile:i,rohIndex:n,ansichtIndex:r}),ps(e,i),B(e,`onRowClick`,{PINDEX:To(e,i)}).catch(z))}function fs(e,t,n){if(n===null||e.hasAttribute(`data-ff-editor`))return;let r=t[n];r!==void 0&&B(e,`onRowDblClick`,{PINDEX:To(e,r)}).catch(z)}function ps(e,t){let n=N(e);n!==``&&Jt(n,t)}var ms={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,kennungKey:`kennung`,standardTitel:_a,eintragNeu:e=>{let t=W(e.spalten);return t.length>=16?{}:{spalten:Fo(t)}},eintragWeg:(e,t)=>{let n=W(e.spalten),r=Lo(n,t);if(r===n)return{};let i=Io(e.rechnung,n,r);return{spalten:[...r],...i===null?{}:{rechnung:i}}},eintragVerschieben:(e,t,n)=>{let r=W(e.spalten),i=Ro(r,t,n);return i===r?{}:{spalten:[...i]}},eintragStellen:`[data-ff-eintrag]`,eintragsSchalter:[{key:`summe`,label:`Summe in der Fußzeile`,kurz:`Summe`},{key:`aenderbar`,label:`In der Zeile änderbar`,kurz:`änderbar`,standard:!0,nurEigeneQuelle:!0},{key:`versteckt`,label:`In der Maske ausblenden`,kurz:`ausgeblendet`}],herkunftProp:`spaltenHerkunft`,eintragsFeldWahl:[{key:`fuellFeld`,label:`Nachschlagen`,hinweis:`Beim Erfassen füllt der gewählte Satz der Hilfsquelle diese Zelle.`,nurFremdeQuellen:!0}]};function hs(e){let t=e,n=ms.eintragsSchalter?.find(e=>e.key===`aenderbar`);return n!==void 0&&e.feld!==``&&bi(ms,t).includes(n)&&yi(n,t)}var gs=`ff_spaltenwahl_`,_s=new Map;function vs(e){let t=typeof document>`u`?``:document.title,n=e.getAttribute(D);if(n!==null&&n!==``)return`${gs}${t}|${n}`;let r=Array.from(e.ownerDocument?.querySelectorAll(e.tagName)??[]);return`${gs}${t}|#${Math.max(0,r.indexOf(e))}`}function ys(e){let t=_s.get(e);if(t)return new Set(t);try{let t=localStorage.getItem(e);if(t===null)return new Set;let n=JSON.parse(t);return Array.isArray(n)?new Set(n.filter(e=>typeof e==`string`)):new Set}catch{return new Set}}function bs(e,t){let n=[...t];_s.set(e,n);try{n.length===0?localStorage.removeItem(e):localStorage.setItem(e,JSON.stringify(n))}catch{}}function xs(e,t){if(e===null)return b;let n=e.waehlbar.filter(t=>!e.weg.has(t.kennung)).length;return v`<div class="sw-schirm" @pointerdown=${t.schliesse}></div>
    <div
      class="spaltenwahl"
      role="dialog"
    ...
    >
      ...
      ${e.weg.size===0?b:v`<button
        ...
        @click=${t.alleZeigen}
      >Alle zeigen</button>`}
    </div>`}function Ss(e,t,n){let r=0,i=0;for(let t of e){let e=fo(t);e!==null&&(r+=e,i++)}return i===0?``:r.toLocaleString(`de-DE`,{minimumFractionDigits:t,maximumFractionDigits:n})}var Cs={min:0,max:3};function ws(e,t){let n=[];return e.spalten.forEach((r,i)=>{if(r.summe!==!0)return;let a=Ss(t.map(t=>e.wertVon(t,i)),Cs.min,Cs.max);a!==``&&n.push({titel:r.titel,text:a})}),n}function Ts(e){return e.datenzeilen.map((t,n)=>e.spalten.map((t,r)=>e.wertVon(n,r)))}function Es(e){let t=Ts(e),n=jo(t,e.suchtext);return e.sortSpalte<0?n:_o(n.map(e=>t[e]),e.sortSpalte,e.sortAuf).map(e=>n[e])}function Ds(e){let t=e.gezeichnet??e.spalten,n=e.plaetze??t.map((e,t)=>t),r={gridTemplateColumns:Ta(t,t=>e.breiteVon?.(n[t]??t))},i=e.gemessen?.zeilenHoehe??28,a=e.hatQuelle,o=!e.erfassungAn&&No(a,e.datenGeliefert,e.datenzeilen.length),s=Es(e),c=e.erfassungAn?1+e.erfassteAnzahl:0,l=e.gemessen===null?null:Math.max(1,e.gemessen.passen-c),u={sichtbar:s,hatQuelle:a,proSeite:l??Math.max(1,10-c),wunschSeite:e.wunschSeite,platzhalterZeilen:Ko(l)},{seiten:d,seite:f,zeilen:p}=e.blaettert?Zo(u):Xo(u);return{cols:r,takt:28,zeilenHoehe:i,hatQuelle:a,leer:o,gesamt:s.length,seiten:d,seite:f,zeilen:p,linealTakte:Yo(l,p.length),summen:ws(e,s)}}var Os=[H(`suche`,`Suchzeile`,`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,{requiresDataSource:!0}),H(`erfassung`,`Erfassungszeile`,`Eine leere Zeile zum Tippen neuer Positionen.`),H(`loeschbar`,`Zeilen löschbar`,`Kreuz an jeder Zeile: merkt sie zum Löschen vor.`,{requiresDataSource:!0}),H(`blaettern`,`Blättern`,`Ja: Seiten mit Blätter-Knöpfen. Nein: alles untereinander, der Rumpf rollt.`),H(`kopfzeile`,`Kopfzeile`,`Aus: keine Titelzeile, kein Sortieren per Titelklick.`),H(`spaltenwahl`,`Spaltenwahl`,`In der Maske: Rechtsklick auf eine Spaltenüberschrift nimmt Spalten weg und holt sie zurück. Braucht die Kopfzeile.`),{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Sätze des gewählten Tages.`,kind:`field`},Ga()];function ks(e,t){let n=e.erfasst+e.geaendert+e.geloescht,r=e.seiten>1||e.summen.length>0||n>0||e.suchtAktiv||e.auswahlAktiv;return e.leer||!r?b:v`<div class="fusszeile">
    <div class="seiten-info">${Po({hatQuelle:e.hatQuelle,sichtbar:e.sichtbar,gesamt:e.gesamt,suchtAktiv:e.suchtAktiv,auswahlAktiv:e.auswahlAktiv})}</div>
    ${n===0?b:v`<div class="vorgemerkt">${Nr(e.erfasst,e.geaendert,e.geloescht)}</div>`}
  ...
  </div>`}var As=/[.*+?^${}()|[\]\\]/g;function js(e,t){let n=ci(t);if(n.length===0||e===``)return e;let r;try{r=RegExp(`(${n.map(e=>e.replace(As,`\\$&`)).join(`|`)})`,`ig`)}catch{return e}let i=e.split(r);return i.length<=1?e:v`${i.map((e,t)=>t%2==1?v`<mark>${e}</mark>`:e)}`}function Ms(e,t,n){let r=40-e,i=t-40,a=r>i?0:Math.min(i,Math.max(r,Math.round(n)));return{links:Math.round(e+a),rechts:Math.round(t-a)}}function Ns(e,t,n){if(e.button!==0)return;let r=[...e.currentTarget?.parentElement?.children??[]].filter(e=>e instanceof HTMLElement&&e.tagName===`DIV`),i=r[t],a=r[t+1];if(!i||!a)return;e.stopPropagation(),e.preventDefault();let o=e.clientX,s=i.getBoundingClientRect().width,c=a.getBoundingClientRect().width,l=Ms(s,c,0),u=()=>{window.removeEventListener(`pointermove`,p),window.removeEventListener(`pointerup`,ee),window.removeEventListener(`pointercancel`,m),window.removeEventListener(`keydown`,te),window.removeEventListener(`blur`,m)},d=r.map(e=>Math.max(1,Math.round(e.getBoundingClientRect().width))),f=()=>d.map((e,n)=>n===t?{index:n,breite:l.links}:n===t+1?{index:n,breite:l.rechts}:{index:n,breite:e});function p(e){l=Ms(s,c,e.clientX-o),n.zeige(f())}function ee(){u(),n.uebernimm(f())}function m(){u(),n.verwirf()}function te(e){e.key===`Escape`&&(e.preventDefault(),m())}window.addEventListener(`pointermove`,p),window.addEventListener(`pointerup`,ee),window.addEventListener(`pointercancel`,m),window.addEventListener(`keydown`,te),window.addEventListener(`blur`,m)}function Ps(e,t){return Array.from({length:Math.max(0,e-1)},(e,n)=>v`<span
    class="breite-griff"
    role="presentation"
    style="grid-row: 1; grid-column: ${n+1}"
    title="Linie ziehen: links breiter, rechts schmaler"
    @pointerdown=${e=>Ns(e,n,t)}
    @click=${e=>e.stopPropagation()}
    @dblclick=${e=>e.stopPropagation()}
  ></span>`)}function Fs(e){return e.linealTakte===0?b:v`<div class="lineal" role="presentation" style=${G(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>v`<div></div>`)}
        </div>`}function Is(e,t){return v`
      ...
      ${e.zeigeKopf?v`<div class="kopf" role="row" style=${G(e.cols)}>
        ${e.spalten.map((n,r)=>v`<div
          ...
          >${n.titel}${!e.editable&&e.sortSpalte===e.plaetze[r]?v`<span class="sort-pfeil">${e.sortAuf?` ▲`:` ▼`}</span>`:``}</div>`)}
        ${Ps(e.spalten.length,t.breiten)}
      </div>`:b}
        ${``}
        ${e.leer?Ka(e.leerText,!0):v`
        ...
        ${e.zeilen.map((n,r)=>{let i=n!==null&&!e.imEditor,a=n!==null&&e.zeilenStand.istGeloescht(n),o=n===null?{status:`gebucht`,titel:``}:e.zeilenStand.statusVon(n);return v`<div
            ...
            @keydown=${i=>{if(!i.target.closest(`.zell-eingabe, button`)){if(i.key===`ArrowDown`||i.key===`ArrowUp`){let e=i.key===`ArrowUp`;(os(i.target,e?-1:1)||e&&cs(i.target))&&i.preventDefault();return}if(i.key===`Delete`&&e.loeschbar&&n!==null&&!e.imEditor){i.preventDefault(),t.schalteLoeschung(n);return}i.key===`Enter`&&(i.preventDefault(),t.aktiviereZeile(n,r))}}}
          >
            ${``}
            ${e.spalten.map((t,i)=>{let a=e.plaetze[i],o=n===null?`—`:e.datenzeilen[n]?.[a]??``,s=e.imEditor&&!e.zeigeKopf&&e.editable;if(e.aendernMoeglich&&n!==null&&hs(t)){let r=e.zeilenStand;return v`<div class="tippbar" role="cell">
                <input
                ...
                class=${t.versteckt===!0?`versteckt`:b}
                role="cell"
                data-ff-editable=${s?``:b}
                data-ff-eintrag=${s&&r===0?a:b}
              >${js(o,e.suchtext)}</div>`})}
        ...
        >
          ${e.spalten.map((t,r)=>v`<div role="cell">${n[e.plaetze[r]]??``}</div>`)}
      ...
      ${xs(e.spaltenwahl,t.spaltenwahl)}
    `}var Ls=o`
...
`,Rs=new Set,q=class extends E{constructor(...e){super(...e),this.spalten=xa(),this.source=``,this.suche=`ja`,this.erfassung=`nein`,this.blaettern=`ja`,this.loeschbar=`nein`,this.kopfzeile=`ja`,this.spaltenwahl=`nein`,this.leerText=Wa,this.rechnung=``,this.datenzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._besitz=`softengine`,this._breiten=new Map,this._breiteVorZug=null,this._ansicht=new us({baustein:this,editable:()=>this.editable,zeilenHoehe:()=>this.zeilenHoehe,melde:()=>this.requestUpdate()}),this._erfassung=new yo,this._lauf=new Wo(()=>this.requestUpdate()),this._zeilen=new Ho({baustein:this,spalten:()=>this.spaltenListe(),rohzeilen:()=>this.rohzeilen,datenzeilen:()=>this.datenzeilen,melde:()=>this.requestUpdate(),lauf:this._lauf,erfassungAn:()=>this.erfassungAn,fokussiereErfassungsZelle:e=>this.fokussiereErfassungsZelle(e)}),this.nimmSeFokus=e=>{!e.defaultPrevented&&this.erfassungAn&&(this.hasAttribute(`data-ff-editor`)||(e.preventDefault(),this.fokussiereErfassungsZelle(0)))},this._wahlWeg=null,this._wahlOffen=null,this.nimmWahlTaste=e=>{e.key===`Escape`&&this.schliesseSpaltenwahl()}}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.kannErfassen={wenn:{attributeName:`erfassung`,equals:`ja`}}}static{this.aenderungsSchluessel=`aenderbar`}static{this.kannLoeschen={wenn:{attributeName:`loeschbar`,equals:`ja`}}}static{this.blockEvents=[{key:`onRowClick`,name:`Zeile gewählt`},{key:`onRowDblClick`,name:`Zeile doppelt geklickt`}]}static{this.listenBindung=ms}static{this.defaultProps={width:`fill`,source:``,spalten:xa(),suche:`ja`,erfassung:`nein`,blaettern:`ja`,loeschbar:`nein`,kopfzeile:`ja`,spaltenwahl:`nein`,tagField:``,rechnung:``,leerText:Wa}}static{this.customProperties=Os}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?Ao(this):ko(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=xo(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.nachPush(),this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._ansicht.zuruecksetzen(),this._erfassung.zuruecksetzen()}get erfassteZeilen(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.werte)}get erfassteSchluessel(){return this._erfassung.vormerkungen(this.erfassungsUmfeld()).map(e=>e.kennung)}get geaenderteZeilen(){return this._zeilen.geaenderteZeilen}get geloeschteZeilen(){return this._zeilen.geloeschteZeilen}zeileSchreibt(e,t){this._lauf.schreibt(e,t)}zeileGescheitert(e,t,n){this._lauf.gescheitert(e,t,n)}laufFertig(e,t){if(this._lauf.fertig(e,t),e===`erfasst`){this._erfassung.markiereGeschrieben(this.erfassungsUmfeld(),t)&&this.requestUpdate();return}this._zeilen.austragen(e,t)}vergissGeschriebene(){this._erfassung.vergissGeschriebene()&&this.requestUpdate()}erfasstStand(e){return this._lauf.zeigt(`erfasst`,this._erfassung.schluessel[e]??``,this._erfassung.istGeschrieben(e)?`geschrieben`:`erfasst`)}erfasseZeile(){return this._erfassung.erfasse(this.erfassungsUmfeld())?(this.requestUpdate(),this.fokussiereErfassungsZelle(0),this.zeigeLetzteErfasste(),!0):!1}zeigeLetzteErfasste(){this.updateComplete.then(()=>{let e=this.shadowRoot?.querySelector(`.koerper`);e&&(e.scrollTop=e.scrollHeight)})}fokussiereSuche(){return this._ansicht.fokussiereSuche()}setzeSuchtext(e){this._ansicht.setzeSuchtext(e),this.requestUpdate()}get hatQuelle(){return this._besitz===`provided`||Mo(this.hasAttribute(`data-ff-editor`),this.source)}spaltenListe(){return W(this.spalten)}get zeilenHoehe(){return 28}breitenWirt(){let e=e=>ga(this.spaltenListe(),this.hasAttribute(`data-ff-editor`)).plaetze[e]??e,t=t=>t.map(t=>({index:e(t.index),breite:t.breite})),n=e=>{this._breiteVorZug===null&&(this._breiteVorZug=new Map(e.map(e=>[e.index,this._breiten.get(e.index)])))};return{zeige:e=>{let r=t(e);n(r);for(let e of r)this._breiten.set(e.index,e.breite);this.requestUpdate()},uebernimm:e=>{let n=t(e);this._breiteVorZug=null;let r=this.spaltenListe();if(!this.hasAttribute(`data-ff-editor`)){for(let e of n)this._breiten.set(e.index,e.breite);this.requestUpdate();return}for(let e of n)e.index>=r.length||(this._breiten.delete(e.index),r[e.index]={...r[e.index],breite:e.breite});this.aendere(r)},verwirf:()=>{let e=this._breiteVorZug;if(this._breiteVorZug=null,e){for(let[t,n]of e)n===void 0?this._breiten.delete(t):this._breiten.set(t,n);this.requestUpdate()}}}}get erfassungAn(){return this.erfassung===`ja`}erfassungsWirt(){return{baustein:this,lauf:this._erfassung.lauf,umfeld:()=>this.erfassungsUmfeld(),melde:()=>this.requestUpdate(),fokussiere:e=>this.fokussiereErfassungsZelle(e),erfasseZeile:()=>this.erfasseZeile()}}fokussiereErfassungsZelle(e){this.updateComplete.then(()=>{let t=this.shadowRoot?.querySelector(`.zeile.erfassung .erf-eingabe[data-spalte="${e}"]`);t&&(t.focus(),t.scrollIntoView({block:`nearest`}))})}erfassungsUmfeld(){return this._erfassung.umfeld(this,this.spaltenListe(),this.source,Va(this.rechnung))}aendere(e){let t=Io(this.rechnung,this.spaltenListe(),e);if(t===null){this.meldeProp(`spalten`,e);return}this.meldeProp(`rechnung`,t,`beginn`),this.meldeProp(`spalten`,e,`ende`)}meldeProp(e,t,n){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:e,value:t,...n===void 0?{}:{geste:n}},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&ko(this),document.addEventListener(Un,this.nimmSeFokus),this._ansicht.beobachte()}firstUpdated(){this._ansicht.beobachte()}willUpdate(e){super.willUpdate(e),e.has(`spalten`)&&this._breiten.clear(),this.erfassungAn&&!this.hasAttribute(`data-ff-editor`)&&this._erfassung.lauf.aktualisiereVorschlaege(this.erfassungsUmfeld())}updated(){this._ansicht.nachRendern(),Rr(this)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`keydown`,this.nimmWahlTaste),document.removeEventListener(Un,this.nimmSeFokus),this._ansicht.loese(),rc(this),Ao(this)}static{this.styles=[E.styles,qa,Ls,hi,bo]}get spaltenwahlAn(){return this.spaltenwahl===`ja`&&this.kopfzeile===`ja`&&!this.hasAttribute(`data-ff-editor`)}wahlWeg(){return this.spaltenwahlAn?(this._wahlWeg===null&&(this._wahlWeg=ys(vs(this))),this._wahlWeg):Rs}oeffneSpaltenwahl(e){e.preventDefault(),e.stopPropagation();let t=this.shadowRoot?.querySelector(`.tabelle`)?.getBoundingClientRect();t&&(this._wahlOffen={links:Math.max(4,Math.min(e.clientX-t.left,Math.max(4,t.width-170))),oben:Math.max(4,Math.min(e.clientY-t.top,Math.max(4,t.height-60)))},window.addEventListener(`keydown`,this.nimmWahlTaste),this.requestUpdate())}schliesseSpaltenwahl(){this._wahlOffen!==null&&(this._wahlOffen=null,window.removeEventListener(`keydown`,this.nimmWahlTaste),this.requestUpdate())}merkeWahl(e){this._wahlWeg=e,bs(vs(this),e),this._breiten.clear(),this.requestUpdate()}render(){let e=this.spaltenListe(),t=ga(e,this.hasAttribute(`data-ff-editor`),this.wahlWeg()),n=Ds({spalten:e,gezeichnet:t.spalten,plaetze:t.plaetze,breiteVon:e=>this._breiten.get(e),hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._ansicht.suchtext,sortSpalte:this._ansicht.sortSpalte,sortAuf:this._ansicht.sortAuf,wunschSeite:this._ansicht.seite,gemessen:this._ansicht.mass,erfassungAn:this.erfassungAn,erfassteAnzahl:this._erfassung.zeilen.length,wertVon:(e,t)=>this._zeilen.zellWert(e,t),blaettert:this.blaettern===`ja`});return v`<div class="tabelle" style=${G({"--takt":`${n.takt}px`,"--zeilen-hoehe":`${n.zeilenHoehe}px`})}>
      ${Is({spalten:t.spalten,plaetze:t.plaetze,cols:n.cols,editable:this.editable,imEditor:this.hasAttribute(`data-ff-editor`),zeigeKopf:this.kopfzeile===`ja`,spaltenwahlAn:this.spaltenwahlAn,spaltenwahl:this._wahlOffen===null?null:{waehlbar:e.filter(e=>e.versteckt!==!0),weg:this.wahlWeg(),links:this._wahlOffen.links,oben:this._wahlOffen.oben},auswahlSemantik:N(this)!==``,zeigeSuche:this.suche===`ja`,suchtext:this._ansicht.suchtext,sortSpalte:this._ansicht.sortSpalte,sortAuf:this._ansicht.sortAuf,zeilen:n.zeilen,linealTakte:n.linealTakte,datenzeilen:this.datenzeilen,hatQuelle:n.hatQuelle,auswahlIndex:this.auswahlIndex,aendernMoeglich:!this.hasAttribute(`data-ff-editor`)&&n.hatQuelle&&Eo(this),loeschbar:this.loeschbar===`ja`&&!this.hasAttribute(`data-ff-editor`)&&n.hatQuelle&&Eo(this),zeilenStand:this._zeilen,leer:n.leer,leerText:this.leerText,erfasste:this._erfassung.zeilen,erfasstStand:e=>this.erfasstStand(e),korrekturPlatz:this.erfassungAn?this._erfassung.korrekturPlatz:null,erfassung:this.erfassungAn?oo(this.erfassungsWirt(),n.cols,this._erfassung.korrekturPlatz===null&&(n.linealTakte??1)<=0,t):b},{setzeSuchtext:e=>this._ansicht.setzeSuchtext(e),oeffneSpaltenwahl:e=>this.oeffneSpaltenwahl(e),spaltenwahl:{schalte:e=>{let t=new Set(this.wahlWeg());t.has(e)?t.delete(e):t.add(e),this.merkeWahl(t)},alleZeigen:()=>this.merkeWahl(new Set),schliesse:()=>this.schliesseSpaltenwahl()},breiten:this.breitenWirt(),klickKopf:e=>{this.editable||this._ansicht.klickSortiere(e)},aktiviereZeile:(e,t)=>ds(this,this.rohzeilen,e,t),zeileDoppelt:e=>fs(this,this.rohzeilen,e),nimmErfassteZeile:e=>{this._erfassung.entferne(e)&&this.requestUpdate()},holeErfassteZeile:e=>{this._erfassung.zurueckholen(this.erfassungsUmfeld(),e)&&(this.requestUpdate(),this.fokussiereErfassungsZelle(0))},schalteLoeschung:e=>this._zeilen.schalteLoeschung(e)})}
      ${ks({hatQuelle:n.hatQuelle,sichtbar:n.gesamt,gesamt:this.datenzeilen.length,suchtAktiv:this._ansicht.suchtAktiv,auswahlAktiv:this.durchAuswahlGefiltert,seite:n.seite,seiten:n.seiten,blaettert:this.blaettern===`ja`,summen:n.summen,erfasst:this.erfassteZeilen.length,geaendert:this._zeilen.vorgemerkteAenderungen(),geloescht:this._zeilen.vorgemerkteLoeschungen(),leer:n.leer},{blaettere:e=>this._ansicht.blaettere(e)})}
    </div>`}};T([C({converter:{fromAttribute:e=>e?wa(e):xa(),toAttribute:e=>JSON.stringify(e)}})],q.prototype,`spalten`,void 0),T([C()],q.prototype,`source`,void 0),T([C()],q.prototype,`suche`,void 0),T([C()],q.prototype,`erfassung`,void 0),T([C()],q.prototype,`blaettern`,void 0),T([C()],q.prototype,`loeschbar`,void 0),T([C()],q.prototype,`kopfzeile`,void 0),T([C()],q.prototype,`spaltenwahl`,void 0),T([C()],q.prototype,`leerText`,void 0),T([C()],q.prototype,`rechnung`,void 0),T([C({attribute:!1})],q.prototype,`datenzeilen`,void 0),T([C({attribute:!1})],q.prototype,`rohzeilen`,void 0),T([C({attribute:!1})],q.prototype,`auswahlIndex`,void 0),T([C({attribute:!1})],q.prototype,`durchAuswahlGefiltert`,void 0),T([C({attribute:!1})],q.prototype,`datenGeliefert`,void 0),E.defineAndRegister(q);function zs(e){return Math.min(900,Math.max(520,160+180*e))}function Bs(e){return v`<div class="nachschlag">
    <input
      class="ctrl"
      type="text"
      .value=${e.wert}
    ...
    >${ha()}</button>
    ${e.liste}
  </div>`}var Vs={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:_a,quelleProp:`nachschlagQuelle`};function Hs(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?W(e):[]}function Us(e,t){let n=e[0];return n===void 0?t:n.feld}function Ws(e,t){let n=e.trim();return n===``||n===t.trim()}function Gs(e,t,n){let r=t.trim(),i=[],a=Ws(t,n),o=new Set;for(let t of e){let e=A(t,n).trim(),s=r===``?e:A(t,r).trim();if(s!==``||e!==``){if(a){if(o.has(e))continue;o.add(e)}i.push({anzeige:s,wert:e,satz:t})}}return i}function Ks(e,t,n,r){return Gs(en(e,t).rows,n,r)}function qs(e){let t=k(L().FF_DATA_SOURCES,e);return t?jt(L().SEDATA,t.name,t.tableId,t.offenerSatz):null}function Js(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=qs(e.quelleId);if(t===null)return{ok:!1,grund:`quelleFehlt`};let n=Us(Hs([...e.spalten]),e.speicherFeld);return{ok:!0,eintraege:Ks(e.el,t,n,e.speicherFeld)}}function Ys(e,t){return t&&e.length===1?e[0]:null}function Xs(e,t){let{rows:n,gefiltert:r}=en(e,[t]);return!r||n.length>0}function Zs(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var Qs=null,$s=null,ec=null;function tc(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function nc(e=!0){let t=e?ec:null;ec=null,Qs?.remove(),Qs=null,$s=null,t?.focus()}function rc(e){$s===e&&nc(!1)}function ic(e){return[{kennung:``,titel:e.speicherTitel===``?`Wert`:e.speicherTitel,feld:e.speicherFeld}]}function ac(e){let t=e=>e.stopPropagation(),n=e.editor;return v`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >${e.inhalt}</ff-dialog-rahmen>`}function oc(e,t){let n=Hs([...e.spalten]),r=Ws(Us(n,e.speicherFeld),e.speicherFeld);return v`<ff-tabelle
    fuellt
    suche="ja"
    style="--se-r-lg:0px"
    .besitz=${`provided`}
    .spalten=${n.length>0?n:ic(e)}
  ...
  ></ff-tabelle>`}function sc(e){let t=e.eintraege;if(t===void 0){let n=Js(e);if(!n.ok){I(n.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}t=n.eintraege}nc(!1);let n=document.createElement(`div`);n.style.display=`contents`,Ve(ac({titel:e.titel,breite:e.breite,hoehe:e.hoehe,inhalt:oc(e,t),onSchliessen:()=>nc()}),n);let r=n.querySelector(nn),i=n.querySelector(q.tagName);i?.addEventListener(ns,n=>{let r=n.detail,i=t[r.rohIndex];i&&(nc(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),ec=e.rueckFokus??tc(e.el),document.body.appendChild(n),Qs=n,$s=e.el;let a=e.suchtext??``;i&&a!==``&&i.setzeSuchtext(a),r&&i&&Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}function cc(e){return ac({titel:e.titel,breite:e.breite,hoehe:e.hoehe,onSchliessen:e.onSchliessen,editor:{onGroesse:e.onGroesse},inhalt:v`<ff-tabelle
      data-ff-editor
      fuellt
      suche="ja"
      style="--se-r-lg:0px"
    ...
    ></ff-tabelle>`})}var J=class e extends E{constructor(...e){super(...e),this.fieldType=`text`,this.placeholder=`Feldname`,this.options=``,this.source=``,this.value=``,this.valueField=``,this.nachschlagQuelle=``,this.speicherFeld=``,this.speicherTitel=``,this.nachschlagSpalten=[],this.fensterBreite=520,this.fensterHoehe=380,this.einzigerTreffer=`nein`,this.spaltenDialog=!1,this.anzeige=``,this.getippt=null,this.marke=0,this.markeVonHand=!1,this.listeZu=!1,this.vorschlaege=[],this.satz=void 0,this.angehakt=!1,this.imSteuerelement=!1}static{this.blockType=`formfeld`}static{this.tagName=`ff-formfeld`}static{this.displayName=`Formularfeld`}static{this.category=`eingabe`}static{this.acceptsDataSource={wenn:{attributeName:`fieldType`,notEquals:`nachschlagen`}}}static{this.kannAuswahlFolgen=!0}static{this.satzWahl={quelleProp:`nachschlagQuelle`,wenn:{attributeName:`fieldType`,equals:`nachschlagen`}}}static{this.listenBindung=Vs}static{this.bindableSpots=[{prop:`value`,label:`Wert`,wenn:{attributeName:`fieldType`,keinesVon:[`checkbox`,`nachschlagen`]},vorschauProp:`placeholder`}]}static{this.actionValueSpots=[{prop:`value`,label:`Wert`}]}static{this.blockEvents=[{key:`onChange`,name:`Wert geändert`}]}static{this.defaultProps={width:240,fieldType:`text`,placeholder:`Feldname`,options:``,source:``,value:``,valueField:``,nachschlagQuelle:``,speicherFeld:``,speicherTitel:``,nachschlagSpalten:[],fensterBreite:520,fensterHoehe:380,einzigerTreffer:`nein`}}static{this.raster={startW:6,startH:2,minW:2,minH:2}}static{this.customProperties=_i}static{this.styles=[E.styles,ua,hi]}onInput(e){let t=e.target;this.value=fa(this.fieldType)===`date`?na(t.value):t.value}onChange(){this.dispatchEvent(new Event(`change`))}textTpl(e,t=!1,n=!1){return v`<span
      class=${e}
      ?hidden=${t}
      ?data-ff-bound=${n}
      data-ff-editable
    ...
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}setzeHaken(e){this.angehakt!==e&&(this.angehakt=e,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return v`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return v`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
        ...
        </select>`}case`nachschlagen`:return Bs({wert:this.getippt??this.anzeige,onTippen:e=>{this.getippt=e,this.marke=0,this.markeVonHand=!1,this.listeZu=!1},onTaste:e=>this.onNachschlagTaste(e),onVerlassen:()=>this.onNachschlagVerlassen(),onLupe:()=>this.onLupe(),liste:this.vorschlaege.length===0?b:mi({eintraege:this.vorschlaege,marke:this.marke,onWaehlen:e=>this.uebernimmVorschlag(e),onMarke:e=>{this.marke=e}})});default:return v`<input
          class="ctrl"
          type=${e}
          .value=${e===`date`?ta(this.value):this.value}
          @input=${this.onInput}
          @change=${this.onChange}
          @focus=${()=>{this.imSteuerelement=!0}}
          @blur=${()=>{this.imSteuerelement=!1}}
        />`}}onLupe(e=``){if(this.hasAttribute(`data-ff-editor`)){this.spaltenDialog=!0;return}sc({el:this,quelleId:this.nachschlagQuelle,speicherFeld:this.speicherFeld,speicherTitel:this.speicherTitel,spalten:this.nachschlagSpalten,titel:this.placeholder,breite:this.fensterBreite,hoehe:this.fensterHoehe,suchtext:e,onUebernehmen:(e,t,n)=>this.uebernimmUndMelde(e,t,n)})}spaltenEffektiv(){let e=Hs(this.nachschlagSpalten);return e.length>0?e:ic({speicherFeld:this.speicherFeld,speicherTitel:this.speicherTitel})}meldeProp(e,t,n){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:e,value:t,...n===void 0?{}:{geste:n}},bubbles:!0,composed:!0}))}spaltenDialogTpl(){return cc({titel:this.placeholder,spalten:this.spaltenEffektiv(),breite:this.fensterBreite,hoehe:this.fensterHoehe,onGroesse:t=>{let n=t.achse===`breite`?`fensterBreite`:`fensterHoehe`;if(t.geste===`standard`){this.meldeProp(n,e.defaultProps[n]);return}this.meldeProp(n,t.wert,t.geste===`laeuft`?void 0:t.geste)},onAendern:e=>{this.meldeProp(`nachschlagSpalten`,e)},onFeldWahl:e=>{this.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:`nachschlagSpalten`,...e},bubbles:!0,composed:!0}))},onSchliessen:()=>{this.spaltenDialog=!1}})}willUpdate(e){super.willUpdate(e),e.has(`fieldType`)&&fa(this.fieldType)!==`nachschlagen`&&(this.spaltenDialog=!1),this.vorschlaege=this.berechneVorschlaege(),this.marke=fi(this.marke,this.vorschlaege.length)}updated(e){super.updated(e),this.toggleAttribute(`data-ff-liste`,this.vorschlaege.length>0)}berechneVorschlaege(){if(this.getippt===null||this.listeZu||fa(this.fieldType)!==`nachschlagen`||this.hasAttribute(`data-ff-editor`))return[];let e=Js({el:this,quelleId:this.nachschlagQuelle,speicherFeld:this.speicherFeld,spalten:this.nachschlagSpalten});return e.ok?ui(e.eintraege,this.getippt):[]}onNachschlagTaste(e){if(this.hasAttribute(`data-ff-editor`))return;let t=this.vorschlaege.length,n=pi(e.key,{listeOffen:t>0,feldLeer:(this.getippt??this.anzeige)===``,treffer:t,markeVonHand:this.markeVonHand});if(n===`nichts`){e.key===`Enter`&&e.preventDefault();return}e.preventDefault(),n===`marke-hoch`||n===`marke-runter`?(this.marke=di(this.marke,t,n===`marke-hoch`?-1:1),this.markeVonHand=!0):n===`uebernehmen`?this.uebernimmVorschlag(this.marke):n===`liste-zu`?this.listeZu=!0:this.onLupe(this.getippt??``)}uebernimmVorschlag(e){let t=this.vorschlaege[e];t&&this.uebernimmUndMelde(t.anzeige,t.wert,t.satz)}leereNachschlagen(){this.satz=void 0,this.anzeige=``,this.value=``,Xt(N(this))}uebernimmUndMelde(e,t,n){this.getippt=null,this.listeZu=!1,this.marke=0,this.markeVonHand=!1,this.uebernimmSatz(e,t,n),this.dispatchEvent(new Event(`change`))}uebernimmSatz(e,t,n){this.anzeige=e===``?t:e,this.value=t,this.satz=n,Yt(N(this),n,!0)}onNachschlagVerlassen(){if(this.hasAttribute(`data-ff-editor`))return;let e=Zs(this.getippt??this.anzeige,this.anzeige,this.value);this.getippt=null,this.listeZu=!1,this.marke=0,this.markeVonHand=!1,e===`leeren`&&(this.leereNachschlagen(),this.dispatchEvent(new Event(`change`)))}pruefeEigenenWert(){fa(this.fieldType)===`nachschlagen`&&(this.getippt!==null&&this.requestUpdate(),this.satz!==void 0&&!Xs(this,this.satz)&&this.leereNachschlagen(),this.uebernimmEinzigenTreffer())}uebernimmEinzigenTreffer(){if(this.einzigerTreffer!==`ja`)return;let e=Js({el:this,quelleId:this.nachschlagQuelle,speicherFeld:this.speicherFeld,spalten:this.nachschlagSpalten});if(!e.ok)return;let t=Ys(e.eintraege,this.satz===void 0);t&&this.uebernimmSatz(t.anzeige,t.wert,t.satz)}render(){let e=fa(this.fieldType);if(e===`checkbox`)return v`<div class="feld">
        <div class="zeile">
          <input
            class="ctrl"
            type="checkbox"
      ...
      >
        ${this.controlTpl(e)}
        ${pa.includes(e)?this.textTpl(`ph ${ma[e]??``}`.trim(),!n,t&&this.valueField!==``):b}
      </div>
      ${this.spaltenDialog&&this.hasAttribute(`data-ff-editor`)?this.spaltenDialogTpl():b}
    </div>`}connectedCallback(){super.connectedCallback(),ca(this)}disconnectedCallback(){super.disconnectedCallback(),la(this),rc(this)}};T([C()],J.prototype,`fieldType`,void 0),T([C()],J.prototype,`placeholder`,void 0),T([C()],J.prototype,`options`,void 0),T([C()],J.prototype,`source`,void 0),T([C()],J.prototype,`value`,void 0),T([C()],J.prototype,`valueField`,void 0),T([C()],J.prototype,`nachschlagQuelle`,void 0),T([C()],J.prototype,`speicherFeld`,void 0),T([C()],J.prototype,`speicherTitel`,void 0),T([C({converter:{fromAttribute:e=>Hs(e??``),toAttribute:e=>JSON.stringify(e)}})],J.prototype,`nachschlagSpalten`,void 0),T([C({type:Number})],J.prototype,`fensterBreite`,void 0),T([C({type:Number})],J.prototype,`fensterHoehe`,void 0),T([C()],J.prototype,`einzigerTreffer`,void 0),T([w()],J.prototype,`spaltenDialog`,void 0),T([w()],J.prototype,`anzeige`,void 0),T([w()],J.prototype,`getippt`,void 0),T([w()],J.prototype,`marke`,void 0),T([w()],J.prototype,`listeZu`,void 0),T([w()],J.prototype,`angehakt`,void 0),T([w()],J.prototype,`imSteuerelement`,void 0),E.defineAndRegister(J);var lc=`ziel`,uc=o`
...
`,fc=`frei · hierher ziehen`,pc=`ff-zimmer-inhalt`,Y=class extends E{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[V.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[E.styles,qa,dc,uc,o`
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(pc,{bubbles:!0,composed:!0}))}render(){return v`<div class="zimmer ${lc}">
      <div
        class="kopf"
        data-ff-editable
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(pc,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(V.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return v`<div class="col ${lc} v-${Vr(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};T([C()],X.prototype,`variant`,void 0),T([C()],X.prototype,`heading`,void 0),T([C({attribute:!1})],X.prototype,`leerHinweis`,void 0),T([w()],X.prototype,`_count`,void 0),E.defineAndRegister(X);function mc(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function hc(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var gc=new WeakMap,_c=X.tagName,vc=Y.tagName,yc=V.tagName;function bc(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===_c)}function xc(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===yc)}function Sc(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===vc)}function Cc(e){return[e,...Sc(e)]}function wc(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=Sc(e);for(let e of t)r(e,xc(e).length===0?fc:``);r(e,t.length===0&&xc(e).length===0?n:``)}}function Tc(e){return Ye().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Ec(e,t){let n=Sc(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),a=mc(A(t,r),i);return a>=0?n[a]:n[0]}function Dc(e){Q?.board===e&&Nc();let t=e.getAttribute(`statusfield`)??``,n=Co(e);if(!n)return;let r=bc(e);if(r.length===0)return;let i=gc.get(e);if(!i){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(yc);t&&(i=t.cloneNode(!0),gc.set(e,i))}if(!i)return;let a=n.zeilen,o=r.map(e=>e.getAttribute(`heading`)??X.defaultProps.heading),s=Tc(i.tagName),c=hc(r.map(e=>e.getAttribute(`auffang`))),l=n.lies;for(let e of r)for(let t of Cc(e))xc(t).forEach(e=>e.remove());for(let e of a){let a=i.cloneNode(!0),u=t===``?-1:mc(A(e,t),o),d=u>=0?r[u]:c>=0?r[c]:r[0];(Ec(d,e)??d).appendChild(a);for(let t of s){let n=a.getAttribute(Si(t.prop))??``;n!==``&&(a[t.prop]=l(e,n))}let f=Et(n.quelle,e);Z.set(a,{row:e,pindex:f}),a.draggable=!0}wc(e,r);let u=r.flatMap(e=>Cc(e).flatMap(xc)),d=qt(N(e),u,e=>Z.get(e)?.row);for(let e of d)u[e].setAttribute(`data-ff-auswahl`,``)}var Z=new WeakMap,Q=null,Oc=new WeakSet,kc=`data-ff-zieht`,Ac=`data-ff-ziel`,jc=null;function Mc(e){jc!==e&&(jc?.removeAttribute(Ac),jc=e,jc?.setAttribute(Ac,``))}function Nc(){Q?.card.removeAttribute(kc),Q=null,Mc(null)}function Pc(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function Fc(e,t){return Pc(e,t,_c)}function Ic(e,t,n){if(!Q||Q.board!==e)return;let r=Z.get(Q.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;B(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(z)}function Lc(e){Oc.has(e)||(Oc.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Z.has(e))??null;if(!n)return;let r=Z.get(n);r&&Jt(N(e),r.row),B(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(z)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Z.has(e))??null;n&&(Q={card:n,board:e},t.dataTransfer?.setData(`text/plain`,Z.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{Q?.card===n&&n.setAttribute(kc,``)},0))}),e.addEventListener(`dragend`,Nc),e.addEventListener(`dragover`,t=>{let n=Fc(e,t);if(Q?.board!==e||!n){Mc(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),Mc(Pc(e,t,vc)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&Mc(null)}),e.addEventListener(`drop`,t=>{let n=Fc(e,t);n&&(t.preventDefault(),Ic(e,n,Pc(e,t,vc)),Nc())}))}var Rc=Ki({hydriere:Dc,verdrahte:Lc}),zc=Rc.connect,Bc=Rc.disconnect,Vc=X.blockType,Hc=class extends E{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Vc]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:Vc}}static{this.templateChild={type:V.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:Wa}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Feld, das die Spalte bestimmt. Leer: alle in die Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Einträge des gewählten Tages.`,kind:`field`},Ga()]}static{this.defaultChildren=[{type:Vc,props:{heading:`Offen`,variant:`warning`},children:[{type:V.blockType}]},{type:Vc,props:{heading:`In Arbeit`,variant:`info`}},{type:Vc,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[E.styles,o`
    ...
    `]}render(){return v`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),zc(this)}disconnectedCallback(){super.disconnectedCallback(),Bc(this)}};E.defineAndRegister(Hc);var Uc={breite:56,breiteOffen:224},Wc=`ff-seiten-wechsel`,Gc=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],Kc=class extends E{static{this.blockType=`navi-eintrag`}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:Gc.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[E.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(Wc,{detail:e,bubbles:!0,composed:!0}))}render(){return v`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};T([C()],Kc.prototype,`seite`,void 0),T([C()],Kc.prototype,`seitename`,void 0),T([C({reflect:!0})],Kc.prototype,`ton`,void 0),E.defineAndRegister(Kc);var qc=`aktiv`;function Jc(e){return Array.from(e.querySelectorAll(Kc.tagName))}function Yc(e,t){let n=Jc(e),r=t??n.find(e=>e.hasAttribute(qc))??n[0];for(let e of n)e===r?e.setAttribute(qc,``):e.removeAttribute(qc)}function Xc(e){let t=e.hasAttribute(`offen`);for(let n of Jc(e))n.toggleAttribute(`breit`,t)}function Zc(e){return e.getAttribute(`name`)??String(lt.defaultProps.name)}function Qc(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function $c(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(lt.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=Qc(e,i);if(!a)return;let o=r.find(e=>Zc(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var el=new WeakMap,tl=new WeakSet;function nl(e){let t=t=>{let n=t.detail;n&&(Yc(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),Xc(e),!e.hasAttribute(`data-ff-editor`)&&$c(e,n.ansicht))};e.addEventListener(Wc,t),el.set(e,t)}function rl(e){let t=el.get(e);t&&(e.removeEventListener(Wc,t),el.delete(e))}function il(e){if(Yc(e),Xc(e),e.hasAttribute(`data-ff-editor`)||tl.has(e))return;let t=Jc(e)[0];if(!t)return;tl.add(e);let n=()=>$c(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var al=Kc.blockType,ol=class extends E{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[al]}static{this.addChildButton={label:`Eintrag`,childType:al}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[ct]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[E.styles,o`
      :host {
        height: 100%;
        width: ${Uc.breite}px;
        transition: width var(--se-move);
      }
      :host([offen]) { width: ${Uc.breiteOffen}px; }
      .leiste {
        box-sizing: border-box;
        height: 100%;
        width: 100%;
    ...
    `]}connectedCallback(){super.connectedCallback(),nl(this)}disconnectedCallback(){super.disconnectedCallback(),rl(this)}klappen(){this.toggleAttribute(`offen`),Xc(this)}render(){return v`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
        ...
        <div class="eintraege">
          <slot @slotchange=${()=>il(this)}></slot>
        </div>
      </div>`}};E.defineAndRegister(ol);var sl=Si(`text`);function cl(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(sl)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function ll(e){let t=Qi(e,sl);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function ul(e){cl(e)&&(e.text=``)}var dl=Ki({hydriere:ll,verdrahte:ul}),fl=dl.connect,pl=dl.disconnect,ml=6,hl=96,gl=14,_l={duenn:`300`,normal:`400`,fett:`700`},vl={links:`left`,mitte:`center`,rechts:`right`},yl={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},bl=`standard`;function xl(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(hl,Math.max(ml,t)):gl}function Sl(e){return typeof e==`string`&&e in _l?e:`normal`}function Cl(e){return typeof e==`string`&&e in vl?e:`links`}function wl(e){return typeof e==`string`&&e in yl?e:bl}var $=class extends E{constructor(...e){super(...e),this.groesse=gl,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=bl,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:gl,gewicht:`normal`,ausrichtung:`links`,farbe:bl,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:ml,max:hl,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[E.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return v`<div
      class="text"
      style=${G({fontSize:`${xl(this.groesse)}px`,fontWeight:_l[Sl(this.gewicht)],textAlign:vl[Cl(this.ausrichtung)],color:yl[wl(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),fl(this)}disconnectedCallback(){super.disconnectedCallback(),pl(this)}};T([C({type:Number})],$.prototype,`groesse`,void 0),T([C()],$.prototype,`gewicht`,void 0),T([C()],$.prototype,`ausrichtung`,void 0),T([C()],$.prototype,`farbe`,void 0),T([C()],$.prototype,`text`,void 0),T([C()],$.prototype,`source`,void 0),T([C()],$.prototype,`textField`,void 0),E.defineAndRegister($);var Tl=[`waagerecht`,`senkrecht`],El=`waagerecht`;function Dl(e){return Tl.includes(e)?e:El}var Ol=class extends E{constructor(...e){super(...e),this.richtung=El}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:El}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[E.styles,o`
    ...
    `]}render(){return v`<div class="flaeche ${Dl(this.richtung)}"><div class="linie"></div></div>`}};T([C()],Ol.prototype,`richtung`,void 0),E.defineAndRegister(Ol),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;I(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();