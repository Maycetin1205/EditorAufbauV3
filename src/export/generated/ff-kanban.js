...
`;function _(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var v=`frei · hierher ziehen`,y=`ff-zimmer-inhalt`,b=class extends t.BasicBlock{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[n.CardBlock.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[t.BasicBlock.styles,r.leerStil,g,h,e.css`
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(y,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(n.CardBlock.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){let t=(0,o.coerceStatusVariant)(this.variant);return e.html`<div class="col ${m} v-${t}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};_([(0,i.property)()],x.prototype,`variant`,void 0),_([(0,i.property)()],x.prototype,`heading`,void 0),_([(0,i.property)({attribute:!1})],x.prototype,`leerHinweis`,void 0),_([(0,i.state)()],x.prototype,`_count`,void 0),t.BasicBlock.defineAndRegister(x);function S(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function C(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var w=new WeakMap,T=x.tagName,E=b.tagName,D=n.CardBlock.tagName;function O(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===T)}function k(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===D)}function A(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===E)}function j(e){return[e,...A(e)]}function M(e,t){let n=e.getAttribute(`leertext`)??r.LEER_TEXT_STANDARD,i=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=A(e);for(let e of t)i(e,k(e).length===0?v:``);i(e,t.length===0&&k(e).length===0?n:``)}}function N(e){return(0,c.getAllBlockDefinitions)().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function P(e,t){let n=A(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??b.defaultProps.heading),a=S((0,l.getField)(t,r),i);return a>=0?n[a]:n[0]}function F(e){L?.board===e&&U();let t=e.getAttribute(`statusfield`)??``,n=(0,f.holeDatenVorspann)(e);if(!n)return;let r=O(e);if(r.length===0)return;let i=w.get(e);if(!i){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(D);t&&(i=t.cloneNode(!0),w.set(e,i))}if(!i)return;let a=n.zeilen,o=r.map(e=>e.getAttribute(`heading`)??x.defaultProps.heading),c=N(i.tagName),d=C(r.map(e=>e.getAttribute(`auffang`))),p=n.lies;for(let e of r)for(let t of j(e))k(t).forEach(e=>e.remove());for(let e of a){let a=i.cloneNode(!0),u=t===``?-1:S((0,l.getField)(e,t),o),f=u>=0?r[u]:d>=0?r[d]:r[0];(P(f,e)??f).appendChild(a);for(let t of c){let n=a.getAttribute((0,s.bindingAttr)(t.prop))??``;n!==``&&(a[t.prop]=p(e,n))}let m=(0,l.satzIndexVon)(n.quelle,e);I.set(a,{row:e,pindex:m}),a.draggable=!0}M(e,r);let m=r.flatMap(e=>j(e).flatMap(k)),h=(0,u.auswahlWiederfinden)((0,u.geberIdVon)(e),m,e=>I.get(e)?.row);for(let e of h)m[e].setAttribute(`data-ff-auswahl`,``)}var I=new WeakMap,L=null,R=new WeakSet,z=`data-ff-zieht`,B=`data-ff-ziel`,V=null;function H(e){V!==e&&(V?.removeAttribute(B),V=e,V?.setAttribute(B,``))}function U(){L?.card.removeAttribute(z),L=null,H(null)}function W(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function G(e,t){return W(e,t,T)}function K(e,t,n){if(!L||L.board!==e)return;let r=I.get(L.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;(0,p.runEvent)(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(p.meldeKettenFehler)}function q(e){R.has(e)||(R.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&I.has(e))??null;if(!n)return;let r=I.get(n);r&&(0,u.waehleAuswahl)((0,u.geberIdVon)(e),r.row),(0,p.runEvent)(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(p.meldeKettenFehler)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&I.has(e))??null;n&&(L={card:n,board:e},t.dataTransfer?.setData(`text/plain`,I.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{L?.card===n&&n.setAttribute(z,``)},0))}),e.addEventListener(`dragend`,U),e.addEventListener(`dragover`,t=>{let n=G(e,t);if(L?.board!==e||!n){H(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),H(W(e,t,E)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&H(null)}),e.addEventListener(`drop`,t=>{let n=G(e,t);n&&(t.preventDefault(),K(e,n,W(e,t,E)),U())}))}var J=(0,d.macheDatenAnschluss)({hydriere:F,verdrahte:q}),Y=J.connect,X=J.disconnect,Z=x.blockType,Q=class extends t.BasicBlock{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Z]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:Z}}static{this.templateChild={type:n.CardBlock.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:r.LEER_TEXT_STANDARD}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Feld, das die Spalte bestimmt. Leer: alle in die Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Einträge des gewählten Tages.`,kind:`field`},(0,r.leerTextProperty)()]}static{this.defaultChildren=[{type:Z,props:{heading:`Offen`,variant:`warning`},children:[{type:n.CardBlock.blockType}]},{type:Z,props:{heading:`In Arbeit`,variant:`info`}},{type:Z,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[t.BasicBlock.styles,e.css`
