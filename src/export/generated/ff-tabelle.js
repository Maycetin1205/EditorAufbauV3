(function(e,t,n,r,i,a,o,s,c,l,u,d,f,p,m,h,g,ee,te,ne,_,re,v,ie){var ae=Object.defineProperty,oe=(e,t)=>{let n={};for(var r in e)ae(n,r,{get:e[r],enumerable:!0});return t||ae(n,Symbol.toStringTag,{value:`Module`}),n};function se(e,t,n=new Set){let r=e=>e.versteckt===!0||n.has(e.kennung);if(t||!e.some(r))return{spalten:e,plaetze:e.map((e,t)=>t)};let i=[],a=[];return e.forEach((e,t)=>{r(e)||(i.push(e),a.push(t))}),i.length===0&&e.length>0?{spalten:[e[0]],plaetze:[0]}:{spalten:i,plaetze:a}}var y=`Spalte {n}`;function b(e){return y.replace(`{n}`,String(e+1))}function x(e){return{kennung:``,titel:b(e),feld:``}}function S(e){let t=(0,p.kennungenVergeben)(e.map(e=>e.kennung));return e.map((e,n)=>e.kennung===t[n]?e:{...e,kennung:t[n]})}function ce(e,t){let n=t.trim();return n===``?-1:e.findIndex(e=>e.kennung===n)}function C(){return S([x(0)])}function le(e){let t=typeof e==`number`?e:Number(e);if(!Number.isFinite(t))return;let n=Math.round(t);return n<40?40:n}var ue=120,de=2e3;function w(e){if(e==null||e===``)return;let t=typeof e==`number`?e:Number(e);if(Number.isFinite(t))return Math.min(de,Math.max(ue,Math.round(t)))}function fe(e,t){if(e&&typeof e==`object`){let n=e,r=n.breite===void 0?void 0:le(n.breite);return{kennung:typeof n.kennung==`string`?n.kennung.trim():``,titel:typeof n.titel==`string`?n.titel:b(t),feld:typeof n.feld==`string`?n.feld:``,...r===void 0?{}:{breite:r},...typeof n.summe==`boolean`?{summe:n.summe}:{},...typeof n.aenderbar==`boolean`?{aenderbar:n.aenderbar}:{},...typeof n.versteckt==`boolean`?{versteckt:n.versteckt}:{},...typeof n.fuellFeld==`string`&&n.fuellFeld.trim()!==``?{fuellFeld:n.fuellFeld.trim()}:{},...Array.isArray(n.fensterSpalten)&&n.fensterSpalten.length>0?{fensterSpalten:n.fensterSpalten.map((e,t)=>fe(e,t))}:{},...w(n.fensterBreite)===void 0?{}:{fensterBreite:w(n.fensterBreite)},...w(n.fensterHoehe)===void 0?{}:{fensterHoehe:w(n.fensterHoehe)}}}return typeof e==`string`?{...x(t),titel:e}:x(t)}function T(e){let t;if(Array.isArray(e))t=e.map((e,t)=>fe(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>x(e))}else t=C();return t.length<1&&(t=[x(0)]),S(t)}function pe(e){try{return T(JSON.parse(e))}catch{return C()}}function me(e,t=()=>void 0){let n=e.map((e,n)=>t(n)??e.breite),r=n.filter(e=>e!==void 0),i=r.length===0?1:Math.max(1,Math.round(r.reduce((e,t)=>e+t,0)/r.length));return n.map(e=>`minmax(0, ${e??i}fr)`).join(` `)}function he(e){return S([...e,x(e.length)])}function ge(e,t,n){let r=(0,i.rechnungVonAttribut)(e);if(!r)return null;let a=new Set(n.map(e=>e.kennung)),o=t.map(e=>e.kennung).filter(e=>e!==``&&!a.has(e)),s=(0,i.ohneSpalten)(r,o);return s===r?null:(0,i.rechnungAlsAttribut)(s)}function _e(e,t){return e.length<=1||t<0||t>=e.length?e:e.filter((e,n)=>n!==t)}function ve(e,t,n){if(t<0||t>=e.length)return e;let r=Math.max(0,Math.min(n,e.length-1));if(r===t)return e;let i=[...e],[a]=i.splice(t,1);return i.splice(r,0,a),i}function ye(e){return pe(e.getAttribute(`spalten`)??``)}function E(e,t){let n=(0,l.findRuntimeDataSource)((0,r.seGlobal)().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?(0,l.satzIndexVon)(n,t):``}function be(e){let t=(0,l.findRuntimeDataSource)((0,r.seGlobal)().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return t!==void 0&&t.indexField!==``}function xe(e,t){t&&e.vergissGeschriebene();let n=(0,g.holeDatenVorspann)(e);if(!n){e.datenzeilen=[];return}let r=ye(e),{rows:i,gefiltert:a}=(0,o.zeilenNachAuswahl)(e,n.zeilen);(0,o.auswahlWiederfinden)((0,o.geberIdVon)(e),i,e=>e);let s=n.lies;e.datenGeliefert=!0,e.rohzeilen=i,e.durchAuswahlGefiltert=a,e.datenzeilen=i.map(e=>r.map(t=>t.feld===``?``:s(e,t.feld)))}var Se=(0,h.macheDatenAnschluss)({hydriere:xe}),Ce=Se.connect,D=Se.disconnect;function we(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen])}}var Te=`ff-zeile-aktiviert`,O=`data-ff-roh`;function Ee(e,t){e.dispatchEvent(new CustomEvent(Te,{detail:t,bubbles:!0,composed:!0}))}var De=class{constructor(e){this.eigenesMerkmal=``,this.letzterPlatz=null,this.baustein=e}get geberId(){return(0,o.geberIdVon)(this.baustein)}get merkmal(){let e=this.geberId;return e===``?this.eigenesMerkmal:(0,o.merkmalVon)((0,o.auswahlFuer)(e))}platzIn(e){let t=this.merkmal;if(t===``)return-1;let n=this.letzterPlatz;if(n!==null&&n.zeilen===e&&n.merkmal===t)return n.platz;let r=e.findIndex(e=>(0,o.merkmalVon)(e)===t);return this.letzterPlatz={zeilen:e,merkmal:t,platz:r},r}schalte(e){let t=(0,o.merkmalVon)(e),n=this.geberId;return n===``?(this.eigenesMerkmal=this.eigenesMerkmal===t?``:t,this.eigenesMerkmal!==``):((0,o.waehleAuswahl)(n,e),t!==``&&(0,o.merkmalVon)((0,o.auswahlFuer)(n))===t)}vergiss(){this.eigenesMerkmal=``,this.letzterPlatz=null}};function Oe(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(O);return r===null||r===``?null:Number(r)}function ke(e,t){if(!(e instanceof HTMLElement))return!1;let n=e.closest(`.zeile`),r=n?.parentElement;if(!n||!r)return!1;let i=[...r.querySelectorAll(`.zeile[${O}]`)],a=i.indexOf(n),o=a===-1?void 0:i[a+t];return o?(o.focus(),o.scrollIntoView?.({block:`nearest`}),!0):!1}function Ae(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.zeile[${O}]`);return t?(t.focus(),!0):!1}function je(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.suchzeile input`);return t?(t.focus(),!0):!1}function Me(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}function Ne(e,t,n,r,i){if(r===null||e.hasAttribute(`data-ff-editor`))return;let a=n[r];if(a!==void 0){if(!t.schalte(a)){Ee(e,{rohzeile:a,rohIndex:-1,ansichtIndex:i});return}Ee(e,{rohzeile:a,rohIndex:r,ansichtIndex:i}),(0,m.runEvent)(e,`onRowClick`,{PINDEX:E(e,a)}).catch(m.meldeKettenFehler)}}function Pe(e,t,n){if(n===null||e.hasAttribute(`data-ff-editor`))return;let r=t[n];r!==void 0&&(0,m.runEvent)(e,`onRowDblClick`,{PINDEX:E(e,r)}).catch(m.meldeKettenFehler)}var Fe=oe({FENSTER_BREITE:()=>520,FENSTER_HOEHE:()=>380,NACHSCHLAG_SPALTEN_BINDUNG:()=>Le,automatikSpalten:()=>z,coerceNachschlagSpalten:()=>A,einzigenTrefferFinden:()=>He,fensterBreiteFuer:()=>k,fensterSpaltenOder:()=>j,folgeBeimVerlassen:()=>We,holeEintraege:()=>Ve,nachschlagEintraege:()=>M,nachschlagFeldTpl:()=>Ie,oeffneNachschlagen:()=>V,quellenZeilen:()=>N,satzPasstZurAuswahl:()=>Ue,schliesseNachschlagenFuer:()=>R,spaltenStellenTpl:()=>qe});function k(e){return Math.min(900,Math.max(520,160+180*e))}function Ie(t){return e.html`<div class="nachschlag">
    <input
      class="ctrl"
      type="text"
      .value=${t.wert}
    ...
    ${t.liste}
  </div>`}var Le={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:y,quelleProp:`nachschlagQuelle`};function A(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?T(e):[]}function j(e,t){let n=A(e);return n.length>0?n:t()}function Re(e,t){let n=e[0];return n===void 0?t:n.feld}function ze(e,t){let n=e.trim();return n===``||n===t.trim()}function M(e,t,n){let r=t.trim(),i=[],a=ze(t,n),o=new Set;for(let t of e){let e=(0,l.getField)(t,n).trim(),s=r===``?e:(0,l.getField)(t,r).trim();if(s!==``||e!==``){if(a){if(o.has(e))continue;o.add(e)}i.push({anzeige:s,wert:e,satz:t})}}return i}function Be(e,t,n,r){return M((0,o.zeilenNachAuswahl)(e,t).rows,n,r)}function N(e){let t=(0,l.findRuntimeDataSource)((0,r.seGlobal)().FF_DATA_SOURCES,e);return t?(0,l.rowsFor)((0,r.seGlobal)().SEDATA,t.name,t.tableId,t.offenerSatz):null}function Ve(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=N(e.quelleId);if(t===null)return{ok:!1,grund:`quelleFehlt`};let n=Re(A([...e.spalten]),e.speicherFeld);return{ok:!0,eintraege:Be(e.el,t,n,e.speicherFeld)}}function He(e,t){return t&&e.length===1?e[0]:null}function Ue(e,t){let{rows:n,gefiltert:r}=(0,o.zeilenNachAuswahl)(e,[t]);return!r||n.length>0}function We(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var P=null,F=null,I=null;function Ge(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function L(e=!0){let t=e?I:null;I=null,P?.remove(),P=null,F=null,t?.focus()}function R(e){F===e&&L(!1)}function z(e){return[{kennung:``,titel:e.speicherTitel===``?`Wert`:e.speicherTitel,feld:e.speicherFeld}]}function B(t){let n=e=>e.stopPropagation(),r=t.editor;return e.html`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >${t.inhalt}</ff-dialog-rahmen>`}function Ke(t,n){let r=A([...t.spalten]),i=ze(Re(r,t.speicherFeld),t.speicherFeld);return e.html`<ff-tabelle
    fuellt
    suche="ja"
    spaltenwahl="ja"
    style="--se-r-lg:0px"
  ...
  ></ff-tabelle>`}function V(t){let n=t.eintraege;if(n===void 0){let e=Ve(t);if(!e.ok){(0,u.meldeFehler)(e.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}n=e.eintraege}L(!1);let r=document.createElement(`div`);r.style.display=`contents`,(0,e.render)(B({titel:t.titel,breite:t.breite,hoehe:t.hoehe,inhalt:Ke(t,n),onSchliessen:()=>L()}),r);let i=r.querySelector(f.DIALOG_RAHMEN_TAG),a=r.querySelector(`ff-tabelle`);a?.addEventListener(Te,e=>{let r=e.detail,i=n[r.rohIndex];i&&(L(),t.onUebernehmen(i.anzeige,i.wert,i.satz))}),I=t.rueckFokus??Ge(t.el),document.body.appendChild(r),P=r,F=t.el;let o=t.suchtext??``;a&&o!==``&&a.setzeSuchtext(o),i&&a&&Promise.all([i.updateComplete,a.updateComplete]).then(()=>{i.isConnected&&a.fokussiereSuche()})}function qe(t){return B({titel:t.titel,breite:t.breite,hoehe:t.hoehe,onSchliessen:t.onSchliessen,editor:{onGroesse:t.onGroesse},inhalt:e.html`<ff-tabelle
      data-ff-editor
      fuellt
      suche="ja"
      style="--se-r-lg:0px"
  ...
  ></span>`)}var zt=class{constructor(e){this._breiten=new Map,this._vorZug=null,this.wirt=e}breiteVon(e){return this._breiten.get(e)}vergessen(){this._breiten.clear()}voll(e){return e.map(e=>({index:this.wirt.vollerPlatz(e.index),breite:e.breite}))}wirtFuerZug(){return{zeige:e=>{let t=this.voll(e);this._vorZug===null&&(this._vorZug=new Map(t.map(e=>[e.index,this._breiten.get(e.index)])));for(let e of t)this._breiten.set(e.index,e.breite);this.wirt.melde()},uebernimm:e=>{let t=this.voll(e);if(this._vorZug=null,!this.wirt.imEditor()){for(let e of t)this._breiten.set(e.index,e.breite);this.wirt.melde();return}let n=this.wirt.spaltenListe();for(let e of t)e.index>=n.length||(this._breiten.delete(e.index),n[e.index]={...n[e.index],breite:e.breite});this.wirt.schreibeSpalten(n)},verwirf:()=>{let e=this._vorZug;if(this._vorZug=null,e){for(let[t,n]of e)n===void 0?this._breiten.delete(t):this._breiten.set(t,n);this.wirt.melde()}}}}};function Bt(e){if(!Array.isArray(e))return null;let t=e.filter(e=>typeof e==`string`);return t.length===0?null:t}var Vt=st(`ff_spaltenwahl_`,Bt);function Ht(t,n){if(t===null)return e.nothing;let r=t.waehlbar.filter(e=>!t.weg.has(e.kennung)).length;return e.html`<div class="sw-schirm" @pointerdown=${n.schliesse}></div>
    ...
    >
      ...
      ${t.weg.size===0?e.nothing:e.html`<button
        ...
        @click=${n.alleZeigen}
      >Alle zeigen</button>`}
    </div>`}var Ut=new Set,Wt=class{constructor(e){this._weg=null,this._offen=null,this.nimmTaste=e=>{e.key===`Escape`&&this.schliesse()},this.wirt=e}get offen(){return this._offen}weg(){return this.wirt.an()?(this._weg===null&&(this._weg=new Set(Vt.lies(this.wirt.baustein)??[])),this._weg):Ut}oeffne(e,t){e.preventDefault(),e.stopPropagation(),this._offen={links:Math.max(4,Math.min(e.clientX-t.left,Math.max(4,t.width-170))),oben:Math.max(4,Math.min(e.clientY-t.top,Math.max(4,t.height-60)))},window.addEventListener(`keydown`,this.nimmTaste),this.wirt.melde()}schliesse(){this._offen!==null&&(this._offen=null,window.removeEventListener(`keydown`,this.nimmTaste),this.wirt.melde())}schalte(e){let t=new Set(this.weg());t.has(e)?t.delete(e):t.add(e),this.merke(t)}alleZeigen(){this.merke(new Set)}merke(e){this._weg=e,Vt.merke(this.wirt.baustein,e.size===0?null:[...e]),this.wirt.breitenVergessen(),this.wirt.melde()}loese(){window.removeEventListener(`keydown`,this.nimmTaste),this._offen=null}};function Gt(e,t){let n=[];return e.spalten.forEach((r,i)=>{if(r.summe!==!0)return;let a=vt(t.map(t=>e.wertVon(t,i)),yt.min,yt.max);a!==``&&n.push({titel:r.titel,text:a})}),n}function Kt(e){return e.datenzeilen.map((t,n)=>e.spalten.map((t,r)=>e.wertVon(n,r)))}function qt(e){let t=Kt(e),n=Yt(t,e.suchtext);return e.sortSpalte<0?n:ht(n.map(e=>t[e]),e.sortSpalte,e.sortAuf).map(e=>n[e])}function Jt(e){let t=e.gezeichnet??e.spalten,n=e.plaetze??t.map((e,t)=>t),r={gridTemplateColumns:me(t,t=>e.breiteVon?.(n[t]??t))},i=e.gemessen?.zeilenHoehe??28,a=e.hatQuelle,o=!e.erfassungAn&&Zt(a,e.datenGeliefert,e.datenzeilen.length),s=qt(e),c=e.erfassungAn?1+e.erfassteAnzahl:0,l=e.gemessen===null?null:Math.max(1,e.gemessen.passen-c),u={sichtbar:s,hatQuelle:a,proSeite:l??Math.max(1,10-c),wunschSeite:e.wunschSeite,platzhalterZeilen:Et(l)},{seiten:d,seite:f,zeilen:p}=e.blaettert?jt(u):At(u);return{cols:r,takt:28,zeilenHoehe:i,hatQuelle:a,leer:o,gesamt:s.length,seiten:d,seite:f,zeilen:p,linealTakte:kt(l,p.length),summen:Gt(e,s)}}function Yt(e,t){let n=[];return e.forEach((e,r)=>{(0,re.zeilePasst)(e,t)&&n.push(r)}),n}function Xt(e,t){return!e&&t.trim()!==``}function Zt(e,t,n){return e&&t&&n===0}function Qt(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}var $t=[(0,v.jaNeinProperty)(`tabelleAnsicht`,`Suchzeile`,`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,{requiresDataSource:!0}),(0,v.jaNeinProperty)(`erfassung`,`Erfassungszeile`,`Eine leere Zeile zum Tippen neuer Positionen.`),(0,v.jaNeinProperty)(`loeschbar`,`Zeilen löschbar`,`Kreuz an jeder Zeile: merkt sie zum Löschen vor.`,{requiresDataSource:!0}),(0,v.jaNeinProperty)(`blaettern`,`Blättern`,`Ja: Seiten mit Blätter-Knöpfen. Nein: alles untereinander, der Rumpf rollt.`),(0,v.jaNeinProperty)(`kopfzeile`,`Kopfzeile`,`Aus: keine Titelzeile, kein Sortieren per Titelklick.`),(0,v.jaNeinProperty)(`spaltenwahl`,`Spaltenwahl`,`In der Maske: Rechtsklick auf eine Spaltenüberschrift nimmt Spalten weg und holt sie zurück. Braucht die Kopfzeile.`),{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Sätze des gewählten Tages.`,kind:`field`},(0,s.leerTextProperty)()],Z={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,kennungKey:`kennung`,standardTitel:y,eintragNeu:e=>{let t=T(e.spalten);return t.length>=16?{}:{spalten:he(t)}},eintragWeg:(e,t)=>{let n=T(e.spalten),r=_e(n,t);if(r===n)return{};let i=ge(e.rechnung,n,r);return{spalten:[...r],...i===null?{}:{rechnung:i}}},eintragVerschieben:(e,t,n)=>{let r=T(e.spalten),i=ve(r,t,n);return i===r?{}:{spalten:[...i]}},eintragsUnterFenster:{label:`Suchfenster…`,hinweis:`Ohne Einstellung nimmt es die Spalten derselben Hilfsquelle.`,eigenschaft:`fensterDialogIndex`},eintragStellen:`[data-ff-eintrag]`,eintragsSchalter:[{key:`summe`,label:`Summe in der Fußzeile`,kurz:`Summe`},{key:`aenderbar`,label:`In der Zeile änderbar`,kurz:`änderbar`,standard:!0,nurEigeneQuelle:!0},{key:`versteckt`,label:`In der Maske ausblenden`,kurz:`ausgeblendet`}],herkunftProp:`spaltenHerkunft`,eintragsFeldWahl:[{key:`fuellFeld`,label:`Nachschlagen`,hinweis:`Beim Erfassen füllt der gewählte Satz der Hilfsquelle diese Zelle.`,nurFremdeQuellen:!0}]};function en(e){let t=e,n=Z.eintragsSchalter?.find(e=>e.key===`aenderbar`);return n!==void 0&&e.feld!==``&&(0,p.schalterFuer)(Z,t).includes(n)&&(0,p.schalterAn)(n,t)}function tn(t){if(t.linealTakte===0)return e.nothing;let r=t.linealTakte===null?t.cols:{...t.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${t.linealTakte})`};return e.html`<div class="lineal" role="presentation" style=${(0,n.styleMap)(r)}>
          ${t.spalten.map(()=>e.html`<div></div>`)}
        </div>`}function nn(t,r){return e.html`
      ${t.zeigeSuche?e.html`<div class="suchzeile">
        <input
          ...
          @keydown=${e=>{e.key===`ArrowDown`&&Ae(e.target)&&e.preventDefault()}}
        />
      </div>`:``}
      ...
      ${t.zeigeKopf?e.html`<div class="kopf" role="row" style=${(0,n.styleMap)(t.cols)}>
        ...
        ${t.zeilen.map((i,a)=>{let o=i!==null&&!t.imEditor,s=i!==null&&t.zeilenStand.istGeloescht(i),c=i===null?{status:`gebucht`,titel:``}:t.zeilenStand.statusVon(i);return e.html`<div
            ...
            @keydown=${e=>{if(!e.target.closest(`.zell-eingabe, button`)){if(e.key===`ArrowDown`||e.key===`ArrowUp`){let t=e.key===`ArrowUp`;(ke(e.target,t?-1:1)||t&&je(e.target))&&e.preventDefault();return}if(e.key===`Delete`&&t.loeschbar&&i!==null&&!t.imEditor){e.preventDefault(),r.schalteLoeschung(i);return}e.key===`Enter`&&(e.preventDefault(),r.aktiviereZeile(i,a))}}}
          >
            ${``}
            ${t.spalten.map((n,r)=>{let o=t.plaetze[r],s=i===null?`—`:t.datenzeilen[i]?.[o]??``,l=t.imEditor&&!t.zeigeKopf&&t.editable;if(t.aendernMoeglich&&i!==null&&en(n)){let r=t.zeilenStand;return e.html`<div class="tippbar" role="cell">
                <input
              ...
              >${(0,ie.markiereTreffer)(s,t.suchtext)}${d}</div>`})}
      ...
      ${Ht(t.spaltenwahl,r.spaltenwahl)}
    `}function rn(t,n){let r=t.hatQuelle||t.erfassungAn||t.seiten>1||t.summen.length>0||t.suchtAktiv||t.auswahlAktiv;if(t.leer||!r)return e.nothing;let i=t.buchen;return e.html`<div class="fusszeile">
    <div class="seiten-info">${Qt({hatQuelle:t.hatQuelle,sichtbar:t.sichtbar,gesamt:t.gesamt,suchtAktiv:t.suchtAktiv,auswahlAktiv:t.auswahlAktiv})}</div>
