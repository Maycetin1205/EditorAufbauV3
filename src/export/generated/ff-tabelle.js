(function(e,t,n,r,i,a,o,s,c,l,u,d,f,p,m,h,g,ee,te,_,v,ne,y,re){var ie=Object.defineProperty,ae=(e,t)=>{let n={};for(var r in e)ie(n,r,{get:e[r],enumerable:!0});return t||ie(n,Symbol.toStringTag,{value:`Module`}),n};function b(e,t,n=new Set){let r=e=>e.versteckt===!0||n.has(e.kennung);if(t||!e.some(r))return{spalten:e,plaetze:e.map((e,t)=>t)};let i=[],a=[];return e.forEach((e,t)=>{r(e)||(i.push(e),a.push(t))}),i.length===0&&e.length>0?{spalten:[e[0]],plaetze:[0]}:{spalten:i,plaetze:a}}var x=`Spalte {n}`;function oe(e){return x.replace(`{n}`,String(e+1))}function S(e){return{kennung:``,titel:oe(e),feld:``}}function C(e){let t=(0,p.kennungenVergeben)(e.map(e=>e.kennung));return e.map((e,n)=>e.kennung===t[n]?e:{...e,kennung:t[n]})}function se(e,t){let n=t.trim();return n===``?-1:e.findIndex(e=>e.kennung===n)}function w(){return C([S(0)])}function ce(e){let t=typeof e==`number`?e:Number(e);if(!Number.isFinite(t))return;let n=Math.round(t);return n<40?40:n}var le=120,ue=2e3;function T(e){if(e==null||e===``)return;let t=typeof e==`number`?e:Number(e);if(Number.isFinite(t))return Math.min(ue,Math.max(le,Math.round(t)))}function de(e,t){if(e&&typeof e==`object`){let n=e,r=n.breite===void 0?void 0:ce(n.breite);return{kennung:typeof n.kennung==`string`?n.kennung.trim():``,titel:typeof n.titel==`string`?n.titel:oe(t),feld:typeof n.feld==`string`?n.feld:``,...r===void 0?{}:{breite:r},...typeof n.summe==`boolean`?{summe:n.summe}:{},...typeof n.aenderbar==`boolean`?{aenderbar:n.aenderbar}:{},...typeof n.versteckt==`boolean`?{versteckt:n.versteckt}:{},...typeof n.fuellFeld==`string`&&n.fuellFeld.trim()!==``?{fuellFeld:n.fuellFeld.trim()}:{},...Array.isArray(n.fensterSpalten)&&n.fensterSpalten.length>0?{fensterSpalten:n.fensterSpalten.map((e,t)=>de(e,t))}:{},...T(n.fensterBreite)===void 0?{}:{fensterBreite:T(n.fensterBreite)},...T(n.fensterHoehe)===void 0?{}:{fensterHoehe:T(n.fensterHoehe)}}}return typeof e==`string`?{...S(t),titel:e}:S(t)}function E(e){let t;if(Array.isArray(e))t=e.map((e,t)=>de(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>S(e))}else t=w();return t.length<1&&(t=[S(0)]),C(t)}function fe(e){try{return E(JSON.parse(e))}catch{return w()}}function pe(e,t=()=>void 0){let n=e.map((e,n)=>t(n)??e.breite),r=n.filter(e=>e!==void 0),i=r.length===0?1:Math.max(1,Math.round(r.reduce((e,t)=>e+t,0)/r.length));return n.map(e=>`minmax(0, ${e??i}fr)`).join(` `)}function me(e){return C([...e,S(e.length)])}function he(e,t,n){let r=(0,i.rechnungVonAttribut)(e);if(!r)return null;let a=new Set(n.map(e=>e.kennung)),o=t.map(e=>e.kennung).filter(e=>e!==``&&!a.has(e)),s=(0,i.ohneSpalten)(r,o);return s===r?null:(0,i.rechnungAlsAttribut)(s)}function ge(e,t){return e.length<=1||t<0||t>=e.length?e:e.filter((e,n)=>n!==t)}function _e(e,t,n){if(t<0||t>=e.length)return e;let r=Math.max(0,Math.min(n,e.length-1));if(r===t)return e;let i=[...e],[a]=i.splice(t,1);return i.splice(r,0,a),i}function ve(e){return fe(e.getAttribute(`spalten`)??``)}function D(e,t){let n=(0,l.findRuntimeDataSource)((0,r.seGlobal)().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?(0,l.satzIndexVon)(n,t):``}function ye(e){let t=(0,l.findRuntimeDataSource)((0,r.seGlobal)().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return t!==void 0&&t.indexField!==``}function be(e,t){t&&e.vergissGeschriebene();let n=(0,g.holeDatenVorspann)(e);if(!n){e.datenzeilen=[];return}let r=ve(e),{rows:i,gefiltert:a}=(0,o.zeilenNachAuswahl)(e,n.zeilen),s=(0,o.auswahlWiederfinden)((0,o.geberIdVon)(e),i,e=>e)[0]??-1,c=n.lies;e.datenGeliefert=!0,e.rohzeilen=i,e.auswahlIndex=s,e.durchAuswahlGefiltert=a,e.datenzeilen=i.map(e=>r.map(t=>t.feld===``?``:c(e,t.feld)))}var xe=(0,h.macheDatenAnschluss)({hydriere:be}),O=xe.connect,k=xe.disconnect;function Se(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen])}}var A=`ff-zeile-aktiviert`,j=`data-ff-roh`;function M(e,t){e.dispatchEvent(new CustomEvent(A,{detail:t,bubbles:!0,composed:!0}))}function Ce(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(j);return r===null||r===``?null:Number(r)}function we(e,t){if(!(e instanceof HTMLElement))return!1;let n=e.closest(`.zeile`),r=n?.parentElement;if(!n||!r)return!1;let i=[...r.querySelectorAll(`.zeile[${j}]`)],a=i.indexOf(n),o=a===-1?void 0:i[a+t];return o?(o.focus(),o.scrollIntoView?.({block:`nearest`}),!0):!1}function Te(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.zeile[${j}]`);return t?(t.focus(),!0):!1}function Ee(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.suchzeile input`);return t?(t.focus(),!0):!1}function De(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}function Oe(e,t,n,r){if(n===null||e.hasAttribute(`data-ff-editor`))return;let i=t[n];if(i===void 0)return;let a=e,s=a.auswahlIndex===n;a.auswahlIndex=s?-1:n;let c=(0,o.geberIdVon)(e);s?(c!==``&&(0,o.klareAuswahl)(c),M(e,{rohzeile:i,rohIndex:-1,ansichtIndex:r})):(c!==``&&(0,o.setzeAuswahl)(c,i,!0),M(e,{rohzeile:i,rohIndex:n,ansichtIndex:r}),(0,m.runEvent)(e,`onRowClick`,{PINDEX:D(e,i)}).catch(m.meldeKettenFehler))}function ke(e,t,n){if(n===null||e.hasAttribute(`data-ff-editor`))return;let r=t[n];r!==void 0&&(0,m.runEvent)(e,`onRowDblClick`,{PINDEX:D(e,r)}).catch(m.meldeKettenFehler)}var Ae=ae({FENSTER_BREITE:()=>520,FENSTER_HOEHE:()=>380,NACHSCHLAG_SPALTEN_BINDUNG:()=>Me,automatikSpalten:()=>He,coerceNachschlagSpalten:()=>P,einzigenTrefferFinden:()=>Le,fensterBreiteFuer:()=>N,folgeBeimVerlassen:()=>ze,holeEintraege:()=>Ie,nachschlagEintraege:()=>F,nachschlagFeldTpl:()=>je,oeffneNachschlagen:()=>We,quellenZeilen:()=>I,satzPasstZurAuswahl:()=>Re,schliesseNachschlagenFuer:()=>Ve,spaltenStellenTpl:()=>Ge});function N(e){return Math.min(900,Math.max(520,160+180*e))}function je(t){return e.html`<div class="nachschlag">
  ...
  >${t.inhalt}</ff-dialog-rahmen>`}function Ue(t,n){let r=P([...t.spalten]),i=Pe(Ne(r,t.speicherFeld),t.speicherFeld);return e.html`<ff-tabelle
    fuellt
    suche="ja"
    spaltenwahl="ja"
    style="--se-r-lg:0px"
  ...
  ></ff-tabelle>`}function We(t){let n=t.eintraege;if(n===void 0){let e=Ie(t);if(!e.ok){(0,u.meldeFehler)(e.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}n=e.eintraege}B(!1);let r=document.createElement(`div`);r.style.display=`contents`,(0,e.render)(V({titel:t.titel,breite:t.breite,hoehe:t.hoehe,inhalt:Ue(t,n),onSchliessen:()=>B()}),r);let i=r.querySelector(f.DIALOG_RAHMEN_TAG),a=r.querySelector(`ff-tabelle`);a?.addEventListener(A,e=>{let r=e.detail,i=n[r.rohIndex];i&&(B(),t.onUebernehmen(i.anzeige,i.wert,i.satz))}),z=t.rueckFokus??Be(t.el),document.body.appendChild(r),L=r,R=t.el;let o=t.suchtext??``;a&&o!==``&&a.setzeSuchtext(o),i&&a&&Promise.all([i.updateComplete,a.updateComplete]).then(()=>{i.isConnected&&a.fokussiereSuche()})}function Ge(t){return V({titel:t.titel,breite:t.breite,hoehe:t.hoehe,onSchliessen:t.onSchliessen,editor:{onGroesse:t.onGroesse},inhalt:e.html`<ff-tabelle
      data-ff-editor
      fuellt
      suche="ja"
      style="--se-r-lg:0px"
    ...
    ></ff-tabelle>`})}function Ke(t,n,r,i){return e.html`<input
    ...
    @blur=${()=>n.verlassen(i)}
  />`}function qe(t,n,r,i,a){if(a)return e.html`<div class="erf-halter">
      ${Ke(t,n,r,i)}
  ...
  ></span>`)}var Rt=class{constructor(e){this._breiten=new Map,this._vorZug=null,this.wirt=e}breiteVon(e){return this._breiten.get(e)}vergessen(){this._breiten.clear()}voll(e){return e.map(e=>({index:this.wirt.vollerPlatz(e.index),breite:e.breite}))}wirtFuerZug(){return{zeige:e=>{let t=this.voll(e);this._vorZug===null&&(this._vorZug=new Map(t.map(e=>[e.index,this._breiten.get(e.index)])));for(let e of t)this._breiten.set(e.index,e.breite);this.wirt.melde()},uebernimm:e=>{let t=this.voll(e);if(this._vorZug=null,!this.wirt.imEditor()){for(let e of t)this._breiten.set(e.index,e.breite);this.wirt.melde();return}let n=this.wirt.spaltenListe();for(let e of t)e.index>=n.length||(this._breiten.delete(e.index),n[e.index]={...n[e.index],breite:e.breite});this.wirt.schreibeSpalten(n)},verwirf:()=>{let e=this._vorZug;if(this._vorZug=null,e){for(let[t,n]of e)n===void 0?this._breiten.delete(t):this._breiten.set(t,n);this.wirt.melde()}}}}},zt=`ff_spaltenwahl_`,Bt=new Map;function Vt(e){let t=typeof document>`u`?``:document.title,n=e.getAttribute(_.ACTION_VALUE_ID_ATTR);if(n!==null&&n!==``)return`${zt}${t}|${n}`;let r=Array.from(e.ownerDocument?.querySelectorAll(e.tagName)??[]);return`${zt}${t}|#${Math.max(0,r.indexOf(e))}`}function Ht(e){let t=Bt.get(e);if(t)return new Set(t);try{let t=localStorage.getItem(e);if(t===null)return new Set;let n=JSON.parse(t);return Array.isArray(n)?new Set(n.filter(e=>typeof e==`string`)):new Set}catch{return new Set}}function Ut(e,t){let n=[...t];Bt.set(e,n);try{n.length===0?localStorage.removeItem(e):localStorage.setItem(e,JSON.stringify(n))}catch{}}function Wt(t,n){if(t===null)return e.nothing;let r=t.waehlbar.filter(e=>!t.weg.has(e.kennung)).length;return e.html`<div class="sw-schirm" @pointerdown=${n.schliesse}></div>
    ...
    >
      ...
      ${t.weg.size===0?e.nothing:e.html`<button
        ...
        @click=${n.alleZeigen}
      >Alle zeigen</button>`}
    </div>`}var Gt=new Set,Kt=class{constructor(e){this._weg=null,this._offen=null,this.nimmTaste=e=>{e.key===`Escape`&&this.schliesse()},this.wirt=e}get offen(){return this._offen}weg(){return this.wirt.an()?(this._weg===null&&(this._weg=Ht(Vt(this.wirt.baustein))),this._weg):Gt}oeffne(e,t){e.preventDefault(),e.stopPropagation(),this._offen={links:Math.max(4,Math.min(e.clientX-t.left,Math.max(4,t.width-170))),oben:Math.max(4,Math.min(e.clientY-t.top,Math.max(4,t.height-60)))},window.addEventListener(`keydown`,this.nimmTaste),this.wirt.melde()}schliesse(){this._offen!==null&&(this._offen=null,window.removeEventListener(`keydown`,this.nimmTaste),this.wirt.melde())}schalte(e){let t=new Set(this.weg());t.has(e)?t.delete(e):t.add(e),this.merke(t)}alleZeigen(){this.merke(new Set)}merke(e){this._weg=e,Ut(Vt(this.wirt.baustein),e),this.wirt.breitenVergessen(),this.wirt.melde()}loese(){window.removeEventListener(`keydown`,this.nimmTaste),this._offen=null}};function qt(e,t){let n=[];return e.spalten.forEach((r,i)=>{if(r.summe!==!0)return;let a=gt(t.map(t=>e.wertVon(t,i)),_t.min,_t.max);a!==``&&n.push({titel:r.titel,text:a})}),n}function Jt(e){return e.datenzeilen.map((t,n)=>e.spalten.map((t,r)=>e.wertVon(n,r)))}function Yt(e){let t=Jt(e),n=Zt(t,e.suchtext);return e.sortSpalte<0?n:ut(n.map(e=>t[e]),e.sortSpalte,e.sortAuf).map(e=>n[e])}function Xt(e){let t=e.gezeichnet??e.spalten,n=e.plaetze??t.map((e,t)=>t),r={gridTemplateColumns:pe(t,t=>e.breiteVon?.(n[t]??t))},i=e.gemessen?.zeilenHoehe??28,a=e.hatQuelle,o=!e.erfassungAn&&$t(a,e.datenGeliefert,e.datenzeilen.length),s=Yt(e),c=e.erfassungAn?1+e.erfassteAnzahl:0,l=e.gemessen===null?null:Math.max(1,e.gemessen.passen-c),u={sichtbar:s,hatQuelle:a,proSeite:l??Math.max(1,10-c),wunschSeite:e.wunschSeite,platzhalterZeilen:wt(l)},{seiten:d,seite:f,zeilen:p}=e.blaettert?kt(u):Ot(u);return{cols:r,takt:28,zeilenHoehe:i,hatQuelle:a,leer:o,gesamt:s.length,seiten:d,seite:f,zeilen:p,linealTakte:Dt(l,p.length),summen:qt(e,s)}}function Zt(e,t){let n=[];return e.forEach((e,r)=>{(0,ne.zeilePasst)(e,t)&&n.push(r)}),n}function Qt(e,t){return!e&&t.trim()!==``}function $t(e,t,n){return e&&t&&n===0}function en(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}var tn=[(0,y.jaNeinProperty)(`tabelleAnsicht`,`Suchzeile`,`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,{requiresDataSource:!0}),(0,y.jaNeinProperty)(`erfassung`,`Erfassungszeile`,`Eine leere Zeile zum Tippen neuer Positionen.`),(0,y.jaNeinProperty)(`loeschbar`,`Zeilen löschbar`,`Kreuz an jeder Zeile: merkt sie zum Löschen vor.`,{requiresDataSource:!0}),(0,y.jaNeinProperty)(`blaettern`,`Blättern`,`Ja: Seiten mit Blätter-Knöpfen. Nein: alles untereinander, der Rumpf rollt.`),(0,y.jaNeinProperty)(`kopfzeile`,`Kopfzeile`,`Aus: keine Titelzeile, kein Sortieren per Titelklick.`),(0,y.jaNeinProperty)(`spaltenwahl`,`Spaltenwahl`,`In der Maske: Rechtsklick auf eine Spaltenüberschrift nimmt Spalten weg und holt sie zurück. Braucht die Kopfzeile.`),{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Sätze des gewählten Tages.`,kind:`field`},(0,s.leerTextProperty)()],Z={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,kennungKey:`kennung`,standardTitel:x,eintragNeu:e=>{let t=E(e.spalten);return t.length>=16?{}:{spalten:me(t)}},eintragWeg:(e,t)=>{let n=E(e.spalten),r=ge(n,t);if(r===n)return{};let i=he(e.rechnung,n,r);return{spalten:[...r],...i===null?{}:{rechnung:i}}},eintragVerschieben:(e,t,n)=>{let r=E(e.spalten),i=_e(r,t,n);return i===r?{}:{spalten:[...i]}},eintragsUnterFenster:{label:`Suchfenster…`,hinweis:`Ohne Einstellung nimmt es die Spalten derselben Hilfsquelle.`,eigenschaft:`fensterDialogIndex`},eintragStellen:`[data-ff-eintrag]`,eintragsSchalter:[{key:`summe`,label:`Summe in der Fußzeile`,kurz:`Summe`},{key:`aenderbar`,label:`In der Zeile änderbar`,kurz:`änderbar`,standard:!0,nurEigeneQuelle:!0},{key:`versteckt`,label:`In der Maske ausblenden`,kurz:`ausgeblendet`}],herkunftProp:`spaltenHerkunft`,eintragsFeldWahl:[{key:`fuellFeld`,label:`Nachschlagen`,hinweis:`Beim Erfassen füllt der gewählte Satz der Hilfsquelle diese Zelle.`,nurFremdeQuellen:!0}]};function nn(e){let t=e,n=Z.eintragsSchalter?.find(e=>e.key===`aenderbar`);return n!==void 0&&e.feld!==``&&(0,p.schalterFuer)(Z,t).includes(n)&&(0,p.schalterAn)(n,t)}function rn(t){if(t.linealTakte===0)return e.nothing;let r=t.linealTakte===null?t.cols:{...t.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${t.linealTakte})`};return e.html`<div class="lineal" role="presentation" style=${(0,n.styleMap)(r)}>
          ${t.spalten.map(()=>e.html`<div></div>`)}
        </div>`}function an(t,r){return e.html`
      ...
      ${t.zeigeKopf?e.html`<div class="kopf" role="row" style=${(0,n.styleMap)(t.cols)}>
        ...
        ${t.zeilen.map((i,a)=>{let o=i!==null&&!t.imEditor,s=i!==null&&t.zeilenStand.istGeloescht(i),c=i===null?{status:`gebucht`,titel:``}:t.zeilenStand.statusVon(i);return e.html`<div
          ...
          >
            ${``}
            ${t.spalten.map((n,r)=>{let o=t.plaetze[r],s=i===null?`—`:t.datenzeilen[i]?.[o]??``,l=t.imEditor&&!t.zeigeKopf&&t.editable;if(t.aendernMoeglich&&i!==null&&nn(n)){let r=t.zeilenStand;return e.html`<div class="tippbar" role="cell">
                <input
      ...
      ${Wt(t.spaltenwahl,r.spaltenwahl)}
    `}function on(t,n){let r=t.hatQuelle||t.erfassungAn||t.seiten>1||t.summen.length>0||t.suchtAktiv||t.auswahlAktiv;if(t.leer||!r)return e.nothing;let i=t.buchen;return e.html`<div class="fusszeile">
    <div class="seiten-info">${en({hatQuelle:t.hatQuelle,sichtbar:t.sichtbar,gesamt:t.gesamt,suchtAktiv:t.suchtAktiv,auswahlAktiv:t.auswahlAktiv})}</div>
