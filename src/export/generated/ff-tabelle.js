(function(e,t,n,r,i,a,o,s,c,l,u,d,f,p,m,h,g,ee,te,ne,_,re,v,ie){var ae=Object.defineProperty,oe=(e,t)=>{let n={};for(var r in e)ae(n,r,{get:e[r],enumerable:!0});return t||ae(n,Symbol.toStringTag,{value:`Module`}),n};function y(e,t,n=new Set){let r=e=>e.versteckt===!0||n.has(e.kennung);if(t||!e.some(r))return{spalten:e,plaetze:e.map((e,t)=>t)};let i=[],a=[];return e.forEach((e,t)=>{r(e)||(i.push(e),a.push(t))}),i.length===0&&e.length>0?{spalten:[e[0]],plaetze:[0]}:{spalten:i,plaetze:a}}var b=`Spalte {n}`;function x(e){return b.replace(`{n}`,String(e+1))}function S(e){return{kennung:``,titel:x(e),feld:``}}function C(e){let t=(0,p.kennungenVergeben)(e.map(e=>e.kennung));return e.map((e,n)=>e.kennung===t[n]?e:{...e,kennung:t[n]})}function se(e,t){let n=t.trim();return n===``?-1:e.findIndex(e=>e.kennung===n)}function w(){return C([S(0)])}function ce(e){let t=typeof e==`number`?e:Number(e);if(!Number.isFinite(t))return;let n=Math.round(t);return n<40?40:n}var le=120,ue=2e3;function T(e){if(e==null||e===``)return;let t=typeof e==`number`?e:Number(e);if(Number.isFinite(t))return Math.min(ue,Math.max(le,Math.round(t)))}function de(e,t){if(e&&typeof e==`object`){let n=e,r=n.breite===void 0?void 0:ce(n.breite);return{kennung:typeof n.kennung==`string`?n.kennung.trim():``,titel:typeof n.titel==`string`?n.titel:x(t),feld:typeof n.feld==`string`?n.feld:``,...r===void 0?{}:{breite:r},...typeof n.summe==`boolean`?{summe:n.summe}:{},...typeof n.aenderbar==`boolean`?{aenderbar:n.aenderbar}:{},...typeof n.versteckt==`boolean`?{versteckt:n.versteckt}:{},...typeof n.fuellFeld==`string`&&n.fuellFeld.trim()!==``?{fuellFeld:n.fuellFeld.trim()}:{},...Array.isArray(n.fensterSpalten)&&n.fensterSpalten.length>0?{fensterSpalten:n.fensterSpalten.map((e,t)=>de(e,t))}:{},...T(n.fensterBreite)===void 0?{}:{fensterBreite:T(n.fensterBreite)},...T(n.fensterHoehe)===void 0?{}:{fensterHoehe:T(n.fensterHoehe)}}}return typeof e==`string`?{...S(t),titel:e}:S(t)}function E(e){let t;if(Array.isArray(e))t=e.map((e,t)=>de(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>S(e))}else t=w();return t.length<1&&(t=[S(0)]),C(t)}function fe(e){try{return E(JSON.parse(e))}catch{return w()}}function pe(e,t=()=>void 0){let n=e.map((e,n)=>t(n)??e.breite),r=n.filter(e=>e!==void 0),i=r.length===0?1:Math.max(1,Math.round(r.reduce((e,t)=>e+t,0)/r.length));return n.map(e=>`minmax(0, ${e??i}fr)`).join(` `)}function me(e){return C([...e,S(e.length)])}function he(e,t,n){let r=(0,i.rechnungVonAttribut)(e);if(!r)return null;let a=new Set(n.map(e=>e.kennung)),o=t.map(e=>e.kennung).filter(e=>e!==``&&!a.has(e)),s=(0,i.ohneSpalten)(r,o);return s===r?null:(0,i.rechnungAlsAttribut)(s)}function ge(e,t){return e.length<=1||t<0||t>=e.length?e:e.filter((e,n)=>n!==t)}function _e(e,t,n){if(t<0||t>=e.length)return e;let r=Math.max(0,Math.min(n,e.length-1));if(r===t)return e;let i=[...e],[a]=i.splice(t,1);return i.splice(r,0,a),i}function ve(e){return fe(e.getAttribute(`spalten`)??``)}function D(e,t){let n=(0,l.findRuntimeDataSource)((0,r.seGlobal)().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?(0,l.satzIndexVon)(n,t):``}function ye(e){let t=(0,l.findRuntimeDataSource)((0,r.seGlobal)().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return t!==void 0&&t.indexField!==``}function be(e,t){t&&e.vergissGeschriebene();let n=(0,g.holeDatenVorspann)(e);if(!n){e.datenzeilen=[];return}let r=ve(e),{rows:i,gefiltert:a}=(0,o.zeilenNachAuswahl)(e,n.zeilen);(0,o.auswahlWiederfinden)((0,o.geberIdVon)(e),i,e=>e);let s=n.lies;e.datenGeliefert=!0,e.rohzeilen=i,e.durchAuswahlGefiltert=a,e.datenzeilen=i.map(e=>r.map(t=>t.feld===``?``:s(e,t.feld)))}var O=(0,h.macheDatenAnschluss)({hydriere:be}),k=O.connect,A=O.disconnect;function xe(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen])}}var j=`ff-zeile-aktiviert`,M=`data-ff-roh`;function N(e,t){e.dispatchEvent(new CustomEvent(j,{detail:t,bubbles:!0,composed:!0}))}var Se=class{constructor(e){this.eigenesMerkmal=``,this.letzterPlatz=null,this.baustein=e}get geberId(){return(0,o.geberIdVon)(this.baustein)}get merkmal(){let e=this.geberId;return e===``?this.eigenesMerkmal:(0,o.merkmalVon)((0,o.auswahlFuer)(e))}platzIn(e){let t=this.merkmal;if(t===``)return-1;let n=this.letzterPlatz;if(n!==null&&n.zeilen===e&&n.merkmal===t)return n.platz;let r=e.findIndex(e=>(0,o.merkmalVon)(e)===t);return this.letzterPlatz={zeilen:e,merkmal:t,platz:r},r}schalte(e){let t=(0,o.merkmalVon)(e),n=this.geberId;return n===``?(this.eigenesMerkmal=this.eigenesMerkmal===t?``:t,this.eigenesMerkmal!==``):((0,o.waehleAuswahl)(n,e),t!==``&&(0,o.merkmalVon)((0,o.auswahlFuer)(n))===t)}vergiss(){this.eigenesMerkmal=``,this.letzterPlatz=null}};function Ce(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(M);return r===null||r===``?null:Number(r)}function we(e,t){if(!(e instanceof HTMLElement))return!1;let n=e.closest(`.zeile`),r=n?.parentElement;if(!n||!r)return!1;let i=[...r.querySelectorAll(`.zeile[${M}]`)],a=i.indexOf(n),o=a===-1?void 0:i[a+t];return o?(o.focus(),o.scrollIntoView?.({block:`nearest`}),!0):!1}function Te(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.zeile[${M}]`);return t?(t.focus(),!0):!1}function Ee(e){if(!(e instanceof HTMLElement))return!1;let t=e.closest(`.tabelle`)?.querySelector(`.suchzeile input`);return t?(t.focus(),!0):!1}function De(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}function Oe(e,t,n,r,i){if(r===null||e.hasAttribute(`data-ff-editor`))return;let a=n[r];if(a!==void 0){if(!t.schalte(a)){N(e,{rohzeile:a,rohIndex:-1,ansichtIndex:i});return}N(e,{rohzeile:a,rohIndex:r,ansichtIndex:i}),(0,m.runEvent)(e,`onRowClick`,{PINDEX:D(e,a)}).catch(m.meldeKettenFehler)}}function ke(e,t,n){if(n===null||e.hasAttribute(`data-ff-editor`))return;let r=t[n];r!==void 0&&(0,m.runEvent)(e,`onRowDblClick`,{PINDEX:D(e,r)}).catch(m.meldeKettenFehler)}var Ae=oe({FENSTER_BREITE:()=>520,FENSTER_HOEHE:()=>380,NACHSCHLAG_SPALTEN_BINDUNG:()=>Me,automatikSpalten:()=>He,coerceNachschlagSpalten:()=>F,einzigenTrefferFinden:()=>Le,fensterBreiteFuer:()=>P,folgeBeimVerlassen:()=>ze,holeEintraege:()=>Ie,nachschlagEintraege:()=>I,nachschlagFeldTpl:()=>je,oeffneNachschlagen:()=>Ge,quellenZeilen:()=>L,satzPasstZurAuswahl:()=>Re,schliesseNachschlagenFuer:()=>Ve,spaltenStellenTpl:()=>Ke});function P(e){return Math.min(900,Math.max(520,160+180*e))}function je(t){return e.html`<div class="nachschlag">
    ...
    ${t.liste}
  </div>`}var Me={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:b,quelleProp:`nachschlagQuelle`};function F(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?E(e):[]}function Ne(e,t){let n=e[0];return n===void 0?t:n.feld}function Pe(e,t){let n=e.trim();return n===``||n===t.trim()}function I(e,t,n){let r=t.trim(),i=[],a=Pe(t,n),o=new Set;for(let t of e){let e=(0,l.getField)(t,n).trim(),s=r===``?e:(0,l.getField)(t,r).trim();if(s!==``||e!==``){if(a){if(o.has(e))continue;o.add(e)}i.push({anzeige:s,wert:e,satz:t})}}return i}function Fe(e,t,n,r){return I((0,o.zeilenNachAuswahl)(e,t).rows,n,r)}function L(e){let t=(0,l.findRuntimeDataSource)((0,r.seGlobal)().FF_DATA_SOURCES,e);return t?(0,l.rowsFor)((0,r.seGlobal)().SEDATA,t.name,t.tableId,t.offenerSatz):null}function Ie(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=L(e.quelleId);if(t===null)return{ok:!1,grund:`quelleFehlt`};let n=Ne(F([...e.spalten]),e.speicherFeld);return{ok:!0,eintraege:Fe(e.el,t,n,e.speicherFeld)}}function Le(e,t){return t&&e.length===1?e[0]:null}function Re(e,t){let{rows:n,gefiltert:r}=(0,o.zeilenNachAuswahl)(e,[t]);return!r||n.length>0}function ze(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var R=null,z=null,B=null;function Be(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function V(e=!0){let t=e?B:null;B=null,R?.remove(),R=null,z=null,t?.focus()}function Ve(e){z===e&&V(!1)}function He(e){return[{kennung:``,titel:e.speicherTitel===``?`Wert`:e.speicherTitel,feld:e.speicherFeld}]}function Ue(t){let n=e=>e.stopPropagation(),r=t.editor;return e.html`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >${t.inhalt}</ff-dialog-rahmen>`}function We(t,n){let r=F([...t.spalten]),i=Pe(Ne(r,t.speicherFeld),t.speicherFeld);return e.html`<ff-tabelle
    fuellt
    suche="ja"
    spaltenwahl="ja"
    style="--se-r-lg:0px"
    .besitz=${`provided`}
    .spalten=${r.length>0?r:He(t)}
  ...
  ></ff-tabelle>`}function Ge(t){let n=t.eintraege;if(n===void 0){let e=Ie(t);if(!e.ok){(0,u.meldeFehler)(e.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}n=e.eintraege}V(!1);let r=document.createElement(`div`);r.style.display=`contents`,(0,e.render)(Ue({titel:t.titel,breite:t.breite,hoehe:t.hoehe,inhalt:We(t,n),onSchliessen:()=>V()}),r);let i=r.querySelector(f.DIALOG_RAHMEN_TAG),a=r.querySelector(`ff-tabelle`);a?.addEventListener(j,e=>{let r=e.detail,i=n[r.rohIndex];i&&(V(),t.onUebernehmen(i.anzeige,i.wert,i.satz))}),B=t.rueckFokus??Be(t.el),document.body.appendChild(r),R=r,z=t.el;let o=t.suchtext??``;a&&o!==``&&a.setzeSuchtext(o),i&&a&&Promise.all([i.updateComplete,a.updateComplete]).then(()=>{i.isConnected&&a.fokussiereSuche()})}function Ke(t){return Ue({titel:t.titel,breite:t.breite,hoehe:t.hoehe,onSchliessen:t.onSchliessen,editor:{onGroesse:t.onGroesse},inhalt:e.html`<ff-tabelle
      data-ff-editor
      fuellt
      suche="ja"
      style="--se-r-lg:0px"
    ...
    ></ff-tabelle>`})}function qe(t,n,r,i){return e.html`<input
    ...
    @blur=${()=>n.verlassen(i)}
  />`}function Je(t,n,r,i,a){if(a)return e.html`<div class="erf-halter">
      ${qe(t,n,r,i)}
  ...
  ></span>`)}var Lt=class{constructor(e){this._breiten=new Map,this._vorZug=null,this.wirt=e}breiteVon(e){return this._breiten.get(e)}vergessen(){this._breiten.clear()}voll(e){return e.map(e=>({index:this.wirt.vollerPlatz(e.index),breite:e.breite}))}wirtFuerZug(){return{zeige:e=>{let t=this.voll(e);this._vorZug===null&&(this._vorZug=new Map(t.map(e=>[e.index,this._breiten.get(e.index)])));for(let e of t)this._breiten.set(e.index,e.breite);this.wirt.melde()},uebernimm:e=>{let t=this.voll(e);if(this._vorZug=null,!this.wirt.imEditor()){for(let e of t)this._breiten.set(e.index,e.breite);this.wirt.melde();return}let n=this.wirt.spaltenListe();for(let e of t)e.index>=n.length||(this._breiten.delete(e.index),n[e.index]={...n[e.index],breite:e.breite});this.wirt.schreibeSpalten(n)},verwirf:()=>{let e=this._vorZug;if(this._vorZug=null,e){for(let[t,n]of e)n===void 0?this._breiten.delete(t):this._breiten.set(t,n);this.wirt.melde()}}}}};function Rt(e){if(!Array.isArray(e))return null;let t=e.filter(e=>typeof e==`string`);return t.length===0?null:t}var zt=it(`ff_spaltenwahl_`,Rt);function Bt(t,n){if(t===null)return e.nothing;let r=t.waehlbar.filter(e=>!t.weg.has(e.kennung)).length;return e.html`<div class="sw-schirm" @pointerdown=${n.schliesse}></div>
    ...
    >
      ...
      ${t.weg.size===0?e.nothing:e.html`<button
        ...
        @click=${n.alleZeigen}
      >Alle zeigen</button>`}
    </div>`}var Vt=new Set,Ht=class{constructor(e){this._weg=null,this._offen=null,this.nimmTaste=e=>{e.key===`Escape`&&this.schliesse()},this.wirt=e}get offen(){return this._offen}weg(){return this.wirt.an()?(this._weg===null&&(this._weg=new Set(zt.lies(this.wirt.baustein)??[])),this._weg):Vt}oeffne(e,t){e.preventDefault(),e.stopPropagation(),this._offen={links:Math.max(4,Math.min(e.clientX-t.left,Math.max(4,t.width-170))),oben:Math.max(4,Math.min(e.clientY-t.top,Math.max(4,t.height-60)))},window.addEventListener(`keydown`,this.nimmTaste),this.wirt.melde()}schliesse(){this._offen!==null&&(this._offen=null,window.removeEventListener(`keydown`,this.nimmTaste),this.wirt.melde())}schalte(e){let t=new Set(this.weg());t.has(e)?t.delete(e):t.add(e),this.merke(t)}alleZeigen(){this.merke(new Set)}merke(e){this._weg=e,zt.merke(this.wirt.baustein,e.size===0?null:[...e]),this.wirt.breitenVergessen(),this.wirt.melde()}loese(){window.removeEventListener(`keydown`,this.nimmTaste),this._offen=null}};function Ut(e,t){let n=[];return e.spalten.forEach((r,i)=>{if(r.summe!==!0)return;let a=ht(t.map(t=>e.wertVon(t,i)),gt.min,gt.max);a!==``&&n.push({titel:r.titel,text:a})}),n}function Wt(e){return e.datenzeilen.map((t,n)=>e.spalten.map((t,r)=>e.wertVon(n,r)))}function Gt(e){let t=Wt(e),n=qt(t,e.suchtext);return e.sortSpalte<0?n:ft(n.map(e=>t[e]),e.sortSpalte,e.sortAuf).map(e=>n[e])}function Kt(e){let t=e.gezeichnet??e.spalten,n=e.plaetze??t.map((e,t)=>t),r={gridTemplateColumns:pe(t,t=>e.breiteVon?.(n[t]??t))},i=e.gemessen?.zeilenHoehe??28,a=e.hatQuelle,o=!e.erfassungAn&&Yt(a,e.datenGeliefert,e.datenzeilen.length),s=Gt(e),c=e.erfassungAn?1+e.erfassteAnzahl:0,l=e.gemessen===null?null:Math.max(1,e.gemessen.passen-c),u={sichtbar:s,hatQuelle:a,proSeite:l??Math.max(1,10-c),wunschSeite:e.wunschSeite,platzhalterZeilen:Ct(l)},{seiten:d,seite:f,zeilen:p}=e.blaettert?Ot(u):Dt(u);return{cols:r,takt:28,zeilenHoehe:i,hatQuelle:a,leer:o,gesamt:s.length,seiten:d,seite:f,zeilen:p,linealTakte:Et(l,p.length),summen:Ut(e,s)}}function qt(e,t){let n=[];return e.forEach((e,r)=>{(0,re.zeilePasst)(e,t)&&n.push(r)}),n}function Jt(e,t){return!e&&t.trim()!==``}function Yt(e,t,n){return e&&t&&n===0}function Xt(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}var Zt=[(0,v.jaNeinProperty)(`tabelleAnsicht`,`Suchzeile`,`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,{requiresDataSource:!0}),(0,v.jaNeinProperty)(`erfassung`,`Erfassungszeile`,`Eine leere Zeile zum Tippen neuer Positionen.`),(0,v.jaNeinProperty)(`loeschbar`,`Zeilen löschbar`,`Kreuz an jeder Zeile: merkt sie zum Löschen vor.`,{requiresDataSource:!0}),(0,v.jaNeinProperty)(`blaettern`,`Blättern`,`Ja: Seiten mit Blätter-Knöpfen. Nein: alles untereinander, der Rumpf rollt.`),(0,v.jaNeinProperty)(`kopfzeile`,`Kopfzeile`,`Aus: keine Titelzeile, kein Sortieren per Titelklick.`),(0,v.jaNeinProperty)(`spaltenwahl`,`Spaltenwahl`,`In der Maske: Rechtsklick auf eine Spaltenüberschrift nimmt Spalten weg und holt sie zurück. Braucht die Kopfzeile.`),{attributeName:`tagField`,name:`Tag filtern nach`,description:`Datumsfeld. Gesetzt: nur Sätze des gewählten Tages.`,kind:`field`},(0,s.leerTextProperty)()],Z={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,kennungKey:`kennung`,standardTitel:b,eintragNeu:e=>{let t=E(e.spalten);return t.length>=16?{}:{spalten:me(t)}},eintragWeg:(e,t)=>{let n=E(e.spalten),r=ge(n,t);if(r===n)return{};let i=he(e.rechnung,n,r);return{spalten:[...r],...i===null?{}:{rechnung:i}}},eintragVerschieben:(e,t,n)=>{let r=E(e.spalten),i=_e(r,t,n);return i===r?{}:{spalten:[...i]}},eintragsUnterFenster:{label:`Suchfenster…`,hinweis:`Ohne Einstellung nimmt es die Spalten derselben Hilfsquelle.`,eigenschaft:`fensterDialogIndex`},eintragStellen:`[data-ff-eintrag]`,eintragsSchalter:[{key:`summe`,label:`Summe in der Fußzeile`,kurz:`Summe`},{key:`aenderbar`,label:`In der Zeile änderbar`,kurz:`änderbar`,standard:!0,nurEigeneQuelle:!0},{key:`versteckt`,label:`In der Maske ausblenden`,kurz:`ausgeblendet`}],herkunftProp:`spaltenHerkunft`,eintragsFeldWahl:[{key:`fuellFeld`,label:`Nachschlagen`,hinweis:`Beim Erfassen füllt der gewählte Satz der Hilfsquelle diese Zelle.`,nurFremdeQuellen:!0}]};function Qt(e){let t=e,n=Z.eintragsSchalter?.find(e=>e.key===`aenderbar`);return n!==void 0&&e.feld!==``&&(0,p.schalterFuer)(Z,t).includes(n)&&(0,p.schalterAn)(n,t)}function $t(t){if(t.linealTakte===0)return e.nothing;let r=t.linealTakte===null?t.cols:{...t.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${t.linealTakte})`};return e.html`<div class="lineal" role="presentation" style=${(0,n.styleMap)(r)}>
          ${t.spalten.map(()=>e.html`<div></div>`)}
        </div>`}function en(t,r){return e.html`
      ${t.zeigeSuche?e.html`<div class="suchzeile">
        <input
          ...
          @keydown=${e=>{e.key===`ArrowDown`&&Te(e.target)&&e.preventDefault()}}
        />
      </div>`:``}
      ...
      ${t.zeigeKopf?e.html`<div class="kopf" role="row" style=${(0,n.styleMap)(t.cols)}>
        ...
        ${t.zeilen.map((i,a)=>{let o=i!==null&&!t.imEditor,s=i!==null&&t.zeilenStand.istGeloescht(i),c=i===null?{status:`gebucht`,titel:``}:t.zeilenStand.statusVon(i);return e.html`<div
            ...
            @keydown=${e=>{if(!e.target.closest(`.zell-eingabe, button`)){if(e.key===`ArrowDown`||e.key===`ArrowUp`){let t=e.key===`ArrowUp`;(we(e.target,t?-1:1)||t&&Ee(e.target))&&e.preventDefault();return}if(e.key===`Delete`&&t.loeschbar&&i!==null&&!t.imEditor){e.preventDefault(),r.schalteLoeschung(i);return}e.key===`Enter`&&(e.preventDefault(),r.aktiviereZeile(i,a))}}}
          >
            ${``}
            ${t.spalten.map((n,r)=>{let o=t.plaetze[r],s=i===null?`—`:t.datenzeilen[i]?.[o]??``,l=t.imEditor&&!t.zeigeKopf&&t.editable;if(t.aendernMoeglich&&i!==null&&Qt(n)){let r=t.zeilenStand;return e.html`<div class="tippbar" role="cell">
                <input
                ...
                />
              </div>`}let u=[n.versteckt===!0?`versteckt`:``,i!==null&&K(s)!==null?`zahl`:``].filter(e=>e!==``).join(` `),d=r===0&&c.status===`fehler`?e.html`<span class="fehltext">${c.titel}</span>`:e.nothing;return e.html`<div
                class=${u===``?e.nothing:u}
                role="cell"
      ...
      ${Bt(t.spaltenwahl,r.spaltenwahl)}
    `}function tn(t,n){let r=t.hatQuelle||t.erfassungAn||t.seiten>1||t.summen.length>0||t.suchtAktiv||t.auswahlAktiv;if(t.leer||!r)return e.nothing;let i=t.buchen;return e.html`<div class="fusszeile">
    <div class="seiten-info">${Xt({hatQuelle:t.hatQuelle,sichtbar:t.sichtbar,gesamt:t.gesamt,suchtAktiv:t.suchtAktiv,auswahlAktiv:t.auswahlAktiv})}</div>
