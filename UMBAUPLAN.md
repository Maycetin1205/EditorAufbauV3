...
- [x] **T1 — Inventur** (Analyse, kein Code). ✅ 2026-09-01 Ergebnis = dieser Abschnitt samt der vier offenen Fragen in T5.
...
- [ ] **T5 — Nutzer-Entscheidungen umsetzen. WARTET auf vier Antworten:** (1) Vorgabe „In der Zeile änderbar" von JA auf NEIN drehen? (JA war Nutzer-Ansage 2026-08-28; NEIN passt zum neuen Grundsatz. Achtung: gespeichert wird nur die Abweichung — beim Drehen brauchen Altstände eine Migration, die ihr bisheriges effektives Verhalten festschreibt.) (2) Spaltenbreiten-Ziehen in der fertigen Maske behalten (heute: ja, flüchtig bis zum Neuladen) oder nur im Editor? (3) „Zeilen löschbar" (Vormerk-Kreuze an gebuchten Zeilen) — wird das gebraucht, oder fliegt das Feature? (4) Neue Tabelle: weiter 3 leere Standard-Spalten oder nur 1?
